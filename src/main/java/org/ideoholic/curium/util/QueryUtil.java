...
public class QueryUtil {
	...
	/**
	 * Helper to turn a list of ids into comma-separated String to use in an IN
	 * (...) clause. Kept simple as a convenience to reduce repetitive concat logic
	 * in DAO. NOTE: this does simple toString on elements; ensure ids list contains
	 * numeric ids.
	 */
