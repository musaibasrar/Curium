...
public class UserService {
    ...
    public DashBoardResponseDto dashBoard(SearchByDateDto dto, String branchId, String currentAcademicYear) {
        ...
        try {
            ...
            if (branchId != null) {
                ...
                //Fees Details
                feesCollectionService.getFeesDetailsDashBoard(
                    ClassesHierarchyDto.builder()
                        .classsecList(classsecList)
    ...
    public void feesdailysearch() {
        ...
        List<Receiptinfo> feesDetailsList;
        ...
        List<String> dailyDatesList = new LinkedList<>();
        List<String> totalFeesSum = new LinkedList<>();
    ...
    public ResultResponse backupData(String fileName) {
        ...
        try {
            ...
            log.debug("The backup directory from input stream is {}", backupDirectoryIS);
            ...
            log.error("Error in backupData", e);
            result.setSuccess(false);
        }
        return result;
    }
    ...
    public ResultResponse advanceSearchByParents(SearchByParentDto dto, String branchId) {
        ...
        try {
            if (branchId != null) {
                ...
                if (StringUtils.hasLength(mothersname)) {
                    querySub = querySub + " AND parents.mothersname like '%" + mothersname + "%'";
                } else if (StringUtils.hasLength(contactnumber)) {
                    querySub = querySub + " AND parents.contactnumber like '%" + contactnumber + "%'";
                }
            ...
            log.error("Error in advanceSearchByParents", e);
            result.setSuccess(false);
        }
        return result;
    }
    ...
    public SearchByDateResponseDto searchByDate(SearchByDateDto dto, String strBranchId, String dayOne, String dateFrom, String dateTo) {
        ...
        try {
            ...
            long fine = 0L;
            long misc = 0L;
            Map<Receiptinfo, Parents> feesMap = new HashMap<>();
            ...
            log.error("Error in searchByDate", e);
            result.setSuccess(false);
        }
        return result;
    }
