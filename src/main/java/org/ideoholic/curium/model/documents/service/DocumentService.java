	...
	public TransferCertificateResponseDto generateTransferCertificate(TransferCertificateDto transferCertificateDto) {
		...
		student.setSid(studentId);
			 ...
			 if(transferCertificate != null){
				 ...
				 String dateinword = new DateUtil().generateDateInWord(parents.getStudent().getDateofbirth());
				 ...
				 return transferCertificateResponseDto;
					...
					transferCertificateString = new DocumentDAO().generateTransferCertificate(tc,student,studentAdmissionStatus);
			}
