...
public class StudentDiaryDTO implements java.io.Serializable {
	...
	public StudentDiaryDTO(String classsec, int sid,String academicyear, int branchid, String subject, String message,
			Date startdate, Date enddate, Date createddate, int userid, String studentName) {
		this.sid = sid;
