...
public class FeesService {
	...
	public StudentIdDto applyConcession(ConcessionDto concessionDto, String academicYear, String branchId, String userId) {
        ...
        if(idFeesCategory!=null){
           ...
           feesCategoryDao.applyConcession(concessionList,transactionsReverseList,transactionsApplyList,updateDrAccountReverseList,updateCrAccountReverseList,updateDrAccountApplyList,updateCrAccountApplyList);
           studentIdDto.setStudentId(studentId);
           return studentIdDto;
        }
