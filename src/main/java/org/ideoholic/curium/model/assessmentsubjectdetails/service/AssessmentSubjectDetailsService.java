...
public class AssessmentSubjectDetailsService {
    ...
    public AssessmentSubjectsResponseDto readListOfAssessmentSubjects(String branchId) {
        ...
        try {
            List<AssessmentSubject> list = assessmentSubjectDetailsDAO.readListOfAssessmentSubjects(Integer.parseInt(branchId));
            result.setList(list);
        ...
        for (String clsCat : classesCat) {
            ...
            for (String sub : subjectNames) {
                if (branchId != null) {
                    ...
                    subject = assessmentSubjectDetailsDAO.addAssessmentSubject(subject);
                }
            }
        }
    ...
    public ResultResponse deleteMultiple(AssessmentSubjectIdsDto subjectIdsDto) {
        ...
        if (assessmentSubjectIds != null) {
            ...
            result = assessmentSubjectDetailsDAO.deleteMultiple(ids);
            return ResultResponse.builder().success(result).build();
        } else {
            result = false;
            return ResultResponse.builder().success(result).build();
    ...
    public ResultResponse addAssessmentSubjectMaster(AssessmentSubjectDto subjectDto, String branchId,
            String userLoginId) {
        ...
        if (branchId != null) {
            ...
            subject.setBranchid(Integer.parseInt(branchId));
            subject.setUserid(Integer.parseInt(userLoginId));
            subject = assessmentSubjectDetailsDAO.addAssessmentSubjectMaster(subject);
    ...
    public AssessmentSubjectsResponseDto readListOfSubjectNames(String branchId) {
        AssessmentSubjectsResponseDto result = new AssessmentSubjectsResponseDto();
        try {
            List<AssessmentSubjectMaster> list = assessmentSubjectDetailsDAO.readListOfSubjectNames(Integer.parseInt(branchId));
    ...
    public ResultResponse deleteMultipleSubjectMaster(AssessmentSubjectIdsDto subjectIdsDto) {
        ...
        if (subjectIds != null) {
            ...
            result = assessmentSubjectDetailsDAO.deleteMultipleSubjectMaster(ids);
            return ResultResponse.builder().success(result).build();
        } else {
            result = false;
            return ResultResponse.builder().success(result).build();
