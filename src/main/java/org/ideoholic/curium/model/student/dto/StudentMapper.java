 ...
 *
 */
@Mapper(imports = { StringUtils.class,DateUtil.class },
...
public interface StudentMapper {
	...
	@Mapping(target = "specialcategory", expression = "java(StringUtils.hasLength(studentDto.getNewcategory()) ? studentDto.getNewcategory() : studentDto.getSpecialcategory())")
	@Mapping(target = "newcateg", source = "newcategory")
