...
public class Studentotherfeesreprt {
	private Parents parent;
	private List<Studentotherfeesstructure> studentFeesStructure;
	private int userid;
	
	public Studentotherfeesreprt() {
	}


	public Studentotherfeesreprt(Parents parents, List<Studentotherfeesstructure> studentFeesStructure) {
		this.parent = parents;
