...
public class EmployeeService {
    ...
    return employeesWithSalaryResponseDto;
}
	...
	public ResultResponse exportDataForEmployees(EmployeeIdsDto dto, String branchId) {
	    ...
	    for (String id : employeeIds) {
	        employeeIdList.add(Integer.parseInt(id));
	    }
	                ...
	                List<Teacher> list = employeeDao.getTeachersList(Integer.parseInt(branchId),employeeIdList);
