...
public class UserServiceImpl implements UserService {
	...
	public void setHttpReqAndRes(HttpServletRequest request, HttpServletResponse response) {
	...
	public void dashBoard() {
		...
		if (httpSession.getAttribute(BRANCHID) != null) {
			...
			List<Classsec> classsecList = new StandardDetailsDAO()
					.viewClasses(Integer.parseInt(httpSession.getAttribute(BRANCHID).toString()));
