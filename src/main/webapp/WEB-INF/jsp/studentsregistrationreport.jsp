<%--
    Document   : Students Registration Report
...
<title>Students Registration Report</title>
...
<script type="text/javascript">
	function searchForStudents() {
		...
		form1.action = "/shatabdi/DocumentsProcess/multiClassSearchRegistrationReport";
		form1.method = "POST";
		form1.submit();
