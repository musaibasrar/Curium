                    ...
                    <td valign="top" background="/images/h_bg.jpg">
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
                            ...
                            <tr>
                            				...
                            				<td width="40" ><div align="center" ><a target="leftFrame" href="/shbranchtl/left"><img src="/shbranchtl/images/house_home.png" width="35" height="35" alt="Home" /></a><div class="noti_bubbleEmpty"></div><div id="" class="noti_bubbleEmpty"></div></td>
                            				<td><a target="leftFrame" href="/shbranchtl/left_admin" style="color:white;font-size: 11px;font-family: arial;">Home</a><div class="noti_bubbleEmpty"></div><div id="" class="noti_bubbleEmpty"></div></td>
