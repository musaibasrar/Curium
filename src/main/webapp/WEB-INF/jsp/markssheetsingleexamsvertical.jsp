...
<jsp:useBean id="now" class="java.util.Date" scope="page" />
	...
	<table style="page-break-inside: avoid;border-collapse: collapse;">
			<tr>
				<td style="padding-left: 200px;"><img src="/alirfan/images/alirfan.jpg" width="72" height="80"/></td>
				<td>
 ...
 <%-- <c:forEach items="${markssheetlist}" var="Parents" begin="0" end="0" step="1">
			...
			style="page-break-inside:avoid; border-collapse: collapse;">
						...
						<tr>
							...
							<td></td>
							<td></td>
							<td><img src="/alirfan/images/principalsignature.png" width="60" height="28"/></td>
						</tr>
				<tr>
				<td></td>
