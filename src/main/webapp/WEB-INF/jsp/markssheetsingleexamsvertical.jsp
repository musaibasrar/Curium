...
<jsp:useBean id="now" class="java.util.Date" scope="page" />
	...
	<table style="page-break-inside: avoid;border-collapse: collapse;">
			<tr>
				<td style="padding-left: 200px;"><img src="/gnyanganga/images/gnyanganga.jpg" width="72" height="80"/></td>
				<td>
	                                	...
	                                	<c:forEach items="${exammarks.subMarks}" var="submarks" >
	                                		...
	                                		<c:choose>
        										...
        										<c:otherwise>
	                                				...
	                                				<fmt:formatNumber value="${marksParts[0]}" type="number" minFractionDigits="0" maxFractionDigits="0"/>/${marksParts[1]}</td>
            										</td>
        										</c:otherwise>
    										</c:choose>
	                                	</c:forEach>
	                                			<td style="border: 1px solid black;text-align: left;">Total Marks Obtained</br><fmt:formatNumber value="${exammarks.totalMarksObtained}" type="number" minFractionDigits="0" maxFractionDigits="0"/></td>
                            					<td style="border: 1px solid black;text-align: left;">Total Marks</br><fmt:formatNumber value="${exammarks.totalMarks}" type="number" minFractionDigits="0" maxFractionDigits="0"/></td>
                            					<td style="border: 1px solid black;text-align: left;">Percentage</br>
                            					...
                            					<td style="border: 1px solid black;text-align: left;">Rank</br>${exammarks.rank}</td>
