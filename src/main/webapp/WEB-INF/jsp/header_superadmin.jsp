						...
						<tr style="height: 45px;">
							...
							<!-- <td align="left"><img src="/patriswamy/images/patriswamyheader.png"
								...
								<td><a href="javascript:parent.toggleLeftFrame()" style="cursor: pointer;"> <img
									src="/patriswamy/images/menu.svg" width="18" height="18" 
									alt="Toggle Menu" style="vertical-align: bottom;" />
							</a></td>
							
							<td><a target="leftFrame" href="/patriswamy/left_superadmin"> <img
							...
							<td>
								<a target="mainFrame"
								href="/patriswamy/AccountProcess/createVoucher"> <img
									src="/patriswamy/images/createvoucher.svg" width="18" height="18"
									alt="Create Voucher" style="vertical-align: bottom;" />
									Create Voucher
								</a>
							</td>

							<!-- <td ><a target="mainFrame" href="/patriswamy/feesCollectionDetails"><img  alt="Fees Details" src="/patriswamy/images/feescoll.png" width="30" height="30" /> <div id="" class="noti_bubbleEmpty"></div><div id="" class="noti_bubbleEmpty"></div></a></td>
                                            <td><label style="color:white;font-size: 12px;">Fees <br>Details</label></td> -->

							<td><a target="mainFrame"
								href="/patriswamy/StudentProcess/addNew"> <img
									src="/patriswamy/images/student_header.svg" width="18" height="18"
									alt="Add New Student" style="vertical-align: bottom;" />Add Student
							</a></td>

							<td ><a target="leftFrame" href="/patriswamy/leftsettings">
							...
							<td ><!-- <a target="mainFrame" href="/patriswamy/sendsms"><img
									src="/patriswamy/images/sendmessage.svg" width="18" height="18" alt="Send SMS" style="vertical-align: bottom;"/>
									Send Message		
							</a> -->
								<a target="leftFrame" href="/patriswamy/reports"><img
							...
							<td ><a target="mainFrame"
								href="/patriswamy/StudentProcess/viewAllStudentsWithParents"><img
									alt="View All Students" src="/patriswamy/images/students.svg" width="18"
									height="18" style="vertical-align: bottom;"/>
								View Students
							</a></td>
							
							<td ><a target="mainFrame"
                href="/patriswamy/UserProcess/superDashboard"><img
							...
							<td ><a target="_parent"
								href="/patriswamy/UserProcess/logout"><img
									src="/patriswamy/images/logout.svg" width="18" height="18" alt="Log Out" 
