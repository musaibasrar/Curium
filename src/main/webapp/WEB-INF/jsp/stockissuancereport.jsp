...
<script type="text/javascript">
	...
	function generateStockIssuanceReport() {
			...
			form1.action = "Controller?process=MessItemsProcess&action=generateStockIssuanceReport";
			form1.method = "POST";
			form1.submit();
	}
	 ...
	 function printRecords() {
			var form1 = document.getElementById("form1");
			form1.action = "Controller?process=MessItemsProcess&action=printStockIssuanceReport";
			form1.method = "POST";
			form1.submit();
		}
