<%--
    Document   : Stock Issuance Report
...
<script type="text/javascript">
	...
	function generateStockIssuanceReport() {
			...
			form1.action = "/brilliantgrammar/MessItemsProcess/generateStockIssuanceReport";
			form1.method = "POST";
			form1.submit();
	}
	 ...
	 function printRecords() {
			var form1 = document.getElementById("form1");
			form1.action = "/brilliantgrammar/MessItemsProcess/printStockIssuanceReport";
			form1.method = "POST";
			form1.submit();
		}
...
<body>
	...
	<form id="form1"
		...
		<div style="overflow: scroll; height: 600px">
			<table width="100%">
				<tr>
					<td class="headerTD">Stock Issuance Report <br>
