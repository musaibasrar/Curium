...
<style>
 ...
 <tr>
 <td style="writing-mode:vertical-lr;background-color: #701704;color:white;border-radius: 5px;text-align: center;font-weight: bold;transform:rotate(180deg);"> ${currentAcademicYear}
 </td>
 <td align="center">
 <img src="data:image;base64,<%= request.getSession().getAttribute("employeephoto" + i + "")%>" style="height:75px;width:75px;border: 1px solid black;border-radius: 50%;" alt="Photo" />
 </td>
 ...
 IDENTITY-CARD
  ...
  <tr>
    <td style="padding: 0;white-space: nowrap;">&nbsp;&nbsp;QUALIFICATION</td>
