	...
	text-align: center;
        ...
        <script type="text/javascript">
            ...
            function updateContact() {
                ...
                form1.action = "/hamidullah/PersonalProcess/updateContactDetails?id=1";
                form1.submit();
            }
...
<style>
   ...
   /* .table-container table {
    ...
    <body class="bodymargin">
        ...
        <form action="/hamidullah/" method="post" id="form1" class="bodymargin">
 ...
 <td>&nbsp;&nbsp;
 <img src="/hamidullah/images/hamidullah.png" width="72" height="72"/>
 </td>
 </tr>
 </table>
   </div>
   ...
   <% i = i + 1;%>
                   ...
                   <table  width="70%"  id="table11" align="left">
                    <tr>
                        ...
                        <td>
                            <button id="print" type="button" style="background-image: url(/hamidullah/images/print.jpg);width: 63px;height: 60px" onclick="window.print();
