 ...
 --%>
    ...
    <div class="accordion" style="width: 100%;height: 100%">
                ...
                <div>
                    ...
                    <td>
                    <a download="studentdoc1.jpg" href="/fathima/data:image/jpg;base64,<c:out value="${student.studentdoc1}"/>">Download</a>
                    </td>
                    </tr>
                    ...
                    <td>
                    <a download="studentdoc2.jpg" href="/fathima/data:image/jpg;base64,<c:out value="${student.studentdoc2}"/>">Download</a>
                    </td>
                    </tr>
                    ...
                    <td>
                    <a download="studentdoc3.jpg" href="/fathima/data:image/jpg;base64,<c:out value="${student.studentdoc3}"/>">Download</a>
                    </td>
                    </tr>
                    ...
                    <td>
                    <a download="studentdoc4.jpg" href="/fathima/data:image/jpg;base64,<c:out value="${student.studentdoc4}"/>">Download</a>
                    </td>
                    </tr>
                    ...
                    <td>
                    <a download="studentdoc5.jpg" href="/fathima/data:image/jpg;base64,<c:out value="${student.studentdoc5}"/>">Download</a>
                    </td>
                    </tr>
                    </table>
                </div>
    ...
    <div class="accordion" style="width: 100%;height: 100%">
        ...
        <script>
            ...
            function Print(){
                var form1=document.getElementById("form1");
                form1.action="/fathima/StudentProcess/printAdmissionForm";
                form1.submit();
            }
        </script>
    </body>
