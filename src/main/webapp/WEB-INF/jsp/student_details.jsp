 ...
 --%>
    ...
    <div class="accordion" style="width: 100%;height: 100%">
                    ...
                    <tbody>
                        <c:forEach items="${receiptinfonarration}" var="receiptinfo">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" target="_blank" href="/iqraschool/FeesCollection/ViewDetails?id=<c:out value='${receiptinfo.key.receiptnumber}'/>&sid=<c:out value='${student.sid}'/>">View Details</a></td>
                            </tr>
                        </c:forEach>
                    ...
                    <tbody>
                        <c:forEach items="${otherreceiptinfo}" var="otherreceiptinfo">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" target="_blank" href="/iqraschoolold/FeesCollection/viewOtherFeesDetails?id=<c:out value='${otherreceiptinfo.receiptnumber}'/>&sid=<c:out value='${student.sid}'/>">View Details</a></td>
        ...
        <script>
            ...
            function Print(){
                var form1=document.getElementById("form1");
                form1.action="/iqraschool/StudentProcess/printAdmissionForm";
                form1.submit();
            }
        </script>
    </body>
