...
%>
 ...
 --%>
                         ...
                         <tr>
                         <td  width="25%"  class="alignLeft" height="50" >Weight
                            </td>
                            <td width="25%" class="tablerows" >
                               <c:out default="" value="${student.bhagyalakshmibondnumber}" />
                            </td>
                            <td  width="25%"  class="alignLeft" height="50" >height
                            </td>
                            <td width="25%" class="tablerows" >
    ...
    <div class="accordion" style="width: 100%;height: 100%">
                ...
                <div>
                    ...
                    <td>
                    <a download="studentdoc1.jpg" href="/children/data:image/jpg;base64,<c:out value="${student.studentdoc1}"/>">Download</a>
                    </td>
                    </tr>
                    ...
                    <td>
                    <a download="studentdoc2.jpg" href="/children/data:image/jpg;base64,<c:out value="${student.studentdoc2}"/>">Download</a>
                    </td>
                    </tr>
                    ...
                    <td>
                    <a download="studentdoc3.jpg" href="/children/data:image/jpg;base64,<c:out value="${student.studentdoc3}"/>">Download</a>
                    </td>
                    </tr>
                    ...
                    <td>
                    <a download="studentdoc4.jpg" href="/children/data:image/jpg;base64,<c:out value="${student.studentdoc4}"/>">Download</a>
                    </td>
                    </tr>
                    ...
                    <td>
                    <a download="studentdoc5.jpg" href="/children/data:image/jpg;base64,<c:out value="${student.studentdoc5}"/>">Download</a>
                    </td>
                    </tr>
                    </table>
                </div>
                ...
                <div>
                    ...
                    <table  border="0px" width="100%"  id="table1" align="center">
                        ...
                        <td width="25%"   class="alignLeft" height="50" >Languages Studied</td>
                            ...
                            <td width="25%"   class="alignLeft" height="50" >Percentage of Marks</td>
                            <td width="25%" class="tablerows" >
    ...
    <div class="accordion" style="width: 100%;height: 100%">
        ...
        <script>
            ...
            function Print(){
                var form1=document.getElementById("form1");
                form1.action="/children/StudentProcess/printAdmissionForm";
                form1.submit();
            }
        </script>
    </body>
