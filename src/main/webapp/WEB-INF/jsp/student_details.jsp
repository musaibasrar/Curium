 ...
 --%>
                        ...
                        <tr>
                         ...
                         <td  width="25%"  class="alignLeft" height="50" >RTE
                            ...
                            <td  width="25%"  class="alignLeft" height="50">Identification Mark
                            </td>
                            <td width="25%" class="tablerows" >
                    ...
                    <tbody>
                        <c:forEach items="${receiptinfonarration}" var="receiptinfo">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" target="_blank" href="/jdh/FeesCollection/ViewDetails?id=<c:out value='${receiptinfo.key.receiptnumber}'/>&sid=<c:out value='${student.sid}'/>">View Details</a></td>
                            </tr>
                        </c:forEach>
