...
<body>
    <div class="receipt-container">
        ...
        <div class="header">
            ...
            <div class="school-info" style="padding-right: 130px;">
...
www.daralmajdschool.com</div>
        ...
        <table class="fees-table">
            ...
            <c:set var="itemTotalNet" value="${0}" />
            	...
            	<tr>
                    <td>
	                    <c:set var="fullName" value="${feescatmap.key.otherfeescategory.feescategoryname}" />
                    ...
                    <c:if test="${applyVAT==1}">
								...
								<c:choose>
									<c:when	test="${fn:containsIgnoreCase(feescatmap.key.otherfeescategory.feescategoryname, 'tuition fee')}">
										<fmt:formatNumber
                    ...
                    <td>
                    	<c:if test="${applyVAT==1}">
                    		...
                    		<c:choose>
									<c:when
										test="${fn:containsIgnoreCase(feescatmap.key.otherfeescategory.feescategoryname, 'tuition fee')}">
