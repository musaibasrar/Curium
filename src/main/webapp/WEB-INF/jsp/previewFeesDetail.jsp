            ...
            <TABLE id="dataTable" width="100%" border="1" >
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <td align="center"><a id="print" href="/brightschool/FeesCollection/printReceipt?id=<c:out value="${recieptinfo.receiptnumber}" />&sid=<c:out value="${student.sid}"/>">Print</a></td>
                    </tr>
                </tfoot>
            </TABLE>
