    ...
    <head>
        ...
        <script type="text/javascript">
             ...
             function printReceipt(){
            	 ...
            	 //document.location.href = "/akshara/FeesProcess/feesCollect"; 
             }
        </script>
    </head>
      <%
            ...
            <table  width="100%">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="width: 20%">Receipt No:  <c:out value="${recieptinfo.branchreceiptnumber}/${recieptinfo.academicyear}" /></td>
            ...
            <TABLE id="dataTable" width="100%" border="1" >
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <td align="center"><a id="print" href="/akshara/FeesCollection/printReceipt?id=<c:out value="${recieptinfo.receiptnumber}" />&sid=<c:out value="${student.sid}"/>">Print</a></td>
                    </tr>
                </tfoot>
            </TABLE>
