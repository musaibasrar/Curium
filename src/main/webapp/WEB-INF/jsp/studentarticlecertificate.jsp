...
<script type="text/javascript">
	function searchStudentsForBonafide() {
		...
		form1.action = "/brilliantgrammar/DocumentsProcess/searchStudentsForArticle";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/brilliantgrammar/DocumentsProcess/GenerateArticle" method="POST">
