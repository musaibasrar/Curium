...
<html>
    <head>
        ...
        <script src="/sac/js/echarts/echarts.min.js"></script>
    </head>
            ...
            <div class="row dashboard-grid">
                    ...
                    <div class="summary-card summary-card--students">
                        <div class="summary-card__row">
                            <div class="summary-card__icon">
                                <img src="/sac/images/student.svg" alt="Students" />
                            </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-12 mb-4">
                    <div class="summary-card summary-card--fees">
                        <div class="summary-card__row">
                            <div class="summary-card__icon">
                                <img src="/sac/images/totalfees.svg" alt="Fees" />
                            </div>
                            <div class="summary-card__content">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-12 mb-4">
                    <div class="summary-card summary-card--revenue">
                        <div class="summary-card__row">
                            <div class="summary-card__icon">
                                <img src="/sac/images/feespaid.svg" alt="Fees Paid" />
                            </div>
                            <div class="summary-card__content">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-12 mb-4">
                    <div class="summary-card summary-card--today">
                        <div class="summary-card__row">
                            <div class="summary-card__icon">
                                <img src="/sac/images/todayscollection.svg" alt="Today" />
                            </div>
                            <div class="summary-card__content">
