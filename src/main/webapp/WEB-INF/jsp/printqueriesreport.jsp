<%-- 
    Document   : Print Assignment Report
...
<c:set var="itemTotal" value="${0}" />
	<form method="post" class="bodymargin">
		<table width="100%" style="border-collapse: collapse;">
			<tr>
				<td align="center">
				<img src="/childrenandglobal/images/childrenandglobal${branchid}.png" width="150" height="141"/>
				</td>
				<td class="dataTextBoldCenter" style="width: 100%">
				<label style="text-transform: uppercase;font-size: 24px;">${branchname}</label>
				<br>
				<label class="addressLineTwo">${branchaddress}</label>
				<br>
				<label class="addressLine">Assignment Report</label><br>
			...
			<tbody>
						...
						<c:forEach items="${parentquerylist}" var="query" varStatus="status">
                            <tr>
                                ...
                                <td class="datatd" style="font-size: 9px;"><fmt:formatDate pattern="dd/MM/yyyy" value="${query.expecteddeliverydate}"/></td>
                            </tr>
                        </c:forEach>
