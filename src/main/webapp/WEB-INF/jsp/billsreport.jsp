...
<script type="text/javascript"
	...
	<!-- Select drop down -->	
	<!-- <link href="/brilliantgrammar/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css"> -->
...
<script type="text/javascript">
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/brilliantgrammar/MessItemsMoveProcess/printStockMove";
		form1.method = "POST";
		form1.submit();
	}
	...
	function generateBillsReport() {
		var form1 = document.getElementById("form1");
		form1.action = "/brilliantgrammar/MessItemsMoveProcess/generateBillsReport";
		form1.method = "POST";
		form1.submit();
	}
			...
			<div align="center">
             <%--For displaying Previous link except for the 1st page --%>
                <c:if test="${currentPage != 1}">
                    <td><a style="color: #4B6A84;font-size: 12px" href="/brilliantgrammar/MessItemsMoveProcess/generateBillsReport?page=${currentPage - 1}&transactiondatefrom=${transactiondatefromselected}&transactiondateto=${transactiondatetoselected}">Previous</a></td>
                </c:if>
                    ...
                    <tr>
                        <c:forEach begin="1" end="${noOfPages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <td style="color: black;font-weight:bold;font-size: 15px "><a style="color: #4B6A84" href="/brilliantgrammar/MessItemsMoveProcess/generateBillsReport?page=${i}&transactiondatefrom=${transactiondatefromselected}&transactiondateto=${transactiondatetoselected}">${i}</a></td>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                    </tr>
                ...
                <c:if test="${currentPage lt noOfPages}">
                    <td ><a style="color: #4B6A84;font-size: 12px" href="/brilliantgrammar/MessItemsMoveProcess/generateBillsReport?page=${currentPage + 1}&transactiondatefrom=${transactiondatefromselected}&transactiondateto=${transactiondatetoselected}">Next</a></td>
                </c:if>
                    </div>
