...
<script type="text/javascript"
	...
	<!-- Select drop down -->	
	<!-- <link href="/daralmajd/css/bootstrap.min.css" rel="stylesheet" id="bootstrap-css"> -->
<script src="/daralmajd/js/bootstrap.min.js"></script>
<!-- <script src="/daralmajd/js/jquery.min.js"></script> -->


<link href="/daralmajd/css/select2.min.css" rel="stylesheet" />
<script src="/daralmajd/js/select2.min.js"></script>
...
<script type="text/javascript">
	...
	function saveissueentry() {
		...
		if(form1.checkValidity()) {
			form1.action = "/daralmajd/MessItemsMoveProcess/saveStockMove";
			form1.method = "POST";
			form1.submit();
		}
	...
	function cancelRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/daralmajd/MessItemsMoveProcess/cancelStockMove";
		form1.method = "POST";
		form1.submit();
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/daralmajd/AdminProcess/printVoucher";
		form1.method = "POST";
		form1.submit();
	}
	...
	function approveRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/daralmajd/AdminProcess/approveVoucher";
		form1.method = "POST";
		form1.submit();
	}
	...
	function rejectRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/daralmajd/AdminProcess/rejectVoucher";
		form1.method = "POST";
		form1.submit();
	}
	...
	function generateBillsReport() {
		var form1 = document.getElementById("form1");
		form1.action = "/daralmajd/MessItemsMoveProcess/generateBillsReport";
		form1.method = "POST";
		form1.submit();
	}
	...
	function getLastPrice(rowIndex){
		...
		var customerName = document.getElementById('issuedto').value;
			...
			xmlHttp.open("GET", "/daralmajd/CustomerLastPrice/getCustomerLastPrice&customerName="+customerName+"&itemid="+itemId+"",true);
			xmlHttp.send(null);
	}
			...
			<div align="center">
             <%--For displaying Previous link except for the 1st page --%>
                <c:if test="${currentPage != 1}">
                    <td><a style="color: #4B6A84;font-size: 12px" href="/daralmajd/MessItemsMoveProcess/generateBillsReport?page=${currentPage - 1}&transactiondatefrom=${transactiondatefromselected}&transactiondateto=${transactiondatetoselected}">Previous</a></td>
                </c:if>
                    ...
                    <tr>
                        <c:forEach begin="1" end="${noOfPages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <td style="color: black;font-weight:bold;font-size: 15px "><a style="color: #4B6A84" href="/daralmajd/MessItemsMoveProcess/generateBillsReport?page=${i}&transactiondatefrom=${transactiondatefromselected}&transactiondateto=${transactiondatetoselected}">${i}</a></td>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                    </tr>
                ...
                <c:if test="${currentPage lt noOfPages}">
                    <td ><a style="color: #4B6A84;font-size: 12px" href="/daralmajd/MessItemsMoveProcess/generateBillsReport?page=${currentPage + 1}&transactiondatefrom=${transactiondatefromselected}&transactiondateto=${transactiondatetoselected}">Next</a></td>
                </c:if>
                    </div>
