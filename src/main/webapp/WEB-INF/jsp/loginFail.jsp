...
<head>
	...
	<link rel="stylesheet" href="/childrenandglobal/css/bootstrap3.min.css">
	<script type="text/javascript" src="/childrenandglobal/js/openWindow.js"></script>
...
.btn:hover, .btn:focus{
	...
	color:#fff;
	     ...
	     <script type="text/javascript">
            ...
            function redirect(){
                ...
                form1.action="/childrenandglobal/UserProcess/authenticate";
                form1.submit();
            }
        </script>
    ...
    <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <script type="text/javascript">
            ...
            if(flag1){
            	...
            	if(type=='superadmin'){
                    window.open('/childrenandglobal/index_superadmin','_self');
                }else if(type=='admin'){
                    window.open('/childrenandglobal/index_admin','_self');
            	...
            	window.open('/childrenandglobal/loginFail','_self');
            }
        </script>
	...
	<div class="container-fluid">
		<div class="row main-content bg-success text-center">
			...
			<div class="col-md-8 col-xs-12 col-sm-12 login_form ">
				<div class="container-fluid">
					<div class="row">
						<!-- <span class="company__logo"><h2><img border="0" style="vertical-align: text-bottom;height: 50px;width: 73px;" alt="ideoholic" src="/childrenandglobal/images/shaheenlogo.png"></h2></span> -->
						<h3>Log In</h3>
						<p align="center" style="color: red;font-size: 10px;">Please enter correct username and password</p>
					</div>
					<div class="row">
						<form action="/childrenandglobal/UserProcess/authenticateUser" id="loginForm" method="post" class="form-group">
							<div class="row">
	...
	<div class="container-fluid text-center footer">
		<p>
			<!-- <p>An <img border="0" style="vertical-align: text-bottom;" alt="ideoholic" src="/childrenandglobal/images/ideoholic.png"> image with a default alignment.</p> --> 
			
			<a href="http://www.ideoholic.com" >
				Powered by <img border="0" style="vertical-align: text-bottom;" alt="ideoholic" src="/childrenandglobal/images/ideoholic.png">
			</a>
