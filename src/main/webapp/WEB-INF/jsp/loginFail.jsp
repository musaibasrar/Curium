...
.btn:hover, .btn:focus{
	...
	<div class="container-fluid">
		<div class="row main-content bg-success text-center">
			...
			<h2><img border="0" style="vertical-align: text-bottom;height: 9s0px;width: 220px;" alt="ideoholic" src="/demov2/images/demov2.png"></h2>
			...
			<div class="col-md-8 col-xs-12 col-sm-12 login_form ">
				<div class="container-fluid">
					...
					<div class="row">
						<form action="/demov2/UserProcess/authenticateUser"  method="post" class="form-group">
							<div class="row">
