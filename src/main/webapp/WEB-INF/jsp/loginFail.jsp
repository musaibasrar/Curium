...
.btn:hover, .btn:focus{
 ...
 <script type="text/javascript">
            ...
            function redirect(){
                ...
                form1.action="/sla/UserProcess/authenticate";
                form1.submit();
            }
        </script>
    ...
    <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        <script type="text/javascript">
            ...
            if(flag1){
            	...
            	window.open('/sla/loginFail','_self');
            }
        </script>
                    	<!-- Main Content -->
	<div class="container-fluid">
		<div class="row main-content bg-success text-center">
			...
			<div class="col-md-8 col-xs-12 col-sm-12 login_form ">
				<div class="container-fluid">
					<div class="row">
						<!-- <span class="company__logo"><h2><img border="0" style="vertical-align: text-bottom;height: 50px;width: 73px;" alt="ideoholic" src="/sla/images/shaheenlogo.png"></h2></span> -->
						<h3>Log In</h3>
						<p align="center" style="color: red;font-size: 10px;">Please enter correct username and password</p>
					</div>
					<div class="row">
						<form action="/sla/UserProcess/authenticateUser"  method="post" class="form-group">
							<div class="row">
