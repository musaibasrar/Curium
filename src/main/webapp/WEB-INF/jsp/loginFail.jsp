...
<head>
	...
	<link rel="stylesheet" href="/alhidaya/css/bootstrap3.min.css">
	<script type="text/javascript" src="/alhidaya/js/openWindow.js"></script>
...
.btn:hover, .btn:focus{
	...
	color:#fff;
	     ...
	     <script type="text/javascript">
            ...
            function redirect(){
                ...
                form1.action="/alhidaya/UserProcess/authenticate";
                form1.submit();
            }
        </script>
        ...
        <script type="text/javascript">
            ...
            if(flag1){
            	...
            	if(type=='superadmin'){
                	...
                	window.open('/alhidaya/index_officeadmin','_self');
                }else if(type=='marksentry'){
                	window.open('/alhidaya/index_marksentry','_self');
                }
            }
            else if(!flag1){
            	window.open('/alhidaya/loginFail','_self');
            }
        </script>
	...
	<div class="container-fluid">
		<div class="row main-content bg-success text-center">
			...
			<div class="col-md-8 col-xs-12 col-sm-12 login_form ">
				<div class="container-fluid">
					<div class="row">
						<!-- <span class="company__logo"><h2><img border="0" style="vertical-align: text-bottom;height: 50px;width: 73px;" alt="ideoholic" src="/alhidaya/images/shaheenlogo.png"></h2></span> -->
						<h3>Log In</h3>
						<p align="center" style="color: red;font-size: 10px;">Please enter correct username and password</p>
					</div>
					<div class="row">
						<form action="/alhidaya/UserProcess/authenticateUser"  method="post" class="form-group">
							<div class="row">
	...
	<div class="container-fluid text-center footer">
		<p>
			<!-- <p>An <img border="0" style="vertical-align: text-bottom;" alt="ideoholic" src="/alhidaya/images/ideoholic.png"> image with a default alignment.</p> --> 
			
			<a href="http://www.ideoholic.com" >
				Powered by <img border="0" style="vertical-align: text-bottom;" alt="ideoholic" src="/alhidaya/images/ideoholic.png">
			</a>
