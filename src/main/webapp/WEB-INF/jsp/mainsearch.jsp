...
<script src="/sla/js/datePicker/jquery-1.7.1.js"></script>
<script src="/sla/js/datePicker/ui/jquery.ui.core.js"></script>
<script src="/sla/js/datePicker/ui/jquery.ui.widget.js"></script>
<script src="/sla/js/datePicker/ui/jquery.ui.datepicker.js"></script>
<script src="/sla/js/datePicker/ui/jquery.ui.tabs.js"></script>
...
<script src="/sla/js/validation/jquery.ketchup.all.min.js"></script>
<script type="text/javascript"
...
<script src="/sla/JavaScript/actb.js"></script>
<script src="/sla/JavaScript/common.js"></script>
...
%>
<body>							
	<form id="form1" action="/sla/UserProcess/advanceMainSearch"
		method="post">
		<%
		...
		<div>
			<div id="tabs">
				<ul>
					<li><a href="#tabs-1">Create Job/Appointment</a></li>
				...
				<div id="tabs-1">
					<table style="width: auto;height: auto;" border="0" align="center" id="table1">
						...
						<tr>
									<td align="center"><h2 style="text-decoration: underline;color: #eb6000">Search Clients</h2><br /></td>
						</tr>
						
						<tr>
							<td class="alignLeft">Contact Number &nbsp;</td>
							<td ><label> <input name="contactnumber"
									type="text" class="myclass" id="contactnumber" size="36"
						...
						<script type="text/javascript">
							function searchStudent() {
								...
								form1.action = "/sla/UserProcess/advanceMainSearch";
								form1.submit();
							}
