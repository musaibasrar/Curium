                 ...
                 <tbody>
                    ...
                    <td class="alignLeft" style="width: 45%">Admission No: &nbsp;&nbsp;&nbsp;&nbsp; <input  type="text" name="admnoDetails" required id="admnoDetails" readonly value="${admnoDetails}" class="myclass" style="border: none;"/> <input name="studentIdDetails" type="hidden" id="studentIdDetails" value="${studentIdDetails}" /> </td>
                        ...
                        <c:if test="${(username == 'admin')}">
                         <input type="text" name="dateoffeesDetails" id="dateoffeesDetails" class="myclass" value="${dateoffeesDetails}" />
                        </c:if>
                        <c:if test="${(username == 'arshiya')}">
                         <input type="text" name="dateoffeesDetails" id="dateoffeesDetails" class="myclass" value="${dateoffeesDetails}" readonly/>
                        </c:if>
                        <c:if test="${(username == 'gulnaaz')}">
                         <input type="text" name="dateoffeesDetails" id="dateoffeesDetails" class="myclass" value="${dateoffeesDetails}" readonly/>
                        </c:if>
                    ...
                    <tbody>
                        <c:forEach items="${receiptinfo}" var="receiptinfo">
                            ...
                            <tr style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextFeesCollection"><a class="dataTextInActive" target="_blank" href="/abc/FeesCollection/ViewDetails?id=<c:out value='${receiptinfo.receiptnumber}'/>&sid=<c:out value='${student.sid}'/>">View Details</a></td>
