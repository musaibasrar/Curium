...
<html>
 ...
 function submitfees(cashpayment,banktransfer,chequetransfer,ackno,transferdate,transferbankname,chequeno,chequedate,chequebankname){
        		...
        		form1.action="/littleangel/FeesCollection/feesAdd?paymentmethod="+paymentmethodvalue+"&ackno="+acknovalue+"&transferdate="+transferdatevalue+"&transferbankname="+transferbanknamevalue+"&chequeno="+chequenovalue+"&chequedate="+chequedatevalue+"&chequebankname="+chequebanknamevalue+"";
        		form1.method = "POST";
        		form1.submit();
            ...
            function getstampfees(){
            	var form1 = document.getElementById("form1");
        		form1.action="/littleangel/FeesCollection/StampFees";
        		form1.method = "POST";
        		form1.submit();
            }
