        ...
        <div id="container" style="width: 95%" >
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/global/DocumentsProcess/studentsDetailsReports" style="font-size: 12px;">Detail Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/global/DocumentsProcess/studentsAdmissionReports" style="font-size: 12px;">Admission Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/global/DocumentsProcess/studentsPendingAdmissionReports" style="font-size: 12px;">Pending Admission Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/global/ClassProcess/viewGraduated" style="font-size: 12px;">Graduated Student</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/global/ClassProcess/viewLeftOut" style="font-size: 12px;">Former Students</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/global/ClassProcess/viewDropped" style="font-size: 12px;">Dropped Out Students</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/global/DocumentsProcess/studentsRegistrationReports" style="font-size: 12px;">Registration Report</a>
            			</td>
            		</tr>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/global/feessummary" style="font-size: 12px;">Fees Summary</a>
            			</td>
            		</tr>
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/global/FeesProcess/feesReportDue" style="font-size: 12px;">Fees Due Report</a>
            			</td>
            		</tr>
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/global/feescollectiondetailscategory" style="font-size: 12px;">Fees Collection Head Wise</a>
            			</td>
            		</tr>
            		
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/global/FeesProcess/feesDueReportHeadWise" style="font-size: 12px;">Fees Due Head Wise</a>
            			</td>
            		</tr>
            		
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/global/FeesProcess/feesDueStampFees" style="font-size: 12px;">Fees Stamp Due Report</a>
            			</td>
            		</tr>
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				<a target="mainFrame" href="/global/feescancelledreceipts" style="font-size: 12px;">Cancelled Fees Receipts</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/global/FeesProcess/otherfeesReport" style="font-size: 12px;">Bus Fees Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/global/otherfeesCollectionDetails" style="font-size: 12px;">Bus Fees Collection Details</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/global/FeesProcess/defaulterReport" style="font-size: 12px;">Defaulter Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/global/FeesProcess/dndReport" style="font-size: 12px;">DND Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				<a target="mainFrame" href="/global/otherfeescancelledreceipts" style="font-size: 12px;">Cancelled Bus Fees Receipts</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/global/FeesProcess/feesOutstanding" style="font-size: 12px;">Fees Outstanding</a>
            			</td>
            		</tr>
                </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/global/MarksDetailsProcess/progressReportSingleExams" style="font-size: 12px;">Marks Card</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/global/MarksDetailsProcess/progressReport" style="font-size: 12px;">Consolidated Marks Card</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/global/MarksDetailsProcess/prePrimaryProgressReport" style="font-size: 12px;">Pre Primary Marks Card</a>
            			</td>
            		</tr>
            				<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/global/MarksDetailsProcess/finalExamReport" style="font-size: 12px;">Final Exam Marks Card</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/global/MarksDetailsProcess/rankReport" style="font-size: 12px;">Generate Student Rank</a>
            			</td>
            		</tr>
                </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				<a target="mainFrame" href="/global/receiptpayment" style="font-size: 12px;">R & P Statement</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				<a target="mainFrame" href="/global/daybook" style="font-size: 12px;">Day Book</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/global/adminexpensesreport" style="font-size: 12px;">Expense Report</a>
            			</td>
            		</tr>
                </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/global/bookhistory" style="font-size: 12px;">Books Issue Report</a>
            			</td>
            		</tr>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/global/MessItemsMoveProcess/generateBillsReport" style="font-size: 12px;">Receipts Report</a>
            			</td>
            		</tr>
            		
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/global/MessItemsMoveProcess/getDueReport" style="font-size: 12px;">Due Report</a>
            			</td>
            		</tr>
            		
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/global/MessItemsMoveProcess/getDueReport" style="font-size: 12px;">Unpaid Receipts</a>
            			</td>
            		</tr>
                </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/global/TeachersPerformanceProcess/SearchTeachers" style="font-size: 12px;">Subject Performance</a>
            			</td>
            		</tr>
			...
			<table style="border-collapse: collapse; width: 100%">
				<tr>
					<td
						...
						<a target="mainFrame"
						href="/global/JobProcess/queryReport"
			...
			<table style="border-collapse: collapse; width: 100%">
				...
				<tr>
					<td
						style="text-align: left; padding: 4px; padding-left: 20px; background-color: #f5f8f9;">
						<a target="mainFrame"
						href="/global/JobProcess/taskReport"
		 ...
		 <h5 class="sideaccordian" ><a href="#" >Attendance</a></h5>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/global/AttendanceProcess/attendanceReport" style="font-size: 12px;">Attendance Report</a>
            			</td>
            		</tr>
		...
		<div style="padding-left: 0px; padding-right: 0px;">
			<table style="border-collapse: collapse; width: 100%">
				<tr>
					<td
						style="text-align: left; padding: 4px; padding-left: 20px; background-color: #f5f8f9;">
						<a target="mainFrame"
						href="/global/AppointmentProcess/appointmentReport"
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/global/SMSProcess/SMSDeliveryReport" style="font-size: 12px;">SMS Report</a>
            			</td>
            		</tr>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/global/DocumentsProcess/getTcDetail" style="font-size: 12px;">Transfer Certificate Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/global/DocumentsProcess/getScDetail" style="font-size: 12px;">Study Certificate Report</a>
            			</td>
            		</tr>
