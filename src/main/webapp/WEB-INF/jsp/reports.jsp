        ...
        <div id="container" style="width: 95%" >
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/daralmajd/DocumentsProcess/studentsDetailsReports" style="font-size: 12px;">Detail Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/daralmajd/DocumentsProcess/studentsAdmissionReports" style="font-size: 12px;">Admission Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/daralmajd/DocumentsProcess/studentsPendingAdmissionReports" style="font-size: 12px;">Pending Admission Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/daralmajd/ClassProcess/viewGraduated" style="font-size: 12px;">Graduated Student</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/daralmajd/ClassProcess/viewLeftOut" style="font-size: 12px;">Former Students</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/daralmajd/ClassProcess/viewDropped" style="font-size: 12px;">Dropped Out Students</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/daralmajd/DocumentsProcess/studentsRegistrationReports" style="font-size: 12px;">Registration Report</a>
            			</td>
            		</tr>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/daralmajd/feessummary" style="font-size: 12px;">Fees Summary</a>
            			</td>
            		</tr>
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/daralmajd/FeesProcess/feesReportDue" style="font-size: 12px;">Fees Due Report</a>
            			</td>
            		</tr>
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/daralmajd/feescollectiondetailscategory" style="font-size: 12px;">Fees Collection Head Wise</a>
            			</td>
            		</tr>
            		
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/daralmajd/FeesProcess/feesDueReportHeadWise" style="font-size: 12px;">Fees Due Head Wise</a>
            			</td>
            		</tr>
            		
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/daralmajd/FeesProcess/feesDueStampFees" style="font-size: 12px;">Fees Stamp Due Report</a>
            			</td>
            		</tr>
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				<a target="mainFrame" href="/daralmajd/feescancelledreceipts" style="font-size: 12px;">Cancelled Fees Receipts</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/daralmajd/FeesProcess/otherfeesReport" style="font-size: 12px;">Other Fees Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/daralmajd/otherfeesCollectionDetails" style="font-size: 12px;">Other Fees Collection Details</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/daralmajd/FeesProcess/defaulterReport" style="font-size: 12px;">Defaulter Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/daralmajd/FeesProcess/dndReport" style="font-size: 12px;">DND Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				<a target="mainFrame" href="/daralmajd/otherfeescancelledreceipts" style="font-size: 12px;">Cancelled Other Fees Receipts</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/daralmajd/FeesProcess/feesOutstanding" style="font-size: 12px;">Fees Outstanding</a>
            			</td>
            		</tr>
                </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/daralmajd/MarksDetailsProcess/progressReportSingleExams" style="font-size: 12px;">Marks Card</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/daralmajd/MarksDetailsProcess/progressReport" style="font-size: 12px;">Consolidated Marks Card</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/daralmajd/MarksDetailsProcess/prePrimaryProgressReport" style="font-size: 12px;">Pre Primary Marks Card</a>
            			</td>
            		</tr>
            				<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/daralmajd/MarksDetailsProcess/finalExamReport" style="font-size: 12px;">Final Exam Marks Card</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/daralmajd/MarksDetailsProcess/rankReport" style="font-size: 12px;">Generate Student Rank</a>
            			</td>
            		</tr>
                </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				<a target="mainFrame" href="/daralmajd/receiptpayment" style="font-size: 12px;">R & P Statement</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				<a target="mainFrame" href="/daralmajd/daybook" style="font-size: 12px;">Day Book</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/daralmajd/adminexpensesreport" style="font-size: 12px;">Expense Report</a>
            			</td>
            		</tr>
                </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/daralmajd/bookhistory" style="font-size: 12px;">Books Issue Report</a>
            			</td>
            		</tr>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/daralmajd/MessItemsMoveProcess/generateBillsReport" style="font-size: 12px;">Receipts Report</a>
            			</td>
            		</tr>
            		
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/daralmajd/MessItemsMoveProcess/getDueReport" style="font-size: 12px;">Due Report</a>
            			</td>
            		</tr>
            		
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/daralmajd/MessItemsMoveProcess/getDueReport" style="font-size: 12px;">Unpaid Receipts</a>
            			</td>
            		</tr>
                </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/daralmajd/TeachersPerformanceProcess/SearchTeachers" style="font-size: 12px;">Subject Performance</a>
            			</td>
            		</tr>
			...
			<table style="border-collapse: collapse; width: 100%">
				<tr>
					<td
						...
						<a target="mainFrame"
						href="/daralmajd/JobProcess/queryReport"
			...
			<table style="border-collapse: collapse; width: 100%">
				...
				<tr>
					<td
						style="text-align: left; padding: 4px; padding-left: 20px; background-color: #f5f8f9;">
						<a target="mainFrame"
						href="/daralmajd/JobProcess/taskReport"
		 ...
		 <h5 class="sideaccordian" ><a href="#" >Attendance</a></h5>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/daralmajd/AttendanceProcess/attendanceReport" style="font-size: 12px;">Attendance Report</a>
            			</td>
            		</tr>
		...
		<div style="padding-left: 0px; padding-right: 0px;">
			<table style="border-collapse: collapse; width: 100%">
				<tr>
					<td
						style="text-align: left; padding: 4px; padding-left: 20px; background-color: #f5f8f9;">
						<a target="mainFrame"
						href="/daralmajd/AppointmentProcess/appointmentReport"
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/daralmajd/SMSProcess/SMSDeliveryReport" style="font-size: 12px;">SMS Report</a>
            			</td>
            		</tr>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/daralmajd/DocumentsProcess/getTcDetail" style="font-size: 12px;">Transfer Certificate Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/daralmajd/DocumentsProcess/getScDetail" style="font-size: 12px;">Study Certificate Report</a>
            			</td>
            		</tr>
