        ...
        <div id="container" style="width: 95%" >
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/bsr/DocumentsProcess/studentsDetailsReports" style="font-size: 12px;">Detail Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/bsr/DocumentsProcess/studentsAdmissionReports" style="font-size: 12px;">Admission Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/bsr/DocumentsProcess/studentsPendingAdmissionReports" style="font-size: 12px;">Pending Admission Report</a>
            			</td>
            		</tr>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/bsr/feessummary" style="font-size: 12px;">Fees Summary</a>
            			</td>
            		</tr>
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/bsr/FeesProcess/feesDueStampFees" style="font-size: 12px;">Fees Stamp Due Report</a>
            			</td>
            		</tr>
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/bsr/FeesProcess/otherfeesReport" style="font-size: 12px;">Other Fees Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/bsr/otherfeesCollectionDetails" style="font-size: 12px;">Other Fees Collection Details</a>
            			</td>
            		</tr>
                </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/bsr/MarksDetailsProcess/progressReport" style="font-size: 12px;">Generate Marks Card</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/bsr/adminexpensesreport" style="font-size: 12px;">Expense Report</a>
            			</td>
            		</tr>
                </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/bsr/MessItemsMoveProcess/billsReport" style="font-size: 12px;">Receipts Report</a>
            			</td>
            		</tr>
            		
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/bsr/MessItemsMoveProcess/getDueReport" style="font-size: 12px;">Due Report</a>
            			</td>
            		</tr>
                </table>
            </div>
