...
<script type="text/javascript">
    function saveEnquiryForm() {
        ...
        form1.action = "/readmodelschool/EnquiryProcess/saveEnquiryFormOnline";
        form1.method = "POST";
        form1.submit();
        }
    }
            ...
            <div class="application-card">
                <div id="tabs">
                    <div class="card-header">
                        <div class="card-logo">
                            <img border="0" style="vertical-align: text-bottom;height: 100px;width: 100px;" alt="ideoholic" src="/readmodelschool/images/readmodelschool.png">
                        </div>
