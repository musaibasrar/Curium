...
<script type="text/javascript">
    function saveEnquiryForm() {
        ...
        form1.action = "/alfarooq/EnquiryProcess/saveEnquiryFormOnline";
        form1.method = "POST";
        form1.submit();
        }
    }
            ...
            <div class="application-card">
                <div id="tabs">
                    <div class="card-header">
                        <div class="card-logo">
                            <img border="0" style="vertical-align: text-bottom;height: 80px;width: 140px;" alt="ideoholic" src="/alfarooq/images/alfarooq.png">
                        </div>
