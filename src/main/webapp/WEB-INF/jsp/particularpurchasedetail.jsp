...
<script type="text/javascript">
	...
	function saveInventory() {
		...
		if(form1.checkValidity()) {
			form1.action = "/nortuntrading/MessItemsProcess/savePurchase";
			form1.method = "POST";
			form1.submit();
		}
...
<body>
	...
	<c:forEach items="${invoicelist}" var="invoicelist" varStatus="status">
						<tr style="border-color: #000000" border="1" cellpadding="1"
						  ...
						  <td class="dataText"><a href="/nortuntrading/MessItemsProcess/particularOrderDetail?id=<c:out value='${invoicelist.key.externalId}'/>">Receive</a></td>
