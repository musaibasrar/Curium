...
<script type="text/javascript">
	...
	function savePeriods() {
		...
		form1.action = "/brilliantgrammar/PeriodProcess/savePeriods";
		form1.method = "POST";
		form1.submit();
	}
	...
	function deleteRecord(){
		var form1 = document.getElementById("form1");
		form1.action = "/brilliantgrammar/PeriodProcess/deletePeriods";
		form1.method = "POST";
		form1.submit();
	}
...
<body>
	<form id="form1" method="POST">
		...
		<div style="overflow: scroll; height: 600px">
			<table width="100%">
				<tr>
					<td class="headerTD">Classes Time Table</td>
				</tr>
			</table>
				...
				<tbody>
					...
					<c:forEach items="${periodmasterlist}" var="periodmasterlist">
						...
						<tr style="border-color: #000000" border="1" cellpadding="1"
							...
							<td class="dataText"><a class="dataTextInActive" href="/brilliantgrammar/PeriodProcess/viewTimeTable?id=<c:out value="${periodmasterlist.idperiodmaster}" />"><c:out value="${periodmasterlist.class_}" /></a></td>
