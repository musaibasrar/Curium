...
<script type="text/javascript">
	...
	function savePeriods() {
		...
		form1.action = "/madina/PeriodProcess/savePeriods";
		form1.method = "POST";
		form1.submit();
	}
	...
	function deleteRecord(){
		var form1 = document.getElementById("form1");
		form1.action = "/madina/PeriodProcess/deletePeriods";
		form1.method = "POST";
		form1.submit();
	}
				...
				<tbody>
					...
					<c:forEach items="${periodmasterlist}" var="periodmasterlist">
						...
						<tr style="border-color: #000000" border="1" cellpadding="1"
							...
							<td class="dataText"><a class="dataTextInActive" href="/madina/PeriodProcess/viewTimeTable?id=<c:out value="${periodmasterlist.idperiodmaster}" />"><c:out value="${periodmasterlist.class_}" /></a></td>
