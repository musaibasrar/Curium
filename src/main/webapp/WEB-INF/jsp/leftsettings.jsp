...
%>
    <body onload="StartClock()" onunload="KillClock()">
        ...
        <div id="container" style="width: 95%" >
            ...
            <div>
                <a target="mainFrame" href="/alirfan/FeesProcess/otherFeesView" style="font-size: 12px;">Other Fees Category</a><br/>
                <a target="mainFrame" href="/alirfan/StampFeesProcess/showOtherFeesDetails" style="font-size: 12px;">Other Fee Stamp</a><br/>
            ...
            <div >
                <a target="mainFrame" href="/alirfan/HrProcess/leaveType" style="font-size: 12px;">Leave Type</a><br/>
                <a target="mainFrame" href="/alirfan/HrProcess/assignLeave" style="font-size: 12px;">Assign/View Leave</a><br/>
                <a target="mainFrame" href="/alirfan/HrProcess/payHead" style="font-size: 12px;">Pay Head</a><br/>
                <a target="mainFrame" href="/alirfan/HrProcess/addPayHead" style="font-size: 12px;">Add Pay Head</a><br/>
                <a target="mainFrame" href="/alirfan/HrProcess/deletePayHead" style="font-size: 12px;">Delete Pay Head</a><br/>
                <a target="mainFrame" href="/alirfan/HrProcess/basicPaySettings" style="font-size: 12px;">Apply Basic Pay</a><br/>
                <a target="mainFrame" href="/alirfan/HrProcess/viewEditbasicPay" style="font-size: 12px;">View/Edit Basic Pay</a><br/>
                <a target="mainFrame" href="/alirfan/HrProcess/pfSettings" style="font-size: 12px;">PF Settings</a><br/>
            </div>
