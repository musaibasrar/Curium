...
%>
    <body onload="StartClock()" onunload="KillClock()">
        ...
        <div id="container" style="width: 95%" >
            ...
            <div>
                <a target="mainFrame" href="/cambridge/YearProcess/updateYear" style="font-size: 12px;">Academic year</a><br/>
                <a target="mainFrame" href="/cambridge/PeriodProcess/periodConfiguration" style="font-size: 12px;">Time Table</a><br/>
            </div>
            
            <h5 style="font-size: 12px"><a href="#">Class</a></h5>
            <div>
                <a target="mainFrame" href="/cambridge/ClassProcess/viewClasses" style="font-size: 12px;">Add Classes</a><br/>
            </div>
            ...
            <div>
                ...
                <a target="mainFrame" href="/cambridge/StampFeesProcess/showSingleFeesDetails" style="font-size: 12px;">Stamp Single Fee</a><br/>
                <a target="mainFrame" href="/cambridge/FeesProcess/bulkConcession" style="font-size: 12px;">Bulk Concession</a>
            </div>
            ...
            <div>
                <a target="mainFrame" href="/cambridge/ExamDetailsProcess/readListOfExams" style="font-size: 12px;">Exam Details</a><br/>
                <a target="mainFrame" href="/cambridge/ExamDetailsProcess/examSchedule" style="font-size: 12px;">Exam Schedule</a><br/>
                <a target="mainFrame" href="/cambridge/SubjectDetailsProcess/readListOfSubjectNames" style="font-size: 12px;">Subject Master</a><br/>
                <a target="mainFrame" href="/cambridge/SubjectDetailsProcess/readListOfSubjects" style="font-size: 12px;">Subject Details</a>
                <a target="mainFrame" href="/cambridge/SubjectDetailsProcess/subSubjectsDetails" style="font-size: 12px;">Sub Subject Details</a>
            </div>
            
            <h5 style="font-size: 12px"><a href="#">Attendance</a></h5>
            <div>
                <a target="mainFrame" href="/cambridge/AttendanceProcess/attendanceConfiguration" style="font-size: 12px;">Staff/Students</a><br/>
                <a target="mainFrame" href="/cambridge/AttendanceProcess/viewAllHolidays" style="font-size: 12px;">Holidays/WeeklyOff</a><br/>
            </div>
            
              <h5 style="font-size: 12px"><a href="#" >Promotion</a></h5>
            <div>
				<a target="mainFrame" href="/cambridge/ClassProcess/classHierarchy" style="font-size: 12px;">Class Hierarchy</a><br/>
            </div>
            
            <h5 style="font-size: 12px"><a href="#">Staff</a></h5>
            <div>
                
                <a target="mainFrame" href="/cambridge/DepartmentProcess/departmentView" style="font-size: 12px;">Add Department</a><br/>
                <a target="mainFrame" href="/cambridge/PositionProcess/positionView" style="font-size: 12px;">Add Position</a><br/>
            </div>
            ...
            <div >
                <a target="mainFrame" href="/cambridge/HrProcess/leaveType" style="font-size: 12px;">Leave Type</a><br/>
                <a target="mainFrame" href="/cambridge/HrProcess/assignLeave" style="font-size: 12px;">Assign/View Leave</a><br/>
                <a target="mainFrame" href="/cambridge/HrProcess/payHead" style="font-size: 12px;">Pay Head</a><br/>
                <a target="mainFrame" href="/cambridge/HrProcess/addPayHead" style="font-size: 12px;">Add Pay Head</a><br/>
                <a target="mainFrame" href="/cambridge/HrProcess/deletePayHead" style="font-size: 12px;">Delete Pay Head</a><br/>
                <a target="mainFrame" href="/cambridge/HrProcess/basicPaySettings" style="font-size: 12px;">Apply Basic Pay</a><br/>
                <a target="mainFrame" href="/cambridge/HrProcess/viewEditbasicPay" style="font-size: 12px;">View/Edit Basic Pay</a><br/>
                <a target="mainFrame" href="/cambridge/HrProcess/pfSettings" style="font-size: 12px;">PF Settings</a><br/>
            </div>
