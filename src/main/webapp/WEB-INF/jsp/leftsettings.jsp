...
%>
    <body onload="StartClock()" onunload="KillClock()">
        ...
        <div id="container" style="width: 95%" >
            ...
            <div>
                <a target="mainFrame" href="/brainystars/YearProcess/updateYear" style="font-size: 12px;">Academic year</a><br/>
                <a target="mainFrame" href="/brainystars/PeriodProcess/periodConfiguration" style="font-size: 12px;">Time Table</a><br/>
            </div>
            
            <h5 style="font-size: 12px"><a href="#">Class</a></h5>
            <div>
                <a target="mainFrame" href="/brainystars/ClassProcess/viewClasses" style="font-size: 12px;">Add Classes</a><br/>
            </div>
            ...
            <div>
                <a target="mainFrame" href="/brainystars/FeesProcess/otherFeesView" style="font-size: 12px;">Bus Fees Category</a><br/>
                <a target="mainFrame" href="/brainystars/StampFeesProcess/showOtherFeesDetails" style="font-size: 12px;">Bus Fee Stamp</a><br/>
            ...
            <div>
                <a target="mainFrame" href="/brainystars/HolisticAssessmentProcess/readListOfAssessments" style="font-size: 12px;">Assessment Details</a><br/>
                <!-- <a target="mainFrame" href="/brainystars/HolisticAssessmentProcess/assessmentSchedule" style="font-size: 12px;">Assessment Schedule</a><br/> -->
                <a target="mainFrame" href="/brainystars/AssessmentSubjectDetailsProcess/readListOfSubjectNames" style="font-size: 12px;">Assessment Subject Master</a><br/>
                <a target="mainFrame" href="/brainystars/AssessmentSubjectDetailsProcess/readListOfSubjects" style="font-size: 12px;">Assessment Subject Details</a>
            </div>
            
            <h5 style="font-size: 12px"><a href="#">Attendance</a></h5>
            <div>
                <a target="mainFrame" href="/brainystars/AttendanceProcess/attendanceConfiguration" style="font-size: 12px;">Staff/Students</a><br/>
                <a target="mainFrame" href="/brainystars/AttendanceProcess/viewAllHolidays" style="font-size: 12px;">Holidays/WeeklyOff</a><br/>
            </div>
            
              <h5 style="font-size: 12px"><a href="#" >Promotion</a></h5>
            <div>
				<a target="mainFrame" href="/brainystars/ClassProcess/classHierarchy" style="font-size: 12px;">Class Hierarchy</a><br/>
            </div>
            
            <h5 style="font-size: 12px"><a href="#">Staff</a></h5>
            <div>
                
                <a target="mainFrame" href="/brainystars/DepartmentProcess/departmentView" style="font-size: 12px;">Add Department</a><br/>
                <a target="mainFrame" href="/brainystars/PositionProcess/positionView" style="font-size: 12px;">Add Position</a><br/>
            </div>

            <h5 style="font-size: 12px"><a href="#" >Accounts</a></h5>
            <div >
                <a target="mainFrame" href="/brainystars/AccountProcess/getCurrentFinancialYear" style="font-size: 12px;">Accounting Year</a><br/>
            </div>
            
             <h5 style="font-size: 12px"><a href="#" >H.R.</a></h5>
            <div >
                <a target="mainFrame" href="/brainystars/HrProcess/leaveType" style="font-size: 12px;">Leave Type</a><br/>
                <a target="mainFrame" href="/brainystars/HrProcess/assignLeave" style="font-size: 12px;">Assign/View Leave</a><br/>
                <a target="mainFrame" href="/brainystars/HrProcess/payHead" style="font-size: 12px;">Pay Head</a><br/>
                <a target="mainFrame" href="/brainystars/HrProcess/addPayHead" style="font-size: 12px;">Add Pay Head</a><br/>
                <a target="mainFrame" href="/brainystars/HrProcess/deletePayHead" style="font-size: 12px;">Delete Pay Head</a><br/>
                <a target="mainFrame" href="/brainystars/HrProcess/basicPaySettings" style="font-size: 12px;">Apply Basic Pay</a><br/>
                <a target="mainFrame" href="/brainystars/HrProcess/viewEditbasicPay" style="font-size: 12px;">View/Edit Basic Pay</a><br/>
                <a target="mainFrame" href="/brainystars/HrProcess/pfSettings" style="font-size: 12px;">PF Settings</a><br/>
            </div>
