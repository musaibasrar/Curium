    ...
    <body onload="StartClock()" onunload="KillClock()">
        ...
        <div id="container" style="width: 95%" >
            ...
            <div>
                ...
                <a target="mainFrame" href="/rahmani/StampFeesProcess/showSingleFeesDetails" style="font-size: 12px;">Stamp Single Fee</a><br/>
            ...
            <div>
                <a target="mainFrame" href="/rahmani/FeesProcess/otherFeesView" style="font-size: 12px;">Other Fees Category</a><br/>
                <a target="mainFrame" href="/rahmani/StampFeesProcess/showOtherFeesDetails" style="font-size: 12px;">Other Fee Stamp</a><br/>
            ...
            <div>
                ...
                <a target="mainFrame" href="/rahmani/SubjectDetailsProcess/subSubjectsDetails" style="font-size: 12px;">Sub Subject Details</a>
            </div>
            
            <h5 style="font-size: 12px"><a href="#">Holistic Development Assessment</a></h5>
            <div>
                <a target="mainFrame" href="/rahmani/HolisticAssessmentProcess/readListOfAssessments" style="font-size: 12px;">Assessment Details</a><br/>
                <!-- <a target="mainFrame" href="/rahmani/HolisticAssessmentProcess/assessmentSchedule" style="font-size: 12px;">Assessment Schedule</a><br/> -->
                <a target="mainFrame" href="/rahmani/AssessmentSubjectDetailsProcess/readListOfSubjectNames" style="font-size: 12px;">Assessment Subject Master</a><br/>
                <a target="mainFrame" href="/rahmani/AssessmentSubjectDetailsProcess/readListOfSubjects" style="font-size: 12px;">Assessment Subject Details</a>
            </div>
            ...
            <div>
                ...
                <a target="mainFrame" href="/rahmani/DepartmentProcess/departmentView" style="font-size: 12px;">Add Department</a><br/>
            ...
            <div >
                <a target="mainFrame" href="/rahmani/HrProcess/leaveType" style="font-size: 12px;">Leave Type</a><br/>
                <a target="mainFrame" href="/rahmani/HrProcess/assignLeave" style="font-size: 12px;">Assign/View Leave</a><br/>
                <a target="mainFrame" href="/rahmani/HrProcess/payHead" style="font-size: 12px;">Pay Head</a><br/>
                <a target="mainFrame" href="/rahmani/HrProcess/addPayHead" style="font-size: 12px;">Add Pay Head</a><br/>
                <a target="mainFrame" href="/rahmani/HrProcess/deletePayHead" style="font-size: 12px;">Delete Pay Head</a><br/>
