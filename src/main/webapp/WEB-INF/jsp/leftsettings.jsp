...
%>
    <body onload="StartClock()" onunload="KillClock()">
        ...
        <div id="container" style="width: 95%" >
            ...
            <div>
                <a target="mainFrame" href="/vasu/YearProcess/updateYear" style="font-size: 12px;">Academic year</a><br/>
                <a target="mainFrame" href="/vasu/PeriodProcess/periodConfiguration" style="font-size: 12px;">Time Table</a><br/>
            </div>
            
            <h5 style="font-size: 12px"><a href="#">Class</a></h5>
            <div>
                <a target="mainFrame" href="/vasu/ClassProcess/viewClasses" style="font-size: 12px;">Add Classes</a><br/>
            </div>
            
            <h5 style="font-size: 12px"><a href="#">Fees</a></h5>
            <div>
                <a target="mainFrame" href="/vasu/FeesProcess/feesView" style="font-size: 12px;">Fees Category</a><br/>
                <a target="mainFrame" href="/vasu/StampFeesProcess/showFeesDetails" style="font-size: 12px;">Stamp Fee</a><br/>
            </div>
            
            <h5 style="font-size: 12px"><a href="#">Other Fee</a></h5>
            <div>
                <a target="mainFrame" href="/vasu/FeesProcess/otherFeesView" style="font-size: 12px;">Other Fees Category</a><br/>
                <a target="mainFrame" href="/vasu/StampFeesProcess/showOtherFeesDetails" style="font-size: 12px;">Other Fee Stamp</a><br/>

            </div>
            
            <h5 style="font-size: 12px"><a href="#">Exams</a></h5>
            <div>
                <a target="mainFrame" href="/vasu/ExamDetailsProcess/readListOfExams" style="font-size: 12px;">Exam Details</a><br/>
                <a target="mainFrame" href="/vasu/ExamDetailsProcess/examSchedule" style="font-size: 12px;">Exam Schedule</a><br/>
                <a target="mainFrame" href="/vasu/SubjectDetailsProcess/readListOfSubjectNames" style="font-size: 12px;">Subject Master</a><br/>
                <a target="mainFrame" href="/vasu/SubjectDetailsProcess/readListOfSubjects" style="font-size: 12px;">Subject Details</a>
                <a target="mainFrame" href="/vasu/SubjectDetailsProcess/subSubjectsDetails" style="font-size: 12px;">Sub Subject Details</a>
            </div>
            
            <h5 style="font-size: 12px"><a href="#">Attendance</a></h5>
            <div>
                <a target="mainFrame" href="/vasu/AttendanceProcess/attendanceConfiguration" style="font-size: 12px;">Staff/Students</a><br/>
                <a target="mainFrame" href="/vasu/AttendanceProcess/viewAllHolidays" style="font-size: 12px;">Holidays/WeeklyOff</a><br/>
            </div>
            
              <h5 style="font-size: 12px"><a href="#" >Promotion</a></h5>
            <div>
				<a target="mainFrame" href="/vasu/ClassProcess/classHierarchy" style="font-size: 12px;">Class Hierarchy</a><br/>
            </div>
            
            <h5 style="font-size: 12px"><a href="#">Staff</a></h5>
            <div>
                
                <a target="mainFrame" href="/vasu/DepartmentProcess/departmentView" style="font-size: 12px;">Add Department</a><br/>
                <a target="mainFrame" href="/vasu/PositionProcess/positionView" style="font-size: 12px;">Add Position</a><br/>
            </div>

            <h5 style="font-size: 12px"><a href="#" >Accounts</a></h5>
            <div >
                <a target="mainFrame" href="/vasu/AccountProcess/getCurrentFinancialYear" style="font-size: 12px;">Accounting Year</a><br/>
            </div>
            
             <h5 style="font-size: 12px"><a href="#" >H.R.</a></h5>
            <div >
                <a target="mainFrame" href="/vasu/HrProcess/leaveType" style="font-size: 12px;">Leave Type</a><br/>
                <a target="mainFrame" href="/vasu/HrProcess/assignLeave" style="font-size: 12px;">Assign/View Leave</a><br/>
                <a target="mainFrame" href="/vasu/HrProcess/payHead" style="font-size: 12px;">Pay Head</a><br/>
                <a target="mainFrame" href="/vasu/HrProcess/addPayHead" style="font-size: 12px;">Add Pay Head</a><br/>
                <a target="mainFrame" href="/vasu/HrProcess/deletePayHead" style="font-size: 12px;">Delete Pay Head</a><br/>
                <a target="mainFrame" href="/vasu/HrProcess/basicPaySettings" style="font-size: 12px;">Apply Basic Pay</a><br/>
                <a target="mainFrame" href="/vasu/HrProcess/viewEditbasicPay" style="font-size: 12px;">View/Edit Basic Pay</a><br/>
                <a target="mainFrame" href="/vasu/HrProcess/pfSettings" style="font-size: 12px;">PF Settings</a><br/>
            </div>
