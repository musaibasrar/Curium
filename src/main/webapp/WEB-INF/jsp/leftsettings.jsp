    ...
    <body onload="StartClock()" onunload="KillClock()">
        ...
        <div id="container" style="width: 95%" >
            ...
            <div>
                ...
                <a target="mainFrame" href="/noble/StampFeesProcess/showFeesDetailsAllStudents" style="font-size: 12px;">Stamp Fee All</a><br/>
                <a target="mainFrame" href="/noble/StampFeesProcess/showSingleFeesDetails" style="font-size: 12px;">Stamp Single Fee</a><br/>
                <a target="mainFrame" href="/noble/FeesProcess/bulkConcession" style="font-size: 12px;">Bulk Concession</a>
            </div>
            
            <h5 style="font-size: 12px"><a href="#">Bus Fee</a></h5>
            <div>
                <a target="mainFrame" href="/noble/FeesProcess/otherFeesView" style="font-size: 12px;">Bus Fees Category</a><br/>
                <a target="mainFrame" href="/noble/StampFeesProcess/showOtherFeesDetails" style="font-size: 12px;">Bus Fee Stamp</a><br/>
            ...
            <div>
                ...
                <a target="mainFrame" href="/noble/SubjectDetailsProcess/subSubjectsDetails" style="font-size: 12px;">Sub Subject Details</a>
            </div>
