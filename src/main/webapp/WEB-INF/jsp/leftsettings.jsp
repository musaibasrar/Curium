    ...
    <body onload="StartClock()" onunload="KillClock()">
        ...
        <div id="container" style="width: 95%" >
            ...
            <div>
                ...
                <a target="mainFrame" href="/mfds/DepartmentProcess/departmentView" style="font-size: 12px;">Add Department</a><br/>
            ...
            <div >
                <a target="mainFrame" href="/mfds/HrProcess/leaveType" style="font-size: 12px;">Leave Type</a><br/>
                <a target="mainFrame" href="/mfds/HrProcess/assignLeave" style="font-size: 12px;">Assign/View Leave</a><br/>
                <a target="mainFrame" href="/mfds/HrProcess/payHead" style="font-size: 12px;">Pay Head</a><br/>
                <a target="mainFrame" href="/mfds/HrProcess/addPayHead" style="font-size: 12px;">Add Pay Head</a><br/>
                <a target="mainFrame" href="/mfds/HrProcess/deletePayHead" style="font-size: 12px;">Delete Pay Head</a><br/>
