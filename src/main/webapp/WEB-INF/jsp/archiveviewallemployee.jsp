    ...
    <head >
        ...
        <script type="text/javascript">
            function deleteRecords(){
                ...
                form1.action="/beaconias/EmployeeProcess/deleteMultipleEmployee";
               form1.submit();
                
            }
            function restoreRecords(){
                var form1=document.getElementById("form1");
                 form1.action="/beaconias/EmployeeProcess/restoreMultiple";
                form1.submit();
            }
                    ...
                    <tbody>
                        <c:forEach items="${studentListArchive}" var="Employee">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/beaconias/EmployeeProcess/ViewDetails?id=<c:out value='${employee.tid}'/>"><c:out value="${Employee.teachername}"/></a></td>
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/beaconias/EmployeeProcess/ViewDetails?id=<c:out value='${employee.tid}'/>"><c:out value="${Employee.contactnumber}"/></a></td>
