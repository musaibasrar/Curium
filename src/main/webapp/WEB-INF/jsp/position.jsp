...
<script type="text/javascript">
	function addPosition() {
		...
		form1.action = "/childrenandglobal/PositionProcess/addPosition";
		form1.method = "POST";
		form1.submit();
	...
	function deletePosition() {
		var form1 = document.getElementById("form1");
		form1.action = "/childrenandglobal/PositionProcess/deleteMultiple";
		form1.method = "POST";
		form1.submit();
...
<body>
	<form id="form1"
		action="/childrenandglobal/PositionProcess/deleteMultiple" method="POST">
