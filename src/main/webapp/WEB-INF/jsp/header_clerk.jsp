    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 45px;">
							...
							<td><a target="leftFrame" href="/shatabdi/left_clerk"> <img
							...
							<td ><a target="leftFrame" href="/shatabdi/leftsettings_clerk">
...
<!-- 							<td ><a target="mainFrame"
							...
							<td ><!-- <a target="mainFrame" href="/shatabdi/sendsms"><img
								...
								<a target="leftFrame" href="/shatabdi/reports_clerk"><img
