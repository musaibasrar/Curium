    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function updateStaff(){
                ...
                form1.action="/nortuntrading/EmployeeProcess/updateEmployeeDetails?id=<c:out value='${employee.tid}'/>";
                form1.submit();
            }
                ...
                .click(function() {
                    Cancel();
                            ...
                            <script type="text/javascript">
                                ...
                                function Cancel(){
                                    var form1=document.getElementById("form1");
                                    form1.action="/nortuntrading/EmployeeProcess/viewAllEmployee";
                                    form1.submit();
                                }
                            </script>
