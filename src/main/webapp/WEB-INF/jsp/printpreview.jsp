    ...
    <head >
        ...
        <script type="text/javascript">
            ...
            function updateContact() {
                ...
                form1.action = "/iica/PersonalProcess/updateContactDetails?id=1";
                form1.submit();
            }
...
<style>
    ...
    <body class="bodymargin">
        ...
        <form action="/iica/" method="post" id="form1" class="bodymargin">
  ...
  <div class="table-container" style="margin-bottom: 5px;">
    <table>
      <tr>
        <td>
          <img src="/iica/images/idlogo.png" alt="Brainy Stars" width="180" height="70">
        </td>
      </tr>
    </table>
   ...
   <% i = i + 1;%>
                   ...
                   <table  width="70%"  id="table11" align="left">
                    <tr>
                        ...
                        <td>
                            <button id="print" type="button" style="background-image: url(/iica/images/print.jpg);width: 63px;height: 60px" onclick="window.print();
