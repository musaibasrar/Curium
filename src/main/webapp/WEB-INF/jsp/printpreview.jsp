    ...
    <head >
        ...
        <script type="text/javascript">
            ...
            function updateContact() {
                ...
                form1.action = "/riyan/PersonalProcess/updateContactDetails?id=1";
                form1.submit();
            }
...
.container {
    ...
    <body class="bodymargin">
        ...
        <form action="/riyan/" method="post" id="form1" class="bodymargin">
                ...
                <table cellpadding="2"  border="0">
                    ...
                    <c:forEach begin="1" end="${endValue}">
                        ...
                        <tr>
                            ...
                            <td class="fontsize" >
                         <div class="card">
  								<img src="/riyan/images/logo.jpg" alt="Avatar" style="width:100%">
  								<div class="container">
