	...
	text-align: center;
        ...
        <script type="text/javascript">
            ...
            function updateContact() {
                ...
                form1.action = "/sanmarg/PersonalProcess/updateContactDetails?id=1";
                form1.submit();
            }
...
<style>
   ...
   /* .table-container table {
    ...
    <body class="bodymargin">
        ...
        <form action="/sanmarg/" method="post" id="form1" class="bodymargin">
 ...
 <td>&nbsp;&nbsp;
 <img src="/sanmarg/images/sanmarg${branchid}.png" width="61" height="72"/>
 </td>
 </tr>
 </table>
   </div>
...
<img src="/sanmarg/images/principalsignature.png" width="30" height="25"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<div>
principal&nbsp;&nbsp;&nbsp;</div>
</div>
</div>
   ...
   <% i = i + 1;%>
                   ...
                   <table  width="70%"  id="table11" align="left">
                    <tr>
                        ...
                        <td>
                            <button id="print" type="button" style="background-image: url(/sanmarg/images/print.jpg);width: 63px;height: 60px" onclick="window.print();
