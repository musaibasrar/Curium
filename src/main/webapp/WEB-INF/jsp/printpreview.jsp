    ...
    <head >
        ...
        <script type="text/javascript">
            ...
            function updateContact() {
                ...
                form1.action = "/jihtel/PersonalProcess/updateContactDetails?id=1";
                form1.submit();
            }
...
.container {
    ...
    <body class="bodymargin">
        ...
        <form action="/jihtel/" method="post" id="form1" class="bodymargin">
                ...
                <table cellpadding="2"  border="0">
                    ...
                    <c:forEach begin="1" end="${endValue}">
                        ...
                        <tr>
                            ...
                            <td class="fontsize" >
                         <div class="card">
  								<img src="/jihtel/images/logo.jpg" alt="Avatar" style="width:100%">
  								<div class="container">
