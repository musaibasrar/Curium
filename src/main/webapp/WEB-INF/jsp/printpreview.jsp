...
<style>
  ...
  <tr align="center"><td style="text-align:center;padding:0px;">
    <p style="margin-bottom:0px;margin-top:0px;padding:0px;font-size:27px;font-weight: 900; color:red">Al-Irfan School </p></td></tr><tr><td style="text-align:center;padding:0px;">
 ...
 <td>&nbsp;&nbsp;
 <img src="/alirfan/images/alirfan.png" width="65" height="72"/>
 </td>
 </tr>
 </table>
   </div>
...
<img src="/alirfan/images/principalsignature.png" width="30" height="25"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<div>
principal&nbsp;&nbsp;&nbsp;</div>
</div>
</div>
