    ...
    <head >
        ...
        <script type="text/javascript">
            ...
            function restoreRecords(){
                var form1=document.getElementById("form1");
                 form1.action="/newexcellent/ClassProcess/restoreMultipleDroppedout";
                form1.submit();
            }
...
%>
    <body  >
        ...
        <form name="form1" id="form1"action="/newexcellent/ClassProcess/restoreMultipleDroppedout" method="post">
                    ...
                    <tbody>
                        <c:forEach items="${studentListDropped}" var="Student">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/newexcellent/StudentProcess/ViewDetails?id=<c:out value='${Student.sid}'/>"><c:out value="${Student.admissionnumber}"/></a></td>
