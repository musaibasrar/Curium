    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 45px;">
								...
								<a target="mainFrame" href="/kwrs/welcome" ><label style="font-family: Tahoma;font-weight: bolder;color: #143160;font-size: 14px;">${branchname}</label></a>
								</td>
								
							<!-- <td align="left"><img src="/kwrs/images/kwrsheader.png"
								style="width: 200px; height: 20px;" /></td> -->
							<td><a target="leftFrame" href="/kwrs/left_officeadmin"> <img
							...
							<td ><a target="leftFrame" href="/kwrs/leftsettings_officeadmin">
							...
							<td ><!-- <a target="mainFrame" href="/kwrs/sendsms"><img
								...
								<a target="leftFrame" href="/kwrs/reports_officeadmin"><img
