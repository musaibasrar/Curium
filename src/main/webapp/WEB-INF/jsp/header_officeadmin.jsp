    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 45px;">
							...
							<td><a target="leftFrame" href="/rkgnyanaganga/left_officeadmin"> <img
							...
							<td ><a target="mainFrame"
								href="/rkgnyanaganga/AdminProcess/viewAllExpenses"><img
									alt="Admin Exp" src="/rkgnyanaganga/FeesProcess/otherfeesCollect" width="18" height="18" style="vertical-align: bottom;"/>
									Bus Fee Collection
							</a></td>
