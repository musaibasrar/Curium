    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 45px;">
								...
								<a target="mainFrame" href="/lflower/welcome" ><label style="font-family: Tahoma;font-weight: bolder;color: #143160;font-size: 14px;">${branchname}</label></a>
								</td>
								
							<!-- <td align="left"><img src="/lflower/images/lflowerheader.png"
								style="width: 200px; height: 20px;" /></td> -->
							<td><a target="leftFrame" href="/lflower/left_officeadmin"> <img
							...
							<td ><a target="leftFrame" href="/lflower/leftsettings_officeadmin">
							...
							<td ><!-- <a target="mainFrame" href="/lflower/sendsms"><img
								...
								<a target="leftFrame" href="/lflower/reports_officeadmin"><img
