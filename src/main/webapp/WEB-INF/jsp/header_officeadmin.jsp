    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 45px;">
							...
							<td><a target="leftFrame" href="/bright/left_officeadmin"> <img
							...
							<td ><a target="mainFrame"
								href="/bright/AdminProcess/viewAllExpenses"><img
									alt="Admin Exp" src="/bright/FeesProcess/otherfeesCollect" width="18" height="18" style="vertical-align: bottom;"/>
									Bus Fee Collection
							</a></td>
