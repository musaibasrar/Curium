...
<link rel="stylesheet" href="/roshan/css/datePicker/jquery-ui-1.8.18.custom.css">
        ...
        <script type="text/javascript" src="/roshan/js/datePicker/ui/jquery.effects.slide.js"></script>
        <script type="text/javascript" src="/roshan/js/datePicker/ui/jquery.effects.bounce.js"></script>
        <script type="text/javascript" src="/roshan/js/datePicker/ui/jquery.effects.clip.js"></script>
        <script type="text/javascript" src="/roshan/js/datePicker/ui/jquery.effects.transfer.js"></script>
        <script type="text/javascript" src="/roshan/js/datePicker/ui/jquery.effects.blind.js"></script>
        <style type="text/css">
            <!--
            .labelCss {
                font-family: Tahoma;
 ...
 function submitfees(cashpayment,banktransfer,chequetransfer,ackno,transferdate,transferbankname,chequeno,chequedate,chequebankname){
        		...
        		form1.action="/roshan/FeesCollection/feesAdd?paymentmethod="+paymentmethodvalue+"&ackno="+acknovalue+"&transferdate="+transferdatevalue+"&transferbankname="+transferbanknamevalue+"&chequeno="+chequenovalue+"&chequedate="+chequedatevalue+"&chequebankname="+chequebanknamevalue+"";
        		form1.method = "POST";
        		form1.submit();
            ...
            function getstampfees(){
            	var form1 = document.getElementById("form1");
        		form1.action="/roshan/FeesCollection/otherStampFees";
        		form1.method = "POST";
        		form1.submit();
            }
...
<body>
 <form id="form1" method="post">
            ...
            <div id="tabs">
				<ul>
					<li><a href="#fragment-1">OtherF ees Collection</a></li>
				</ul>
				...
				<tbody>
					<c:forEach items="${studentotherfeesdetails}" var="studentfeesdetails" varStatus="status">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataText" align="center" style="font-weight: bold;font-size: 13px;"><c:out	value="${studentfeesdetails.key.feecategory.feescategoryname}" /></a><input name="idfeescategory" type="hidden" id="idfeescategory" value="${studentfeesdetails.key.idfeescategory}" /></td>
