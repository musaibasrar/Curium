...
<link rel="stylesheet" href="/littleflower/css/datePicker/jquery-ui-1.8.18.custom.css">
 ...
 function submitfees(cashpayment,banktransfer,chequetransfer,ackno,transferdate,transferbankname,chequeno,chequedate,chequebankname){
        		...
        		form1.action="/littleflower/FeesCollection/feesAddother?paymentmethod="+paymentmethodvalue+"&ackno="+acknovalue+"&transferdate="+transferdatevalue+"&transferbankname="+transferbanknamevalue+"&chequeno="+chequenovalue+"&chequedate="+chequedatevalue+"&chequebankname="+chequebanknamevalue+"";
        		form1.method = "POST";
        		form1.submit();
            ...
            function getstampfees(){
            	var form1 = document.getElementById("form1");
        		form1.action="/littleflower/FeesCollection/otherStampFees";
        		form1.method = "POST";
        		form1.submit();
            }
