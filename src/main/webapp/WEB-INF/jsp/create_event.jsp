...
<body>
    <div class="container">
        <div class="form-container">
            ...
            <form id="eventForm" action="/pips/EventProcess/createEvent" method="post" class="needs-validation" novalidate>
                ...
                <div class="form-group mt-4">
                    ...
                    <a href="/pips/EventProcess/calendar" class="btn btn-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
