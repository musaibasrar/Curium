...
<body>
    <div class="container">
        <div class="form-container">
            ...
            <form id="eventForm" action="/noble/EventProcess/createEvent" method="post" class="needs-validation" novalidate>
                ...
                <div class="form-group mt-4">
                    ...
                    <a href="/noble/EventProcess/calendar" class="btn btn-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
