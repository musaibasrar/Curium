...
<script type="text/javascript">
	function searchForFeesConcession() {
		...
		form1.action = "/cambridge/FeesProcess/searchFeesConcessionReport";
		form1.method = "POST";
		form1.submit();
...
<script type="text/javascript">
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/cambridge/FeesProcess/printFeesConcessionReport";
		form1.method = "POST";
		form1.submit();
	}
						...
						<c:forEach items="${students.value}" var="fees">
							...
							<tr class="trClass" style="border-color: #000000" border="1" cellpadding="1" cellspacing="1">
								...
								<td class="dataTextInActive"><a class="dataTextInActive"
									href="/cambridge/StudentProcess/ViewFeesStructure?id=<c:out value='${students.key.student.sid}'/>"><c:out
											value="${students.key.student.admissionnumber}" /></a></td>
								<td class="dataText"><c:out value="${students.key.student.studentexternalid}" /></td>
