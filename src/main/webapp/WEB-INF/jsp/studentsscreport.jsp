...
<html >
    <head >
        ...
        <style type="text/css" title="currentStyle">
            @import "/global/css/dataTable/css/demo_page.css";
            @import "/global/css/dataTable/css/jquery.dataTables.css";
        </style>
        ...
        <script type="text/javascript">
            function printRecords(){
                ...
                form1.action="/global/DocumentsProcess/printScList";
                form1.submit();
            }
        ...
        <script type="text/javascript">
            ...
            function refreshPage(){
                 var form1=document.getElementById("form1");
                form1.action="/global/PersonalProcess/ViewAllGo";
                form1.submit();
            ...
            function redirect(){
                 var form1=document.getElementById("form1");
                    form1.action="/global/PersonalProcess/redirect";
                    form1.submit();
...
%>
    <body>
        ...
        <form name="form1" id="form1"action="/global/StudentProcess/archiveMultiple" method="post">
                    ...
                    <tbody>
                        <c:forEach items="${studentscissued}" var="parent">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/global/StudentProcess/ViewDetails?id=<c:out value='${parent.id}'/>&urlbranchid=<c:out value='${Parents.branchid}'/>"><c:out value="${parent.uid}"/></a></td>
            ...
            <div align="center">
             <%--For displaying Previous link except for the 1st page --%>
                <c:if test="${currentPage != 1}">
                    <td><a style="color: #4B6A84;font-size: 12px" href="/global/PersonalProcessPages&page=${currentPage - 1}">Previous</a></td>
                </c:if>
                    ...
                    <tr>
                        <c:forEach begin="1" end="${noOfPages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <td style="color: black;font-weight:bold;font-size: 15px "><a style="color: #4B6A84" href="/global/PersonalProcessPages&page=${i}">${i}</a></td>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                    </tr>
                ...
                <c:if test="${currentPage lt noOfPages}">
                    <td ><a style="color: #4B6A84;font-size: 12px" href="/global/PersonalProcessPages&page=${currentPage + 1}">Next</a></td>
                </c:if>
                    </div>
