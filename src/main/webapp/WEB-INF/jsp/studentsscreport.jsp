...
<html >
    <head >
        ...
        <style type="text/css" title="currentStyle">
            @import "${ctx}/css/dataTable/css/demo_page.css";
            @import "${ctx}/css/dataTable/css/jquery.dataTables.css";
        </style>
        <link rel="stylesheet" href="${ctx}/css/datePicker/jquery-ui-1.8.17.custom.css">
        <link rel="stylesheet" href="${ctx}/css/datePicker/demos.css">
        <!--<script type="text/javascript" language="javascript" src="${ctx}/js/dataTable/jquery.js"></script>-->
        <script type="text/javascript" src="${ctx}/js/datePicker/jquery-1.7.1.js"></script>
        <script type="text/javascript" language="javascript" src="${ctx}/js/dataTable/jquery.dataTables.js"></script>
        <script type="text/javascript" src="${ctx}/js/datePicker/ui/jquery-ui-1.8.17.custom.js"></script>
        <script type="text/javascript" src="${ctx}/js/datePicker/ui/jquery.ui.core.js"></script>
        <script type="text/javascript" src="${ctx}/js/datePicker/ui/jquery.ui.widget.js"></script>
        <script type="text/javascript" src="${ctx}/js/datePicker/ui/jquery.ui.button.js"></script>
        <script type="text/javascript" src="${ctx}/js/datePicker/ui/jquery.ui.tabs.js"></script>
        <style type="text/css" >
            <!--
            .header {
        ...
        <script type="text/javascript">
            function printRecords(){
                ...
                form1.action="${ctx}/DocumentsProcess/printScList";
                form1.submit();
            }
                    ...
                    <tbody>
                        <c:forEach items="${studentscissued}" var="parent">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="${ctx}/StudentProcess/ViewDetails?id=<c:out value='${parent.id}'/>&urlbranchid=<c:out value='${Parents.branchid}'/>"><c:out value="${parent.uid}"/></a></td>
            ...
            <div align="center">
             <%--For displaying Previous link except for the 1st page --%>
                <c:if test="${currentPage != 1}">
                    <td><a style="color: #4B6A84;font-size: 12px" href="${ctx}/PersonalProcessPages&page=${currentPage - 1}">Previous</a></td>
                </c:if>
                    ...
                    <tr>
                        <c:forEach begin="1" end="${noOfPages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <td style="color: black;font-weight:bold;font-size: 15px "><a style="color: #4B6A84" href="${ctx}/PersonalProcessPages&page=${i}">${i}</a></td>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                    </tr>
                ...
                <c:if test="${currentPage lt noOfPages}">
                    <td ><a style="color: #4B6A84;font-size: 12px" href="${ctx}/PersonalProcessPages&page=${currentPage + 1}">Next</a></td>
                </c:if>
                    </div>
