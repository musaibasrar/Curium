    ...
    <head >
        ...
        <script type="text/javascript">
            function printRecords(){
                ...
                form1.action="/fathima/DocumentsProcess/printScList";
                form1.submit();
            }
                    ...
                    <tbody>
                        <c:forEach items="${studentscissued}" var="parent">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/fathima/StudentProcess/ViewDetails?id=<c:out value='${parent.id}'/>&urlbranchid=<c:out value='${Parents.branchid}'/>"><c:out value="${parent.uid}"/></a></td>
