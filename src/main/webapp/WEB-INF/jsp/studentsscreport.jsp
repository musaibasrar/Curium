...
<html >
    <head >
        ...
        <style type="text/css" title="currentStyle">
            @import "/littleflower/css/dataTable/css/demo_page.css";
            @import "/littleflower/css/dataTable/css/jquery.dataTables.css";
        </style>
        ...
        <script type="text/javascript">
            function printRecords(){
                ...
                form1.action="/littleflower/DocumentsProcess/printScList";
                form1.submit();
            }
...
%>
    <body>
        ...
        <form name="form1" id="form1"action="/littleflower/StudentProcess/archiveMultiple" method="post">
                    ...
                    <tbody>
                        <c:forEach items="${studentscissued}" var="parent">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/littleflower/StudentProcess/ViewDetails?id=<c:out value='${parent.id}'/>&urlbranchid=<c:out value='${Parents.branchid}'/>"><c:out value="${parent.uid}"/></a></td>
