...
<script type="text/javascript">
	function searchByDate() {
		...
		form1.action = "/descent/FeesCollection/searchOtherFeesCollection";
		form1.method = "POST";
		form1.submit();
...
<body>
	<form id="form1"
		action="/descent/FeesDetails/exportDataForOtherFees" method="POST">
                    ...
                    <tbody>
                        <c:forEach items="${searchotherfeesdetailslist}" var="feesdetails">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/descent/FeesCollection/viewOtherFeesDetails?id=<c:out value='${feesdetails.receiptnumber}'/>&sid=<c:out value='${feesdetails.sid}'/>">View Details</a></td>
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/descent/FeesCollection/CancelOtherFeesReceipt?id=<c:out value='${feesdetails.receiptnumber}'/>&sid=<c:out value='${feesdetails.sid}'/>&receiptid=<c:out value='${feesdetails.receiptvoucher}'/>&journalid=<c:out value='${feesdetails.journalvoucher}'/>"><i class="fa fa-times" style="color:#93051f;font-size: 18px;"></i></a></td>
