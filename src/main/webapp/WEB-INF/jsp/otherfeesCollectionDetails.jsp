...
<script type="text/javascript">
	function searchByDate() {
		...
		form1.action = "/jrs/FeesCollection/searchOtherFeesCollection";
		form1.method = "POST";
		form1.submit();
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/jrs/FeesCollection/printOtherDataForFees";
		form1.method = "POST";
		form1.submit();
}
...
<body>
	<form id="form1"
		action="/jrs/FeesDetails/exportDataForOtherFees" method="POST">
