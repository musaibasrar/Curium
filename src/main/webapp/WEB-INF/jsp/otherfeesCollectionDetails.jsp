...
<script type="text/javascript">
	function searchByDate() {
		...
		form1.action = "/pips/FeesCollection/searchOtherFeesCollection";
		form1.method = "POST";
		form1.submit();
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/pips/FeesCollection/printOtherDataForFees";
		form1.method = "POST";
		form1.submit();
}
...
<body>
	<form id="form1"
		action="/pips/FeesDetails/exportDataForOtherFees" method="POST">
				...
				<thead>
                    ...
                    <tbody>
                        ...
                        <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/pips/FeesCollection/viewOtherFeesDetails?id=<c:out value='${feesdetails.key.receiptnumber}'/>&sid=<c:out value='${feesdetails.key.sid}'/>">View Details</a></td>
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/pips/FeesCollection/CancelOtherFeesReceipt?id=<c:out value='${feesdetails.key.receiptnumber}'/>&sid=<c:out value='${feesdetails.key.sid}'/>&receiptid=<c:out value='${feesdetails.key.receiptvoucher}'/>&journalid=<c:out value='${feesdetails.key.journalvoucher}'/>"><i class="fa fa-times" style="color:#93051f;font-size: 18px;"></i></a></td>
                            </tr>
                        </c:forEach>
                    </tbody>
