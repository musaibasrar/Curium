    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 45px;">
							...
							<td><a target="leftFrame" href="/shatabdi/left_marksentry"> <img
									src="/shatabdi/images/home.svg" width="18" height="18" 
									alt="Home" style="vertical-align: bottom;font-size: 144px;" />Home
							</a></td>

							<td ><a target="leftFrame" href="/shatabdi/leftsettings_marksentry">
							...
							<td ><!-- <a target="mainFrame" href="/shatabdi/sendsms"><img
								...
								<a target="leftFrame" href="/shatabdi/reports_marksentry"><img
