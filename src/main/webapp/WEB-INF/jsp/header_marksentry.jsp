    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 45px;">
								...
								<a target="mainFrame" href="/littleangel/welcome" ><label style="font-family: Tahoma;font-weight: bolder;color: #143160;font-size: 14px;">${branchname}</label></a>
								</td>
								
							<!-- <td align="left"><img src="/littleangel/images/littleangelheader.png"
								style="width: 200px; height: 20px;" /></td> -->
							<!-- <td><a target="leftFrame" href="/littleangel/left_officeadmin"> <img
							...
							<td ><a target="leftFrame" href="/littleangel/leftsettings_officeadmin">
							...
							<td ><a target="mainFrame" href="/littleangel/sendsms"><img
								...
								<a target="leftFrame" href="/littleangel/reports_officeadmin"><img
