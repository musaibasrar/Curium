    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 45px;">
								...
								<a target="mainFrame" href="/curium/welcome" ><label style="font-family: Tahoma;font-weight: bolder;color: #143160;font-size: 14px;">${branchname}</label></a>
								</td>
								
							<!-- <td align="left"><img src="/curium/images/nobleheader.png"
								style="width: 200px; height: 20px;" /></td> -->
							<!-- <td><a target="leftFrame" href="/curium/left_officeadmin"> <img
							...
							<td ><a target="leftFrame" href="/curium/leftsettings_officeadmin">
							...
							<td ><a target="mainFrame" href="/curium/sendsms"><img
								...
								<a target="leftFrame" href="/curium/reports_officeadmin"><img
