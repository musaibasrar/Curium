...
<script type="text/javascript">
	...
	function searchForEmployees(staffName, staffDepartment){
		...
		form1.action = "/peace/HrProcess/searchEmployeesForPayHead?staffName="+staffName+"&staffDepartment="+staffDepartment+"";
		form1.method = "POST";
		form1.submit();
	...
	function addPayHeadStaff() {
		var form1 = document.getElementById("form1");
		form1.action = "/peace/HrProcess/addPayHeadStaffDetails";
		form1.method = "POST";
		form1.submit();
	}
				...
				<tbody>
					   <c:forEach items="${employeeList}" var="employee">
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive" style="text-transform:uppercase"><a class="dataTextInActive" href="/peace/HrProcess/viewLeavesDetails?id=<c:out value='${employee.tid}'/>"><c:out value="${employee.teachername}"/></a></td>
