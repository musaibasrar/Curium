...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <script type="text/javascript">
            ...
            function updatePeriodDetail(){
                ...
                form1.action="/greatindiaacademy/PeriodProcess/updatePeriodDetails";
                method="POST";
                form1.submit();
            }
...
<body>
	<form id="form1">
		...
		<tr><td><br></td></tr>
                        <tr>
                                <td align="center" style="font-size:16px;"><a id="print" href="/greatindiaacademy/PeriodProcess/updatePeriodDetails?id=<c:out value="${periodMasterid}" />">Modify</a></td>
                            </td>
