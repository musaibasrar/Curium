...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <script type="text/javascript">
            ...
            function updatePeriodDetail(){
                ...
                form1.action="/littleflower/PeriodProcess/updatePeriodDetails";
                method="POST";
                form1.submit();
            }
...
<script type="text/javascript">
                                $(function() {
                                    ...
                                    $( "#modify" ).button().click(function() {
                                        window.location.href = "/littleflower/PeriodProcess/updatePeriodDetails?id=<c:out value='${periodMasterid}' />";
                                    });
