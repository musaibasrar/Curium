        ...
        <input type="hidden" value="${duplicate}" id="duplicate" name="duplicate">
            ...
            <TABLE id="dataTable" width="100%" border="1" >
                ...
                <tfoot>
                    ...
                    <%-- </c:forEach> --%>
                    <tr>
                        <td align="center"><a id="print" href="/gnyanganga/FeesCollection/otherprintReceipt?id=<c:out value="${receiptinfo.receiptnumber}" />&sid=<c:out value="${student.sid}"/>">Print</a></td>
                    </tr>
                </tfoot>
            </TABLE>
        </form>
