	 ...
	 <style type="text/css" >
        ...
        <script type="text/javascript">
             ...
             function printReceipt(){
            	 ...
            	 //document.location.href = "/noblewisdom/FeesProcess/feesCollect"; 
             }
        </script>
</head>
 <%
        ...
        <input type="hidden" value="${duplicate}" id="duplicate" name="duplicate">
            ...
            <TABLE id="dataTable" width="100%" border="1" >
                ...
                <tfoot>
                    ...
                    <%-- </c:forEach> --%>
                    <tr>
                        <td align="center"><a id="print" href="/noblewisdom/FeesCollection/otherprintReceipt?id=<c:out value="${recieptinfo.receiptnumber}" />&sid=<c:out value="${student.sid}"/>">Print</a></td>
                    </tr>
                </tfoot>
            </TABLE>
        </form>
