...
<script type="text/javascript">
	function addFeesCategory() {
		...
		form1.action = "/cambridge/FeesProcess/addFeesParticular";
		form1.method = "POST";
		form1.submit();
	...
	$(function() {
	 ...
	 function savePayHead(){
		 var form1=document.getElementById("form1");
         form1.action="/cambridge/HrProcess/savePayHead";
         form1.submit();
     }
	...
	function deleteRecords(){
		...
		if(confirm('Are you sure, you want to delete the leave type?')){
			var form1=document.getElementById("form1");
	         form1.action="/cambridge/HrProcess/deleteLeaveType";
	        form1.submit();
		}
				...
				<thead>
					<tr>
						...
						<th title="click to sort" class="headerText">Pay Head Name<img
							...
							src="/cambridge/css/dataTable/images/sort_both.png" /></th>
