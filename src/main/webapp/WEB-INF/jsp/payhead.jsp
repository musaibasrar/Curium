...
<script type="text/javascript">
	function addFeesCategory() {
		...
		form1.action = "/alirfan/FeesProcess/addFeesParticular";
		form1.method = "POST";
		form1.submit();
	...
	$(function() {
	 ...
	 function savePayHead(){
		 var form1=document.getElementById("form1");
         form1.action="/alirfan/HrProcess/savePayHead";
         form1.submit();
     }
	...
	function deleteRecords(){
		...
		if(confirm('Are you sure, you want to delete the leave type?')){
			var form1=document.getElementById("form1");
	         form1.action="/alirfan/HrProcess/deleteLeaveType";
	        form1.submit();
		}
				...
				<thead>
					<tr>
						...
						<th title="click to sort" class="headerText">Pay Head Name<img
							...
							src="/alirfan/css/dataTable/images/sort_both.png" /></th>
