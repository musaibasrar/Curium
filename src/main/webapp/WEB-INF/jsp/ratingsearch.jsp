...
<script type="text/javascript">
	function searchForRatings() {
		...
		form1.action = "/abc/RatingDetailsProcess/viewRatings";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/abc/RatingDetailsProcess/deleteMultiple";
		form1.method = "POST";
		form1.submit();
...
function checkMandatoryandSubmit(){
    	...
    	if(document.getElementById("assessment").value == ""){
    		...
    		var form1 = document.getElementById("form1");
						form1.action = "/abc/RatingDetailsProcess/addRatings";
    		form1.method = "POST";
    		form1.submit();
...
%>
<body>
	<form id="form1" action="/abc/RatingDetailsProcess/updateRatings" method="POST">
