...
<script src="/presidency/js/validation/jquery.ketchup.all.min.js"></script>
<script type="text/javascript"
...
<script type="text/javascript">
	...
	function updateEnquiryForm(){
		...
		form1.action="/presidency/EnquiryProcess/updateEnquiryFormDetails?id=<c:out value='${admissionEnquiry.id}'/>";
		form1.submit();
	}
