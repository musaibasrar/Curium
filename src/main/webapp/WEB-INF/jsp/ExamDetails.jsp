...
<script type="text/javascript">
	function addExam() {
		...
		form1.action = "/fathima/ExamDetailsProcess/addExam";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/fathima/ExamDetailsProcess/deleteMultiple";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/fathima/ExamDetailsProcess/deleteMultiple" method="POST">
		<%
