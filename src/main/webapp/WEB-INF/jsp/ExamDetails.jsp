...
<script type="text/javascript">
	function addExam() {
		...
		form1.action = "/brightschool/ExamDetailsProcess/addExam";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/brightschool/ExamDetailsProcess/deleteMultiple";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/brightschool/ExamDetailsProcess/deleteMultiple" method="POST">
		<%
