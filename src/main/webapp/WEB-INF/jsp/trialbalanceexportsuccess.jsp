...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle">
            @import "/jasmine/css/dataTable/css/demo_page.css";
            @import "/jasmine/css/dataTable/css/jquery.dataTables.css";
        </style>
...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/jasmine/AccountProcess/downloadTrialBalance";
                form1.submit();
            }
        </script>
</head>
...
%>
    <body background="/jasmine/images/bg.jpg" >
