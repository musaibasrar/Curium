...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle">
            @import "/littleangels/css/dataTable/css/demo_page.css";
            @import "/littleangels/css/dataTable/css/jquery.dataTables.css";
        </style>
...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/littleangels/AccountProcess/downloadTrialBalance";
                form1.submit();
            }
        </script>
</head>
...
%>
    <body background="/littleangels/images/bg.jpg" >
