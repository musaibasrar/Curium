...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle">
            @import "/nortuntrading/css/dataTable/css/demo_page.css";
            @import "/nortuntrading/css/dataTable/css/jquery.dataTables.css";
        </style>
...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/nortuntrading/AccountProcess/downloadTrialBalance";
                form1.submit();
            }
        </script>
</head>
