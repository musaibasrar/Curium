...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle">
            @import "/taha/css/dataTable/css/demo_page.css";
            @import "/taha/css/dataTable/css/jquery.dataTables.css";
        </style>
...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/taha/AccountProcess/downloadTrialBalance";
                form1.submit();
            }
        </script>
</head>
...
%>
    <body background="/taha/images/bg.jpg" >
