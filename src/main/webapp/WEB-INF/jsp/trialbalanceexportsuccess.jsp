...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle">
            @import "/jih/css/dataTable/css/demo_page.css";
            @import "/jih/css/dataTable/css/jquery.dataTables.css";
        </style>
...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/jih/AccountProcess/downloadTrialBalance";
                form1.submit();
            }
        </script>
</head>
...
%>
    <body background="/jih/images/bg.jpg" >
