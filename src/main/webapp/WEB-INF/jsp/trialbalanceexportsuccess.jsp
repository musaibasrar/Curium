...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle">
            @import "/vasu/css/dataTable/css/demo_page.css";
            @import "/vasu/css/dataTable/css/jquery.dataTables.css";
        </style>
...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/vasu/AccountProcess/downloadTrialBalance";
                form1.submit();
            }
        </script>
</head>
...
%>
    <body background="/vasu/images/bg.jpg" >
