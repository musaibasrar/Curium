...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle">
            @import "/iica/css/dataTable/css/demo_page.css";
            @import "/iica/css/dataTable/css/jquery.dataTables.css";
        </style>
...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/iica/AccountProcess/downloadTrialBalance";
                form1.submit();
            }
        </script>
</head>
...
%>
    <body background="/iica/images/bg.jpg" >
