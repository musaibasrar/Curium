...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle">
            @import "/sneha/css/dataTable/css/demo_page.css";
            @import "/sneha/css/dataTable/css/jquery.dataTables.css";
        </style>
...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/sneha/AccountProcess/downloadTrialBalance";
                form1.submit();
            }
        </script>
</head>
...
%>
    <body background="/sneha/images/bg.jpg" >
