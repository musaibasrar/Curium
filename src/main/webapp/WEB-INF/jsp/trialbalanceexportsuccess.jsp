...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle">
            @import "/alhidaya/css/dataTable/css/demo_page.css";
            @import "/alhidaya/css/dataTable/css/jquery.dataTables.css";
        </style>
...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/alhidaya/AccountProcess/downloadTrialBalance";
                form1.submit();
            }
        </script>
</head>
...
%>
    <body background="/alhidaya/images/bg.jpg" >
