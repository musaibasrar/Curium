...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle">
            @import "/presidency/css/dataTable/css/demo_page.css";
            @import "/presidency/css/dataTable/css/jquery.dataTables.css";
        </style>
...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/presidency/AccountProcess/downloadTrialBalance";
                form1.submit();
            }
        </script>
</head>
...
%>
    <body background="/presidency/images/bg.jpg" >
