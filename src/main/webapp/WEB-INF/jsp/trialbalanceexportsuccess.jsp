...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle">
            @import "/rauzamission/css/dataTable/css/demo_page.css";
            @import "/rauzamission/css/dataTable/css/jquery.dataTables.css";
        </style>
...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/rauzamission/AccountProcess/downloadTrialBalance";
                form1.submit();
            }
        </script>
</head>
...
%>
    <body background="/rauzamission/images/bg.jpg" >
