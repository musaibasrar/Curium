...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle">
            @import "/demov2/css/dataTable/css/demo_page.css";
            @import "/demov2/css/dataTable/css/jquery.dataTables.css";
        </style>
...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/demov2/AccountProcess/downloadTrialBalance";
                form1.submit();
            }
        </script>
</head>
...
%>
    <body background="/demov2/images/bg.jpg" >
