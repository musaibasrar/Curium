...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle">
            @import "/children/css/dataTable/css/demo_page.css";
            @import "/children/css/dataTable/css/jquery.dataTables.css";
        </style>
...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/children/AccountProcess/downloadTrialBalance";
                form1.submit();
            }
        </script>
</head>
...
%>
    <body background="/children/images/bg.jpg" >
