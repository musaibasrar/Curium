...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle">
            @import "/ruyaa/css/dataTable/css/demo_page.css";
            @import "/ruyaa/css/dataTable/css/jquery.dataTables.css";
        </style>
...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/ruyaa/AccountProcess/downloadTrialBalance";
                form1.submit();
            }
        </script>
</head>
