...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle">
            @import "/bsb/css/dataTable/css/demo_page.css";
            @import "/bsb/css/dataTable/css/jquery.dataTables.css";
        </style>
...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/bsb/AccountProcess/downloadTrialBalance";
                form1.submit();
            }
        </script>
</head>
...
%>
    <body background="/bsb/images/bg.jpg" >
