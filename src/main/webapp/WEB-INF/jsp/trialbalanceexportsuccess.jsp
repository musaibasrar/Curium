...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle">
            @import "/jihtel/css/dataTable/css/demo_page.css";
            @import "/jihtel/css/dataTable/css/jquery.dataTables.css";
        </style>
...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/jihtel/AccountProcess/downloadTrialBalance";
                form1.submit();
            }
        </script>
</head>
...
%>
    <body background="/jihtel/images/bg.jpg" >
