...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle">
            @import "/noman/css/dataTable/css/demo_page.css";
            @import "/noman/css/dataTable/css/jquery.dataTables.css";
        </style>
...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/noman/AccountProcess/downloadTrialBalance";
                form1.submit();
            }
        </script>
</head>
...
%>
    <body background="/noman/images/bg.jpg" >
