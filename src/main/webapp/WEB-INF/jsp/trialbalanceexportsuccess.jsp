...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle">
            @import "/alfalahschool/css/dataTable/css/demo_page.css";
            @import "/alfalahschool/css/dataTable/css/jquery.dataTables.css";
        </style>
...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/alfalahschool/AccountProcess/downloadTrialBalance";
                form1.submit();
            }
        </script>
</head>
...
%>
    <body background="/alfalahschool/images/bg.jpg" >
