...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle">
            @import "/littleangel/css/dataTable/css/demo_page.css";
            @import "/littleangel/css/dataTable/css/jquery.dataTables.css";
        </style>
...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/littleangel/AccountProcess/downloadTrialBalance";
                form1.submit();
            }
        </script>
</head>
...
%>
    <body background="/littleangel/images/bg.jpg" >
