...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle">
            @import "/madina/css/dataTable/css/demo_page.css";
            @import "/madina/css/dataTable/css/jquery.dataTables.css";
        </style>
...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/madina/AccountProcess/downloadTrialBalance";
                form1.submit();
            }
        </script>
</head>
...
%>
    <body background="/madina/images/bg.jpg" >
