...
<script type="text/javascript">
	...
	function issuecheque() {
		...
		if(form1.checkValidity()) {
			form1.action="/kwrs/MessSuppliersProcess/issueCheque";
			form1.method = "POST";
			form1.submit();
		}
	}
	...
	function cancelcheque() {
		var form1 = document.getElementById("form1");
		form1.action="/kwrs/MessSuppliersProcess/cancelCheque";
		form1.method = "POST";
		form1.submit();
	...
	function deliveredcheque(delivereddate) {
		var form1 = document.getElementById("form1");
		form1.action="/kwrs/MessSuppliersProcess/deliveredCheque?deliverydate="+delivereddate;
		form1.method = "POST";
		form1.submit();
	}
	...
	function clearedcheque(cleareddate,bankname) {
		var form1 = document.getElementById("form1");
		form1.action="/kwrs/MessSuppliersProcess/clearedCheque?cleardate="+cleareddate+"&bankname="+bankname+"";
		form1.method = "POST";
		form1.submit();
	}
	...
	function printRecords(){
		var form1 = document.getElementById("form1");
		form1.action="/kwrs/MessSuppliersProcess/printSupplierPayment";
		form1.method = "POST";
		form1.submit();
	}
			...
			<div align="center">
             <%--For displaying Previous link except for the 1st page --%>
                <c:if test="${currentPage != 1}">
                    <td><a style="color: #4B6A84;font-size: 12px" href="/kwrs/MessSuppliersProcess/paymentSuppliers?page=${currentPage - 1}">Previous</a></td>
                </c:if>
                    ...
                    <tr>
                        <c:forEach begin="1" end="${noOfPages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <td style="color: black;font-weight:bold;font-size: 15px "><a style="color: #4B6A84" href="/kwrs/MessSuppliersProcess/paymentSuppliers?page=${i}">${i}</a></td>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                    </tr>
                ...
                <c:if test="${currentPage lt noOfPages}">
                    <td ><a style="color: #4B6A84;font-size: 12px" href="/kwrs/MessSuppliersProcess/paymentSuppliers?page=${currentPage + 1}">Next</a></td>
                </c:if>
                    </div>
