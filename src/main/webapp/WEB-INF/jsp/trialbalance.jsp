...
<script type="text/javascript">
	...
	function getTrialBalance(){
		...
		form1.action="/lflower/AccountProcess/trialBalance";
		form1.method = "POST";
		form1.submit();
	}
...
function printTrialBalance(){
	var form1 = document.getElementById("form1");
	form1.action = "/lflower/AccountProcess/printTrialBalance";
	form1.method = "POST";
	form1.submit();
}
...
function exportTrialBalance(){
	var form1 = document.getElementById("form1");
	form1.action = "/lflower/AccountProcess/exportTrialBalance";
	form1.method = "POST";
	form1.submit();
}
</script>
