...
<script type="text/javascript">
	...
	function getTrialBalance(){
		...
		form1.action = "/descent/AccountProcess/trialBalance";
		form1.method = "POST";
		form1.submit();
	}
...
function printTrialBalance(){
	var form1 = document.getElementById("form1");
	form1.action = "/descent/AccountProcess/printTrialBalance";
	form1.method = "POST";
	form1.submit();
}
...
function exportTrialBalance(){
	var form1 = document.getElementById("form1");
	form1.action = "/descent/AccountProcess/exportTrialBalance";
	form1.method = "POST";
	form1.submit();
}
</script>
				...
				<tbody>
					...
					<c:forEach items="${accountdetailsbalanceMap}" var="accountdetails">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<a target="mainFrame" href="/descent/AccountProcess/searchSingleLedgerEntries?accountid=${accountdetails.key.accountdetailsid}&ledgername=${accountdetails.key.accountname}">
