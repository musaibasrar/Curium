...
<script type="text/javascript">
	...
	function getTrialBalance(){
		...
		form1.action="/curium/AccountProcess/trialBalance";
		form1.method = "POST";
		form1.submit();
	}
				...
				<tbody>
					...
					<c:forEach items="${accountdetailsbalanceMap}" var="accountdetails">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<a target="mainFrame" href="/roshan/AccountProcess/searchSingleLedgerEntries&accountid=${accountdetails.key.accountdetailsid}&ledgername=${accountdetails.key.accountname}">
