...
$(function(){
    ...
    function deleteRecords(){
        ...
        form1.action="/readmodelschool/LibraryProcess/deleteRecord";
        form1.method = "POST";
       form1.submit();
				...
				<tbody>
					...
					<c:forEach items="${book}" var="book">
						...
						<tr style="border-color: #000000" border="1" cellpadding="1"
							...
							<td class="dataText"><a class="dataTextInActive" href="/readmodelschool/LibraryProcess/bookdetail?id=<c:out value='${book.bid}'/>"><c:out value="${book.bookname}" /></a></td>	
