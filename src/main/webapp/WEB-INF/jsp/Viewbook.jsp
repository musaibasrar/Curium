...
$(function(){
    ...
    function deleteRecords(){
        ...
        form1.action="/salihath/LibraryProcess/deleteRecord";
        form1.method = "POST";
       form1.submit();
				...
				<tbody>
					...
					<c:forEach items="${book}" var="book" varStatus="status">
						...
						<tr style="border-color: #000000" border="1" cellpadding="1"
							...
							<td class="dataText"><a class="dataTextInActive" href="/salihath/LibraryProcess/bookdetail?id=<c:out value='${book.bid}'/>"><c:out value="${book.bookname}" /></a></td>	
