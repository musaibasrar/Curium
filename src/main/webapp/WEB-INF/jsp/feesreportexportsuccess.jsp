...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle">
            @import "/tajacc/css/dataTable/css/demo_page.css";
            @import "/tajacc/css/dataTable/css/jquery.dataTables.css";
        </style>
	...
	color: #000000;
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/tajacc/FeesCollection/download";
                form1.submit();
            }
        </script>
</head>
...
%>
    <body background="/tajacc/images/bg.jpg" >
