...
<html>
    <head>
        ...
        <style type="text/css" title="currentStyle">
            @import "/flora/css/dataTable/css/demo_page.css";
            @import "/flora/css/dataTable/css/jquery.dataTables.css";
        </style>
	...
	color: #000000;
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/flora/FeesCollection/download";
                form1.submit();
            }
        </script>
</head>
...
%>
    <body background="/flora/images/bg.jpg" >
