...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/jih/FeesCollection/exportDataForFeesMonthlyCollectionDownload";
                form1.submit();
            }
        </script>
</head>
...
%>
    ...
    <table height="462" class="tableCSS"  >
      <tr>
        <td height="250" align="center" valign="middle"><p class="style1"> File Exported Successfully</p>
