            ...
            <table  width="100%">
                <thead>
                    <tr  >
                        ...
                        <td colspan="4" class="headerText">Receipt Details</td>
                ...
                <tbody>
                    <tr>
                        <td style="width: 35%">Name: <c:out value="${student.name}" /></td>
                        <td style="width: 20%">UID:  <c:out value="${student.studentexternalid}" /></td>
            ...
            <table width="100%">
               <thead>
                    <tr>
                        ...
                        <td  class="headerText">Receipt Details</td>
            ...
            <TABLE id="dataTable" width="100%" border="1" >
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <td align="center"><a id="print" href="/jihtel/FeesCollection/printFeesReceipt?id=<c:out value="${recieptinfo.receiptnumber}" />&sid=<c:out value="${student.sid}"/>">Print</a></td>
                    </tr>
                </tfoot>
            </TABLE>
