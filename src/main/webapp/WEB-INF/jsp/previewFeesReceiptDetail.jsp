    ...
    <head>
        ...
        <script type="text/javascript">
             ...
             function printReceipt(){
            	 ...
            	 //document.location.href = "/greatindiaacademy/FeesProcess/feesCollect"; 
             }
        </script>
    </head>
    <%
    ...
    <body onload="printReceipt()">
        ...
        <input type="hidden" value="${duplicate}" id="duplicate" name="duplicate">
            ...
            <table class="table" border="1">
                ...
                <tfoot>
                    <tr>
                        <td align="center"><a id="print" href="/greatindiaacademy/FeesCollection/printFeesReceipt?id=<c:out value="${recieptinfo.receiptnumber}" />&sid=<c:out value="${student.sid}"/>">Print</a></td>
                        <td>Total Amount</td>
                        <td class="totalAmount"><c:out value="${receiptinfo.totalamount}" /></td>
                    </tr>
                    <tr>
                        <td colspan="3"><a id="print" href="/greatindiaacademy/FeesCollection/printFeesReceipt?id=<c:out value="${receiptinfo.receiptnumber}" />&sid=<c:out value="${student.sid}"/>">Print</a></td>
                    </tr>
                </tfoot>
            </table>
        </form>
