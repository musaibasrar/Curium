        ...
        <input type="hidden" value="${duplicate}" id="duplicate" name="duplicate">
            ...
            <table class="table" border="1">
                ...
                <tfoot>
                    ...
                    <tr>
                        <td colspan="3"><a id="print" href="/iqraschool/FeesCollection/printFeesReceipt?id=<c:out value="${receiptinfo.receiptnumber}" />&sid=<c:out value="${student.sid}"/>">Print</a></td>
                    </tr>
                </tfoot>
            </table>
        </form>
