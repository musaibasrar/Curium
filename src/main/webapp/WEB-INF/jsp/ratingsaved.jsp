...
%>
    <body background="/images/bg.jpg" >
        <form id="form1" action="/brightschool/"  method="post">
    <table height="462" class="tableCSS"  >
      <tr>
        ...
        <p class="style1">
          	...
          	<input type="button" value="Enter Ratings" id="addnew" onClick="JavaScript:window.location='/brightschool/RatingDetailsProcess/ratingEntry';">
