...
<script type="text/javascript">
	function searchForStudents() {
		...
		form1.action = "/nortuntrading/DocumentsProcess/searchForStudents";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/nortuntrading/DocumentsProcess/generateAdmissionAbstract" method="POST">
