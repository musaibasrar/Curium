...
<script type="text/javascript">
	function searchForStudents() {
		...
		form1.action = "/iqra/DocumentsProcess/searchForStudents";
		form1.method = "POST";
		form1.submit();
...
function printSinglePageAdmissionAbstract() {
	var form1 = document.getElementById("form1");
	form1.action = "/iqra/DocumentsProcess/printSinglePageAdmissionAbstract";
	form1.method = "POST";
	form1.submit();
...
%>
<body>
	<form id="form1" action="/iqra/DocumentsProcess/generateAdmissionAbstract" method="POST">
