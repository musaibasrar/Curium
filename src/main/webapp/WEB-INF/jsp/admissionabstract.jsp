...
<script type="text/javascript">
	function searchForStudents() {
		...
		form1.action = "/school/DocumentsProcess/searchForStudents";
		form1.method = "POST";
		form1.submit();
...
function printAdmissionAbstract() {
	var form1 = document.getElementById("form1");
	form1.action = "/school/DocumentsProcess/printAdmissionAbstract";
	form1.method = "POST";
	form1.submit();
...
function printSinglePageAdmissionAbstract() {
	var form1 = document.getElementById("form1");
	form1.action = "/school/DocumentsProcess/printSinglePageAdmissionAbstract";
	form1.method = "POST";
	form1.submit();
...
%>
<body>
	<form id="form1" action="/school/DocumentsProcess/generateAdmissionAbstract" method="POST">
