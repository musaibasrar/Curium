...
<script type="text/javascript">
	function searchForStudents() {
		...
		form1.action = "/sanmarg/DocumentsProcess/searchForStudents";
		form1.method = "POST";
		form1.submit();
...
function printAdmissionAbstract() {
	var form1 = document.getElementById("form1");
	form1.action = "/sanmarg/DocumentsProcess/printAdmissionAbstract";
	form1.method = "POST";
	form1.submit();
...
%>
<body>
	<form id="form1" action="/sanmarg/DocumentsProcess/generateAdmissionAbstract" method="POST">
