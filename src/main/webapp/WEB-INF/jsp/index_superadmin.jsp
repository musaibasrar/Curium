...
%>
    <frameset    rows="55,*"frameborder="0" border="0" framespacing="0"  >
			    ...
			    <frame   src="/awami/header_superadmin"   name="topFrame" scrolling="NO" noresize frameborder="0">

            <frameset  cols="195,*" frameborder="0" border="0" framespacing="0">
                <frame  src="/awami/left_superadmin" name="leftFrame" scrolling="yes"  frameborder="1"   />
                <frame src="/awami/UserProcess/superDashboard" name="mainFrame" scrolling="yes" />
            </frameset>
