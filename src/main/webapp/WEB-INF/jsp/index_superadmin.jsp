...
%>
    <frameset    rows="55,*"frameborder="0" border="0" framespacing="0"  >
			    ...
			    <frame   src="/littleflower/header_superadmin"   name="topFrame" scrolling="NO" noresize frameborder="0">

            <frameset  cols="195,*" frameborder="0" border="0" framespacing="0">
                <frame  src="/littleflower/left_superadmin" name="leftFrame" scrolling="yes"  frameborder="1"   />
                <frame src="/littleflower/UserProcess/superDashboard" name="mainFrame" scrolling="yes" />
            </frameset>
