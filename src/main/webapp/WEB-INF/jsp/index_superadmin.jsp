...
%>
    <frameset    rows="55,*"frameborder="0" border="0" framespacing="0"  >
			    ...
			    <frame   src="/genius/header_superadmin"   name="topFrame" scrolling="NO" noresize frameborder="0">

            <frameset  cols="195,*" frameborder="0" border="0" framespacing="0">
                <frame  src="/genius/left_superadmin" name="leftFrame" scrolling="yes"  frameborder="1"   />
