...
%>
    <frameset    rows="55,*"frameborder="0" border="0" framespacing="0"  >
			    ...
			    <frame   src="/salihath/header_superadmin"   name="topFrame" scrolling="NO" noresize frameborder="0">

            <frameset  cols="195,*" frameborder="0" border="0" framespacing="0">
                <frame  src="/salihath/left_superadmin" name="leftFrame" scrolling="yes"  frameborder="1"   />
                <frame src="/salihath/UserProcess/superDashboard" name="mainFrame" scrolling="yes" />
            </frameset>
