...
%>
    <frameset    rows="55,*"frameborder="0" border="0" framespacing="0"  >
		   ...
		   <c:if test="${(userType == 'feescollectoradmin')}">
			    <frame   src="/greatindiaacademy/header_feescollectoradmin"   name="topFrame" scrolling="NO" noresize frameborder="0">
		   </c:if>

            <frameset  cols="195,*" frameborder="0" border="0" framespacing="0">
                <frame  src="/greatindiaacademy/left_feescollectoradmin" name="leftFrame" scrolling="yes"  frameborder="1"   />
                <frame src="/greatindiaacademy/welcome" name="mainFrame" scrolling="yes" />
            </frameset>
