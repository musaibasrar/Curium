...
<script type="text/javascript">
	...
	function addHolidays() {
		...
		form1.action="/tajacc/AttendanceProcess/addHolidays";
		form1.method = "POST";
		form1.submit();
	...
	function searchForEmployees(staffName, staffDepartment){
		var form1 = document.getElementById("form1");
		form1.action="/tajacc/AttendanceProcess/searchEmployees?staffName="+staffName+"&staffDepartment="+staffDepartment+"";
		form1.method = "POST";
		form1.submit();
	...
	function addStudentAttendanceMaster() {
		var form1 = document.getElementById("form1");
		form1.action="/tajacc/AttendanceProcess/addStudentAttendanceMaster";
		form1.method = "POST";
		form1.submit();
	}
	...
	function addStaffAttendanceMaster() {
		var form1 = document.getElementById("form1");
		form1.action="/tajacc/AttendanceProcess/addStaffAttendanceMaster";
		form1.method = "POST";
		form1.submit();
	}
</script>
...
%>
<body>
	<form id="form1" action="/tajacc/MarksDetailsProcess/updateMarks" method="POST">
				...
				<tbody>
					   ...
					   <c:forEach items="${employeeList}" var="employee">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive" style="text-transform:uppercase"><a class="dataTextInActive" href="/tajacc/EmployeeProcess/ViewDetails?id=<c:out value='${employee.tid}'/>"><c:out value="${employee.teachername}"/></a></td>
