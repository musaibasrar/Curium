...
<script type="text/javascript">
	...
	function addHolidays() {
		...
		form1.action = "/bright/AttendanceProcess/addHolidays";
		form1.method = "POST";
		form1.submit();
	...
	function searchForEmployees(staffName, staffDepartment){
		var form1 = document.getElementById("form1");
		form1.action = "/bright/AttendanceProcess/searchEmployees?staffName="+staffName+"&staffDepartment="+staffDepartment+"";
		form1.method = "POST";
		form1.submit();
	...
	function addStudentAttendanceMaster() {
		var form1 = document.getElementById("form1");
		form1.action = "/bright/AttendanceProcess/addStudentAttendanceMaster";
		form1.method = "POST";
		form1.submit();
	}
	...
	function addStaffAttendanceMaster() {
		var form1 = document.getElementById("form1");
		form1.action = "/bright/AttendanceProcess/addStaffAttendanceMaster";
		form1.method = "POST";
		form1.submit();
	}
</script>
...
%>
<body>
	<form id="form1" action="/bright/MarksDetailsProcess/updateMarks" method="POST">
