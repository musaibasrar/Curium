...
<script type="text/javascript">
	...
	function addHolidays() {
		...
		form1.action = "/syedbarey/AttendanceProcess/addHolidays";
		form1.method = "POST";
		form1.submit();
	...
	function searchForEmployees(staffName, staffDepartment){
		var form1 = document.getElementById("form1");
		form1.action = "/syedbarey/AttendanceProcess/searchEmployees?staffName="+staffName+"&staffDepartment="+staffDepartment+"";
		form1.method = "POST";
		form1.submit();
	...
	function addStudentAttendanceMaster() {
		var form1 = document.getElementById("form1");
		form1.action = "/syedbarey/AttendanceProcess/addStudentAttendanceMaster";
		form1.method = "POST";
		form1.submit();
	}
	...
	function addStaffAttendanceMaster() {
		var form1 = document.getElementById("form1");
		form1.action = "/syedbarey/AttendanceProcess/addStaffAttendanceMaster";
		form1.method = "POST";
		form1.submit();
	}
</script>
...
%>
<body>
	<form id="form1" action="/syedbarey/MarksDetailsProcess/updateMarks" method="POST">
				...
				<tbody>
					   ...
					   <c:forEach items="${employeeList}" var="employee">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive" style="text-transform:uppercase"><a class="dataTextInActive" href="/syedbarey/EmployeeProcess/ViewDetails?id=<c:out value='${employee.tid}'/>"><c:out value="${employee.teachername}"/></a></td>
