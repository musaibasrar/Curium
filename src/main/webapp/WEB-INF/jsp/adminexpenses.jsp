...
<script type="text/javascript">
	function addExpenses() {
		...
		form1.action="/tajacc/AdminProcess/addExpenses";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action="/tajacc/AdminProcess/deleteMultiple";
		form1.method = "POST";
		form1.submit();
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action="/tajacc/AdminProcess/printVoucher";
		form1.method = "POST";
		form1.submit();
	}
	...
	function approveRecords() {
		var form1 = document.getElementById("form1");
		form1.action="/tajacc/AdminProcess/approveVoucher";
		form1.method = "POST";
		form1.submit();
	}
	...
	function rejectRecords() {
		var form1 = document.getElementById("form1");
		form1.action="/tajacc/AdminProcess/rejectVoucher";
		form1.method = "POST";
		form1.submit();
	}
