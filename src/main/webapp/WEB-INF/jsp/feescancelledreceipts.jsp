...
<script type="text/javascript">
	function searchByDate() {
		...
		form1.action = "/bsr/FeesCollection/viewCancelledReceipts";
		form1.method = "POST";
		form1.submit();
                    ...
                    <tbody>
                        <c:forEach items="${searchfeesdetailslistcancelled}" var="feesdetails">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/bsr/FeesCollection/UndoFeesReceipt?id=<c:out value='${feesdetails.receiptnumber}'/>&sid=<c:out value='${feesdetails.sid}'/>"><i class="fa fa-undo" style="color:#1b5605;font-size: 18px;"></i></a></td>
