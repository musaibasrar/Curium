    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function updateStudent(){
                ...
                form1.action="Controller?process=StudentProcess/updateStudentDetails?id=<c:out value='${student.sid}'/>";
                form1.submit();
            }
...
%>
    <body background="/images/bg.jpg" onload="checkUsertype();">
        ...
        <script>
            ...
            function Cancel(){
                var form1=document.getElementById("form1");
                form1.action="Controller?process=StudentProcess/viewAllSuperAdmin";
                form1.submit();
            }
        </script>
    </body>
