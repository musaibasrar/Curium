    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function updateStudent(){
                ...
                form1.action="/bsr/StudentProcess/updateStudentDetails?id=<c:out value='${student.sid}'/>";
                form1.submit();
            }
...
%>
    <body background="/images/bg.jpg" onload="checkUsertype();">
        ...
        <form  method="post" id="form1">
            ...
            <div id="accordion" style="width: 100%;height: 100%">
                ...
                <div>
                    ...
                    <tr>
                    <td>
                    <img src="data:image/jpg;base64,<c:out value="${student.studentpic}"/>" alt="Student's Photo">
                    </td>
                    </tr>
        ...
        <script>
            ...
            function Cancel(){
                var form1=document.getElementById("form1");
                form1.action="/bsr/StudentProcess/viewAllSuperAdmin";
                form1.submit();
            }
        </script>
    </body>
