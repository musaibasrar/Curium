...
<TABLE  width="100%" border="1" style="border-collapse:collapse;">
		...
		<TABLE width="100%" border="0">
		<tr style="font-size: 10px;">
		<td align="left" style="padding-left: 20px;">Payment Mode:&nbsp;${receiptinfo.paymenttype}<br><br>Cashier Name:<label style="text-transform: capitalize;">${user.username}</label>
		Date&nbsp;:&nbsp;${receiptdate}<br>${narrationreceipt}</td>
