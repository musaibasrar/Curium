...
<div style="page-break-inside: avoid;border-collapse:collapse;">
	<form method="post" class="bodymargin">
			...
			<tr>
				<td><img src="/iqra/images/iqra.jpg" width="63" height="80"/></td>
				<td>
...
<TABLE  width="100%" border="1" style="border-collapse:collapse;">
		...
		<TABLE width="100%" border="0">
		<tr style="font-size: 10px;">
		<td align="left" style="padding-left: 20px;">Payment Mode:&nbsp;${receiptinfo.paymenttype}<br><br>Cashier Name:<label style="text-transform: capitalize;">${user.username}</label>&nbsp;&nbsp;${narrationreceipt}</td>
