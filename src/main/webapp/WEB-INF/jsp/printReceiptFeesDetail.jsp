...
<div style="page-break-inside: avoid;border-collapse:collapse;">
	<form method="post" class="bodymargin">
			...
			<tr>
				<td><img src="/scholargroup/images/scholargroup${branchid}.jpg" width="121" height="80"/></td>
				<td>
...
<TABLE  width="100%" border="1" style="border-collapse:collapse;">
		...
		<!-- <td><img src="/scholargroup/images/scholargrouppaytm.jpeg" width="70" height="65"/></td> -->
