...
<div style="page-break-inside: avoid;border-collapse:collapse;">
	<form method="post" class="bodymargin">
			...
			<tr>
				<td><img src="/readmodelschool/images/readmodelschool.jpg" width="80" height="80"/></td>
				<td>
...
<TABLE  width="100%" border="1" style="border-collapse:collapse;">
		...
		<TABLE id="dataTable" width="100%" border="0"
			...
			<tr>
				...
				<td class="headerText"></td>
				<td class="headerText" style="padding-left: 220px;"><label style="font-weight: bold;">Total Paid:</label>&nbsp;&nbsp;&nbsp;Rs.  <c:out value="${receiptinfo.totalamount}" /></td>
			</tr>
		...
		<!-- <td><img src="/readmodelschool/images/readmodelschoolpaytm.jpeg" width="70" height="65"/></td> -->
