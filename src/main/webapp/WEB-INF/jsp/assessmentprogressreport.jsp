...
<script type="text/javascript">
	function searchForReports() {
		...
		form1.action = "/vision/RatingDetailsProcess/searchForReport";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/vision/RatingDetailsProcess/searchForReport" method="POST">
				...
				<tfoot>
					<tr>
												...
												<td class="footerTD" colspan="2"><input value="Generate Report"
													type="submit" id="generatereport" formaction="/vision/RatingDetailsProcess/generateProgressReport" formmethod="post" formtarget="_blank" />
