                        ...
                        <tbody>
                            <c:forEach items="${receiptinfo}" var="receiptinfo">
                                <tr>
                                    ...
                                    <td class="dataText">
                                        <a class="btn btn-primary btn-sm" target="_blank" href="/peace/FeesCollection/ViewDetails?id=<c:out value='${receiptinfo.receiptnumber}' />&sid=<c:out value='${student.sid}' />">View</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
                        ...
                        <tbody>
                            <c:forEach items="${otherreceiptinfo}" var="receiptinfo">
                                <tr>
                                    ...
                                    <td class="dataText"><c:out value="${receiptinfo.totalamount}" /></td>
                                    <td class="dataText">
                                        <a class="btn btn-primary btn-sm" target="_blank" href="/peace/FeesCollection/viewOtherFeesDetails?id=<c:out value='${receiptinfo.receiptnumber}' />&sid=<c:out value='${student.sid}' />">View</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
