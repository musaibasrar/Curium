	...
	<form id="form1" method="post" class="bodymargin">
		<br>
		 <table align="center">
			...
			Caste <b><c:out value="${studentdetailsbonafide.student.studentscaste}" /></b> Sub Caste&nbsp;&nbsp;<b><c:out value="${studentdetailsbonafide.student.socialcategory}" /></b> and G.R. <b><c:out value="${studentdetailsbonafide.student.sts}" /></b>
