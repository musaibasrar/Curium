...
%>
    <body onload="StartClock()" onunload="KillClock()">
        ...
        <div id="container" style="width: 100%" >
            ...
            <div>
                <a target="mainFrame" href="/jihtel/StudentProcess/viewAllSuperAdmin" style="font-size: 12px;">View All</a><br/>
            </div>
            ...
            <div>
                <a target="mainFrame" href="/jihtel/FeesProcess/feesCollectAllBranches" style="font-size: 12px;">Fees Collect</a><br/>
            </div> 
            
            <h5 style="font-size: 12px"><a href="#" >Send Notifications</a></h5>
            <div >
                <a target="mainFrame" href="/jihtel/sendsms_superadmin" style="font-size: 12px;">SMS</a><br/>
            </div>
