...
<script type="text/javascript">
	function searchForFeesWaiveOff() {
		...
		form1.action = "/brilliantgrammar/FeesProcess/searchFeesWaiveoffReport";
		form1.method = "POST";
		form1.submit();
...
<script type="text/javascript">
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/brilliantgrammar/FeesProcess/printFeesWaiveoffReport";
		form1.method = "POST";
		form1.submit();
	}
	...
	<form id="form1">
		...
		<div style="overflow: scroll; height: 600px">
			...
			<table width="100%" border="0" style="border-color: #4b6a84;"
				...
				<tbody>
					<c:forEach items="${studentsfeesstructuredetailswaiveoff}" var="students" varStatus="status">
