...
<script type="text/javascript" src="/sla/js/globalize.min.js"></script>
<script type="text/javascript" charset="utf-8" src="/sla/js/globalize.cultures.js"></script>
...
<script type="text/javascript">
	...
	function deleteFeesStamp(){
		var form1 = document.getElementById("form1");
		form1.action="/sla/StampFeesProcess/delete";
		form1.method = "POST";
		form1.submit();
	}
</script>
					...
					<c:forEach items="${searchStudentList}" var="Parents">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataTextInActive"><a class="dataTextInActive"
								href="/sla/StudentProcess/ViewDetails?id=<c:out value='${Parents.student.sid}'/>&urlbranchid=<c:out value='${Parents.student.branchid}'/>"><c:out
