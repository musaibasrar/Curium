...
<script type="text/javascript">
	function searchForFees() {
		...
		form1.action = "/redrose/StampFeesProcess/search";
		form1.method = "POST";
		form1.submit();
...
//         var col5="<td class='dataTextInActive'><input type='text' value='0' name='feesConcession' id=feesConcession_"+rowCount+" readonly/></td>";
        var col6="<td class='dataTextInActive'><input class='feesFullAmount' type='text' value='0'   name='fessFullCat'  id=hiddenfees_full_amount_"+rowCount+" /><input type='hidden' value='0' name='feesConcession' id=feesConcession_"+rowCount+" readonly/></td>";
