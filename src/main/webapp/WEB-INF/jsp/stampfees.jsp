...
<script type="text/javascript" src="/alirfan/js/globalize.min.js"></script>
<script type="text/javascript" charset="utf-8" src="/alirfan/js/globalize.cultures.js"></script>
...
<script type="text/javascript">
	function searchForFees() {
		...
		form1.action = "/alirfan/StampFeesProcess/advanceSearchForStampFees";
		form1.method = "POST";
		form1.submit();
	...
	function deleteFeesStamp(){
		var form1 = document.getElementById("form1");
		form1.action = "/alirfan/StampFeesProcess/delete";
		form1.method = "POST";
		form1.submit();
	}
</script>
			...
			<table width="100%" border="0" style="border-color: #4b6a84;"
				...
				<thead>
					<tr>
						...
						<th title="click to sort" class="headerText">Student Type</th>
					</tr>
				</thead>
					...
					<c:forEach items="${searchStudentList}" var="Parents">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataTextInActive"><a class="dataTextInActive"
								href="/alirfan/StudentProcess/ViewDetails?id=<c:out value='${Parents.student.sid}'/>&urlbranchid=<c:out value='${Parents.student.branchid}'/>"><c:out
							...
							<td class="dataText"><c:out
									value="${Parents.student.bhagyalakshmibondnumber}" /></td>
