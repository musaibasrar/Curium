    ...
    font-weight: bold;
        ...
        <script type="text/javascript">
            ...
            function searchFeesStructure() {
                ...
                form1.action = "/shaheen/StudentProcess/feesStructurePerYear?id="+id;
                form1.submit();
            ...
            function deleteRecord() {
                ...
                var form1 = document.getElementById("form1");
                form1.action = "/shaheen/FeesProcess/deleteFeesCategory";
                form1.submit();
            ...
            function applyConcession() {
                ...
                var form1 = document.getElementById("form1");
                form1.action = "/shaheen/FeesProcess/applyConcession";
                form1.submit();
                                    ...
                                    <tr>
                                        <td align="left">
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                             ...
                                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                             <button id="print" onclick="window.location.href='/shaheen/printstudentdetailsfeesstructure'">Print</button>
