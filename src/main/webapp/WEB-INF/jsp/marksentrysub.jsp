...
<script type="text/javascript">
	function searchForMarksSub() {
		...
		form1.action = "/theage/MarksDetailsProcess/searchForMarksSub";
		form1.method = "POST";
		form1.submit();
...
function checkMandatoryandSubmit(){
    	...
    	if(document.getElementById("exam").value == ""){
    		...
    		var form1 = document.getElementById("form1");
    		form1.action = "/theage/MarksDetailsProcess/addMarksSubSubject";
    		form1.method = "POST";
    		form1.submit();
...
%>
<body>
	<form id="form1" action="/theage/MarksDetailsProcess/addMarksSubSubject" method="POST">
