        ...
        <div id="container" style="width: 95%" >
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/MarksDetailsProcess/marksEntrySub" style="font-size: 12px;">Enter Marks</a>
            			</td>
            		</tr>
            		<!--<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				<a target="mainFrame" href="/littleflower/MarksDetailsProcess/getSubjectsExamsSub" style="font-size: 12px;">View Marks</a>
            			</td>
            		</tr>
            		<!-- <tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
