        ...
        <div id="container" style="width: 95%" >
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/lilyrose/AccountProcess/viewVoucherReceipt" style="font-size: 12px;">View/Cancel Voucher</a>
            			</td>
           ...
           <!--   <h5 style="font-size: 12px"><a href="#" >H.R.</a></h5>
        	...
        	<div style="padding-left: 0px;padding-right: 0px;">
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/lilyrose/MessItemsMoveProcess/issueItems" style="font-size: 12px;">Generate Receipt</a>
            			</td>
            		</tr>
            		<!-- <tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
