...
<html>
    <head>
        ...
        <title>Left</title>
        <script language="JavaScript" src="/littleflower/js/motionpack.js"></script>
        ...
        <script src="/littleflower/js/datePicker/ui/jquery.ui.widget.js"></script>
        <script src="/littleflower/js/datePicker/ui/jquery.ui.datepicker.js"></script>
        <script src="/littleflower/js/datePicker/ui/jquery.ui.accordion.js"></script>
        <script src="/littleflower/js/datePicker/ui/sliderAccess.js"></script>
        <script src="/littleflower/js/datePicker/ui/jquery-ui-timepicker-addon.js"></script>
        <link href="/littleflower/css/notification/jquery.jnotify.css" rel="stylesheet" type="text/css" />
        <script src="/littleflower/js/notification/jquery.jnotify.js" type="text/javascript"></script>
		<link rel="stylesheet" href="/littleflower/css/font-awesome.css">
        ...
        <div id="container" style="width: 95%" >
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/StudentProcess/viewAll" style="font-size: 12px;">View All</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/StudentProcess/addNew" style="font-size: 12px;">Add New</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/StudentProcess/QuickStudentSave" style="font-size: 12px;">Quick Student Save</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/vouchersearch" style="font-size: 12px;">View/Cancel Voucher</a>
            			</td>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/DocumentsProcess/studentsDetailsStudyCertificate" style="font-size: 12px;">Study Certificate</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/DocumentsProcess/studentsArticleCertificate" style="font-size: 12px;">Article 371</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				<a target="mainFrame" href="/littleflower/DocumentsProcess/characterCertificate" style="font-size: 12px;">Character Certificate</a>
            			</td>
            		</tr>
            		<tr>
            		<tr>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<!-- <tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/MarksDetailsProcess/progressReport" style="font-size: 12px;">Generate Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				<a target="mainFrame" href="/littleflower/MarksDetailsProcess/getGraphicalReportData" style="font-size: 12px;">Graphical Report</a>
            			</td>
            		</tr> -->
                </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/RatingDetailsProcess/ratingEntry" style="font-size: 12px;">Enter Ratings</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/RatingDetailsProcess/getSubjectsAssessments" style="font-size: 12px;">View Ratings</a>
            			</td>
            		</tr>
                </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/Printids/generateIds" style="font-size: 12px;">Student IDs</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/Printids/generateIdsEmployees" style="font-size: 12px;">Staff IDs</a>
            			</td>
            		</tr>
                </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/LibraryProcess/addbooks" style="font-size: 12px;">Add Books</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/LibraryProcess/viewbooks" style="font-size: 12px;">View Books</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/LibraryProcess/issuebooks" style="font-size: 12px;">Issue Books</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/LibraryProcess/returnbooks" style="font-size: 12px;">Return Books</a>
            			</td>
            		</tr>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/SponserProcess/ViewAllSponsor" style="font-size: 12px;">View All</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/SponserProcess/addSponsorPage" style="font-size: 12px;">Add Sponsor</a>
            			</td>
            		</tr>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/LoginProcess/viewLoginDetail" style="font-size: 12px;">View Login Detail</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/LoginProcess/addLoginStaff" style="font-size: 12px;">Add Staff Login</a>
            			</td>
            		</tr>
                </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/EventProcess/calendar" style="font-size: 12px;">Create Event</a>
            			</td>
            		</tr>
            		<!-- <tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/EventProcess/create" style="font-size: 12px;">Create Event</a>
            			</td>
            		</tr> -->
            		
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				<a target="mainFrame" href="/littleflower/EventProcess/viewCalendar" style="font-size: 12px;">View Calendar</a>
            			</td>
            		</tr>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/Backup&Restore" style="font-size: 12px;">Backup</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/EmployeeProcess/archiveEmployeeViewAll" style="font-size: 12px;">Archive Employee</a>
            			</td>
            		</tr>
                </table>
            </div>
           ...
           <!--   <h5 style="font-size: 12px"><a href="#" >H.R.</a></h5>
            <div >
                <a target="mainFrame" href="/littleflower/HrProcess/advanceSalary" style="font-size: 12px;">Advance Salary</a><br/>
                <a target="mainFrame" href="/littleflower/HrProcess/salaryApproval" style="font-size: 12px;">Advance Salary Approval</a><br/>
                <a target="mainFrame" href="/littleflower/HrProcess/salaryIssue" style="font-size: 12px;">Advance Salary Status</a><br/>
                <a target="mainFrame" href="/littleflower/HrProcess/processSalary" style="font-size: 12px;">Process Salary</a><br/>
                <a target="mainFrame" href="/littleflower/HrProcess/issueStaffSalary" style="font-size: 12px;">Issue Staff Salary</a><br/>
            </div>
            
            <h5 style="font-size: 12px"><a href="#" >Leave Management</a></h5>
            <div >
                <a target="mainFrame" href="/littleflower/HrProcess/leaveApplication" style="font-size: 12px;">Leave Application</a><br/>
                <a target="mainFrame" href="/littleflower/HrProcess/leaveApprovals" style="font-size: 12px;">Leave Approvals</a><br/>
            </div> -->
        	...
        	<div style="padding-left: 0px;padding-right: 0px;">
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/MessItemsMoveProcess/issueItems" style="font-size: 12px;">Generate Receipts</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/MessItemsMoveProcess/generateTaxInvoice" style="font-size: 12px;">Generate Tax Invoice</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/MessItemsMoveProcess/generateTaxInvoiceReport" style="font-size: 12px;">Tax Invoice Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/MessItemsProcess/purchaseItems" style="font-size: 12px;">Purchase</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/MessItemsProcess/purchaseOrder" style="font-size: 12px;">Purchase Order</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				<a target="mainFrame" href="/littleflower/MessItemsProcess/viewItems" style="font-size: 12px;">View/Add Items</a>
            			</td>
            		</tr>
            	</table>
            </div>
           ...
           <!--  <h5 class="sideaccordian" ><a href="#" >Stock Reports</a></h5>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/MessItemsProcess/currentStock" style="font-size: 12px;">Stock Quantity Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/MessItemsProcess/batchStock" style="font-size: 12px;">Stock Price Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				<a target="mainFrame" href="/littleflower/MessItemsProcess/issuanceStock" style="font-size: 12px;">Stock Issuance Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/MessItemsProcess/receiveStock" style="font-size: 12px;">Stock Received Report</a>
            			</td>
            		</tr>
            	</table>
            </div> -->
            ...
            <h5 class="sideaccordian"><a href="#" >Suppliers</a></h5>
              ...
              <div style="padding-left: 0px;padding-right: 0px;">
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/MessSuppliersProcess/paymentSuppliers" style="font-size: 12px;">Make Payment</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/MessSuppliersProcess/balanceSuppliers" style="font-size: 12px;">Balance Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				<a target="mainFrame" href="/littleflower/MessSuppliersProcess/supplierPaymentReport" style="font-size: 12px;">Payment & Receipt Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/MessSuppliersProcess/viewSuppliers" style="font-size: 12px;">View/Add Suppliers</a>
            			</td>
            		</tr>
            	</table>
            </div>
           ...
           <!--  <h5 class="sideaccordian"><a href="#" >Mess Cards</a></h5>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/Printids/cardValidity" style="font-size: 12px;">Card Validity</a>
            			</td>
            		</tr>
            	</table>
            </div> -->
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/SMSProcess/sendSMS" style="font-size: 12px;">SMS</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				<a target="mainFrame" href="/littleflower/sendemail" style="font-size: 12px;">Email</a>
            			</td>
            		</tr>
                </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				<a target="mainFrame" href="/littleflower/ClassProcess/promoteClass" style="font-size: 12px;">Promotions</a>
            			</td>
            		</tr>
                </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
                              <a target="mainFrame" href="/littleflower/importfile" style="font-size: 12px;">Import Files</a><br/>
				        </td>
				     </tr>
				     <tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
                              <a target="mainFrame" href="/littleflower/importfilefees" style="font-size: 12px;">Import Fees Files</a><br/>
				        </td>
				     </tr>
				 </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	...
            	<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/EnquiryProcess/enquiry" style="font-size: 12px;">Enquiry</a>
            			</td>
            			
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/EnquiryProcess/viewEnquiry" style="font-size: 12px;">View Enquiry</a>
            			</td>
            		...
            		<!-- <tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/EnquiryProcess/newEnquiry" style="font-size: 12px;">Enquiry</a>
            			</td>
            			
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/EnquiryProcess/newEnquiry" style="font-size: 12px;">View Enquiries</a>
            			</td>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/JobProcess/viewAllQueries" style="font-size: 12px;">View Assignment</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            ...
            <div >
                <a target="mainFrame" href="/littleflower/HrProcess/advanceSalary" style="font-size: 12px;">Advance Salary</a><br/>
                <a target="mainFrame" href="/littleflower/HrProcess/salaryApproval" style="font-size: 12px;">Advance Salary Approval</a><br/>
                <a target="mainFrame" href="/littleflower/HrProcess/salaryIssue" style="font-size: 12px;">Advance Salary Issue</a><br/>
                <a target="mainFrame" href="/littleflower/HrProcess/processSalary" style="font-size: 12px;">Process Salary</a><br/>
                <a target="mainFrame" href="/littleflower/HrProcess/issueStaffSalary" style="font-size: 12px;">Issue Staff Salary</a><br/>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/AppointmentProcess/viewAllAppointments" style="font-size: 12px;">Appointment</a>
            			</td>
            		</tr>
                </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/CasesProcess/viewAllCases" style="font-size: 12px;">Cases</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/CasesProcess/createCase" style="font-size: 12px;">Create Cases</a>
            			</td>
            		</tr>
                </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/littleflower/CaveatProcess/viewAllCaveats" style="font-size: 12px;">Caveats</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/CaveatProcess/createCaveats" style="font-size: 12px;">Create Caveat</a>
            			</td>
            		</tr>
                </table>
            </div> -->
