        ...
        <div id="container" style="width: 95%" >
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/noble/StudentProcess/QuickStudentSave" style="font-size: 12px;">Quick Student Save</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/noble/FeesProcess/otherfeesCollect" style="font-size: 12px;">Bus Fees Collect</a>
            			</td>
            		</tr>
            		<!-- <tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/noble/vouchersearch" style="font-size: 12px;">View/Cancel Voucher</a>
            			</td>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/noble/DocumentsProcess/studentsDetailsStudyCertificate" style="font-size: 12px;">Study Certificate</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/noble/DocumentsProcess/studentsArticleCertificate" style="font-size: 12px;">Article 371</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				<a target="mainFrame" href="/noble/DocumentsProcess/characterCertificate" style="font-size: 12px;">Character Certificate</a>
            			</td>
            		</tr>
            		<tr>
            		<tr>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/noble/MarksDetailsProcess/marksEntrySub" style="font-size: 12px;">Enter Marks All</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				<a target="mainFrame" href="/noble/MarksDetailsProcess/getSubjectsExamsSub" style="font-size: 12px;">View Marks All</a>
            			</td>
            		</tr>
            		<!-- <tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/noble/Printids/generateIds" style="font-size: 12px;">Student IDs</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/noble/Printids/generateIdsEmployees" style="font-size: 12px;">Staff IDs</a>
            			</td>
            		</tr>
                </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/noble/LibraryProcess/addbooks" style="font-size: 12px;">Add Books</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/noble/LibraryProcess/viewbooks" style="font-size: 12px;">View Books</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/noble/LibraryProcess/issuebooks" style="font-size: 12px;">Issue Books</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/noble/LibraryProcess/returnbooks" style="font-size: 12px;">Return Books</a>
            			</td>
            		</tr>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/noble/SponserProcess/ViewAllSponsor" style="font-size: 12px;">View All</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/noble/SponserProcess/addSponsorPage" style="font-size: 12px;">Add Sponsor</a>
            			</td>
            		</tr>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/noble/LoginProcess/viewLoginDetail" style="font-size: 12px;">View Login Detail</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/noble/LoginProcess/addLoginStaff" style="font-size: 12px;">Add Staff Login</a>
            			</td>
            		</tr>
                </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/noble/EventProcess/calendar" style="font-size: 12px;">Create Event</a>
            			</td>
            		</tr>
            		<!-- <tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/noble/EventProcess/create" style="font-size: 12px;">Create Event</a>
            			</td>
            		</tr> -->
            		
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				<a target="mainFrame" href="/noble/EventProcess/viewCalendar" style="font-size: 12px;">View Calendar</a>
            			</td>
            		</tr>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/noble/EmployeeProcess/archiveEmployeeViewAll" style="font-size: 12px;">Archive Employee</a>
            			</td>
            		</tr>
                </table>
            </div>
           ...
           <!--   <h5 style="font-size: 12px"><a href="#" >H.R.</a></h5>
        	...
        	<div style="padding-left: 0px;padding-right: 0px;">
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/noble/MessItemsMoveProcess/issueItems" style="font-size: 12px;">Generate Receipts</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/noble/MessItemsMoveProcess/generateTaxInvoice" style="font-size: 12px;">Generate Tax Invoice</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/noble/MessItemsMoveProcess/generateTaxInvoiceReport" style="font-size: 12px;">Tax Invoice Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/noble/MessItemsProcess/purchaseItems" style="font-size: 12px;">Purchase</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/noble/MessItemsProcess/purchaseOrder" style="font-size: 12px;">Purchase Order</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
           ...
           <!--  <h5 class="sideaccordian"><a href="#" >Mess Cards</a></h5>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
				     ...
				     <tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
                              <a target="mainFrame" href="/noble/importfilefees" style="font-size: 12px;">Import Fees Files</a><br/>
				        </td>
				     </tr>
				 </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/noble/DiaryProcess/getdiarystudent" style="font-size: 12px;">Diary</a>
            			</td>
            			
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/noble/DiaryProcess/viewdiarystudent" style="font-size: 12px;">View Diary</a>
            			</td>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/noble/StudentDiaryProcess/getdiarystudent" style="font-size: 12px;">Add Log</a>
            			</td>
            			
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/noble/StudentDiaryProcess/viewdiarystudent" style="font-size: 12px;">View Logbook</a>
            			</td>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	...
            	<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/noble/EnquiryProcess/enquiry" style="font-size: 12px;">Enquiry</a>
            			</td>
            			
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/noble/EnquiryProcess/viewEnquiry" style="font-size: 12px;">View Enquiry</a>
            			</td>
            		...
            		<!-- <tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/noble/EnquiryProcess/newEnquiry" style="font-size: 12px;">Enquiry</a>
            			</td>
            			
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/noble/EnquiryProcess/newEnquiry" style="font-size: 12px;">View Enquiries</a>
            			</td>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/noble/JobProcess/viewAllQueries" style="font-size: 12px;">View Assignment</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/noble/JobProcess/viewAllTasks" style="font-size: 12px;">View Tasks</a>
            			</td>
            		</tr>
                </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/noble/AppointmentProcess/viewAllAppointments" style="font-size: 12px;">Appointment</a>
            			</td>
            		</tr>
                </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/noble/CasesProcess/viewAllCases" style="font-size: 12px;">Cases</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/noble/CasesProcess/createCase" style="font-size: 12px;">Create Cases</a>
            			</td>
            		</tr>
                </table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/noble/CaveatProcess/viewAllCaveats" style="font-size: 12px;">Caveats</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/noble/CaveatProcess/createCaveats" style="font-size: 12px;">Create Caveat</a>
            			</td>
            		</tr>
                </table>
            </div> -->
