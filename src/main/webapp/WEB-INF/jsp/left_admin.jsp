       ...
       <!--  <form name="theClock">
        ...
        <div id="container" style="width: 95%" >
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/Controller?process=StudentProcess/viewAll" style="font-size: 12px;">View All</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/Controller?process=StudentProcess/addNew" style="font-size: 12px;">Add New</a>
            			</td>
            		</tr>
                </table>
            </div>
            ...
            <div>
                ...
                <a target="mainFrame" href="/Controller?process=AttendanceProcess/markAttendance" style="font-size: 12px;">Mark Attendance</a><br/>
                <a target="mainFrame" href="/Controller?process=AttendanceProcess/attendanceExport" style="font-size: 12px;">Export Attendance</a><br/>
            </div>
            ...
            <div>
				...
				<a target="mainFrame" href="/Controller?process=FeesProcess/feesStructure" style="font-size: 12px;">Fees Structure</a><br/>                
				...
				<a target="mainFrame" href="/Controller?process=FeesProcess/feesReport" style="font-size: 12px;">Fees Report</a><br/>
				<a target="mainFrame" href="/Controller?process=FeesProcess/feesWaiveoffReport" style="font-size: 12px;">Fees Waive off Report</a><br/>
				<a target="mainFrame" href="/Controller?process=FeesProcess/feesConcessionReport" style="font-size: 12px;">Fees Concession Report</a><br/>
            </div> 
            
            <h5 style="font-size: 12px"><a href="/#">Exams</a></h5>
            
            <div>
                <a target="mainFrame" href="/Controller?process=MarksDetailsProcess/marksEntry" style="font-size: 12px;">Enter Marks</a><br/>
                <a target="mainFrame" href="/Controller?process=MarksDetailsProcess/getSubjectsExams" style="font-size: 12px;">View Marks</a><br/>
            	<a target="mainFrame" href="/Controller?process=MarksDetailsProcess/progressReport" style="font-size: 12px;">Generate Report</a><br/>
            ...
            <div>
                <a target="mainFrame" href="/Controller?process=StudentProcess/advanceSearchStudents" style="font-size: 12px;">Search</a><br/>
            ...
            <div >
                ...
                <a target="mainFrame" href="/Controller?process=StudentProcess/archiveViewAll" style="font-size: 12px;">Archive Students</a><br/>
            </div>
            
            
            <h5 style="font-size: 12px"><a href="/#" >Generate Cards</a></h5>
            <div >
                <a target="mainFrame" href="/Controller?process=printids/generateIds" style="font-size: 12px;">Generate IDs</a><br/>
            </div>
            
            <h5 style="font-size: 12px"><a href="/#" >Documents</a></h5>
            <div >
                <a target="mainFrame" href="/Controller?process=DocumentsProcess/studentsDetailsReports" style="font-size: 12px;">Student Details</a><br/>
                ...
                <a target="mainFrame" href="/Controller?process=DocumentsProcess/studentsDetailsBonafide" style="font-size: 12px;">Bonafide Certificate</a><br/>
                ...
                <a target="mainFrame" href="/Controller?process=PeriodProcess/generateTimeTable" style="font-size: 12px;">Class Time Table</a><br/>
                <a target="mainFrame" href="/Controller?process=PeriodProcess/generateTeacherTimeTable" style="font-size: 12px;">Teacher Time Table</a><br/>
            </div> 
            ...
            <div >
                <a target="mainFrame" href="/Controller?process=SMSProcess/sendSMS" style="font-size: 12px;">SMS</a><br/>
            ...
            <div >
                ...
                <a target="mainFrame" href="/Controller?process=AccountProcess/viewVoucherReceipt" style="font-size: 12px;">View/Cancel Voucher</a><br/>
                <a target="mainFrame" href="/Controller?process=AccountProcess/viewCancelledVouchers" style="font-size: 12px;">Cancelled Vouchers</a><br/>
                <a target="mainFrame" href="/Controller?process=AccountProcess/generalLedgerReport" style="font-size: 12px;">General Ledger Report</a><br/>
            ...
            <div >
                ...
                <a target="mainFrame" href="/Controller?process=HrProcess/salaryIssue" style="font-size: 12px;">Advance Salary Status</a><br/>
        	...
        	<div style="padding-left: 0px;padding-right: 0px;">
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/Controller?process=MessItemsMoveProcess/issueItems" style="font-size: 12px;">Issue</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/Controller?process=MessItemsProcess/purchaseItems" style="font-size: 12px;">Receive</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				<a target="mainFrame" href="/Controller?process=MessItemsProcess/viewItems" style="font-size: 12px;">View/Add Items</a>
            			</td>
            		</tr>
            	</table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/Controller?process=MessItemsProcess/currentStock" style="font-size: 12px;">Stock Quantity Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/Controller?process=MessItemsProcess/batchStock" style="font-size: 12px;">Stock Price Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				<a target="mainFrame" href="/Controller?process=MessItemsProcess/issuanceStock" style="font-size: 12px;">Stock Issuance Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/Controller?process=MessItemsProcess/receiveStock" style="font-size: 12px;">Stock Received Report</a>
            			</td>
            		</tr>
            	</table>
            </div>
            ...
            <h5 class="sideaccordian"><a href="/#" >Suppliers</a></h5>
              ...
              <div style="padding-left: 0px;padding-right: 0px;">
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/Controller?process=MessSuppliersProcess/paymentSuppliers" style="font-size: 12px;">Make Payment</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/Controller?process=MessSuppliersProcess/balanceSuppliers" style="font-size: 12px;">Balance Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				<a target="mainFrame" href="/Controller?process=MessSuppliersProcess/supplierPaymentReport" style="font-size: 12px;">Payment & Receipt Report</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/Controller?process=MessSuppliersProcess/viewSuppliers" style="font-size: 12px;">View/Add Suppliers</a>
            			</td>
            		</tr>
            	</table>
            </div>
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				 <a target="mainFrame" href="/Controller?process=printids/generateIds" style="font-size: 12px;">Generate IDs</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/Controller?process=printids/cardValidity" style="font-size: 12px;">Card Validity</a>
            			</td>
            		</tr>
            	</table>
            </div>
            ...
            <div>
                <a target="mainFrame" href="/Controller?process=MessItemsMoveProcess/issueItems" style="font-size: 12px;">Issue</a><br/>
                <a target="mainFrame" href="/Controller?process=MessItemsProcess/purchaseItems" style="font-size: 12px;">Receive</a><br/>
                <a target="mainFrame" href="/Controller?process=MessItemsProcess/viewItems" style="font-size: 12px;">View/Add Items</a><br/>
                <a target="mainFrame" href="/Controller?process=MessProcess/addSuppliers" style="font-size: 12px;">View/Add Suppliers</a><br/>
            </div> -->
            
            <h5 style="font-size: 12px"><a href="/#" >Promotion</a></h5>
            <div>
                <a target="mainFrame" href="/Controller?process=ClassProcess/promoteClass" style="font-size: 12px;">Promotions</a><br/>
