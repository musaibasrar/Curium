<%--
    Document   : Hall Ticket Assignment
    Created on : SEP 27, 2024, 9:44:28 PM
    Author     : Musaib
--%>
...
<title>Hall Ticket Assignment</title>
...
<script type="text/javascript">
	function searchForHallTicketInfo() {
		var form1 = document.getElementById("form1");
		form1.action = "/abc/DocumentsProcess/searchStudentsForHallTicketInfo";
		form1.method = "POST";
		form1.submit();
...
function checkMandatoryandSubmit(){
    	...
    	if(resultCheckBox){
    		alert('Select the student(s) to Update Info');
    	}else{
    		var form1 = document.getElementById("form1");
    		form1.action = "/abc/DocumentsProcess/addHallTicketInfo";
    		form1.method = "POST";
    		form1.submit();
...
%>
<body>
	<form id="form1" action="/abc/MarksDetailsProcess/addMarks" method="POST">
		...
		<div id="effect" class="ui-widget-content ui-corner-all">
			<div id="tabs">
				<ul>
					<li><a href="#tabs-1">Enter Hall Ticket Info</a></li>
			...
			<table width="100%" border="0" style="border-color: #4b6a84;"
				...
				<thead>
					<tr>
						...
						<th title="click to sort" class="headerText">Block No</th>
						<th title="click to sort" class="headerText">Seat No</th>
					...
					<c:forEach items="${searchStudentList}" var="Parents">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataText"><input type="text"
								id="blocknos" 
								name="blocknos"
								onkeyup="checkMandatory();" value="${Parents.student.bankifsc}"
								...
								id="seatnos" 
								name="seatnos"
								onkeyup="checkMandatory();" value="${Parents.student.urbanrural}"
								onkeypress="return (event.charCode >= 00 && event.charCode <=57) || event.charCode == 65"
								maxlength="3"
								 /></td>
				...
				<tfoot>
					<tr>
						<td class="footerTD" colspan="2"><input value="Submit"
							type="button" id="addInfo" onclick="checkMandatoryandSubmit();"/>
