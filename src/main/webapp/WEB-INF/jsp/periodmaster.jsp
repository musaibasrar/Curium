  ...
  function duplicatePeriods() {
	...
	function savePeriods() {
		...
		if(form1.checkValidity()) {
			form1.action = "/sac/PeriodProcess/savePeriods";
			form1.method = "POST";
			form1.submit();
		  }
	}
	...
	function deleteRecord(){
		var form1 = document.getElementById("form1");
		form1.action = "/sac/PeriodProcess/deletePeriods";
		form1.method = "POST";
		form1.submit();
	}
				...
				<thead>
					<tr>
						...
						<th title="click to sort" class="headerText">Classes<img
							...
							src="/sac/css/dataTable/images/sort_both.png" /></th>
				...
				<tbody>
					...
					<c:forEach items="${periodmasterlist}" var="periodmasterlist">
						...
						<tr style="border-color: #000000" border="1" cellpadding="1"
							...
							<td class="dataText"><a class="dataTextInActive" href="/sac/PeriodProcess/viewTimeTable?id=<c:out value="${periodmasterlist.idperiodmaster}" />"><c:out value="${periodmasterlist.classSec}" /></a></td>
