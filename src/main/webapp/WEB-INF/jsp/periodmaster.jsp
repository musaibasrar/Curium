...
<script type="text/javascript" language="javascript"
	src="/iqra/js/dataTable/jquery.dataTables.js"></script>
<script type="text/javascript" src="/iqra/js/datePicker/ui/jquery.ui.core.js"></script>
<script type="text/javascript"
	src="/iqra/js/datePicker/ui/jquery.ui.widget.js"></script>
<script type="text/javascript"
	src="/iqra/js/datePicker/ui/jquery.ui.datepicker.js"></script>
<script type="text/javascript" src="/iqra/js/datePicker/ui/jquery.ui.tabs.js"></script>
<script type="text/javascript" src="/iqra/js/datePicker/ui/sliderAccess.js"></script>

<script type="text/javascript"
	src="/iqra/js/validation/jquery.ketchup.all.min.js"></script>
<script type="text/javascript"
	src="/iqra/js/datePicker/ui/jquery.ui.button.js"></script>
<script type="text/javascript"
	src="/iqra/js/datePicker/ui/jquery.ui.accordion.js"></script>
<script type="text/javascript"
	src="/iqra/js/datePicker/ui/jquery.effects.core.js"></script>
<script type="text/javascript"
	src="/iqra/js/datePicker/ui/jquery.ui.accordion.js"></script>
<script type="text/javascript"
	src="/iqra/js/datePicker/ui/jquery.effects.slide.js"></script>
<script type="text/javascript"
	src="/iqra/js/datePicker/ui/jquery.effects.bounce.js"></script>
<script type="text/javascript"
	src="/iqra/js/datePicker/ui/jquery.effects.clip.js"></script>
<script type="text/javascript"
	src="/iqra/js/datePicker/ui/jquery.effects.transfer.js"></script>
<script type="text/javascript"
	src="/iqra/js/datePicker/ui/jquery.effects.blind.js"></script>
<script type="text/javascript"
	src="/iqra/js/datePicker/ui/ScrollableGridPlugin.js"></script>
  ...
  function duplicatePeriods() {
	...
	function savePeriods() {
		...
		if(form1.checkValidity()) {
			form1.action = "/iqra/PeriodProcess/savePeriods";
			form1.method = "POST";
			form1.submit();
		  }
	}
	...
	function deleteRecord(){
		var form1 = document.getElementById("form1");
		form1.action = "/iqra/PeriodProcess/deletePeriods";
		form1.method = "POST";
		form1.submit();
	}
				...
				<thead>
					<tr>
						...
						<th title="click to sort" class="headerText">Classes<img
							...
							src="/iqra/css/dataTable/images/sort_both.png" /></th>
