...
<link rel="stylesheet" href="/rahmani/css/validation/jquery.ketchup.css">
...
<script type="text/javascript"
	src="/rahmani/js/datePicker/ui/jquery.ui.widget.js"></script>
<script type="text/javascript"
...
<script type="text/javascript"
	src="/rahmani/js/datePicker/ui/jquery.effects.core.js"></script>
<script type="text/javascript"
	src="/rahmani/js/datePicker/ui/jquery.ui.accordion.js"></script>
<script type="text/javascript"
	src="/rahmani/js/datePicker/ui/jquery.effects.slide.js"></script>
<script type="text/javascript"
	src="/rahmani/js/datePicker/ui/jquery.effects.bounce.js"></script>
<script type="text/javascript"
	src="/rahmani/js/datePicker/ui/jquery.effects.clip.js"></script>
<script type="text/javascript"
  ...
  function duplicatePeriods() {
	...
	function savePeriods() {
		...
		if(form1.checkValidity()) {
			form1.action = "/rahmani/PeriodProcess/savePeriods";
			form1.method = "POST";
			form1.submit();
		  }
	}
	...
	function deleteRecord(){
		var form1 = document.getElementById("form1");
		form1.action = "/rahmani/PeriodProcess/deletePeriods";
		form1.method = "POST";
		form1.submit();
	}
				...
				<thead>
					<tr>
						...
						<th title="click to sort" class="headerText">Classes<img
							...
							src="/rahmani/css/dataTable/images/sort_both.png" /></th>
				...
				<tbody>
					...
					<c:forEach items="${periodmasterlist}" var="periodmasterlist">
						...
						<tr style="border-color: #000000" border="1" cellpadding="1"
							...
							<td class="dataText"><a class="dataTextInActive" href="/rahmani/PeriodProcess/viewTimeTable?id=<c:out value="${periodmasterlist.idperiodmaster}" />"><c:out value="${periodmasterlist.classSec}" /></a></td>
