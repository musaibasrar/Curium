    ...
    <head >
        ...
        <script type="text/javascript">
            ...
            function archiveRecords(){
                var form1=document.getElementById("form1");
               form1.action="/school/EmployeeProcess/archiveMultipleEmployee";
               form1.submit();
                ...
                <table   width="100%"  border="0" style="border-color:#4b6a84;"  id="myTable">
                    ...
                    <tfoot><tr>
                            <td  class="footerTD" colspan="2" ><!-- <input value="Delete" type="submit" id="delete"/> -->
                             <input value="Export" type="submit" id="export" formaction="/school/EmployeeProcess/exportDataForEmployees" />
