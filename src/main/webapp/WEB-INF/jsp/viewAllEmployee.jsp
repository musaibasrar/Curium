    ...
    <head >
        ...
        <script type="text/javascript">
            ...
            function createQuery(tid,branchid){
                var form1=document.getElementById("form1");
               form1.action="/qpevents/JobProcess/CreateQuery?id="+tid+"&urlbranchid="+branchid+"";
               form1.submit();
            }
        </script>
    </head>
...
%>
    <body  >
        ...
        <form name="form1" id="form1"action="/qpevents/EmployeeProcess/deleteMultiple" method="post">
