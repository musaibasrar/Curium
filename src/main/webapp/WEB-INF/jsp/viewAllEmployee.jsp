    ...
    <head >
        ...
        <script type="text/javascript">
            ...
            function createQuery(tid,branchid){
                var form1=document.getElementById("form1");
               form1.action="${ctx}/JobProcess/CreateQuery?id="+tid+"&urlbranchid="+branchid+"";
               form1.submit();
            }
        </script>
    </head>
...
%>
    <body  >
        ...
        <form name="form1" id="form1"action="${ctx}/EmployeeProcess/deleteMultiple" method="post">
                    ...
                    <tbody>
                        <c:forEach items="${employeeList}" var="employee">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive" style="text-transform:uppercase"><a class="dataTextInActive" href="${ctx}/EmployeeProcess/ViewDetails?id=<c:out value='${employee.tid}'/>"><c:out value="${employee.teachername}"/></a></td>
