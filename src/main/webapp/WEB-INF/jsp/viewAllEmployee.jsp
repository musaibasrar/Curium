    ...
    <head >
        ...
        <script type="text/javascript">
            ...
            function archiveRecords(){
                var form1=document.getElementById("form1");
               form1.action="/noblewisdom/EmployeeProcess/archiveMultipleEmployee";
               form1.submit();
...
%>
    <body  >
        ...
        <form name="form1" id="form1"action="/noblewisdom/EmployeeProcess/deleteMultiple" method="post">
                ...
                <table   width="100%"  border="0" style="border-color:#4b6a84;"  id="myTable">
                    ...
                    <tfoot><tr>
                            <td  class="footerTD" colspan="2" ><!-- <input value="Delete" type="submit" id="delete"/> -->
                             <input value="Export" type="submit" id="export" formaction="/noblewisdom/EmployeeProcess/exportDataForEmployees" />
