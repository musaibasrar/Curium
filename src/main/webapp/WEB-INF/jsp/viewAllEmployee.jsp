    ...
    <head >
        ...
        <script type="text/javascript">
            ...
            function archiveRecords(){
                var form1=document.getElementById("form1");
               form1.action="/hira/EmployeeProcess/archiveMultipleEmployee";
               form1.submit();
...
%>
    <body  >
        ...
        <form name="form1" id="form1"action="/hira/EmployeeProcess/deleteMultiple" method="post">
                ...
                <table   width="100%"  border="0" style="border-color:#4b6a84;"  id="myTable">
                    ...
                    <tbody>
                        <c:forEach items="${employeeList}" var="employee" varStatus="status">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive" style="text-transform:uppercase"><a class="dataTextInActive" href="/hira/EmployeeProcess/ViewDetails?id=<c:out value='${employee.tid}'/>"><c:out value="${employee.teachername}"/></a></td>
                    ...
                    <tfoot><tr>
                            <td  class="footerTD" colspan="2" ><!-- <input value="Delete" type="submit" id="delete"/> -->
                             <input value="Export" type="submit" id="export" formaction="/hira/EmployeeProcess/exportDataForEmployees" />
