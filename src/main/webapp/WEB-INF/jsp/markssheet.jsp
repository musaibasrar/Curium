...
<jsp:useBean id="now" class="java.util.Date" scope="page" />
	<form method="post" class="bodymargin">
			...
			<tr>
				<td width="10%"></td>
				<td><img src="/sla/images/slaheader.png" width="190" height="60"/></td>
				<td width="5%"></td>
				<td>
				...
				<td class="namedetails"><label>Father's Name:&nbsp;&nbsp;&nbsp;</label><label style="font-weight: bold;text-transform: capitalize;"><c:out value="${Parents.parents.fathersname}"/></label></td>	
                           ...
                           <!-- <tr>
                            ...
                            <table style=" border-collapse: collapse;width: 30%;float: left">
                            	<tr>
                            		<td>
                            			<img src="/sla//sladata:image;base64,<c:out value="${Parents.parents.student.studentpic}"/>" alt="Student's Photo" style="width: 60px;height: 60px;">
                            		</td>
                            	</tr>
