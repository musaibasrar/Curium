...
<jsp:useBean id="now" class="java.util.Date" scope="page" />
	<form method="post" class="bodymargin">
			...
			<tr>
				<td style="padding-left: 200px;"><img src="/gnyanganga/images/gnyanganga${branchid}.jpg" width="72" height="80"/></td>
				<td>
                                ...
                                <td>
                                	<table style=" border-collapse: collapse;width: 100%;border: 1px solid black;">
	                                	...
	                                	<tr style="border: 1px solid black;">
	                                		...
	                                		<fmt:formatNumber value="${marksParts[0]}" type="number" minFractionDigits="0" maxFractionDigits="0"/>/${marksParts[1]}-<%-- (${dateParts[2]}) --%>-(${dateParts[1]})</td>
	                                	</tr>
	                                </c:forEach>
	                                		<tr style="border-top: 1px solid black;">
	                                			<td style="border: 1px solid black;text-align: left;">Total Marks Obtained</td>
	                                			<td style="border: 1px solid black;text-align: left;"><fmt:formatNumber value="${exammarks.totalMarksObtained}" type="number" minFractionDigits="0" maxFractionDigits="0"/>
	                                			</td>
	                                		</tr>
	                                		<tr style="border: 1px solid black;">
