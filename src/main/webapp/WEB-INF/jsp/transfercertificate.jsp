...
%>
    ...
    <jsp:useBean id="now" class="java.util.Date" scope="page" />
        <form id="form1" action="/fathima/DocumentsProcess/generateTransferCertificate" method="post" onkeypress="if (event.keyCode == 92) datetowords();">
            <table  width="100%">
                <thead>
                    <tr>
            ...
            <table>
                    ...
                    <tr>
                    <td >The pupil's conduct and character: &nbsp;&nbsp;&nbsp;&nbsp;</td><td> <input  type="text" name="conduct" id="conduct" style="width: 200px" /></td>
                    ...
                    <td >Reason for Leaving the School:&nbsp;&nbsp;&nbsp;&nbsp;</td><td> <input  type="text" name="reason" id="reason" style="width: 200px" /></td>    
                     ...
                     <tr>
                    <td>Whether Promoted to higher class: &nbsp;&nbsp;&nbsp;&nbsp;</td><td> <input  type="text" name="Remarks" id="Remarks" style="width: 200px" /></td>
                    </tr>
                    </table>
                    <tr>
                    <td><br></td>
