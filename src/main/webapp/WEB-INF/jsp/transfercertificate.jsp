    ...
    $(function() {
        ...
        $( "#effect" ).hide();
            ...
            function getstampfees(){
        		...
        		form1.action = "/alfalahschool/FeesCollection/StampFees";
        		form1.method = "POST";
        		form1.submit();
            }
...
%>
    ...
    <jsp:useBean id="now" class="java.util.Date" scope="page" />
        <form id="form1" action="/alfalahschool/DocumentsProcess/generateTransferCertificate" method="post" onkeypress="if (event.keyCode == 92) datetowords();">
            <table  width="100%">
                <thead>
                    <tr>
