...
%>
    ...
    <jsp:useBean id="now" class="java.util.Date" scope="page" />
        <form id="form1" action="/shatabdi/DocumentsProcess/generateTransferCertificate" method="post" onsubmit="return validateForm()" onkeypress="if (event.keyCode == 92) datetowords();">
            <table  width="100%">
                <thead>
                    <tr>
