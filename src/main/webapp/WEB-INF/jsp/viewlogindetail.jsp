...
$(function(){
    ...
    function deleteRecords(){
        ...
        form1.action="/fathima/LoginProcess/deleteRecord";
        form1.method = "POST";
       form1.submit();
				...
				<tbody>
					...
					<c:forEach items="${logindetail}" var="logindetail">
						...
						<tr style="border-color: #000000" border="1" cellpadding="1"
							...
							<td class="dataText"><a class="dataTextInActive" href="/fathima/LoginProcess/logindetail?id=<c:out value='${logindetail.lid}'/>"><c:out value="${logindetail.username}" /></a></td>	
