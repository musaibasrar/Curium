...
<script>
    ...
    function searchfeecategory() {
    	...
    	if (!addClass) {
			...
			xmlHttp.onreadystatechange = stateChanged;
			xmlHttp.open("GET", "/greatindiaacademy/FeesProcess/searchfeecategory?classstudying="+addClass+"&yearofadmission="+yoa+"&feescategories="+checkedFeesCategoryValues+"",true);
			xmlHttp.send(null);
...
function searchOtherFeecategory() {
    ...
    xmlHttpof.open("GET", "/greatindiaacademy/FeesProcess/searchOtherFeecategory?classstudying="+addClass+"&yearofadmission="+yoa, true);
    xmlHttpof.send(null);
}
</script>
<script>
...
<script type="text/javascript" charset="utf-8">
        ...
        function searchListOfParent() {
            ...
            xmlHttpParent.open(
                "GET",
                "/greatindiaacademy/StudentProcess/searchListOfParent",
                true
            );
	...
	<script type="text/javascript">
							function addStudent() {
								...
								if(form1.checkValidity()) {
									...
									form1.action = "/greatindiaacademy/StudentProcess/AddStudent";
									form1.submit();
								  }
							}
