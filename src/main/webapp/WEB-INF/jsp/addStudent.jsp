...
<script src="/childrenandglobal/js/datePicker/jquery-1.7.1.js"></script>
<script src="/childrenandglobal/js/datePicker/ui/jquery.ui.core.js"></script>
...
<script src="/childrenandglobal/js/validation/jquery.ketchup.all.min.js"></script>
<script type="text/javascript"
...
<script src="/childrenandglobal/JavaScript/actb.js"></script>
<script src="/childrenandglobal/JavaScript/common.js"></script>
...
<script>
    ...
    function searchfeecategory() {
    	...
    	if (!addClass) {
			...
			xmlHttp.onreadystatechange = stateChanged;
			xmlHttp.open("GET", "/childrenandglobal/FeesProcess/searchfeecategory?classstudying="+addClass+"&yearofadmission="+yoa+"",true);
			xmlHttp.send(null);
...
function searchOtherFeecategory() {
    ...
    xmlHttpof.open("GET", "/childrenandglobal/FeesProcess/searchOtherFeecategory?classstudying="+addClass+"&yearofadmission="+yoa, true);
    xmlHttpof.send(null);
}
</script>
<script>
	...
	<script type="text/javascript">
							function addStudent() {
								...
								if(form1.checkValidity()) {
									...
									form1.action = "/childrenandglobal/StudentProcess/AddStudent";
									form1.submit();
								  }
							}
