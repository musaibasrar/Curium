...
<script src="/shadaan/JavaScript/actb.js"></script>
<script src="/shadaan/JavaScript/common.js"></script>
...
<script>
    ...
    function searchfeecategory() {
    	...
    	var yoa=document.getElementById('yearofadmission').value;
			...
			xmlHttp.onreadystatechange = stateChanged;
			xmlHttp.open("GET", "/shadaan/FeesProcess/searchfeecategory?classstudying="+addClass+"&yearofadmission="+yoa+"",true);
			xmlHttp.send(null);
...
function searchOtherFeecategory() {
    ...
    xmlHttpof.open("GET", "/shadaan/FeesProcess/searchOtherFeecategory?classstudying=" + addClass + "&yearofadmission=" + yoa, true);
    xmlHttpof.send(null);
}
</script>
<script>
	...
	<script type="text/javascript">
							function addStudent() {
								...
								if(form1.checkValidity()) {
									...
									form1.action = "/shadaan/StudentProcess/AddStudent";
									form1.submit();
								  }
							}
