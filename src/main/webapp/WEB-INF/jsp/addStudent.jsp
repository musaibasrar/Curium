...
<script src="/aashiyana/js/datePicker/jquery-1.7.1.js"></script>
<script src="/aashiyana/js/datePicker/ui/jquery.ui.core.js"></script>
...
<script src="/aashiyana/js/validation/jquery.ketchup.all.min.js"></script>
<script type="text/javascript"
...
<script>
    ...
    function searchfeecategory() {
    	...
    	if (!addClass) {
			...
			xmlHttp.onreadystatechange = stateChanged;
			xmlHttp.open("GET", "/aashiyana/FeesProcess/searchfeecategory?classstudying="+addClass+"&yearofadmission="+yoa+"&feescategories="+checkedFeesCategoryValues+"",true);
			xmlHttp.send(null);
...
function searchOtherFeecategory() {
    ...
    xmlHttpof.open("GET", "/aashiyana/FeesProcess/searchOtherFeecategory?classstudying="+addClass+"&yearofadmission="+yoa, true);
    xmlHttpof.send(null);
}
</script>
<script>
...
<script type="text/javascript" charset="utf-8">
        ...
        function searchListOfParent() {
            ...
            xmlHttpParent.open(
                "GET",
                "/aashiyana/StudentProcess/searchListOfParent",
                true
            );
	...
	<script type="text/javascript">
							function addStudent() {
								...
								if(form1.checkValidity()) {
									...
									form1.action = "/aashiyana/StudentProcess/AddStudent";
									form1.submit();
								  }
							}
