					...
					<table style="width: auto;height: auto;" border="0" align="center" id="table1">
						...
						<tr>
							<td class="alignLeft">Contact Number&nbsp;</td>
									...
									<td class="alignLeft" style="padding-left: 20px;">Qualification&nbsp;</td>
						...
						<tr>
							...
							<td class="alignLeft" style="padding-left: 20px;">Area&nbsp;</td>
									...
									<td><label><input name="nationality"
											type="text" class="myclass" id="nationality" size="36"
											> 
						...
						<tr>
							...
							<td><label> <input
									name="languagesstudied" type="text"
									style="text-transform:capitalize;"
									class="myclass" id="languagesstudied" size="36">
							</label></td>
						</tr>
	...
	<script type="text/javascript">
							function addStudent() {
								...
								if(form1.checkValidity()) {
									...
									form1.action = "/jih/StudentProcess/AddStudent";
									form1.submit();
								  }
							}
