...
<title>Add Student</title>
 ...
 <style type="text/css" title="currentStyle">
            @import "/bright/css/dataTable/css/demo_page.css";
            @import "/bright/css/dataTable/css/jquery.dataTables.css";
        </style>

<script type="text/javascript"
	src="/bright/js/datePicker/ui/jquery-ui-1.8.17.custom.js"></script>
<script src="/bright/js/datePicker/jquery-1.7.1.js"></script>
<script src="/bright/js/datePicker/ui/jquery.ui.core.js"></script>
...
<script src="/bright/js/validation/jquery.ketchup.all.min.js"></script>
<script type="text/javascript"
...
<script>
    ...
    function searchfeecategory() {
    	...
    	if (!addClass) {
			...
			xmlHttp.onreadystatechange = stateChanged;
			xmlHttp.open("GET", "/bright/FeesProcess/searchfeecategory?classstudying="+addClass+"&yearofadmission="+yoa+"&feescategories="+checkedFeesCategoryValues+"",true);
			xmlHttp.send(null);
...
function searchOtherFeecategory() {
    ...
    xmlHttpof.open("GET", "/bright/FeesProcess/searchOtherFeecategory?classstudying="+addClass+"&yearofadmission="+yoa, true);
    xmlHttpof.send(null);
}
</script>
<script>
...
<script type="text/javascript" charset="utf-8">
        ...
        function searchListOfParent() {
            ...
            xmlHttpParent.open(
                "GET",
                "/bright/StudentProcess/searchListOfParent",
                true
            );
	...
	<script type="text/javascript">
							function addStudent() {
								...
								if(form1.checkValidity()) {
									...
									form1.action = "/bright/StudentProcess/AddStudent";
									form1.submit();
								  }
							}
