...
<script src="/daralmajd/JavaScript/actb.js"></script>
<script src="/daralmajd/JavaScript/common.js"></script>
...
<script>
    ...
    function searchfeecategory() {
    	...
    	if (!addClass) {
			...
			xmlHttp.onreadystatechange = stateChanged;
			xmlHttp.open("GET", "/daralmajd/FeesProcess/searchfeecategory?classstudying="+addClass+"&yearofadmission="+yoa+"",true);
			xmlHttp.send(null);
...
function searchOtherFeecategory() {
    ...
    xmlHttpof.open("GET", "/daralmajd/FeesProcess/searchOtherFeecategory?classstudying=" + addClass + "&yearofadmission=" + yoa, true);
    xmlHttpof.send(null);
}
</script>
<script>
	...
	<script type="text/javascript">
							function addStudent() {
								...
								if(form1.checkValidity()) {
									...
									form1.action = "/daralmajd/StudentProcess/AddStudent";
									form1.submit();
								  }
							}
