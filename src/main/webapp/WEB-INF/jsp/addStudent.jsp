...
<script>
    ...
    function searchfeecategory() {
    	...
    	if (!addClass) {
			...
			xmlHttp.onreadystatechange = stateChanged;
			xmlHttp.open("GET", "/sac/FeesProcess/searchfeecategory?classstudying="+addClass+"&yearofadmission="+yoa+"&feescategories="+checkedFeesCategoryValues+"",true);
			xmlHttp.send(null);
...
function searchOtherFeecategory() {
    ...
    xmlHttpof.open("GET", "/sac/FeesProcess/searchOtherFeecategory?classstudying="+addClass+"&yearofadmission="+yoa, true);
    xmlHttpof.send(null);
}
</script>
<script>
...
<script type="text/javascript" charset="utf-8">
        ...
        function searchListOfParent() {
            ...
            xmlHttpParent.open(
                "GET",
                "/sac/StudentProcess/searchListOfParent",
                true
            );
						...
						<tr>
							...
							<td ><label>
								...
								&nbsp;Transport <select name="feescategories" id="transport" style="width: 140px;border-radius: 4px;background: white;height: 28px;">
												...
												<option value="BAHLOLPUR">BAHLOLPUR</option>
												<option value="BARASHANKAR MOHAMMADPUR">BARASHANKAR MOHAMMADPUR</option>
												<option value="BAREWA">BAREWA</option>
												<option value="BARHARWA FATEH MOHAMMAD">BARHARWA FATEH MOHAMMAD</option>
												<option value="BHANDAR">BHANDAR</option>
												<option value="BILHARDE">BILHARDE</option>
												<option value="CHAKNAGRI">CHAKNAGRI</option>
												<option value="CHAKWA PUNARWAS">CHAKWA PUNARWAS</option>
												<option value="CHANDANBARA">CHANDANBARA</option>
												<option value="DAUDNAGAR">DAUDNAGAR</option>
												<option value="DHAKA">DHAKA</option>
												<option value="DOSTIYA">DOSTIYA</option>
												<option value="GAMHARIYA">GAMHARIYA</option>
												<option value="GARAHIYA">GARAHIYA</option>
												<option value="HARUHANI">HARUHANI</option>
												<option value="JAMUA">JAMUA</option>
												<option value="JHITKAHI">JHITKAHI</option>
												<option value="JIHULI">JIHULI</option>
												<option value="KHAIRWA">KHAIRWA</option>
												<option value="KHARIHANIA">KHARIHANIA</option>
												<option value="KHORIPAKAR">KHORIPAKAR</option>
												<option value="KUSMAHWA">KUSMAHWA</option>
												<option value="LAHSANIYA">LAHSANIYA</option>
												<option value="MARPA TAHIR">MARPA TAHIR</option>
												<option value="MATHIYA MOHAN">MATHIYA MOHAN</option>
												<option value="MOHAMMADPUR">MOHAMMADPUR</option>
												<option value="MURLI">MURLI</option>
												<option value="PACHPAKRI">PACHPAKRI</option>
	...
	<script type="text/javascript">
							function addStudent() {
								...
								if(form1.checkValidity()) {
									...
									form1.action = "/sac/StudentProcess/AddStudent";
									form1.submit();
								  }
							}
