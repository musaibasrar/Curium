...
<script src="/jrs/js/datePicker/jquery-1.7.1.js"></script>
<script src="/jrs/js/datePicker/ui/jquery.ui.core.js"></script>
<script src="/jrs/js/datePicker/ui/jquery.ui.widget.js"></script>
<script src="/jrs/js/datePicker/ui/jquery.ui.datepicker.js"></script>
<script src="/jrs/js/datePicker/ui/jquery.ui.tabs.js"></script>
...
<script src="/jrs/js/validation/jquery.ketchup.all.min.js"></script>
<script type="text/javascript"
...
<script src="/jrs/JavaScript/actb.js"></script>
<script src="/jrs/JavaScript/common.js"></script>
...
var xmlHttp;
    ...
    function searchfeecategory() {
    	...
    	if (!addClass) {
			...
			xmlHttp.onreadystatechange = stateChanged;
			xmlHttp.open("GET", "/jrs/FeesProcess/searchfeecategory?classstudying="+addClass+"&yearofadmission="+yoa+"",true);
			xmlHttp.send(null);
...
function searchOtherFeecategory() {
    ...
    xmlHttpof.open("GET", "/jrs/FeesProcess/searchOtherFeecategory?classstudying="+addClass+"&yearofadmission="+yoa, true);
    xmlHttpof.send(null);
}
</script>
<script>
				...
				<div id="fragment-1">
					...
					<tr>
						...
						<tr>
							...
							<td ><label> <input name="admnno" onblur="checkDuplicate()"
						...
						<tr>
							...
							<td class="alignLeft" style="display: none;">Created Date &nbsp;</td>
							<td style="display: none;"><label> <input name="createddate"
									type="text"
...
<tr>
						...
						<div id="fragment-3">
							<table width="100%" border="0" align="center">
								...
								<tr>
									<td><label style="font-size: 12px;color: #325F6D;font-weight: bold;">Student Aadhaar</label><br /> <input type="file" name="fileToUpload"
								...
								<tr>
									<td><label style="font-size: 12px;color: #325F6D;font-weight: bold;">Father Aadhaar</label><br /> <input type="file" name="fileToUpload"
								...
								<tr>
									<td><label style="font-size: 12px;color: #325F6D;font-weight: bold;">Mother Aadhaar</label><br /> <input type="file" name="fileToUpload"
								...
								<tr>
									<td><label style="font-size: 12px;color: #325F6D;font-weight: bold;">T.C.</label><br /> <input type="file" name="fileToUpload"
								...
								<tr>
									<td><label style="font-size: 12px;color: #325F6D;font-weight: bold;">B.P.L Card</label><br /> <input type="file" name="fileToUpload"
	...
	<script type="text/javascript">
							function addStudent() {
								...
								if(form1.checkValidity()) {
									...
									form1.action = "/jrs/StudentProcess/AddStudent";
									form1.submit();
								  }
							}
