...
var xmlHttp;
    ...
    function searchfeecategory() {
    	...
    	var yoa=document.getElementById('yearofadmission').value;
			...
			xmlHttp.onreadystatechange = stateChanged;
			xmlHttp.open("GET", "/alfalahschool/FeesProcess/searchfeecategory?classstudying="+addClass+"&yearofadmission="+yoa+"",true);
			xmlHttp.send(null);
	...
	<script type="text/javascript">
							function addStudent() {
								...
								if(form1.checkValidity()) {
									...
									form1.action = "/alfalahschool/StudentProcess/AddStudent";
									form1.submit();
								  }
							}
