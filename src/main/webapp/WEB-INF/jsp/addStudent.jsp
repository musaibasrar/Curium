...
<script>
    ...
    function searchfeecategory() {
    	...
    	if (!addClass) {
			...
			xmlHttp.onreadystatechange = stateChanged;
			xmlHttp.open("GET", "/daralmajd/FeesProcess/searchfeecategory?classstudying="+addClass+"&yearofadmission="+yoa+"&feescategories="+checkedFeesCategoryValues+"",true);
			xmlHttp.send(null);
...
<script type="text/javascript" charset="utf-8">
	...
	function searchStudentDuplicate() {
		...
		xmlHttp2.open(
			"GET",
			"/daralmajd/StudentProcess/checkDuplicateStudent?"
