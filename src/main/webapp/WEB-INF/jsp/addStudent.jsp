...
<script src="/akshara/js/validation/jquery.ketchup.all.min.js"></script>
<script type="text/javascript"
...
var xmlHttp;
    ...
    function searchfeecategory() {
    	...
    	var yoa=document.getElementById('yearofadmission').value;
			...
			xmlHttp.onreadystatechange = stateChanged;
			xmlHttp.open("GET", "/akshara/FeesProcess/searchfeecategory?classstudying="+addClass+"&yearofadmission="+yoa+"",true);
			xmlHttp.send(null);
		...
		<div>
			<div id="tabs">
				<ul>
					...
					<li><a href="#fragment-2">Other Details</a></li>
				...
				<div id="fragment-1">
					<table style="width: auto;height: auto;" border="0" align="center" id="table1">
						...
						<tr>
							...
							<td class="alignLeft" style="padding-left: 20px;">Father's Name* &nbsp;</td>
									<td ><label> <input
	...
	<script type="text/javascript">
							function addStudent() {
								...
								if(form1.checkValidity()) {
									...
									form1.action = "/akshara/StudentProcess/AddStudent";
									form1.submit();
								  }
							}
