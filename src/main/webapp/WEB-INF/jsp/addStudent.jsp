...
<script>
    ...
    function searchfeecategory() {
    	...
    	if (!addClass) {
			...
			xmlHttp.onreadystatechange = stateChanged;
			xmlHttp.open("GET", "/dolphin/FeesProcess/searchfeecategory?classstudying="+addClass+"&yearofadmission="+yoa+"&feescategories="+checkedFeesCategoryValues+"",true);
			xmlHttp.send(null);
...
function searchOtherFeecategory() {
    ...
    xmlHttpof.open("GET", "/dolphin/FeesProcess/searchOtherFeecategory?classstudying="+addClass+"&yearofadmission="+yoa, true);
    xmlHttpof.send(null);
}
</script>
<script>
...
<script type="text/javascript" charset="utf-8">
        ...
        function searchListOfParent() {
            ...
            xmlHttpParent.open(
                "GET",
                "/dolphin/StudentProcess/searchListOfParent",
                true
            );
	...
	function searchStudentDuplicate() {
		...
		xmlHttp2.open(
			"GET",
			"/dolphin/StudentProcess/checkDuplicateStudent?"
				...
				<div id="fragment-1">
					...
					<tr>
						...
						<tr>
							...
							<td ><label>
							          Fee<input type="checkbox" value="Fee" name="feescategories" id="fee"/>
								&nbsp;Library Fund<input type="checkbox" value="Library Fund" name="feescategories" id="libraryfund"/>
	...
	<script type="text/javascript">
							function addStudent() {
								...
								if(form1.checkValidity()) {
									...
									form1.action = "/dolphin/StudentProcess/AddStudent";
									form1.submit();
								  }
							}
