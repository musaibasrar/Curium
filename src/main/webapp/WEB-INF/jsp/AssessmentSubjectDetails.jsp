...
<script type="text/javascript">
	function addAssessmentSubjects() {
		...
		form1.action = "/brightschool/AssessmentSubjectDetailsProcess/addAssessmentSubject";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/brightschool/AssessmentSubjectDetailsProcess/deleteMultipleAssessmentSubjectDetails";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/brightschool/AssessmentSubjectDetailsProcess/deleteMultipleAssessmentSubjectDetails" method="POST">
		<%
