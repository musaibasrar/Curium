...
<script type="text/javascript">
	function addSubjects() {
		...
		form1.action = "/peace/SubjectDetailsProcess/addSubjectMaster";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/peace/SubjectDetailsProcess/deleteMultipleSubjects";
		form1.method = "POST";
		form1.submit();
...
<script type="text/javascript">
	function searchForTeacherDetail() {
		var form1 = document.getElementById("form1");
		form1.action = "/peace/TeachersPerformanceProcess/searchForTeacherDetail";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/peace/SubjectDetailsProcess/deleteMultipleSubjects" method="POST">
		<%
