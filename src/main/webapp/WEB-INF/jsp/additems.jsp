...
<script type="text/javascript">
	...
	function addItems(){
		...
		if(form1.checkValidity()) {
			form1.action="/newexcellent/MessItemsProcess/addItems";
			form1.method = "POST";
			form1.submit();
		}
	...
	function updateItems(){
		var form1 = document.getElementById("form1");
			form1.action="/newexcellent/MessItemsProcess/updateItems";
			form1.method = "POST";
			form1.submit();	
	}
	
	function deleteItems(){
			form1.action="/newexcellent/MessItemsProcess/deleteItems";
			form1.method = "POST";
			form1.submit();	
	}
