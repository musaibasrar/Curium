...
<title>Students Details Certificate for Counselling </title>
...
<script type="text/javascript">
	function searchStudentsForCounselling() {
		var form1 = document.getElementById("form1");
		form1.action = "/littleangels/DocumentsProcess/searchStudentsForCounselling";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/littleangels/DocumentsProcess/GenerateStudyCertificateforCounselling" method="POST">
		...
		<div id="effect" class="ui-widget-content ui-corner-all">
			<div id="tabs">
				<ul>
					<li><a href="#tabs-1">Study Certificate for Counselling</a></li>
