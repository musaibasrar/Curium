...
<script type="text/javascript">
	function searchStudentsForCounselling() {
		...
		form1.action = "/littleangel/DocumentsProcess/searchStudentsForCounselling";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/littleangel/DocumentsProcess/GenerateStudyCertificateforCounselling" method="POST">
