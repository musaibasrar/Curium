...
<!-- 	     <script type="text/javascript">
	...
	<div class="container-fluid">
		<div class="row main-content bg-success text-center">
			...
			<h2 style="font-weight: bold;">Roshan<!-- <img border="0" style="vertical-align: text-bottom;height: 120px;width: 200px;" alt="ideoholic" src="/roshan/images/shaheenwhitelogo.png"> --></h2><h3> Group of Institutions</h3></span>
				...
				<div class="container-fluid">
					...
					<div class="row">
						<form action="/roshan/EnquiryProcess/genarateNewCertificate"  method="post" class="form-group">
							...
							<div class="row">
								<input type="text" name="place" id="place" class="form__input" placeholder="Place">
							</div>
							<div class="row">
								<input type="text" name="mobileno" id="mobileno" class="form__input" placeholder="Mobile No">
							</div>
														
							<div class="row">
								<input type="submit" value="Generate Certificate" class="btn">
							</div>
						</form>
					</div>
