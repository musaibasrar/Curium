...
<html >
    <head >
        ...
        <script type="text/javascript" src="/sac/js/chosen.jquery.min.js"></script>
		<link rel="stylesheet" href="/sac/css/chosen.min.css">
        <style type="text/css" >
        	.myclass {
				font-size: 1.3em;
        ...
        <script type="text/javascript">
            function deleteRecords(){
                ...
                form1.action="/sac/StudentProcess/archiveMultiple";
               form1.submit();
           }
        ...
        <script type="text/javascript">
            ...
            function saveQuery(){
                var form1=document.getElementById("form1");
               form1.action="/sac/JobProcess/addQuery";
               form1.submit();
            }
        ...
        <script type="text/javascript">
            ...
            function deleteRow(tableID) {
				...
				function fixAppointment(appointmentdate,appointmenttime){
		            	...
		            	var form1 = document.getElementById("form1");
		        		form1.action = "/sac/AppointmentProcess/addAppointment?appointmentdate="+appointmentDate+"&appointmenttime="+appointmentTime+"";
		        		form1.method = "POST";
		        		form1.submit();
		            }
