...
<html >
    <head >
        ...
        <script type="text/javascript" src="/demov2/js/chosen.jquery.min.js"></script>
		<link rel="stylesheet" href="/demov2/css/chosen.min.css">
        <style type="text/css" >
        	.myclass {
				font-size: 1.3em;
        ...
        <script type="text/javascript">
            ...
            function saveQuery(){
                var form1=document.getElementById("form1");
               form1.action="/demov2/JobProcess/addQuery";
               form1.submit();
            }
