...
<html >
    <head >
        ...
        <script type="text/javascript" src="/brilliantgrammar/js/chosen.jquery.min.js"></script>
		<link rel="stylesheet" href="/brilliantgrammar/css/chosen.min.css">
        <style type="text/css" >
        	.myclass {
				font-size: 1.3em;
        ...
        <script type="text/javascript">
            function deleteRecords(){
                ...
                form1.action="/brilliantgrammar/StudentProcess/archiveMultiple";
               form1.submit();
           }
        ...
        <script type="text/javascript">
            ...
            function saveQuery(){
                var form1=document.getElementById("form1");
               form1.action="/brilliantgrammar/JobProcess/addQuery";
               form1.submit();
            }
        ...
        <script type="text/javascript">
                        ...
                        buttons: {
                            OK: function() {                              	
                            	writeQuery(document.getElementById("assignto"),document.getElementById("filetype"),
                            			...
                            			document.getElementById("typeofworknoncourtmw"),document.getElementById("typeofworknoncourtno"),document.getElementById("jobquery"),document.getElementById("expecteddeliverydate"));
                                		$( this ).dialog( "close" );
                         		   }
                        }
                    });
            ...
            function deleteRow(tableID) {
				...
				function fixAppointment(appointmentdate,appointmenttime){
		            	...
		            	var form1 = document.getElementById("form1");
		        		form1.action = "/brilliantgrammar/AppointmentProcess/addAppointment?appointmentdate="+appointmentDate+"&appointmenttime="+appointmentTime+"";
		        		form1.method = "POST";
		        		form1.submit();
		            }
