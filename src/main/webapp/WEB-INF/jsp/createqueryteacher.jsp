...
<html >
    <head >
        ...
        <script type="text/javascript" src="/greatindiaacademy/js/chosen.jquery.min.js"></script>
		<link rel="stylesheet" href="/greatindiaacademy/css/chosen.min.css">
        <style type="text/css" >
        	.myclass {
				font-size: 1.3em;
        ...
        <script type="text/javascript">
            function deleteRecords(){
                ...
                form1.action="/greatindiaacademy/StudentProcess/archiveMultiple";
               form1.submit();
           }
        ...
        <script type="text/javascript">
            ...
            function saveQuery(){
                var form1=document.getElementById("form1");
               form1.action="/greatindiaacademy/JobProcess/addQuery";
               form1.submit();
            }
        ...
        <script type="text/javascript">
            ...
            function deleteRow(tableID) {
				...
				function fixAppointment(appointmentdate,appointmenttime){
		            	...
		            	var form1 = document.getElementById("form1");
		        		form1.action = "/greatindiaacademy/AppointmentProcess/addAppointment?appointmentdate="+appointmentDate+"&appointmenttime="+appointmentTime+"";
		        		form1.method = "POST";
		        		form1.submit();
		            }
