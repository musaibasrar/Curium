...
<script type="text/javascript">
	function searchStudentsForBonafide() {
		...
		form1.action = "/greatindiaacademy/StudentProcess/searchStudentsForBonafide";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/greatindiaacademy/StudentProcess/GenerateBonafide" method="POST">
