...
<script type="text/javascript">
	function searchStudentsForBonafide() {
		...
		form1.action = "/childrenandglobal/StudentProcess/searchStudentsForBonafide";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/childrenandglobal/StudentProcess/GenerateBonafide" method="POST">
