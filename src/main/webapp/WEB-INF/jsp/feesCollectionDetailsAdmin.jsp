...
<script type="text/javascript">
	function searchByDate() {
		...
		form1.action = "/littleangels/UserProcess/searchByDate";
		form1.method = "POST";
		form1.submit();
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/littleangels/FeesDetails/printDataForFees";
		form1.method = "POST";
		form1.submit();
	}
                    ...
                    <tbody>
                        <c:forEach items="${searchfeesdetailslist}" var="feesdetails">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/littleangels/FeesCollection/ViewDetails?id=<c:out value='${feesdetails.value.receiptnumber}'/>&sid=<c:out value='${feesdetails.value.sid}'/>">View Details</a></td>
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/littleangels/FeesCollection/CancelFeesReceipt?id=<c:out value='${feesdetails.value.receiptnumber}'/>&sid=<c:out value='${feesdetails.value.sid}'/>&receiptid=<c:out value='${feesdetails.value.receiptvoucher}'/>&journalid=<c:out value='${feesdetails.value.journalvoucher}'/>"><i class="fa fa-times" style="color:#93051f;font-size: 18px;"></i></a></td>
