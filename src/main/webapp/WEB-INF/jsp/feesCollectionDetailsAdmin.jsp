...
<script type="text/javascript">
	function searchByDate() {
		...
		form1.action = "/daralmajd/UserProcess/searchByDate";
		form1.method = "POST";
		form1.submit();
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/daralmajd/FeesDetails/printDataForFees";
		form1.method = "POST";
		form1.submit();
	}
...
<body>
	<form id="form1"
		...
		<div style="overflow: scroll; height: 600px">
			<table width="100%">
				<tr>
					<td class="headerTD"><label style="color: #EB6000;">${branchname} </label>${feesdetailsbranchname}&nbsp;&nbsp;&nbsp; <label style="color: #EB6000;">total fees :</label>SR. ${sumofonlyfee}
					&nbsp;&nbsp;&nbsp; <label style="color: #EB6000;">total fine :</label>SR. ${sumoffine}&nbsp;&nbsp;&nbsp; <label style="color: #EB6000;">total VAT :</label>SR. ${sumofmisc}
					&nbsp;&nbsp;&nbsp; <label style="color: #EB6000;">Grand Total :</label>SR. ${sumofdetailsfees}
