...
<script type="text/javascript">
	function addExpenses() {
		...
		form1.action="/scholar/AdminProcess/addExpenses";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action="/scholar/AdminProcess/deleteMultiple";
		form1.method = "POST";
		form1.submit();
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action="/scholar/AdminProcess/printAllExpenses";
		form1.method = "POST";
		form1.submit();
	}
	...
	function searchRecords() {
		var form1 = document.getElementById("form1");
		form1.action="/scholar/AdminProcess/viewExpensesBetweenDates";
		form1.method = "POST";
		form1.submit();
	}
...
<body>
	<form id="form1"
		action="/scholar/DepartmentProcess/deleteMultiple" method="POST">
		<%
