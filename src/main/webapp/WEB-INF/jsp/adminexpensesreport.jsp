...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#anim").change(function() {
			$("#datepickerfromdate").datepicker("option", "showAnim", $(this).val());
		});
...
<script type="text/javascript">
	function addExpenses() {
		...
		form1.action="/brilliantgrammar/AdminProcess/addExpenses";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action="/brilliantgrammar/AdminProcess/deleteMultiple";
		form1.method = "POST";
		form1.submit();
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action="/brilliantgrammar/AdminProcess/printAllExpenses";
		form1.method = "POST";
		form1.submit();
	}
	...
	function approveRecords() {
		var form1 = document.getElementById("form1");
		form1.action="/brilliantgrammar/AdminProcess/approveVoucher";
		form1.method = "POST";
		form1.submit();
	}
	...
	function rejectRecords() {
		var form1 = document.getElementById("form1");
		form1.action="/brilliantgrammar/AdminProcess/rejectVoucher";
		form1.method = "POST";
		form1.submit();
	}
	...
	function searchRecords() {
		var form1 = document.getElementById("form1");
		form1.action="/brilliantgrammar/AdminProcess/viewExpensesBetweenDates";
		form1.method = "POST";
		form1.submit();
	}
...
<body>
	<form id="form1"
		action="/brilliantgrammar/DepartmentProcess/deleteMultiple" method="POST">
		<%
			java.text.DateFormat df = new java.text.SimpleDateFormat(
					"MM/dd/yyyy");
		%>
		<div style="height: 28px">
			<button id="add">Search Expenses</button>
			<br />
		</div>
		...
		<div id="effect" class="ui-widget-content ui-corner-all">
			<div id="tabs">
				...
				<div id="tabs-2">
					<table style="margin-left: auto;margin-right: auto;" id="table1">
						...
						<tr>
							<td class="alignLeft">Voucher Status: &nbsp;&nbsp;</td>
							<td ><label>
