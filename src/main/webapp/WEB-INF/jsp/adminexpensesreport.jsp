...
<script type="text/javascript">
	function addExpenses() {
		...
		form1.action="/alfalahschool/AdminProcess/addExpenses";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action="/alfalahschool/AdminProcess/deleteMultiple";
		form1.method = "POST";
		form1.submit();
	...
	function searchRecords() {
		var form1 = document.getElementById("form1");
		form1.action="/alfalahschool/AdminProcess/viewExpensesBetweenDates";
		form1.method = "POST";
		form1.submit();
	}
