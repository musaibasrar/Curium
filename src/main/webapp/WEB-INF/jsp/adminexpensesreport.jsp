...
<script type="text/javascript">
	function addExpenses() {
		...
		form1.action="/greatindiaacademy/AdminProcess/addExpenses";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action="/greatindiaacademy/AdminProcess/deleteMultiple";
		form1.method = "POST";
		form1.submit();
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action="/greatindiaacademy/AdminProcess/printAllExpenses";
		form1.method = "POST";
		form1.submit();
	}
	...
	function searchRecords() {
		var form1 = document.getElementById("form1");
		form1.action="/greatindiaacademy/AdminProcess/viewExpensesBetweenDates";
		form1.method = "POST";
		form1.submit();
	}
...
<body>
	<form id="form1"
		action="/greatindiaacademy/DepartmentProcess/deleteMultiple" method="POST">
		<%
