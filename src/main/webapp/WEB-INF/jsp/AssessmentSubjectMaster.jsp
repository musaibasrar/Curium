...
<script type="text/javascript">
	function addAssessmentSubjects() {
		...
		form1.action = "/school/AssessmentSubjectDetailsProcess/addAssessmentSubjectMaster";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/school/AssessmentSubjectDetailsProcess/deleteMultipleAssessmentSubjects";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/school/AssessmentSubjectDetailsProcess/deleteMultipleAssessmentSubjects" method="POST">
		<%
