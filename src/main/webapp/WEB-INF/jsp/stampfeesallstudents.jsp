...
<script type="text/javascript" src="/mfds/js/globalize.min.js"></script>
<script type="text/javascript" charset="utf-8" src="/mfds/js/globalize.cultures.js"></script>
...
<script type="text/javascript">
	function searchForFees() {
		...
		form1.action = "/mfds/StampFeesProcess/advanceSearchForStampFeesByCategory";
		form1.method = "POST";
		form1.submit();
	...
	function deleteFeesStamp(){
		var form1 = document.getElementById("form1");
		form1.action = "/mfds/StampFeesProcess/delete";
		form1.method = "POST";
		form1.submit();
	}
</script>
...
%>
<body>
	<form id="form1" action="/mfds/StampFeesProcess/applyFeesAll" method="POST">
					...
					<c:forEach items="${searchStudentList}" var="Parents" varStatus="status">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataTextInActive"><a class="dataTextInActive"
								href="/mfds/StudentProcess/ViewDetails?id=<c:out value='${Parents.student.sid}'/>&urlbranchid=<c:out value='${Parents.student.branchid}'/>"><c:out
