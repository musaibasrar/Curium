...
<script type="text/javascript">
	function searchForFees() {
		...
		form1.action = "/readmodelschool/StampFeesProcess/advanceSearchForStampFeesByCategory";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/readmodelschool/StampFeesProcess/applyFeesAll" method="POST">
					...
					<c:forEach items="${searchStudentList}" var="Parents">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataTextInActive"><a class="dataTextInActive"
								href="/readmodelschool/StudentProcess/ViewDetails?id=<c:out value='${Parents.student.sid}'/>&urlbranchid=<c:out value='${Parents.student.branchid}'/>"><c:out
