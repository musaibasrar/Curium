...
<script type="text/javascript" src="/brilliantgrammar/js/globalize.min.js"></script>
<script type="text/javascript" charset="utf-8" src="/brilliantgrammar/js/globalize.cultures.js"></script>
...
<script type="text/javascript">
	function searchForFees() {
		...
		form1.action = "/brilliantgrammar/StampFeesProcess/advanceSearchForStampFeesByCategory";
		form1.method = "POST";
		form1.submit();
	...
	function deleteFeesStamp(){
		var form1 = document.getElementById("form1");
		form1.action = "/brilliantgrammar/StampFeesProcess/delete";
		form1.method = "POST";
		form1.submit();
	}
</script>
			...
			function searchTable() {
			    ...
			    for (let i = 1; i < trs.length; i++) {   // Skip header row
			        ...
			        for (let j = 0; j < tds.length; j++) {
			            let cellText = (tds[j].innerText || tds[j].textContent).toLowerCase();
...
%>
<body>
	<form id="form1" action="/brilliantgrammar/StampFeesProcess/applyFeesAll" method="POST">
					...
					<c:forEach items="${searchStudentList}" var="Parents" varStatus="status">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataTextInActive"><a class="dataTextInActive"
								href="/brilliantgrammar/StudentProcess/ViewDetails?id=<c:out value='${Parents.student.sid}'/>&urlbranchid=<c:out value='${Parents.student.branchid}'/>"><c:out
