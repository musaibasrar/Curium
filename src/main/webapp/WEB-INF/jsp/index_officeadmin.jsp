...
%>
    <frameset    rows="55,*"frameborder="0" border="0" framespacing="0"  >
			    ...
			    <frame   src="/jihtel/header_officeadmin"   name="topFrame" scrolling="NO" noresize frameborder="0">

            <frameset  cols="195,*" frameborder="0" border="0" framespacing="0">
                <frame  src="/jihtel/left_officeadmin" name="leftFrame" scrolling="yes"  frameborder="1"   />
