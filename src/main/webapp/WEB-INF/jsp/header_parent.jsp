    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 45px;">
								...
								<a target="mainFrame" href="/scholar/welcomeparent" ><img src="/scholar/images/curiumheader.png" width="90" height="30"/></a>
								</td>
								
							<!-- <td align="left"><img src="/scholar/images/scholar/header.png"
								style="width: 200px; height: 20px;" /></td> -->
							<td align="left" style="padding-left:40px;">
 
                                                         <a target="mainFrame" href="/scholar/welcomeparent" style="display: inline-flex; align-items: center;">
     <img src="/scholar/images/home.svg" width="22" height="22" alt="Home" style="margin-right: 4px;" />
     <strong style="font-size: 18px;">Home</strong>
 </a>&nbsp;&nbsp;
 
                                                          <a target="_parent"
                                                                 href="/scholar/UserProcess/logout" style="display: inline-flex; align-items: center;"><img
                                                                         src="/scholar/images/logout.svg" width="22" height="22" alt="Log Out" 
