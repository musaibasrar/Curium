    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 45px;">
								...
								<a target="mainFrame" href="/alirfan/welcomeparent" ><img src="/alirfan/images/curiumheader.png" width="90" height="30"/></a>
								</td>
								
							<!-- <td align="left"><img src="/alirfan/images/alirfan/header.png"
								style="width: 200px; height: 20px;" /></td> -->
							<td align="left" style="padding-left:40px;">
 
                                                         <a target="mainFrame" href="/alirfan/welcomeparent" style="display: inline-flex; align-items: center;">
     <img src="/alirfan/images/home.svg" width="22" height="22" alt="Home" style="margin-right: 4px;" />
     <strong style="font-size: 18px;">Home</strong>
 </a>&nbsp;&nbsp;
 
                                                          <a target="_parent"
                                                                 href="/alirfan/UserProcess/logout" style="display: inline-flex; align-items: center;"><img
                                                                         src="/alirfan/images/logout.svg" width="22" height="22" alt="Log Out" 
