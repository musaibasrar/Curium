    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 85px;">
								...
								<a target="mainFrame" href="/noman/welcomeparent" ><img src="/noman/images/curiumheader.png" width="206" height="75"/></a>
								</td>
								
							<!-- <td align="left"><img src="/noman/images/noman/header.png"
								style="width: 200px; height: 20px;" /></td> -->
							<td align="right"><a target="mainFrame" href="/noman/welcomeparent" style="font-size: 40px;"> <img
									src="/noman/images/home.svg" width="80" height="60" 
							...
							<td align="right" style="width: 242px;"><a target="_parent" style="font-size: 40px;"
								href="/noman/UserProcess/logout"><img
									src="/noman/images/logout.svg" width="80" height="57" alt="Log Out" 
