    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 45px;">
								...
								<a target="mainFrame" href="/stanley/welcomeparent" ><img src="/stanley/images/curiumheader.png" width="90" height="30"/></a>
								</td>
								
							<!-- <td align="left"><img src="/stanley/images/stanley/header.png"
								style="width: 200px; height: 20px;" /></td> -->
							<td align="left" style="padding-left:40px;">
 
                                                         <a target="mainFrame" href="/stanley/welcomeparent" style="display: inline-flex; align-items: center;">
     <img src="/stanley/images/home.svg" width="22" height="22" alt="Home" style="margin-right: 4px;" />
     <strong style="font-size: 18px;">Home</strong>
 </a>&nbsp;&nbsp;
 
                                                          <a target="_parent"
                                                                 href="/stanley/UserProcess/logout" style="display: inline-flex; align-items: center;"><img
                                                                         src="/stanley/images/logout.svg" width="22" height="22" alt="Log Out" 
