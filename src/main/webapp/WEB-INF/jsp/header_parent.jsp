    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 85px;">
								...
								<a target="mainFrame" href="/presidency/welcomeparent" ><img src="/presidency/images/curiumheader.png" width="206" height="75"/></a>
								</td>
								
							<!-- <td align="left"><img src="/presidency/images/presidency/header.png"
								style="width: 200px; height: 20px;" /></td> -->
							<td align="right"><a target="mainFrame" href="/presidency/welcomeparent" style="font-size: 40px;"> <img
									src="/presidency/images/home.svg" width="80" height="60" 
							...
							<td align="right" style="width: 242px;"><a target="_parent" style="font-size: 40px;"
								href="/presidency/UserProcess/logout"><img
									src="/presidency/images/logout.svg" width="80" height="57" alt="Log Out" 
