    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 85px;">
								...
								<a target="mainFrame" href="/alirfan/welcomeparent" ><img src="/alirfan/images/curiumheader.png" width="206" height="75"/></a>
								</td>
								
							<!-- <td align="left"><img src="/alirfan/images/alirfan/header.png"
								style="width: 200px; height: 20px;" /></td> -->
							<td align="right"><a target="mainFrame" href="/alirfan/welcomeparent" style="font-size: 40px;"> <img
									src="/alirfan/images/home.svg" width="80" height="60" 
							...
							<td align="right" style="width: 242px;"><a target="_parent" style="font-size: 40px;"
								href="/alirfan/UserProcess/logout"><img
									src="/alirfan/images/logout.svg" width="80" height="57" alt="Log Out" 
