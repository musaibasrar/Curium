        ...
        ">
						...
						<tr style="height: 45px;">
							...
							<td align="left" style="padding-left:40px;">
                                                         ...
                                                         <a target="mainFrame" href="/bright/welcomeparent" style="display: inline-flex; align-items: center;">
     <img src="/bright/images/home.svg" width="22" height="22" alt="Home" style="margin-right: 4px;" />
     <strong style="font-size: 18px;">Home</strong>
 </a>&nbsp;&nbsp;
 
                                                          <a target="_parent"
                                                                 href="/bright/UserProcess/logout" style="display: inline-flex; align-items: center;"><img
                                                                         src="/bright/images/logout.svg" width="22" height="22" alt="Log Out" 
