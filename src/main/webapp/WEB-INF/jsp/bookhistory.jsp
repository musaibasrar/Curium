...
<script type="text/javascript">
	...
	function searchBookHistory(){
	    ...
	    form1.action="/hwfschools/LibraryProcess/searchBookHistory";
	    form1.method = "POST";
	   form1.submit();
	...
	function deleteBookHistory(){
	    ...
	    var form1=document.getElementById("form1");
	    form1.action="/hwfschools/LibraryProcess/deleteBookHistory";
	    form1.method = "POST";
	   form1.submit();
				...
				<tbody>
					...
					<c:forEach items="${bookhistorylist}" var="book" varStatus="status">
						...
						<tr style="border-color: #000000" border="1" cellpadding="1"
							...
							<td class="dataText"><a class="dataTextInActive" href="/hwfschools/LibraryProcess/bookdetail?id=<c:out value='${book.id}'/>"><c:out value="${book.bookName}" /></a></td>	
