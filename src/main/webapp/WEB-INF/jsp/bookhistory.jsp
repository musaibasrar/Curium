...
$(function(){
    ...
    function deleteBookHistory(){
        ...
        form1.action="/sneha/LibraryProcess/deleteBookHistory";
        form1.method = "POST";
       form1.submit();
				...
				<tbody>
					...
					<c:forEach items="${bookhistory}" var="book">
						...
						<tr style="border-color: #000000" border="1" cellpadding="1"
							...
							<%-- <td class="dataText"><a class="dataTextInActive" href="/sneha/LibraryProcess/bookdetail?id=<c:out value='${book.id}'/>"><c:out value="${book.bookName}" /></a></td>	 --%>
