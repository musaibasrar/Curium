    ...
    border-collapse:collapse;
        ...
        <script type="text/javascript">
            ...
            function updateContact() {
                ...
                form1.action = "/brainystars/PersonalProcess/updateContactDetails?id=1";
                form1.submit();
            }
   ...
   <% i = i + 1;%>
                   ...
                   <table  width="70%"  id="table11" align="left">
                    <tr>
                        ...
                        <td>
                            <button id="print" type="button" style="background-image: url(/brainystars/images/print.jpg);width: 63px;height: 60px" onclick="window.print();
