 ...
 width:40px;
	...
	<script type="text/javascript" src="/noble/js/datePicker/jquery-1.7.1.js"></script>
        ...
        function printtc(){
        		...
        		form1.action = "/noble/DocumentsProcess/printCharacterCertificate";
        		form1.method = "POST";
        		form1.submit();
            }
        </script>
	...
	<form id="form1" method="post" class="bodymargin">
		<br>
		 <table align="center">
			...
			<tr>
				<td ><img src="/noble/images/noble.jpg" width="140" height="140"/></td>
		...
		<td></td>
			...
			<tr>
              ...
              <!-- <a id="print" href="/noble/DocumentsProcess/printCharacterCertificate">Print</a> -->
            </tr>
		</TABLE>
	</form>
</body>
