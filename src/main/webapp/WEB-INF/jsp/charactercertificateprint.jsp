 ...
 width:40px;
	...
	<script type="text/javascript" src="/awami/js/datePicker/jquery-1.7.1.js"></script>
        ...
        function printtc(){
        		...
        		form1.action = "/awami/DocumentsProcess/printCharacterCertificate";
        		form1.method = "POST";
        		form1.submit();
            }
        </script>
	...
	<form id="form1" method="post" class="bodymargin">
		<br>
		 <table align="center">
			...
			<tr>
				<td ><img src="/awami/images/awami.jpg" width="200" height="100"/></td>
		...
		<td></td>
			...
			<tr>
              ...
              <!-- <a id="print" href="/awami/DocumentsProcess/printCharacterCertificate">Print</a> -->
            </tr>
		</TABLE>
	</form>
</body>
