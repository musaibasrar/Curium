 ...
 width:40px;
	...
	<script type="text/javascript" src="/patriswamy/js/datePicker/jquery-1.7.1.js"></script>
        ...
        function printtc(){
        		...
        		form1.action = "/patriswamy/DocumentsProcess/printCharacterCertificate";
        		form1.method = "POST";
        		form1.submit();
            }
        </script>
	...
	<form id="form1" method="post" class="bodymargin">
		<br>
		 <table align="center">
			...
			<tr>
				<td ><img src="/patriswamy/images/patriswamy.jpg" width="117" height="140"/></td>
			...
			<td class="dataTextBoldLeft">
			<h3 style="font-weight: normal;" >
			His/Her date of Birth as per our record is<span class="rightside" style="font-weight: bold;text-transform: capitalize;width:520px;border-bottom:dotted;">&nbsp;&nbsp;&nbsp;&nbsp;<fmt:formatDate type="date" value="${studentdetailsbonafide.student.dateofbirth}" pattern="dd/MM/yyyy"/></span>
			</h3>
			</td>
			</tr>
			<tr>
		...
		<td></td>
			...
			<tr>
              ...
              <!-- <a id="print" href="/patriswamy/DocumentsProcess/printCharacterCertificate">Print</a> -->
            </tr>
		</TABLE>
	</form>
</body>
