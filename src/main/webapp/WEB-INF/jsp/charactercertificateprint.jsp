 ...
 width:40px;
	...
	<script type="text/javascript" src="/brightschool/js/datePicker/jquery-1.7.1.js"></script>
        ...
        function printtc(){
        		...
        		form1.action = "/brightschool/DocumentsProcess/printCharacterCertificate";
        		form1.method = "POST";
        		form1.submit();
            }
        </script>
	...
	<form id="form1" method="post" class="bodymargin">
		<br>
		 <table align="center">
			...
			<tr>
				<td ><img src="/brightschool/images/brightschool.jpg" width="140" height="140"/></td>
		...
		<td></td>
			...
			<tr>
              ...
              <!-- <a id="print" href="/brightschool/DocumentsProcess/printCharacterCertificate">Print</a> -->
            </tr>
		</TABLE>
	</form>
</body>
