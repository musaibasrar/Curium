 ...
 width:40px;
	...
	<script type="text/javascript" src="/childrenandglobal/js/datePicker/jquery-1.7.1.js"></script>
        ...
        function printtc(){
        		...
        		form1.action = "/childrenandglobal/DocumentsProcess/printCharacterCertificate";
        		form1.method = "POST";
        		form1.submit();
            }
        </script>
	...
	<form id="form1" method="post" class="bodymargin">
		...
		<td></td>
			...
			<tr>
              ...
              <!-- <a id="print" href="/childrenandglobal/DocumentsProcess/printCharacterCertificate">Print</a> -->
            </tr>
		</TABLE>
	</form>
</body>
