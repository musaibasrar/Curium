 ...
 width:40px;
	...
	<script type="text/javascript" src="/presidency/js/datePicker/jquery-1.7.1.js"></script>
        ...
        function printtc(){
        		...
        		form1.action = "/presidency/DocumentsProcess/printCharacterCertificate";
        		form1.method = "POST";
        		form1.submit();
            }
        </script>
	...
	<form id="form1" method="post" class="bodymargin">
		<br>
		 <table align="center">
			...
			<tr>
				<td ><img src="/presidency/images/presidency.jpg" width="140" height="140"/></td>
		...
		<td></td>
			...
			<tr>
              ...
              <!-- <a id="print" href="/presidency/DocumentsProcess/printCharacterCertificate">Print</a> -->
            </tr>
		</TABLE>
	</form>
</body>
