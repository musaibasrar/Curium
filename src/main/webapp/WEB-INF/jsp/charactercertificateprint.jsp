 ...
 width:40px;
	...
	<script type="text/javascript" src="/littleangel/js/datePicker/jquery-1.7.1.js"></script>
        ...
        function printtc(){
        		...
        		form1.action = "/littleangel/DocumentsProcess/printCharacterCertificate";
        		form1.method = "POST";
        		form1.submit();
            }
        </script>
	...
	<form id="form1" method="post" class="bodymargin">
		<br>
		 <table align="center">
			...
			<tr>
				<td ><img src="/littleangel/images/littleangel.jpg" width="104" height="120"/></td>
				...
				<h6 style="margin-top:0px; margin-bottom:0px;">Contact No.${branchcontact}</h6>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="dataTextBoldLeft">
					...
					<td class="dataTextBoldLeft">
					<h3 style="font-weight: normal;" >
					has passed the AISSE/AISSCE<span style="font-weight: bold;text-transform: capitalize;border-bottom:dotted;width:200px;">&nbsp;&nbsp;&nbsp;&nbsp;
					<c:forEach var="splt" items="${fn:split(studentdetailsbonafide.student.classstudying,'--')}">
						    		${splt} 
					</c:forEach>
					</span>
					bearing Roll Number<span class="rightside" style="font-weight: bold;text-transform: capitalize;width:250px;border-bottom:dotted;">&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${studentdetailsbonafide.student.sts}" /></span>
					</h3>
				</td>
		...
		<td></td>
			...
			<tr>
              ...
              <!-- <a id="print" href="/littleangel/DocumentsProcess/printCharacterCertificate">Print</a> -->
            </tr>
		</TABLE>
	</form>
</body>
