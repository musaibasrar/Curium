 ...
 width:40px;
	...
	<script type="text/javascript" src="/qpevents/js/datePicker/jquery-1.7.1.js"></script>
        ...
        function printtc(){
        		...
        		form1.action = "/qpevents/DocumentsProcess/printCharacterCertificate";
        		form1.method = "POST";
        		form1.submit();
            }
        </script>
	...
	<form id="form1" method="post" class="bodymargin">
		<br>
		 <table align="center">
			...
			<tr>
				<td ><img src="/qpevents/images/qpevents.jpg" width="126" height="140"/></td>
		...
		<td></td>
			...
			<tr>
              ...
              <!-- <a id="print" href="/qpevents/DocumentsProcess/printCharacterCertificate">Print</a> -->
            </tr>
		</TABLE>
	</form>
</body>
