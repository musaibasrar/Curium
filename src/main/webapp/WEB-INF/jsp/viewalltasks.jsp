...
<script type="text/javascript" src="/sky/js/datetimepicker_css.js"></script>
	...
	<script type="text/javascript">
		function completeTasks() {
			...
			form1.action = "/sky/JobProcess/completeTasks?display=viewall";
			form1.method = "POST";
			form1.submit();
		}
		...
		function cancelTasks() {
			var form1 = document.getElementById("form1");
			form1.action = "/sky/JobProcess/cancelTasks?display=viewall";
			form1.method = "POST";
			form1.submit();
		}
		...
		function inProgressTasks() {
			var form1 = document.getElementById("form1");
			form1.action = "/sky/JobProcess/inProgressTasks?display=viewall";
			form1.method = "POST";
			form1.submit();
		}
		...
		function toDoTasks() {
			var form1 = document.getElementById("form1");
			form1.action = "/sky/JobProcess/toDoTasks?display=viewall";
			form1.method = "POST";
			form1.submit();
		}
		...
		function updateQueryRemarks(queryRemarksAdded,queryRemarks, queryid, username) {
			...
			form1.action = "/sky/JobProcess/updateTaskRemarks?queryremarks="+result+"&queryid="+queryid.value+"&jobid="+queryid.value+"&display=viewall";
			form1.method = "POST";
			form1.submit();
		}
	</script>
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
            ...
            function viewOneJobDetails(jobid){
                var form1=document.getElementById("form1");
                form1.action="/sky/JobProcess/viewOneJobDetails?jobid="+jobid+"";
                form1.submit();
            }
                ...
                <div align="center">
		             <%--For displaying Previous link except for the 1st page --%>
		                <c:if test="${currentPage != 1}">
		                    <td><a style="color: #4B6A84;font-size: 12px" href="/sky/JobProcess/viewAllTasks&page=${currentPage - 1}">Previous</a></td>
		                </c:if>
		                ...
		                <c:if test="${currentPage lt noOfPages}">
		                    <td ><a style="color: #4B6A84;font-size: 12px" href="/sky/JobProcess/viewAllTasks&page=${currentPage + 1}">Next</a></td>
		                </c:if>
                </div>
