...
<script type="text/javascript" src="/futurestars/js/datetimepicker_css.js"></script>
	...
	<script type="text/javascript">
		function completeTasks() {
			...
			form1.action = "/futurestars/JobProcess/completeTasks?display=viewall";
			form1.method = "POST";
			form1.submit();
		}
		...
		function cancelTasks() {
			var form1 = document.getElementById("form1");
			form1.action = "/futurestars/JobProcess/cancelTasks?display=viewall";
			form1.method = "POST";
			form1.submit();
		}
		...
		function inProgressTasks() {
			var form1 = document.getElementById("form1");
			form1.action = "/futurestars/JobProcess/inProgressTasks?display=viewall";
			form1.method = "POST";
			form1.submit();
		}
		...
		function toDoTasks() {
			var form1 = document.getElementById("form1");
			form1.action = "/futurestars/JobProcess/toDoTasks?display=viewall";
			form1.method = "POST";
			form1.submit();
		}
		...
		function updateQueryRemarks(queryRemarksAdded,queryRemarks, queryid, username) {
			...
			form1.action = "/futurestars/JobProcess/updateTaskRemarks?queryremarks="+result+"&queryid="+queryid.value+"&jobid="+queryid.value+"&display=viewall";
			form1.method = "POST";
			form1.submit();
		}
	</script>
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
            ...
            function viewOneJobDetails(jobid){
                var form1=document.getElementById("form1");
                form1.action="/futurestars/JobProcess/viewOneJobDetails?jobid="+jobid+"";
                form1.submit();
            }
                ...
                <div align="center">
		             <%--For displaying Previous link except for the 1st page --%>
		                <c:if test="${currentPage != 1}">
		                    <td><a style="color: #4B6A84;font-size: 12px" href="/futurestars/JobProcess/viewAllTasks&page=${currentPage - 1}">Previous</a></td>
		                </c:if>
		                ...
		                <c:if test="${currentPage lt noOfPages}">
		                    <td ><a style="color: #4B6A84;font-size: 12px" href="/futurestars/JobProcess/viewAllTasks&page=${currentPage + 1}">Next</a></td>
		                </c:if>
                </div>
