...
<script type="text/javascript" src="/alalmas/js/datetimepicker_css.js"></script>
	...
	<script type="text/javascript">
		function completeTasks() {
			...
			form1.action = "/alalmas/JobProcess/completeTasks?jobid="+jobId+"&display=viewall";
			form1.method = "POST";
			form1.submit();
		}
		...
		function cancelTasks() {
			var jobId = document.getElementById("jobid").value;
			var form1 = document.getElementById("form1");
			form1.action = "/alalmas/JobProcess/cancelTasks?jobid="+jobId+"&display=viewall";
			form1.method = "POST";
			form1.submit();
		}
		...
		function inProgressTasks() {
			var jobId = document.getElementById("jobid").value;
			var form1 = document.getElementById("form1");
			form1.action = "/alalmas/JobProcess/inProgressTasks?jobid="+jobId+"&display=viewall";
			form1.method = "POST";
			form1.submit();
		}
		...
		function toDoTasks() {
			var jobId = document.getElementById("jobid").value;
			var form1 = document.getElementById("form1");
			form1.action = "/alalmas/JobProcess/toDoTasks?jobid="+jobId+"&display=viewall";
			form1.method = "POST";
			form1.submit();
		}
