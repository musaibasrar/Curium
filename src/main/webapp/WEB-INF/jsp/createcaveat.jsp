...
.buttonred {
  ...
  border-radius: 12px;
        ...
        <script type="text/javascript">
            ...
            function createCaveat(sid,branchid){
                var form1=document.getElementById("form1");
               form1.action="/sla/CaveatProcess/createNewCaveats?id="+sid+"&urlbranchid="+branchid+"";
               form1.submit();
            }
                        ...
                        buttons: {
                            OK: function() {                              	
                            	writeQuery(document.getElementById("assignto"),document.getElementById("filetype"),
                            			...
                            			document.getElementById("typeofworkcourtcaveat"),document.getElementById("typeofworkcourtdocs"),document.getElementById("typeofworknoncourtabt"),
                ...
                <table   width="100%"  border="0" style="border-color:#4b6a84;"  id="myTable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th title="click to sort" class="headerText">Create Caveat</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        <c:forEach items="${studentList}" var="Parents">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
								...
								<td class="dataText" style='white-space: nowrap'><button id="query_${Parents.student.sid}" class="querybutton" onclick="createCaveat(${Parents.student.sid},${Parents.student.branchid})">Create Caveat</button></td>                                 
                            </tr>
                        </c:forEach>
                    </tbody>
                    <tfoot><tr>
