    ...
    <head >
        ...
        <script type="text/javascript">
            ...
            function restoreRecords(){
                var form1=document.getElementById("form1");
                 form1.action="/sunrise/StudentProcess/restoreMultiple";
                form1.submit();
            }
...
%>
    <body  >
        ...
        <form name="form1" id="form1"action="/sunrise/StudentProcess/restoreMultiple" method="post">
                    ...
                    <tbody>
                        <c:forEach items="${studentListArchive}" var="Student">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/sunrise/StudentProcess/ViewDetails?id=<c:out value='${Student.sid}'/>&urlbranchid=<c:out value='${Parents.student.branchid}'/>"><c:out value="${Student.admissionnumber}"/></a></td>
