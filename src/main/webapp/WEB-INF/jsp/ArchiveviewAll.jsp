    ...
    <head >
        ...
        <script type="text/javascript">
            ...
            function restoreRecords(){
                var form1=document.getElementById("form1");
                 form1.action="/sla/StudentProcess/restoreMultiple";
                form1.submit();
            }
...
%>
    <body  >
        ...
        <form name="form1" id="form1"action="/sla/StudentProcess/restoreMultiple" method="post">
            <div style="overflow: hidden">
                <table width="100%">
                    <tr>
                        <td  class="headerTD">View All Archive Clients</td>
                    </tr>
                    ...
                    <tbody>
                        <c:forEach items="${studentListArchive}" var="Student">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/sla/StudentProcess/ViewDetails?id=<c:out value='${Student.sid}'/>&urlbranchid=<c:out value='${Parents.student.branchid}'/>"><c:out value="${Student.studentexternalid}"/></a></td>
