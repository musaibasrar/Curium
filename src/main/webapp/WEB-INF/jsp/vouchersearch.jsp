...
<script type="text/javascript">
	function search() {
		...
		form1.action = "/madina/AccountProcess/viewNextVoucher";
		form1.method = "POST";
		form1.submit();
	...
	function exportVoucher(){
		var form1 = document.getElementById("form1");
		form1.action = "/madina/AccountProcess/exportVoucher";
		form1.method = "POST";
		form1.submit();
	}
	...
	function cancelVoucher(){
		...
		if(confirm('Are you sure, you want to cancel the Receipt Voucher?')){
			var form1 = document.getElementById("form1");
			form1.action="/madina/AccountProcess/cancelVoucher";
			form1.method = "POST";
			form1.submit();	
		}
	...
	function printVoucher(){
			...
			var form1 = document.getElementById("form1");
			form1.action="/madina/AccountProcess/voucherPrint";
			form1.method = "POST";
			form1.submit();	
	}
		...
		<div style="overflow: scroll; height: 600px">
			...
			<table width="100%" border="0" style="border-color: #4b6a84;">
					...
					<tr>
						...
						<%-- <a id="print" href="/madina/AccountProcess/voucherPrint?fromdate=<c:out value="${fromdate}"/>&todate=<c:out value="${todate}"/>&vouchertype=<c:out value="${vouchertype}"/>">Print</a> --%>
