...
<script type="text/javascript">
	...
	function generateQueriesReport() {
			var form1 = document.getElementById("form1");
				form1.action = "/brilliantgrammar/JobProcess/generateQueriesReport";
				form1.method = "POST";
				form1.submit();
	}
	...
	function viewTaskDetails(jobid){
	 ...
	 function printRecords() {
			var form1 = document.getElementById("form1");
			form1.action = "/brilliantgrammar/JobProcess/printQueriesReport";
			form1.method = "POST";
			form1.submit();
		}
	 ...
	 var employees = [
         <c:forEach varStatus="status" items="${employeeList}" var="employee">{
         	 value:'<c:out default="0" value="${employee.teachername}" />',
             id:'<c:out default="0" value="${employee.tid}" />',
	 ...
	 function exportRecords() {
			var form1 = document.getElementById("form1");
			form1.action = "/brilliantgrammar/JobProcess/exportQueriesReport";
			form1.method = "POST";
			form1.submit();
		}
...
<body>
	...
	<form id="form1"
				...
				<div id="tabs-1">
					...
					<table style="margin-left: auto;margin-right: auto;">
						...
						<tr>
							...
							<td ><label>
										<input  type="text" name="staffname" id="staffname"  class="myclass" style="width: 200px" /> 
										<input name="staffId" type="hidden" id="staffId" value="" />
										<input name="staffName" type="hidden" id="staffName" value="" />
							</label></td>
		...
		<div style="overflow: scroll; height: 600px">
			<table width="100%">
				<tr>
					<td class="headerTD">Assignment Report <br>
