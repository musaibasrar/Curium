...
<script type="text/javascript">
	...
	function generateQueriesReport() {
			var form1 = document.getElementById("form1");
				form1.action = "/alalmas/JobProcess/generateQueriesReport";
				form1.method = "POST";
				form1.submit();
	}
	...
	function viewTaskDetails(jobid){
	 ...
	 function printRecords() {
			var form1 = document.getElementById("form1");
			form1.action = "/alalmas/JobProcess/printQueriesReport";
			form1.method = "POST";
			form1.submit();
		}
	 ...
	 function exportRecords() {
			var form1 = document.getElementById("form1");
			form1.action = "/alalmas/JobProcess/exportQueriesReport";
			form1.method = "POST";
			form1.submit();
		}
