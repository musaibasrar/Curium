...
<html>
    ...
    <frameset    rows="139,*"frameborder="0" border="0" framespacing="0"  >
        <frame   src="/readmodelschool/header1"   name="topFrame" scrolling="NO" noresize frameborder="0">

            <frameset  cols="175,*" frameborder="0" border="0" framespacing="0">
                <frame  src="/readmodelschool/left" name="leftFrame" scrolling="NO"  frameborder="1"   />
