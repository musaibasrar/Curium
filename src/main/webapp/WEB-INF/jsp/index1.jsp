...
<html>
    ...
    <frameset    rows="139,*"frameborder="0" border="0" framespacing="0"  >
        <frame   src="/littleflower/header1"   name="topFrame" scrolling="NO" noresize frameborder="0">

            <frameset  cols="175,*" frameborder="0" border="0" framespacing="0">
                <frame  src="/littleflower/left" name="leftFrame" scrolling="NO"  frameborder="1"   />
                <frame src="/littleflower/StudentProcess/viewAll" name="mainFrame" scrolling="yes" />
            </frameset>
