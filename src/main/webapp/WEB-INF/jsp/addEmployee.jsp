...
%>
<body>
	<form id="form1" action="/taha/PersonalProcess/add" method="post">
					...
					<table width="100%" border="0" align="center" id="table1">
						...
						<script type="text/javascript">
							function addEmployee() {
								...
								form1.action = "/taha/EmployeeProcess/addEmployee";
								form1.submit();
							}

							function Cancel() {
								var form1 = document.getElementById("form1");
								form1.action = "/taha/EmployeeProcess/viewAllEmployee";
								form1.submit();
							}
