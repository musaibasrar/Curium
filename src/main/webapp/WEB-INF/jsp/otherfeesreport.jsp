...
<script type="text/javascript">
	function searchForStudents() {
		...
		form1.action = "/brilliantgrammar/FeesCollection/othersearchFeesReport";
		form1.method = "POST";
		form1.submit();
	}
	$(function() {
...
%>
<body>
	<form id="form1" action="/brilliantgrammar/FeesCollection/exportDataForStudentsOtherFeesReport" method="POST">
					...
					<tr>
                     ...
                     <tr>
						...
						<tr>
							...
							<c:forEach items="${otherfeescategory}" var="otherfeescategory">
										<label class="labelClass" style="font-weight: bold;color:#325F6D"> <input
									 type="checkbox" name="otherfeescategory" class="chcktbl" value="${otherfeescategory.idfeescategory}"
									size="36"> ${otherfeescategory.feescategoryname} : </label> <label style="font-weight: bold;color:#eb6000">${otherfeescategory.particularname}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										</label><br>
		...
		<div style="overflow: scroll; height: 600px">
			...
			<table width="100%" border="0" style="border-color: #4b6a84;"
				...
				<tbody>
					...
					<c:forEach items="${studentotherfeesreportlist}" var="studentfeesreportlist" varStatus="status">
