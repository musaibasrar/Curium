...
<script type="text/javascript">
	function searchForStudents() {
		...
		form1.action = "/presidency/FeesCollection/othersearchFeesReport";
		form1.method = "POST";
		form1.submit();
	}
	$(function() {
...
<script type="text/javascript">
    ...
    function getFeesCategory() {
		var selected=document.getElementById('academicyear').value;
			...
			xmlHttp.open("GET", "/presidency/StampFeesProcess/showFeesDetailsYearly?year="+selected,true);
			xmlHttp.send(null);
	}
...
%>
<body>
	<form id="form1" action="/presidency/FeesCollection/exportDataForStudentsOtherFeesReport" method="POST">
