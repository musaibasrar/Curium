...
<script type="text/javascript">
	function searchForStudents() {
		...
		form1.action = "/alfarooq/FeesCollection/othersearchFeesReport";
		form1.method = "POST";
		form1.submit();
	}
	$(function() {
...
%>
<body>
	<form id="form1" action="/alfarooq/FeesCollection/exportDataForStudentsOtherFeesReport" method="POST">
