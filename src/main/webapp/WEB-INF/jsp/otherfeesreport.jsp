...
<title>/readmodelschool Report</title>
...
<script type="text/javascript">
	function searchForStudents() {
		...
		form1.action = "/orion/FeesCollection/othersearchFeesReport";
		form1.method = "POST";
		form1.submit();
	}
	$(function() {
...
<script type="text/javascript">
    ...
    function getFeesCategory() {
		var selected=document.getElementById('academicyear').value;
			...
			xmlHttp.open("GET", "/orion/StampFeesProcess/showFeesDetailsYearly?year="+selected,true);
			xmlHttp.send(null);
	}
...
%>
<body>
	<form id="form1" action="/orion/FeesCollection/exportDataForStudentsOtherFeesReport" method="POST">
		...
		<div id="effect" class="ui-widget-content ui-corner-all">
			<div id="tabs">
				<ul>
					<li><a href="#tabs-1">/readmodelschool Report</a></li>
					...
					<tr>
                     ...
                     <tr>
						<td><br></td>
                    		...
                    		<tr>
							<td style="font-weight: bold;color:#325F6D">/readmodelschool Category: &nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td>
		...
		<div style="overflow: scroll; height: 600px">
			<table width="100%">
				<tr>
					<td class="headerTD">/readmodelschool Report</td>
				</tr>
			</table>
