    ...
    <head >
        ...
        <script type="text/javascript">
            ...
            function restoreRecords(){
                var form1=document.getElementById("form1");
                 form1.action="/nortuntrading/ClassProcess/restoreMultipleLeftout";
                form1.submit();
            }
...
%>
    <body  >
        ...
        <form name="form1" id="form1"action="/nortuntrading/ClassProcess/restoreMultipleLeftout" method="post">
