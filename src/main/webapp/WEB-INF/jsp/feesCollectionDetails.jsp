...
<script type="text/javascript">
	function searchByDate() {
		...
		form1.action = "/bsr/UserProcess/searchByDate";
		form1.method = "POST";
		form1.submit();
...
<body>
	<form id="form1"
		action="/bsr/FeesDetails/exportDataForFees" method="POST">
			...
			<table width="100%" border="0" style="border-color: #4b6a84;"
				...
				<thead>
                        <tr>
                            ...
                            <th title="click to sort" class="headerText">Manual Receipt No.</th>
                    ...
                    <tbody>
                        ...
                        <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataText"><c:set var="paymentParts" value="${fn:split(feesdetails.key.paymenttype, ':')}" />
                                ${paymentParts[fn:length(paymentParts) - 1]}
                                </td>
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/bsr/FeesCollection/ViewDetails?id=<c:out value='${feesdetails.key.receiptnumber}'/>&sid=<c:out value='${feesdetails.key.sid}'/>">View Details</a></td>
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/bsr/FeesCollection/CancelFeesReceipt?id=<c:out value='${feesdetails.key.receiptnumber}'/>&sid=<c:out value='${feesdetails.key.sid}'/>&receiptid=<c:out value='${feesdetails.key.receiptvoucher}'/>&journalid=<c:out value='${feesdetails.key.journalvoucher}'/>"><i class="fa fa-times" style="color:#93051f;font-size: 18px;"></i></a></td>
                            </tr>
                           ...
                           <%--  <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataText"><c:set var="paymentParts" value="${fn:split(recieptinfo.paymenttype, ':')}" />
                                ${paymentParts[1]}
                                </td>
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/bsr/FeesCollection/ViewDetails?id=<c:out value='${feesdetails.receiptnumber}'/>&sid=<c:out value='${feesdetails.sid}'/>">View Details</a></td>
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/bsr/FeesCollection/CancelFeesReceipt?id=<c:out value='${feesdetails.receiptnumber}'/>&sid=<c:out value='${feesdetails.sid}'/>&receiptid=<c:out value='${feesdetails.receiptvoucher}'/>&journalid=<c:out value='${feesdetails.journalvoucher}'/>"><i class="fa fa-times" style="color:#93051f;font-size: 18px;"></i></a></td>
