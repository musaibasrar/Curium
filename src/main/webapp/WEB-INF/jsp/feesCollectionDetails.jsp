...
<script type="text/javascript">
	function searchByDate() {
		...
		form1.action = "/littleangel/UserProcess/searchByDate";
		form1.method = "POST";
		form1.submit();
                    ...
                    <tbody>
                        <c:forEach items="${searchfeesdetailslist}" var="feesdetails">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/littleangel/FeesCollection/CancelFeesReceipt?id=<c:out value='${feesdetails.receiptnumber}'/>&sid=<c:out value='${feesdetails.sid}'/>&receiptid=<c:out value='${feesdetails.receiptvoucher}'/>&journalid=<c:out value='${feesdetails.journalvoucher}'/>"><i class="fa fa-times" style="color:#93051f;font-size: 18px;"></i></a></td>
