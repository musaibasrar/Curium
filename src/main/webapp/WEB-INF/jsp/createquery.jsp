...
<html >
    <head >
        ...
        <script type="text/javascript" src="/scholar/js/chosen.jquery.min.js"></script>
		<link rel="stylesheet" href="/scholar/css/chosen.min.css">
        <style type="text/css" >
        	.myclass {
				font-size: 1.3em;
        ...
        <script type="text/javascript">
            ...
            function saveQuery(){
                var form1=document.getElementById("form1");
               form1.action="/scholar/JobProcess/addQuery";
               form1.submit();
            }
