...
<html >
    <head >
        ...
        <script type="text/javascript" src="/vasu/js/chosen.jquery.min.js"></script>
		<link rel="stylesheet" href="/vasu/css/chosen.min.css">
        <style type="text/css" >
        	.myclass {
				font-size: 1.3em;
        ...
        <script type="text/javascript">
            function deleteRecords(){
                ...
                form1.action="/vasu/StudentProcess/archiveMultiple";
               form1.submit();
           }
        ...
        <script type="text/javascript">
            ...
            function saveQuery(){
                var form1=document.getElementById("form1");
               form1.action="/vasu/JobProcess/addQuery";
               form1.submit();
            }
        ...
        <script type="text/javascript">
            ...
            function deleteRow(tableID) {
				...
				function fixAppointment(appointmentdate,appointmenttime){
		            	...
		            	var form1 = document.getElementById("form1");
		        		form1.action = "/vasu/AppointmentProcess/addAppointment?appointmentdate="+appointmentDate+"&appointmenttime="+appointmentTime+"";
		        		form1.method = "POST";
		        		form1.submit();
		            }
                    ...
                    <tr>
                        <td  class="headerTD">Create Job</td>
		           		...
		           		<table style="margin-left: auto;margin-right: auto;">
								...
								<%-- <tr>
									<td class="alignLeft" style="font-weight: bold;font-size: 16px;">Permanent Number:</td>
