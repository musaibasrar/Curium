...
<script type="text/javascript">
	...
	function searchForStudents() {
		...
		form1.action = "/sanmarg/FeesCollection/searchFeesReportOutstanding";
		form1.method = "POST";
		form1.submit();
	...
	function sendSMS() {
		var form1 = document.getElementById("form1");
		form1.action = "/sanmarg/SMSProcess/sendSMSFeesDueReminder";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/sanmarg/FeesCollection/exportDataForStudentsFeesReport" method="POST">
