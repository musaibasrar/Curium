...
<script type="text/javascript">
	...
	function searchForStudents() {
		...
		form1.action = "/newexcellent/FeesCollection/searchFeesStampDueReport";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/newexcellent/FeesCollection/exportDataForStudentsFeesReport" method="POST">
