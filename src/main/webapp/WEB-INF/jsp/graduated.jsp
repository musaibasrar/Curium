    ...
    <head >
        ...
        <script type="text/javascript">
            function deleteRecords(){
                ...
                form1.action="/mfds/StudentProcess/deleteMultiple";
               form1.submit();
                
            }
            function restoreRecords(){
                var form1=document.getElementById("form1");
                 form1.action="/mfds/ClassProcess/restoreMultipleGraduate";
                form1.submit();
            }
...
%>
    <body  >
        ...
        <form name="form1" id="form1"action="/mfds/ClassProcess/restoreMultipleGraduate" method="post">
                    ...
                    <tbody>
                        <c:forEach items="${studentListGraduated}" var="Student" varStatus="status">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/mfds/StudentProcess/ViewDetails?id=<c:out value='${Student.sid}'/>&urlbranchid=<c:out value='${Parents.student.branchid}'/>"><c:out value="${Student.studentexternalid}"/></a></td>
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/mfds/StudentProcess/ViewDetails?id=<c:out value='${Student.sid}'/>&urlbranchid=<c:out value='${Parents.student.branchid}'/>"><c:out value="${Student.admissionnumber}"/></a></td>
