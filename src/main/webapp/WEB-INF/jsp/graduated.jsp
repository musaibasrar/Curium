    ...
    <head >
        ...
        <script type="text/javascript">
            function deleteRecords(){
                ...
                form1.action="/peace/StudentProcess/deleteMultiple";
               form1.submit();
                
            }
            function restoreRecords(){
                var form1=document.getElementById("form1");
                 form1.action="/peace/ClassProcess/restoreMultipleGraduate";
                form1.submit();
            }
...
%>
    <body  >
        ...
        <form name="form1" id="form1"action="/peace/ClassProcess/restoreMultipleGraduate" method="post">
                    ...
                    <tbody>
                        <c:forEach items="${studentListGraduated}" var="Student">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/peace/StudentProcess/ViewDetails?id=<c:out value='${Student.sid}'/>&urlbranchid=<c:out value='${Parents.student.branchid}'/>"><c:out value="${Student.studentexternalid}"/></a></td>
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/peace/StudentProcess/ViewDetails?id=<c:out value='${Student.sid}'/>&urlbranchid=<c:out value='${Parents.student.branchid}'/>"><c:out value="${Student.admissionnumber}"/></a></td>
            ...
            <div align="center">
             <%--For displaying Previous link except for the 1st page --%>
                <c:if test="${currentPage != 1}">
                    <td><a style="color: #4B6A84;font-size: 12px" href="/peace/PersonalProcessPages&page=${currentPage - 1}">Previous</a></td>
                </c:if>
                    ...
                    <tr>
                        <c:forEach begin="1" end="${noOfPages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <td style="color: black;font-weight:bold;font-size: 15px "><a style="color: #4B6A84" href="/peace/PersonalProcessPages&page=${i}">${i}</a></td>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                    </tr>
                ...
                <c:if test="${currentPage lt noOfPages}">
                    <td ><a style="color: #4B6A84;font-size: 12px" href="/peace/PersonalProcessPages&page=${currentPage + 1}">Next</a></td>
                </c:if>
                    </div>
