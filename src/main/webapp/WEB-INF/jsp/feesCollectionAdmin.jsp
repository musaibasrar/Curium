...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/scholargroup/css/graph/jquery.jqplot.css">
        ...
        <script type="text/javascript" src="/scholargroup/js/datePicker/ui/jquery-ui-1.8.17.custom.js"></script>
        <script type="text/javascript" src="/scholargroup/js/datePicker/ui/jquery.ui.dialog.js"></script>
        <script type="text/javascript" src="/scholargroup/js/datePicker/ui/jquery.ui.autocomplete.js"></script>
        <script type="text/javascript" src="/scholargroup/js/datePicker/ui/jquery.ui.core.js"></script>
        <script type="text/javascript" src="/scholargroup/js/datePicker/ui/jquery.ui.widget.js"></script>
        <script type="text/javascript" src="/scholargroup/js/datePicker/ui/jquery.ui.datepicker.js"></script>
        <script type="text/javascript" src="/scholargroup/js/datePicker/ui/jquery.ui.accordion.js"></script>
        <script type="text/javascript" src="/scholargroup/js/datePicker/ui/sliderAccess.js"></script>
        <script type="text/javascript" src="/scholargroup/js/datePicker/ui/jquery-ui-timepicker-addon.js"></script>
        <script  type="text/javascript" src="/scholargroup/js/datePicker/ui/jquery.ui.position.js"></script>
        <script type="text/javascript" src="/scholargroup/js/datePicker/ui/jquery.ui.mouse.js"></script>
        <script type="text/javascript" src="/scholargroup/js/datePicker/ui/jquery.ui.draggable.js"></script>
        <script type="text/javascript" src="/scholargroup/js/datePicker/ui/jquery.ui.resizable.js"></script>

        <script type="text/javascript" src="/scholargroup/js/datePicker/ui/jquery.effects.slide.js"></script>
        <script type="text/javascript" src="/scholargroup/js/datePicker/ui/jquery.effects.bounce.js"></script>
        <script type="text/javascript" src="/scholargroup/js/datePicker/ui/jquery.effects.clip.js"></script>
        <script type="text/javascript" src="/scholargroup/js/datePicker/ui/jquery.effects.transfer.js"></script>
        <script type="text/javascript" src="/scholargroup/js/datePicker/ui/jquery.effects.blind.js"></script>
        <style type="text/css">
            <!--
            .labelCss {
                font-family: Tahoma;
 ...
 function submitfees(cashpayment,banktransfer,chequetransfer,ackno,transferdate,transferbankname,chequeno,chequedate,chequebankname){
        		...
        		form1.action="/scholargroup/FeesCollection/feesAdd?paymentmethod="+paymentmethodvalue+"&ackno="+acknovalue+"&transferdate="+transferdatevalue+"&transferbankname="+transferbanknamevalue+"&chequeno="+chequenovalue+"&chequedate="+chequedatevalue+"&chequebankname="+chequebanknamevalue+"";
        		form1.method = "POST";
        		form1.submit();
            ...
            function getstampfees(){
            	var form1 = document.getElementById("form1");
        		form1.action="/scholargroup/FeesCollection/StampFees";
        		form1.method = "POST";
        		form1.submit();
            }
 ...
 function calculateConcessionPercent(feesAmount, percentValue, sfsid,dueAmount) {
	    ...
	    if (!isNaN(percent)) {
		 ...
		 function checkConcession(feesAmount,concession,sfsid,dueAmount){
         	var due = dueAmount;
         	var con = concession;
    ...
    <%
//allow access only if session existscheckConcession
String user = null;
...
%>
				...
				<tbody>
					<c:forEach items="${studentfeesdetails}" var="studentfeesdetails" varStatus="status">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataText1" align="center"><input type="checkbox"  class = "chcktb2"
								id="<c:out value="${studentfeesdetails.key.sfsid}"/>" 
								name="studentsfsids" 
								value="<c:out value="${studentfeesdetails.key.sfsid}"/>_${status.index}" /></td>
							<td class="dataText1" align="center" style="font-weight: bold;font-size: 13px;"><c:out	value="${studentfeesdetails.key.feescategory.feescategoryname}" /></a><input name="idfeescategory" type="hidden" id="idfeescategory" value="${studentfeesdetails.key.idfeescategory}" /></td>
							<td class="dataText1" align="center" style="font-weight: bold;font-size: 13px;">
							...
							<td class="dataText1" align="center">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataText1" align="center"><input type="checkbox"  class = "chcktb2"
								...
								name="fine" 
								value="1"></td>
							<td class="dataText1" align="center" style="font-weight: bold;font-size: 13px;">Fine</td>
							<td class="dataText1" align="center" style="font-weight: bold;font-size: 13px;">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataText1" align="center"><input type="checkbox"  class = "chcktb2"
								...
								name="misc" 
								value="1"></td>
							<td class="dataText1" align="center" style="font-weight: bold;font-size: 13px;">Miscellaneous</td>
							<td class="dataText1" align="center" style="font-weight: bold;font-size: 13px;">
						...
						<tr class="trClass" style="border-color: #000000;background: red" border="1" 
							cellpadding="1" cellspacing="1">
							<td class="dataText1" align="center"><input type="checkbox"  class = "chcktb2" disabled="disabled"
								id="<c:out value="${studentfeesdetails.key.sfsid}"/>" 
								name="studentsfsidspy" 
								value="<c:out value="${studentfeesdetails.key.sfsid}"/>_${status.index}" /></td>
							<td class="dataText1" align="center" style="font-weight: bold;font-size: 13px;color:white;"><c:out	value="${studentfeesdetails.key.feescategory.feescategoryname}" /></a><input name="idfeescategory" type="hidden" id="idfeescategorypy" value="${studentfeesdetails.key.idfeescategory}" /></td>
							<td class="dataText1" align="center" style="font-weight: bold;font-size: 13px;color:white;">
 ...
 -->
			...
			<tr>
					...
					<tr>
                    <td style="width: 45%;font-weight: bold;font-size: 15px;color: #eb6000;">Fees Concession:&nbsp;&nbsp;&nbsp;&nbsp; 
                    </tr>
                     <tr>
						<td><br></td>
                    </tr>
                    ...
                    <tbody>
                       <c:forEach items="${studentfeesdetails}" var="studentfeesdetails" varStatus="status">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
								...
								id="<c:out value="${studentfeesdetails.key.sfsid}"/>_concession" 
								name="sfsidconcession" 
								value="<c:out value="${studentfeesdetails.key.sfsid}"/>_<c:out value="${studentfeesdetails.key.feescategory.idfeescategory}"/>" /></td>
                                <td class="dataText"><c:out value="${studentfeesdetails.key.feescategory.feescategoryname}"/></td>
                                <td class="dataText"><c:out value="${studentfeesdetails.key.feescategory.amount}"/></td>
                                <td class="dataText"><c:out value="${studentfeesdetails.key.totalinstallment}"/></td>
                                <td class="dataText"><c:out value="${studentfeesdetails.key.feesamount}"/></td>
                                <td class="dataText"><c:out value="${studentfeesdetails.key.feespaid}"/></td>
                                <td class="dataText"><input type="text" style="background: transparent;border: none;color: #4b6a84;font-size: 13px;" name="dueamount:${studentfeesdetails.key.sfsid}" value="${studentfeesdetails.key.feesamount-studentfeesdetails.key.feespaid-studentfeesdetails.key.concession-studentfeesdetails.key.waiveoff}" readonly></td>
                                <td class="dataText"><input type="text" 
       id="concessionPercent:${studentfeesdetails.key.sfsid}" 
       placeholder="%"
       style="width: 50px; margin-left: 5px; font-size: 13px;" 
       onkeyup="calculateConcessionPercent(${studentfeesdetails.key.feesamount}, this.value, ${studentfeesdetails.key.sfsid}, ${studentfeesdetails.key.feesamount-studentfeesdetails.key.feespaid-studentfeesdetails.key.concession-studentfeesdetails.key.waiveoff})"></td>
                                <td class="dataText">
                                <input type="hidden" id="concessionold:${studentfeesdetails.key.sfsid}" name="concessionold:${studentfeesdetails.key.sfsid}" value="${studentfeesdetails.key.concession}">
                                <input type="text" id="concession:${studentfeesdetails.key.sfsid}" style="background: transparent;border: none;color: #4b6a84;font-size: 13px;" onkeyup="checkConcession(${studentfeesdetails.key.feesamount-studentfeesdetails.key.feespaid},this.value,${studentfeesdetails.key.sfsid},${studentfeesdetails.key.feesamount-studentfeesdetails.key.feespaid-studentfeesdetails.key.concession-studentfeesdetails.key.waiveoff})" 
                                name="concession:${studentfeesdetails.key.sfsid}" class="concession"
                                value="${studentfeesdetails.key.concession}"></td>
                                <td class="dataText">
	                                <input type="text" style="background: transparent;border: none;color: #4b6a84;font-size: 13px;" name="concessionnotes:${studentfeesdetails.key.sfsid}" id="concessionnotes:${studentfeesdetails.key.sfsid}" value="${studentfeesdetails.key.concessionnotes}">		
                                </td>
