...
<script type="text/javascript" src="/gnyanganga/js/dataTable/jquery.dataTables.js"></script>
...
<script type="text/javascript">
	...
	function addSuppliers(){
		...
		if(form1.checkValidity()) {
			form1.action = "/gnyanganga/MessSuppliersProcess/addSuppliers";
			form1.method = "POST";
			form1.submit();
		}
	...
	function updateSuppliers(){
		var form1 = document.getElementById("form1");
			form1.action = "/gnyanganga/MessSuppliersProcess/updateSuppliers";
			form1.method = "POST";
			form1.submit();	
	}
	
	function deleteSuppliers(){
			form1.action = "/gnyanganga/MessSuppliersProcess/deleteSuppliers";
			form1.method = "POST";
			form1.submit();	
	}
