...
<script type="text/javascript" src="/lilyrose/js/dataTable/jquery.dataTables.js"></script>
...
<script type="text/javascript">
	...
	function addSuppliers(){
		...
		if(form1.checkValidity()) {
			form1.action = "/lilyrose/MessSuppliersProcess/addSuppliers";
			form1.method = "POST";
			form1.submit();
		}
	...
	function updateSuppliers(){
		var form1 = document.getElementById("form1");
			form1.action = "/lilyrose/MessSuppliersProcess/updateSuppliers";
			form1.method = "POST";
			form1.submit();	
	}
	
	function deleteSuppliers(){
			form1.action = "/lilyrose/MessSuppliersProcess/deleteSuppliers";
			form1.method = "POST";
			form1.submit();	
	}
