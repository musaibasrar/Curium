    ...
    <head >
        ...
        <script type="text/javascript">
            function printRecords(){
                ...
                form1.action="/alirfan/DocumentsProcess/printTcList";
                form1.submit();
            }
                    ...
                    <tbody>
                        <c:forEach items="${studenttcissued}" var="parent">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/alirfan/StudentProcess/ViewDetails?id=<c:out value='${parent.student.sid}'/>&urlbranchid=<c:out value='${Parents.student.branchid}'/>"><c:out value="${parent.student.studentexternalid}"/></a></td>
