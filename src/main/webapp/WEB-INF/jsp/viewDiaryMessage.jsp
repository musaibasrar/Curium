...
.btn:hover, .btn:focus{
	...
	<div class="container-fluid">
		...
		<!-- 	<div class="col-md-4 text-center company__info">
			...
			<h2 style="font-weight: bold;">Roshan<img border="0" style="vertical-align: text-bottom;height: 120px;width: 200px;" alt="ideoholic" src="/alirfan/images/shaheenwhitelogo.png"> </h2></span>
			</div>
