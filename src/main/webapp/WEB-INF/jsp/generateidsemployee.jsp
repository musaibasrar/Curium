...
<script type="text/javascript">
	function searchDetails() {
		var form1 = document.getElementById("form1");
 		form1.action = "/presidency/Printids/searchDetails";
		form1.method = "POST";
		form1.submit();
	...
	function printPreview() {
		var form1 = document.getElementById("form1");
		form1.action = "/presidency/Printids/printpreviewemployee";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/presidency/Printids/printpreviewemployee" method="POST">
					...
					<c:forEach items="${employeeList}" var="employees">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataTextInActive"><a class="dataTextInActive"
								href="/presidency/EmployeeProcess/ViewDetails&id=<c:out value='${employee.tid}'/>"><c:out
