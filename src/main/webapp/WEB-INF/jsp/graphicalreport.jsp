...
<script type="text/javascript">
	function searchForReports() {
		...
		form1.action = "/childrenandglobal/MarksDetailsProcess/searchForGraphicalReport";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/childrenandglobal/MarksDetailsProcess/getStudentGraph" method="POST">
					...
					<c:forEach items="${searchStudentList}" var="Parents" >
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<%-- 					<td class="dataTextInActive"><a class="dataTextInActive"
								href="/childrenandglobal//childrenandglobal/StudentProcess/ViewDetails&id=<c:out value='${Parents.student.sid}'
								/>&urlbranchid=<c:out value='${Parents.student.branchid}'/>"><c:out
									value="${Parents.student.admissionnumber}" /></a></td> 
									/childrenandglobal/MarksDetailsProcess/getStudentGraph--%>
