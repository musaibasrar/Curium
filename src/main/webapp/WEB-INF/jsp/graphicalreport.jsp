...
<script type="text/javascript">
	function searchForReports() {
		...
		form1.action="/newexcellent/MarksDetailsProcess/searchForGraphicalReport";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/newexcellent/MarksDetailsProcess/getStudentGraph" method="POST">
