...
<script type="text/javascript">
	function searchForReports() {
		...
		form1.action = "/nortuntrading/MarksDetailsProcess/searchForGraphicalReport";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/nortuntrading/MarksDetailsProcess/getStudentGraph" method="POST">
					...
					<c:forEach items="${searchStudentList}" var="Parents" >
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<%-- 					<td class="dataTextInActive"><a class="dataTextInActive"
								href="/nortuntrading//nortuntrading/StudentProcess/ViewDetails&id=<c:out value='${Parents.student.sid}'
								/>&urlbranchid=<c:out value='${Parents.student.branchid}'/>"><c:out
									value="${Parents.student.admissionnumber}" /></a></td> 
									/nortuntrading/MarksDetailsProcess/getStudentGraph--%>
