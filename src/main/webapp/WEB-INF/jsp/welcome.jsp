	...
	<div class="row" style="padding-left: 20px;">
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td>																						
        						<label style="font-family: Tahoma;font-weight: bolder;color: #5E87B0;font-size: 18px;"> Maaz Foundation Danish School </label><br>
        						<a target="_parent" 
        						 href="/mfds/UserProcess/multiUser?branchid=2"> <img
									src="/mfds/images/login.svg" width="25" height="25" alt="Login" />Login</a>
        					</td>
        				</tr>
        			</table>
        			</div>
        	...
        	<div class="col" style="padding-bottom: 40px;"> 
        			...
        			<table>
        				<tr>
        					<td>
        						<label style="font-family: Tahoma;font-weight: bolder;color: #5E87B0;font-size: 18px;"> Maaz Foundation Danish School-Hifz</label><br>
        						<a target="_parent"
        						 href="/mfds/UserProcess/multiUser?branchid=3"> <img
									src="/mfds/images/login.svg" width="25" height="25" alt="Login"/>Login</a>
        					</td>
        				</tr>
        			</table>
