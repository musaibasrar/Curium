	...
	<div class="row" style="padding-left: 20px;">
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td>
        						<label style="font-family: Tahoma;font-weight: bolder;color: #5E87B0;font-size: 18px;"> Brainy Stars International Holistic Montessori School </label><br>
        						<a target="_parent" 
        						 href="/bsb/UserProcess/multiUser?branchid=2"> <img
									src="/bsb/images/login.svg" width="25" height="25" alt="Login" />Login</a>
        					</td>
        				</tr>
        			</table>
        			</div>
        	...
        	<div class="col" style="padding-bottom: 40px;"> 
        			...
        			<table>
        				<tr>
        					<td>
        						<label style="font-family: Tahoma;font-weight: bolder;color: #5E87B0;font-size: 18px;"> Brainy Stars International School</label><br>
        						<a target="_parent"
        						 href="/bsb/UserProcess/multiUser?branchid=3"> <img
									src="/bsb/images/login.svg" width="25" height="25" alt="Login"/>Login</a>
        					</td>
        				</tr>
        			</table>
