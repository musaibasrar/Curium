...
<style>
 ...
 <td>&nbsp;&nbsp;
 <!-- <img src="/awami/images/awami.png" width="140" height="70"/> -->
 </td>
 </tr>
 </table>
   </div>
 ...
 <%--  <tr>
    ...
    <td style="padding: 0;color:white;">:&nbsp;<%= request.getSession().getAttribute("rollnumber" + i + "") %></td>
  </tr>
  <tr>
    <td style="padding: 0;white-space: nowrap;color:white;">&nbsp;&nbsp;ADM NO.</td>
