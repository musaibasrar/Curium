<%-- 
    Document   : PrintStockReceivedReport
					...
					<c:forEach items="${messstockentrylist}" var="messstockentrylist" varStatus="status">
						...
						<tr>
								...
								<c:set var="dataParts" value="${fn:split(messstockentrylist.externalid, '_')}" />
						 		 <c:out value="${dataParts[0]}" /></td>
								<td class="datatdright" style="font-size: 9px;"><c:out value="${messstockentrylist.quantity}" /></td>
								<td class="datatdright" style="font-size: 9px;"><c:out value="${messstockentrylist.itemunitprice}" /></td>
								...
								<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${messstockentrylist.itemunitprice * messstockentrylist.quantity}" />
								</td>
						</tr>	
