    ...
    font-weight: bold;
        ...
        <script type="text/javascript">
            ...
            function searchFeesStructure() {
                ...
                form1.action = "/abc/StudentProcess/otherFeesStructurePerYear?id="+id;
                form1.submit();
            }
                    ...
                    <tbody>
                        <c:forEach items="${feesstructure}" var="feesstructure">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                name="concession:${feesstructure.sfsid}" class="concession" readonly
                                ...
                                <td class="dataText">
	                                ...
	                                <!-- <input type="text" style="background: transparent;border: none;color: #4b6a84;font-size: 13px;" > -->		
                                </td>
                                <td class="dataText">
