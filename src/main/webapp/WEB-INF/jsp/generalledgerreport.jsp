...
<script type="text/javascript">
	function search() {
		...
		if(form1.checkValidity()) {
			form1.action = "/shatabdi/AccountProcess/searchLedgerEntries";
			form1.method = "POST";
			form1.submit();
		  }
	}
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/shatabdi/AccountProcess/printSearchLedgerEntries";
		form1.method = "POST";
		form1.submit();
}
			...
			<div id="tabs">
				...
				<div id="tabs-1">
					<table style="margin-left: auto;margin-right: auto;">
						...
						<td class="alignRight">Dr/Cr Only</td>
							<td><label> <select name="onlydrcr" id="onlydrcr" class="select2" style="width: 230px">
										<option selected>${onlydrcrselected}</option>
										<option></option>
										<option>Debit</option>
