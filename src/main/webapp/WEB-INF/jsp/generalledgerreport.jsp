...
<script type="text/javascript"	src="/newexcellent/js/datePicker/ui/ScrollableGridPlugin.js"></script>
...
<script type="text/javascript">
	function search() {
		...
		if(form1.checkValidity()) {
			form1.action = "/newexcellent/AccountProcess/searchLedgerEntries";
			form1.method = "POST";
			form1.submit();
		  }
	}
	...
	function printRecords() {
			var form1 = document.getElementById("form1");
			form1.action = "/newexcellent/AccountProcess/printSearchLedgerEntries";
			form1.method = "POST";
			form1.submit();
	}
