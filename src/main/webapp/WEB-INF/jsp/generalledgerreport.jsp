...
<script type="text/javascript"	src="/rauzamission/js/datePicker/ui/ScrollableGridPlugin.js"></script>
...
<script type="text/javascript">
	function search() {
		...
		if(form1.checkValidity()) {
			form1.action = "/rauzamission/AccountProcess/searchLedgerEntries";
			form1.method = "POST";
			form1.submit();
		  }
	}
	...
	function printRecords() {
			var form1 = document.getElementById("form1");
			form1.action = "/rauzamission/AccountProcess/printSearchLedgerEntries";
			form1.method = "POST";
			form1.submit();
	}
