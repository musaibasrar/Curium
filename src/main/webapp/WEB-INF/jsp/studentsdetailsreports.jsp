...
function printStudentDetail() {
	...
	form1.action = "/school/StudentProcess/printStudentDetail";
	form1.method = "POST";
	form1.submit();
...
<script type="text/javascript">
	function searchForStudents() {
		var form1 = document.getElementById("form1");
		form1.action = "/school/StudentProcess/multiClassSearch";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/school/StudentProcess/exportDataForStudents" method="POST">
