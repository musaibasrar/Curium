...
%>
<body>
	<form id="form1" action="/shatabdi/StudentProcess/exportDataForStudents" method="POST">
			...
			<table width="100%" border="0" style="border-color: #4b6a84;"
				...
				<thead>
					<tr>
						...
						<th title="click to sort" class="headerText">D.O.B</th>
				...
				<tbody>
					<c:forEach items="${searchStudentList}" var="Parents" varStatus="status">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataText"><fmt:formatDate type="date" value="${Parents.student.dateofbirth}" pattern="dd/MM/yyyy"/></td>
							...
							<td class="dataText"><img src="${Parents.student.studentpic}" alt="Student's Photo" style="width: 50px;height: 50px;"></td>
