<%-- 
    Document   : student_details_dc
    Created on : JUL 6, 2018, 10:39:24 AM
    Author     : Musaib
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" language="JavaScript" src="/brilliantgrammar/js/motionpack.js"></script>
        <link rel="stylesheet" href="/brilliantgrammar/css/datePicker/jquery-ui-1.8.18.custom.css">
        <link rel="stylesheet" href="/brilliantgrammar/css/graph/jquery.jqplot.css">
        ...
        <script type="text/javascript" src="/brilliantgrammar/js/datePicker/ui/jquery-ui-1.8.17.custom.js"></script>
        <script type="text/javascript" src="/brilliantgrammar/js/datePicker/ui/jquery.ui.dialog.js"></script>
        <script type="text/javascript" src="/brilliantgrammar/js/datePicker/ui/jquery.ui.autocomplete.js"></script>
        <script type="text/javascript" src="/brilliantgrammar/js/datePicker/ui/jquery.ui.core.js"></script>
        <script type="text/javascript" src="/brilliantgrammar/js/datePicker/ui/jquery.ui.widget.js"></script>
        <script type="text/javascript" src="/brilliantgrammar/js/datePicker/ui/jquery.ui.datepicker.js"></script>
        <script type="text/javascript" src="/brilliantgrammar/js/datePicker/ui/jquery.ui.accordion.js"></script>
        <script type="text/javascript" src="/brilliantgrammar/js/datePicker/ui/sliderAccess.js"></script>
        <script type="text/javascript" src="/brilliantgrammar/js/datePicker/ui/jquery-ui-timepicker-addon.js"></script>

        <script  type="text/javascript" src="/brilliantgrammar/js/datePicker/ui/jquery.ui.position.js"></script>
        <script type="text/javascript" src="/brilliantgrammar/js/datePicker/ui/jquery.ui.mouse.js"></script>
        <script type="text/javascript" src="/brilliantgrammar/js/datePicker/ui/jquery.ui.draggable.js"></script>
        <script type="text/javascript" src="/brilliantgrammar/js/datePicker/ui/jquery.ui.resizable.js"></script>
        <script type="text/javascript" src="/brilliantgrammar/js/graph/jquery.jqplot.js"></script>
        <script  type="text/javascript" src="/brilliantgrammar/js/graph/plugins/jqplot.dateAxisRenderer.min.js"></script>
        <script type="text/javascript" src="/brilliantgrammar/js/graph/plugins/jqplot.barRenderer.min.js"></script>
        <script type="text/javascript" src="/brilliantgrammar/js/graph/plugins/jqplot.categoryAxisRenderer.min.js"></script>
        <script type="text/javascript" src="/brilliantgrammar/js/graph/plugins/jqplot.cursor.min.js"></script>
        <script type="text/javascript" src="/brilliantgrammar/js/graph/plugins/jqplot.highlighter.min.js"></script>
        <script type="text/javascript" src="/brilliantgrammar/js/graph/plugins/jqplot.dragable.min.js"></script>
        <script type="text/javascript" src="/brilliantgrammar/js/graph/plugins/jqplot.trendline.min.js"></script>
        ...
        <script type="text/javascript">
            ...
            function updateStudent(){
                ...
                form1.action="/brilliantgrammar/StudentProcess/updateStudentDetails?id=<c:out value='${student.sid}'/>&urlbranchid=<c:out value='${student.branchid}'/>";
                form1.submit();
            }
...
%>
    <body background="/images/bg.jpg" onload="checkUsertype();">
        ...
        <form  method="post" id="form1" modelAttribute="student" enctype="multipart/form-data">
            ...
            <div id="accordion" style="width: 100%;height: 100%">
                ...
                <div>
                    ...
                    <img src="data:image;base64,<c:out value="${student.studentpic}"/>" alt="Student's Photo" style="width: 200px;height: 200px;">
                        ...
                        <tr>
                        <td width="25%"   class="alignLeft" height="50" >Medium of Instruction taken at the Pre-university</td>
                            <td width="25%" class="tablerows" >
                                <c:out default="" value="${student.degreedetails.pumediuminstruction}" />
                            </td>
                            
                            
                            <td width="25%"   class="alignLeft" height="50" >From Karnataka by Birth</td>
                            <td width="25%" class="tablerows" >
                                &nbsp;Yes<input
                         ...
                         <tr>
                        <td width="25%"   class="alignLeft" height="50" >Highest Public Examination passed</td>
                            <td width="25%" class="tablerows" >
                                <label> First appearance &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
                            ...
                            <td width="25%"   class="alignLeft" height="50" >Year</td>
                            <td width="25%" class="tablerows" >
                                <c:out default="" value="${student.degreedetails.exampassedyear}" />
                            </td>
                        </tr>
                        
                        <tr>
                        <td width="25%"   class="alignLeft" height="50" >Reg. No.</td>
                            <td width="25%" class="tablerows" >
                                <c:out default="" value="${student.degreedetails.exampassedregno}" />
                            </td>
                            
                            
                            <td width="25%"   class="alignLeft" height="50" >Result With Class</td>
                            <td width="25%" class="tablerows" >
                                <c:out default="" value="${student.degreedetails.exampassedresultwithclass}" />
                            </td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <tr>
                            <td  width="25%"  class="alignLeft" height="50">Subjects Offered at the Qualifying Examination
                            </td>
                            <td width="25%" class="tablerows">
                                 Part-I : <c:out default="" value="${student.degreedetails.subjectsqualifingexampartone}" /><br>
                                Part-II : <c:out default="" value="${student.degreedetails.subjectsqualifingexamparttwo}" />
                            </td>
                            
                            <td  width="25%"  class="alignLeft" height="50" >Subjects Proposed in Degree Course
                            </td>
                            <td width="25%" class="tablerows" >
                                 Part-I :  <c:out default="" value="${student.degreedetails.subjectsdegreecoursepartone}" /> <br>
                                Part-II :  <c:out default="" value="${student.degreedetails.subjectsdegreecourseparttwo}" />
                            </td>
                        </tr>
						...
						<tr>
							<td width="25%"  class="alignLeft" height="50">Whether the following certificates are attached &nbsp;</td>
							<td width="25%" class="tablerows" style="font-size: 11px;">
							<input
								...
								/>Income Certificate Original with Two Copies <br><br><input
								...
								/>Migration Certificate(In case the student is from other state)<br><br><input
							...
							<td width="25%"  class="alignLeft" height="50">Institution Last Attended &nbsp;<br><br><br> Proficiency in Games & Sports &nbsp; <br><br><br> 
							Extra Curricular Activities &nbsp;</td>
							<td width="25%" class="tablerows" >
							 <c:out default="" value="${student.schoollastattended}" />
									
							<br><br><br>
									<c:out default="" value="${student.degreedetails.proficiencysports}" /><br><br><br>
						...
						<tr>
                            ...
                            <td width="25%" class="tablerows" >
                             ...
                             <td  width="25%"  class="alignLeft" height="50">Are you an Employee? If yes, have you produced the written permission from the Employer
                            </td>
                            <td width="25%" class="tablerows">
                                &nbsp;Yes<input
                    ...
                    <tbody>
                        <c:forEach items="${receiptinfo}" var="receiptinfo">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" target="_blank" href="/brilliantgrammar/FeesCollection/ViewDetails?id=<c:out value='${receiptinfo.receiptnumber}'/>&sid=<c:out value='${student.sid}'/>">View Details</a></td>
        ...
        <script>
            ...
            function Cancel(){
                var form1=document.getElementById("form1");
                form1.action="/brilliantgrammar/StudentProcess/ViewAll";
                form1.submit();
            }
        </script>
    </body>
