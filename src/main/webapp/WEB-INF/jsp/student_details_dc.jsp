    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function updateStudent(){
                ...
                form1.action="/alirfan/StudentProcess/updateStudentDetails?id=<c:out value='${student.sid}'/>&urlbranchid=<c:out value='${student.branchid}'/>";
                form1.submit();
            }
...
%>
    <body background="/images/bg.jpg" onload="checkUsertype();">
        ...
        <script>
            ...
            function Cancel(){
                var form1=document.getElementById("form1");
                form1.action="/alirfan/StudentProcess/ViewAll";
                form1.submit();
            }
        </script>
    </body>
