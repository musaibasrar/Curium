...
<html>
    <head>
        ...
        <script type="text/javascript" language="JavaScript" src="/patriswamy/js/motionpack.js"></script>
        ...
        <script type="text/javascript" src="/patriswamy/js/graph/plugins/jqplot.categoryAxisRenderer.min.js"></script>
        <script type="text/javascript" src="/patriswamy/js/graph/plugins/jqplot.cursor.min.js"></script>
        <script type="text/javascript" src="/patriswamy/js/graph/plugins/jqplot.highlighter.min.js"></script>
        <script type="text/javascript" src="/patriswamy/js/graph/plugins/jqplot.dragable.min.js"></script>
        <script type="text/javascript" src="/patriswamy/js/graph/plugins/jqplot.trendline.min.js"></script>
        ...
        <script type="text/javascript">
            ...
            function updateStudent(){
                ...
                form1.action="/patriswamy/StudentProcess/updateStudentDetails?id=<c:out value='${student.sid}'/>&urlbranchid=<c:out value='${student.branchid}'/>";
                form1.submit();
            }
...
%>
    <body background="/images/bg.jpg" onload="checkUsertype();">
                    ...
                    <tbody>
                        <c:forEach items="${receiptinfo}" var="receiptinfo">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" target="_blank" href="/patriswamy/FeesCollection/ViewDetails?id=<c:out value='${receiptinfo.receiptnumber}'/>&sid=<c:out value='${student.sid}'/>">View Details</a></td>
        ...
        <script>
            ...
            function Cancel(){
                var form1=document.getElementById("form1");
                form1.action="/patriswamy/StudentProcess/ViewAll";
                form1.submit();
            }
        </script>
    </body>
