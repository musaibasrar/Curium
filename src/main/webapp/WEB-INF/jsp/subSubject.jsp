...
<script type="text/javascript">
	function addSubSubjects() {
		...
		form1.action = "/school/SubjectDetailsProcess/addSubSubject";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/school/SubjectDetailsProcess/deleteMultipleSubSubject";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/school/SubjectDetailsProcess/deleteMultipleSubSubject" method="POST">
		<%
