...
<script type="text/javascript">
	function addSubSubjects() {
		...
		form1.action = "/beaconias/SubjectDetailsProcess/addSubSubject";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/beaconias/SubjectDetailsProcess/deleteMultipleSubSubject";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/beaconias/SubjectDetailsProcess/deleteMultipleSubSubject" method="POST">
		<%
