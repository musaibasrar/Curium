	...
	<form method="post" class="bodymargin">
		...
		<table width="100%" style="border-collapse: collapse;">
			<tr>
				...
				<img src="/noman/images/noman.png" width="90" height="90"/>
				</td> 
				...
				<label class="addressLine" style="padding-left: 50px;">Contact:&nbsp;${branchcontact} </label><br>
				<label class="addressLine" style="padding-left: 70px;">Duplicate Receipt</label>
				</td>
			</tr>
		</table>
...
<TABLE  width="100%" border="1" style="border-collapse:collapse;">
		...
		<!-- <td><img src="/noman/images/nomanpaytm.jpeg" width="70" height="65"/></td> -->
