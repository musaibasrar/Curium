	...
	<div style="border: 1px solid;border-radius: 15px">
		...
		<table width="100%" style="border-collapse: collapse;">
			<tr>
				...
				<label class="addressLine" style="padding-left: 150px;">Contact:&nbsp;${branchcontact} </label><br>
				<label class="addressLine" style="padding-left: 170px;">Duplicate Receipt </label>
				</td>
			</tr>
</table>
