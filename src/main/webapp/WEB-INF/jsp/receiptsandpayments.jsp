...
<script type="text/javascript">
	...
	function getRPStatement(){
		...
		form1.action = "/orion/AccountProcess/rpStatement";
		form1.method = "POST";
		form1.submit();
	}
				...
				<tfoot>
					<tr>
						<td class="footerTD" colspan="3">
							<a id="print" href="/orion/AccountProcess/rpStatementPrint?fromdate=<c:out value="${fromdate}" />&todate=<c:out value="${todate}"/>">Print</a>
							</td>
