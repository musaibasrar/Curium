...
<script type="text/javascript">
	...
	function getRPStatement(){
		...
		form1.action = "/brilliantgrammar/AccountProcess/rpStatement";
		form1.method = "POST";
		form1.submit();
	}
		...
		<div style="overflow: scroll; height: 600px">
			...
			<table width="50%" style="border-color: #4b6a84;float: left;">
				...
				<tbody>
						<tr><td><br/></td></tr>
						<tr class="trClass">
							<td class="dataTextInActive" style="text-align: left;height: 60px;width:40%">Sign Administrator</td>
					   ...
					   <tr class="trClass">
							<td class="dataTextInActive" style="text-align: left;height: 60px;width:40%">Sign Principal</td>
							<td class="dataTextInActive" style="text-align: center;">:</td>
							<td class="dataTextInActive" style="text-align: left" >-----------------------------</td>
				...
				<tfoot>
					<tr>
						<td class="footerTD" colspan="3">
							<a id="print" href="/brilliantgrammar/AccountProcess/rpStatementPrint?fromdate=<c:out value="${fromdate}" />&todate=<c:out value="${todate}"/>">Print</a>
							</td>
