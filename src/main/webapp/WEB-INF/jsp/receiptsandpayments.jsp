...
<script type="text/javascript">
	...
	function getRPStatement(){
		...
		form1.action = "/school/AccountProcess/rpStatement";
		form1.method = "POST";
		form1.submit();
	}
				...
				<tfoot>
					<tr>
						<td class="footerTD" colspan="3">
							<a id="print" href="/school/AccountProcess/rpStatementPrint?fromdate=<c:out value="${fromdate}" />&todate=<c:out value="${todate}"/>">Print</a>
							</td>
