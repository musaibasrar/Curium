    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 45px;">
								...
								<a target="mainFrame" href="/shatabdi/welcome" >
								<img src="/shatabdi/images/curiumheader.png" width="112" height="41"/>
								</a>
								</td>
								
							<!-- <td align="left"><img src="/shatabdi/images/shatabdiheader.png"
								style="width: 200px; height: 20px;" /></td> -->
							<td><a target="leftFrame" href="/shatabdi/left_accountant"> <img
...
<!-- 
							...
							<td ><a target="leftFrame" href="/shatabdi/leftsettings_accountant">
							...
							<td ><!-- <a target="mainFrame" href="/shatabdi/sendsms"><img
								...
								<a target="leftFrame" href="/shatabdi/reports_accountant"><img
