...
<script type="text/javascript">
	function search() {
		...
		form1.action="/tajacc/AccountProcess/viewNextVoucher";
		form1.method = "POST";
		form1.submit();
	...
	function cancelVoucher(){
		...
		if(confirm('Are you sure, you want to cancel the Journal Voucher?')){
			var form1 = document.getElementById("form1");
			form1.action="/tajacc/AccountProcess&voucherType=4/cancelVoucher";
			form1.method = "POST";
			form1.submit();	
		}
				...
				<tbody>
					<c:forEach items="${vouchertransactions}" var="vouchertransactions">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataText"><fmt:formatDate value="${vouchertransactions.key.transactiondate}" pattern="dd/MM/yyyy"/></td>
									<td class="dataText"><c:out
