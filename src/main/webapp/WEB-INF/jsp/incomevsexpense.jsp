...
<script type="text/javascript">
	function searchIncomeExpense() {
		...
		form1.action = "/jihtel/AccountProcess/searchIncomeExpense";
		form1.method = "POST";
		form1.submit();
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/jihtel/AccountProcess/printIncomevsExpense";
		form1.method = "POST";
		form1.submit();
}
...
%>
<body>
	<form id="form1" action="/jihtel/AccountProcess/exportDataForIncomeVsExpense" method="POST">
