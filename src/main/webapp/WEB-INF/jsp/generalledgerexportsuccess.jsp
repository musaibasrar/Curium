<%-- 
    Document   : General Ledger export success
...
<html>
    <head>
        ...
        <title>General Ledger Export Success</title>
...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="/shatabdi/AccountProcess/downloadGeneralLedgerReport";
                form1.submit();
            }
        </script>
</head>
...
%>
    ...
    <table height="462" class="tableCSS"  >
      <tr>
        <td height="50" align="center" valign="middle"><p class="style1"> General Ledger Report has been exported successfully</p>
        </td>
