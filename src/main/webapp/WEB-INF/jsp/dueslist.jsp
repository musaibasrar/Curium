...
<script src="/readmodelschool/js/bootstrap.min.js"></script>
<script type="text/javascript" src="/readmodelschool/js/datetimepicker_css.js"></script>
<link href="/readmodelschool/css/select2.min.css" rel="stylesheet" />
<script src="/readmodelschool/js/select2.min.js"></script>
<script type="text/javascript">

function generateDueReport() {
	var form1 = document.getElementById("form1");
	form1.action = "/readmodelschool/MessItemsMoveProcess/generateDueReport";
	form1.method = "POST";
	form1.submit();
}
...
$(function(){
    ...
    function deleteRecords(){
        ...
        var form1=document.getElementById("form1");
        form1.action="/readmodelschool/DiaryProcess/deleteRecord";
        form1.method = "POST";
       form1.submit();
 ...
 <script type="text/javascript">
            ...
            function openPopup(id,date,studentName,branchreceiptnumber,due){
        			...
        			xmlHttp.open("GET", "/readmodelschool/stockentry/dueMrvDetails?date="+date+"&studentName="+studentName+"&branchreceiptnumber="+branchreceiptnumber+"&due="+due+"",true);
        			xmlHttp.send(null);  
        ...
        <script type="text/javascript">
            ...
            $(function() {
              ...
              function generatebill(itemsGrandNetDueAmount,dueid){
            	...
            	var form1 = document.getElementById("form1");
        		form1.action="/readmodelschool/MessItemsMoveProcess/paydue?itemsGrandNetDueAmount="+dueAmountValue+"&dueid="+dueidValue+"";
        		form1.method = "POST";
        		form1.submit();
...
$(function(){
    ...
    function payDue(){
        ...
        var form1=document.getElementById("form1");
        form1.action="/readmodelschool/MessItemsMoveProcess/paydue";
        form1.method = "POST";
       form1.submit();
 ...
 <div align="center">
             <%--For displaying Previous link except for the 1st page --%>
                <c:if test="${currentPage != 1}">
                    <td><a style="color: #4B6A84;font-size: 12px" href="/readmodelschool/DiaryProcess/viewdiarystudent?page=${currentPage - 1}">Previous</a></td>
                </c:if>
                    ...
                    <tr>
                        <c:forEach begin="1" end="${noOfPages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <td style="color: black;font-weight:bold;font-size: 15px "><a style="color: #4B6A84" href="/readmodelschool/DiaryProcess/viewdiarystudent?page=${i}">${i}</a></td>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                    </tr>
                ...
                <c:if test="${currentPage lt noOfPages}">
                    <td ><a style="color: #4B6A84;font-size: 12px" href="/readmodelschool/DiaryProcess/viewdiarystudent?page=${currentPage + 1}">Next</a></td>
                </c:if>
                    </div>
