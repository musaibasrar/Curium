...
function generateDueReport() {
	...
	form1.action = "/divine/MessItemsMoveProcess/generateDueReport";
	form1.method = "POST";
	form1.submit();
}
...
$(function(){
 ...
 <script type="text/javascript">
            ...
            function openPopup(id,date,studentName,branchreceiptnumber,due){
        			...
        			xmlHttp.open("GET", "/divine/stockentry/dueMrvDetails?date="+date+"&studentName="+studentName+"&branchreceiptnumber="+branchreceiptnumber+"&due="+due+"",true);
        			xmlHttp.send(null);  
        ...
        <script type="text/javascript">
            ...
            $(function() {
              ...
              function generatebill(itemsGrandNetDueAmount,dueid){
            	...
            	var form1 = document.getElementById("form1");
        		form1.action="/divine/MessItemsMoveProcess/paydue?itemsGrandNetDueAmount="+dueAmountValue+"&dueid="+dueidValue+"";
        		form1.method = "POST";
        		form1.submit();
...
$(function(){
    ...
    function payDue(){
        ...
        var form1=document.getElementById("form1");
        form1.action="/divine/MessItemsMoveProcess/paydue";
        form1.method = "POST";
       form1.submit();
