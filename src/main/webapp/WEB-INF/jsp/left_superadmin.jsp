                ...
                <table style=" border-collapse: collapse;width: 100%">
                    <tr>
                        <td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
                            <a target="mainFrame" href="/littleflower/UserProcess/superDashboard" style="font-size: 12px;">Super User Dashboard</a>
                        </td>
                    </tr>
                </table>
            </div>
           ...
           <!--   <h5 style="font-size: 12px"><a href="#" >H.R.</a></h5>
        	...
        	<div style="padding-left: 0px;padding-right: 0px;">
            	...
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;">
            				 <a target="mainFrame" href="/littleflower/MessItemsProcess/purchaseItems" style="font-size: 12px;">Receive</a>
            			</td>
            		</tr>
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
