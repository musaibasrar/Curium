...
%>
    <body onload="StartClock()" onunload="KillClock()">
        ...
        <div id="container" style="width: 100%" >
            ...
            <div>
                <a target="mainFrame" href="/newexcellent/StudentProcess/viewAllSuperAdmin" style="font-size: 12px;">View All</a><br/>
            </div>
            ...
            <div>
                ...
                <a target="mainFrame" href="/newexcellent/ClassProcess/viewGraduated" >Graduated Students</a><br/>
                <a target="mainFrame" href="/newexcellent/ClassProcess/viewDropped" >Dropped Out Students</a><br/>
                <a target="mainFrame" href="/newexcellent/ClassProcess/viewLeftOut" >Left Out Students</a><br/>
            </div>
            ...
            <div >
                <a target="mainFrame" href="/newexcellent/sendsms_superadmin" style="font-size: 12px;">SMS</a><br/>
            </div>
