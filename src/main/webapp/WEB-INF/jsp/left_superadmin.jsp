...
%>
    <body onload="StartClock()" onunload="KillClock()">
        ...
        <div id="container" style="width: 100%" >
            ...
            <div>
                <a target="mainFrame" href="/lflower/StudentProcess/viewAllSuperAdmin" style="font-size: 12px;">View All</a><br/>
            </div>
            ...
            <div>
                ...
                <a target="mainFrame" href="/lflower/ClassProcess/viewGraduated" >Graduated Students</a><br/>
                <a target="mainFrame" href="/lflower/ClassProcess/viewDropped" >Dropped Out Students</a><br/>
                <a target="mainFrame" href="/lflower/ClassProcess/viewLeftOut" >Left Out Students</a><br/>
            </div>
            ...
            <div >
                <a target="mainFrame" href="/lflower/sendsms_superadmin" style="font-size: 12px;">SMS</a><br/>
            </div>
