...
%>
    <body onload="StartClock()" onunload="KillClock()">
        ...
        <div id="container" style="width: 100%" >
            ...
            <div>
                <a target="mainFrame" href="/shadaan/StudentProcess/viewAllSuperAdmin" style="font-size: 12px;">View All</a><br/>
            </div>
            ...
            <div>
                ...
                <a target="mainFrame" href="/shadaan/ClassProcess/viewGraduated" >Graduated Students</a><br/>
                <a target="mainFrame" href="/shadaan/ClassProcess/viewDropped" >Dropped Out Students</a><br/>
                <a target="mainFrame" href="/shadaan/ClassProcess/viewLeftOut" >Left Out Students</a><br/>
            </div>
            ...
            <div >
                <a target="mainFrame" href="/shadaan/sendsms_superadmin" style="font-size: 12px;">SMS</a><br/>
            </div>
