...
<html>
    <head >
        ...
        <title>Student Id Card puc</title> 
	...
	text-align: center;
        ...
        <script type="text/javascript">
            ...
            function updateContact() {
                ...
                form1.action = "/gnyanganga/PersonalProcess/updateContactDetails?id=1";
                form1.submit();
            }
...
<style>
    ...
    <body class="bodymargin">
        ...
        <form action="/gnyanganga/" method="post" id="form1" class="bodymargin">
 ...
 <table align="center">
 <tr>
 <td style="border-radius: 5px;text-align: center;font-weight: bold;">STUDENT ID CARD
 </td>
 </tr>
 <tr>
 <td style="text-align: center;">
 <img src="data:image;base64,<%= request.getSession().getAttribute("studentpic" + i + "")%>" style="height:78px;width:60px;border: 1px solid black;border-radius: 5px;" alt="Photo" />
 </td>
<%--  <td>&nbsp;&nbsp;
   ...
   <% i = i + 1;%>
                   ...
                   <table  width="70%"  id="table11" align="left">
                    <tr>
                        ...
                        <td>
                            <button id="print" type="button" style="background-image: url(/gnyanganga/images/print.jpg);width: 63px;height: 60px" onclick="window.print();
