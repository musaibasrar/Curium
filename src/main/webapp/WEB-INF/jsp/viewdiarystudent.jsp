...
function viewStudentDiary(sid){
    var form1=document.getElementById("form1");
   form1.action="/bright/StudentDiaryProcess/ViewDiaryDetailsParent?id="+sid+"";
   form1.submit();
}                  
...
<div class="container mt-5" style="max-width:38%;">
...
<div class="container" style="max-width:38%;">
 <%--For displaying Previous link except for the 1st page --%>
                ...
                <c:forEach begin="1" end="${noOfPages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                <td><a style="color: #4B6A84" href="/bright/DiaryProcess/viewdiarystudent?page=${i}">${i}</a></td>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                </tr>
