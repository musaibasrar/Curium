...
function viewStudentDiary(sid){
    var form1=document.getElementById("form1");
   form1.action="/greatindiaacademy/StudentDiaryProcess/ViewDiaryDetailsParent?id="+sid+"";
   form1.submit();
}                  
 ...
 <%--For displaying Previous link except for the 1st page --%>
                ...
                <c:forEach begin="1" end="${noOfPages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                <td><a style="color: #4B6A84" href="/greatindiaacademy/DiaryProcess/viewdiarystudent?page=${i}">${i}</a></td>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                </tr>
