...
$(function(){
   /* $("#delete").button({
    ...
    function deleteRecords(){
        ...
        form1.action="/madina/DiaryProcess/deleteRecord";
        form1.method = "POST";
       form1.submit();
...
function viewStudentDiary(sid){
    var form1=document.getElementById("form1");
   form1.action="/madina/StudentDiaryProcess/ViewDiaryDetailsParent?id="+sid+"";
   form1.submit();
}                  
...
<div class="container" style="max-width:100%;">
 <%--For displaying Previous link except for the 1st page --%>
                <c:if test="${currentPage != 1}">
                    <td><a style="color: #4B6A84;font-size: 12px" href="/madina/DiaryProcess/viewdiarystudent?page=${currentPage - 1}">Previous</a></td>
                </c:if>
                ...
                <c:forEach begin="1" end="${noOfPages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                <td><a style="color: #4B6A84" href="/madina/DiaryProcess/viewdiarystudent?page=${i}">${i}</a></td>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                </tr>
                ...
                <c:if test="${currentPage lt noOfPages}">
                    <td ><a style="color: #4B6A84;font-size: 12px" href="/madina/DiaryProcess/viewdiarystudent?page=${currentPage + 1}">Next</a></td>
                </c:if>
</div>
</form>
	</body></html>