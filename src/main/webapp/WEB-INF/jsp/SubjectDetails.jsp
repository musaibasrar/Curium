...
<script type="text/javascript">
	function addSubjects() {
		...
		form1.action = "/alirfan/SubjectDetailsProcess/addSubject";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/alirfan/SubjectDetailsProcess/deleteMultiple";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/alirfan/SubjectDetailsProcess/deleteMultiple" method="POST">
		<%
