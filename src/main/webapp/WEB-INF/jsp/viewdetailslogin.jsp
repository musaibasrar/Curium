    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function updateLoginStaff(){
                ...
                form1.action="/greatindiaacademy/LoginProcess/updateLoginDetails?id=<c:out value='${logindetail.lid}'/>";
                form1.submit();
            }
                ...
                .click(function() {
                    Cancel();
                            ...
                            <script type="text/javascript">
                                ...
                                function Cancel(){
                                    var form1=document.getElementById("form1");
                                    form1.action="/greatindiaacademy/SponserProcess/ViewAllSponsor";
                                    form1.submit();
                                }
                            </script>
