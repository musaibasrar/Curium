...
-->
        ...
        <script type="text/javascript">
            ...
            function ViewAll(){
                ...
                form1.action="/brightschool/PersonalProcess/viewAll";
                form1.submit();
            }
        </script>
</head>
...
%>
    <body background="/images/bg.jpg" >
        ...
        <form action="/brightschool/AttendanceProcess/uploadAttendanceFile" method="post" enctype="multipart/form-data">
