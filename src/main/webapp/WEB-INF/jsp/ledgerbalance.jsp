...
<script type="text/javascript">
	...
	function printRecords() {
		...
		form1.action = "/jihtel/AccountProcess/printLedgerBalances";
		form1.method = "POST";
		form1.submit();
}
	...
	<form id="form1">
		...
		<div style="overflow: scroll; height: 600px">
			...
			<table width="100%">
				<tr>
					<td class="headerTD">
						<label style="text-decoration: underline;">Ledger Balances</label><br>
					</td>
				</tr>
			...
			<table width="100%" border="0" style="border-color: #4b6a84;"
				...
				<thead>
					<tr>
						...
						<th title="click to sort" class="headerText">Ledger&nbsp;</th>
				...
				<fmt:setLocale value="en_IN" scope="session"/>
					<c:forEach items="${ledgerbalances}" var="ledgerbalances" varStatus="status">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataTextInActive"><c:out value="${ledgerbalances.accountDetails.accountname}" />
							</td>
