...
<script src="/dolphin/js/echarts/echarts.min.js"></script>
<style>
body {
...
<c:forEach items="${markssheetlist}" var="Parents" varStatus="studentStatus">
	...
	<div class="container">
		...
		<div class="header">
			...
			<div class="schoolbox">
				...
				<div class="logo">
					<img border="0" style="vertical-align: text-bottom;height: 80px;width: 90px;" alt="ideoholic" src="/dolphin/images/dolphin.png">
				</div>
		
				<div class="schoolname">
					<h3 style="font-size: 40px;color: #971d1d;">${branchname}</h3>
					<!-- <img border="0" style="vertical-align: text-bottom;height: 30px;width: 200px;" alt="ideoholic" src="/dolphin/images/dolphinschoolname.png"> -->
					<div>
	...
	<!-- <div class="footer">
    <img src="/dolphin/images/hmsign.png" class="signature" width="200" height="60"/>
