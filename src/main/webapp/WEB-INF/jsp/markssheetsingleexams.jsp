...
<c:forEach items="${markssheetlist}" var="Parents" varStatus="studentStatus">
		...
		<div class="header">
			...
			<div class="schoolbox">
				...
				<div class="schoolname">
					...
					<!-- <img border="0" style="vertical-align: text-bottom;height: 30px;width: 200px;" alt="ideoholic" src="/iqraschool/images/iqraschoolschoolname.png"> -->
					<div>
	...
	<!-- <div class="footer">
    <img src="/iqraschool/images/hmsign.png" class="signature" width="200" height="60"/>
