...
<c:forEach items="${markssheetlist}" var="Parents" varStatus="studentStatus">
	...
	<div class="container">
		...
		<div class="header">
			...
			<div class="schoolbox">
				...
				<div class="logo">
					<img border="0" style="vertical-align: text-bottom;height: 80px;width: 90px;" alt="ideoholic" src="/readmodelschool/images/readmodel.png">
				</div>
		
				<div class="schoolname">
					<h3 style="font-size: 40px;color: #971d1d;">Little Flower Public School</h3>
					<!-- <img border="0" style="vertical-align: text-bottom;height: 30px;width: 200px;" alt="ideoholic" src="/readmodelschool/images/readmodelschoolname.png"> -->
					<div>
	...
	<!-- <div class="footer">
    <img src="/readmodelschool/images/hmsign.png" class="signature" width="200" height="60"/>
