...
<c:forEach items="${markssheetlist}" var="Parents" varStatus="studentStatus">
	...
	<div class="container">
		...
		<div class="header">
			...
			<div class="schoolbox">
				...
				<div class="logo">
					<img border="0" style="vertical-align: text-bottom;height: 80px;width: 90px;" alt="ideoholic" src="/sac/images/sac.png">
				</div>
	...
	<!-- <div class="footer">
    <img src="/sac/images/hmsign.png" class="signature" width="200" height="60"/>
