...
<script type="text/javascript">
	function searchByDate() {
		...
		form1.action = "/readmodelschool/FeesCollection/searchByDateFeesCollectionCategory";
		form1.method = "POST";
		form1.submit();
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/readmodelschool/FeesCollection/searchByDateFeesCollectionCategoryPrint";
		form1.method = "POST";
		form1.submit();
	}
