...
<script type="text/javascript">
	function searchByDate() {
		...
		form1.action = "/orion/FeesCollection/searchByDateFeesCollectionCategory";
		form1.method = "POST";
		form1.submit();
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/orion/FeesCollection/searchByDateFeesCollectionCategoryPrint";
		form1.method = "POST";
		form1.submit();
	}
		...
		<div style="overflow: scroll; height: 600px">
			<table width="100%">
				...
				<fmt:setLocale value="en_IN" scope="session"/>
					...
					<tr>
						<td class="dataText">Total /readmodelschool Paid by Cash</td>
						<td class="dataText">${feesbycashotherfees}</td>
					</tr>
					<tr>
						<td class="dataText">Total /readmodelschool Paid by Bank</td>
