...
<script src="/shaheen/js/Chart.js"></script>
...
<link rel="stylesheet" href="/shaheen/css/graph/jquery.jqplot.min.css">
  ...
  <script type="text/javascript" src="/shaheen/js/datePicker/jquery-1.7.1.js"></script>
        ...
        <script src="/shaheen/js/jquery.jqplot.min.js" ></script>
        <script src="/shaheen/js/graph/plugins/jqplot.pieRenderer.min.js" ></script> 
...
<script type="text/javascript">
	...
	function searchStudentAttendanceDetailsMonthly() {
		...
		form1.action = "/shaheen/AttendanceProcess/searchStudentAttendanceDetailsMonthly";
		form1.method = "POST";
		form1.submit();
	...
	function searchStudentAttendanceDetailsMonthlyGraph() {
		var form1 = document.getElementById("form1");
		form1.action = "/shaheen/AttendanceProcess/searchStudentAttendanceDetailsMonthlyGraph";
		form1.method = "POST";
		form1.submit();
	...
	function searchStudentAttendanceDetails() {
		var form1 = document.getElementById("form1");
		form1.action = "/shaheen/AttendanceProcess/searchStudentAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	...
	function updateRecords(){
		var form1 = document.getElementById("form1");
		form1.action = "/shaheen/AttendanceProcess/updateStudentAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	}
...
<jsp:useBean id="now" class="java.util.Date" scope="page" />
	<form id="form1" action="/shaheen/StampFeesProcess/applyFees" method="POST">
