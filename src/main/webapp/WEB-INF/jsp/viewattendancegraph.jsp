...
<script src="/vasu/js/Chart.js"></script>
...
<link rel="stylesheet" href="/vasu/css/graph/jquery.jqplot.min.css">
  ...
  <script type="text/javascript" src="/vasu/js/datePicker/jquery-1.7.1.js"></script>
        ...
        <script src="/vasu/js/jquery.jqplot.min.js" ></script>
        <script src="/vasu/js/graph/plugins/jqplot.pieRenderer.min.js" ></script> 
...
<script type="text/javascript">
	...
	function searchStudentAttendanceDetailsMonthly() {
		...
		form1.action = "/vasu/AttendanceProcess/searchStudentAttendanceDetailsMonthly";
		form1.method = "POST";
		form1.submit();
	...
	function searchStudentAttendanceDetailsMonthlyGraph() {
		var form1 = document.getElementById("form1");
		form1.action = "/vasu/AttendanceProcess/searchStudentAttendanceDetailsMonthlyGraph";
		form1.method = "POST";
		form1.submit();
	...
	function searchStudentAttendanceDetails() {
		var form1 = document.getElementById("form1");
		form1.action = "/vasu/AttendanceProcess/searchStudentAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	...
	function updateRecords(){
		var form1 = document.getElementById("form1");
		form1.action = "/vasu/AttendanceProcess/updateStudentAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	}
...
<jsp:useBean id="now" class="java.util.Date" scope="page" />
	<form id="form1" action="/vasu/StampFeesProcess/applyFees" method="POST">
	...
	font-weight: bolder;
        font-size: 15px;"> Temp Admn. No.: </label>
