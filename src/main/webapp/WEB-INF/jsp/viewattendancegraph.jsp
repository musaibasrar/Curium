...
<script src="/bbis/js/Chart.js"></script>
...
<link rel="stylesheet" href="/bbis/css/graph/jquery.jqplot.min.css">
  ...
  <script type="text/javascript" src="/bbis/js/datePicker/jquery-1.7.1.js"></script>
        ...
        <script src="/bbis/js/jquery.jqplot.min.js" ></script>
        <script src="/bbis/js/graph/plugins/jqplot.pieRenderer.min.js" ></script> 
...
<script type="text/javascript">
	...
	function searchStudentAttendanceDetailsMonthly() {
		...
		form1.action = "/bbis/AttendanceProcess/searchStudentAttendanceDetailsMonthly";
		form1.method = "POST";
		form1.submit();
	...
	function searchStudentAttendanceDetailsMonthlyGraph() {
		var form1 = document.getElementById("form1");
		form1.action = "/bbis/AttendanceProcess/searchStudentAttendanceDetailsMonthlyGraph";
		form1.method = "POST";
		form1.submit();
	...
	function searchStudentAttendanceDetails() {
		var form1 = document.getElementById("form1");
		form1.action = "/bbis/AttendanceProcess/searchStudentAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	...
	function updateRecords(){
		var form1 = document.getElementById("form1");
		form1.action = "/bbis/AttendanceProcess/updateStudentAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	}
...
<jsp:useBean id="now" class="java.util.Date" scope="page" />
	<form id="form1" action="/bbis/StampFeesProcess/applyFees" method="POST">
