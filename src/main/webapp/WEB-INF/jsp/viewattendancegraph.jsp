...
<script src="/stanley/js/Chart.js"></script>
...
<link rel="stylesheet" href="/stanley/css/graph/jquery.jqplot.min.css">
  ...
  <script type="text/javascript" src="/stanley/js/datePicker/jquery-1.7.1.js"></script>
        ...
        <script src="/stanley/js/jquery.jqplot.min.js" ></script>
        <script src="/stanley/js/graph/plugins/jqplot.pieRenderer.min.js" ></script> 
...
<script type="text/javascript" language="javascript"
	src="/stanley/js/dataTable/jquery.dataTables.js"></script>
<script type="text/javascript" src="/stanley/js/datePicker/ui/jquery.ui.core.js"></script>
<script type="text/javascript"
	src="/stanley/js/datePicker/ui/jquery.ui.widget.js"></script>
<script type="text/javascript"
	src="/stanley/js/datePicker/ui/jquery.ui.datepicker.js"></script>
<script type="text/javascript" src="/stanley/js/datePicker/ui/jquery.ui.tabs.js"></script>
<script type="text/javascript" src="/stanley/js/datePicker/ui/sliderAccess.js"></script>

<script type="text/javascript"
	src="/stanley/js/validation/jquery.ketchup.all.min.js"></script>
<script type="text/javascript"
	src="/stanley/js/datePicker/ui/jquery.ui.button.js"></script>
<script type="text/javascript"
	src="/stanley/js/datePicker/ui/jquery.ui.accordion.js"></script>
<script type="text/javascript"
	src="/stanley/js/datePicker/ui/jquery.effects.core.js"></script>
<script type="text/javascript"
	src="/stanley/js/datePicker/ui/jquery.ui.accordion.js"></script>
<script type="text/javascript"
	src="/stanley/js/datePicker/ui/jquery.effects.slide.js"></script>
<script type="text/javascript"
	src="/stanley/js/datePicker/ui/jquery.effects.bounce.js"></script>
<script type="text/javascript"
	src="/stanley/js/datePicker/ui/jquery.effects.clip.js"></script>
<script type="text/javascript"
	src="/stanley/js/datePicker/ui/jquery.effects.transfer.js"></script>
<script type="text/javascript"
	src="/stanley/js/datePicker/ui/jquery.effects.blind.js"></script>
<script type="text/javascript"
	src="/stanley/js/datePicker/ui/ScrollableGridPlugin.js"></script>
...
<script type="text/javascript">
	...
	function searchStudentAttendanceDetailsMonthly() {
		...
		form1.action = "/stanley/AttendanceProcess/searchStudentAttendanceDetailsMonthly";
		form1.method = "POST";
		form1.submit();
	...
	function searchStudentAttendanceDetailsMonthlyGraph() {
		var form1 = document.getElementById("form1");
		form1.action = "/stanley/AttendanceProcess/searchStudentAttendanceDetailsMonthlyGraph";
		form1.method = "POST";
		form1.submit();
	...
	function searchStudentAttendanceDetails() {
		var form1 = document.getElementById("form1");
		form1.action = "/stanley/AttendanceProcess/searchStudentAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	...
	function updateRecords(){
		var form1 = document.getElementById("form1");
		form1.action = "/stanley/AttendanceProcess/updateStudentAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	}
...
<jsp:useBean id="now" class="java.util.Date" scope="page" />
	<form id="form1" action="/stanley/StampFeesProcess/applyFees" method="POST">
