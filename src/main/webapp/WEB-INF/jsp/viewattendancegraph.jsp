<%--
    Document   : View Attendance Graph
...
<script src="/brilliantgrammar/js/Chart.js"></script>
...
<link rel="stylesheet" href="/brilliantgrammar/css/graph/jquery.jqplot.min.css">
  ...
  <script type="text/javascript" src="/brilliantgrammar/js/datePicker/jquery-1.7.1.js"></script>
        ...
        <script src="/brilliantgrammar/js/jquery.jqplot.min.js" ></script>
        <script src="/brilliantgrammar/js/graph/plugins/jqplot.pieRenderer.min.js" ></script> 
...
<link rel="stylesheet" href="/brilliantgrammar/css/validation/jquery.ketchup.css">
<script type="text/javascript" src="/brilliantgrammar/js/datePicker/jquery-1.7.1.js"></script>
<script type="text/javascript"
	src="/brilliantgrammar/js/datePicker/ui/jquery-ui-1.8.17.custom.js"></script>
<script type="text/javascript" language="javascript"
	src="/brilliantgrammar/js/dataTable/jquery.dataTables.js"></script>
<script type="text/javascript" src="/brilliantgrammar/js/datePicker/ui/jquery.ui.core.js"></script>
<script type="text/javascript"
	src="/brilliantgrammar/js/datePicker/ui/jquery.ui.widget.js"></script>
<script type="text/javascript"
	src="/brilliantgrammar/js/datePicker/ui/jquery.ui.datepicker.js"></script>
<script type="text/javascript" src="/brilliantgrammar/js/datePicker/ui/jquery.ui.tabs.js"></script>
<script type="text/javascript" src="/brilliantgrammar/js/datePicker/ui/sliderAccess.js"></script>

<script type="text/javascript"
	src="/brilliantgrammar/js/validation/jquery.ketchup.all.min.js"></script>
<script type="text/javascript"
	src="/brilliantgrammar/js/datePicker/ui/jquery.ui.button.js"></script>
<script type="text/javascript"
	src="/brilliantgrammar/js/datePicker/ui/jquery.ui.accordion.js"></script>
<script type="text/javascript"
	src="/brilliantgrammar/js/datePicker/ui/jquery.effects.core.js"></script>
<script type="text/javascript"
	src="/brilliantgrammar/js/datePicker/ui/jquery.ui.accordion.js"></script>
<script type="text/javascript"
	src="/brilliantgrammar/js/datePicker/ui/jquery.effects.slide.js"></script>
<script type="text/javascript"
	src="/brilliantgrammar/js/datePicker/ui/jquery.effects.bounce.js"></script>
<script type="text/javascript"
	src="/brilliantgrammar/js/datePicker/ui/jquery.effects.clip.js"></script>
<script type="text/javascript"
	src="/brilliantgrammar/js/datePicker/ui/jquery.effects.transfer.js"></script>
<script type="text/javascript"
	src="/brilliantgrammar/js/datePicker/ui/jquery.effects.blind.js"></script>
<script type="text/javascript"
	src="/brilliantgrammar/js/datePicker/ui/ScrollableGridPlugin.js"></script>
...
<script type="text/javascript" src="/brilliantgrammar/js/datetimepicker_css.js"></script>
<script type="text/javascript">
	...
	function searchStudentAttendanceDetailsMonthly() {
		...
		form1.action = "/brilliantgrammar/AttendanceProcess/searchStudentAttendanceDetailsMonthly";
		form1.method = "POST";
		form1.submit();
	...
	function searchStudentAttendanceDetailsMonthlyGraph() {
		var form1 = document.getElementById("form1");
		form1.action = "/brilliantgrammar/AttendanceProcess/searchStudentAttendanceDetailsMonthlyGraph";
		form1.method = "POST";
		form1.submit();
	...
	function searchStudentAttendanceDetails() {
		var form1 = document.getElementById("form1");
		form1.action = "/brilliantgrammar/AttendanceProcess/searchStudentAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	...
	function updateRecords(){
		var form1 = document.getElementById("form1");
		form1.action = "/brilliantgrammar/AttendanceProcess/updateStudentAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	}
...
<jsp:useBean id="now" class="java.util.Date" scope="page" />
	<form id="form1" action="/brilliantgrammar/StampFeesProcess/applyFees" method="POST">
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<label> <input
									...
									id="frommonthlyattendance" size="25" value="<fmt:formatDate type="date" value="${now}" pattern="dd/MM/yyyy"/>" data-validate="validate(required)"/>
							</label>	
							&nbsp;&nbsp;&nbsp;&nbsp;
							<label>To Date: &nbsp;</label>
							<label> <input
									name="tomonthlyattendance" type="text" class="textField"
									id="tomonthlyattendance" size="25" value="<fmt:formatDate type="date" value="${now}" pattern="dd/MM/yyyy"/>" data-validate="validate(required)"/>
							</label>
							</td>
	...
	font-weight: bolder;
	color: #5E87B0;
        font-size: 15px;">${admnograph}</label>
        <label style="color:#EB6000;font-family: Tahoma;
	font-weight: bolder;
	...
	font-weight: bolder;
	color: #5E87B0;
        font-size: 15px;">${studentnamegraph}</label>
    		<h1 align="center" class="headerTD">Student's Attendance Per Month</h1>
