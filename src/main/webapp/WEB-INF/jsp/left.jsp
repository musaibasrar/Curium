...
%>
    <body onload="StartClock()" onunload="KillClock()">
        ...
        <div id="container" style="width: 100%" >
            ...
            <div>
                <a target="mainFrame" href="/riyan/StudentProcess/viewAll" style="font-size: 12px;">View All</a><br/>
                <a target="mainFrame" href="/riyan/StudentProcess/addNew" style="font-size: 12px;">Add New</a><br/>
            </div>
            
            <h5 style="font-size: 12px"><a href="#">Attendance</a></h5>
            <div>
                <a target="mainFrame" href="/riyan/AttendanceProcess/viewAttendance" style="font-size: 12px;">View Attendance</a><br/>
                <a target="mainFrame" href="/riyan/attendancemark" style="font-size: 12px;">Mark Attendance</a><br/>
                <a target="mainFrame" href="/riyan/attendanceexport" style="font-size: 12px;">Export Attendance</a><br/>
            </div>
            
            <h5 style="font-size: 12px"><a href="#">Staff</a></h5>
            <div>
                <a target="mainFrame" href="/riyan/EmployeeProcess/viewAllEmployee" style="font-size: 12px;">View All</a><br/>
                <a target="mainFrame" href="/riyan/EmployeeProcess/addEmployeePage" style="font-size: 12px;">Add Staff</a><br/>
				<a target="mainFrame" href="/riyan/AttendanceProcess/viewAttendanceStaff" style="font-size: 12px;">View Attendance</a><br/>
				<a target="mainFrame" href="/riyan/AttendanceProcess/attendanceMarkStaff" style="font-size: 12px;">Mark Attendance</a><br/>
				<a target="mainFrame" href="/riyan/AttendanceProcess/attendanceExportViewStaff" style="font-size: 12px;">Export Attendance</a><br/>
            </div>

            <h5 style="font-size: 12px"><a href="#">FEES</a></h5>
            
            <div>
                <a target="mainFrame" href="/riyan/FeesProcess/feesCollect" style="font-size: 12px;">Fees Collect</a><br/>
				<a target="mainFrame" href="/riyan/feesstructure" style="font-size: 12px;">Fees Structure</a><br/>                
				<a target="mainFrame" href="/riyan/feesCollectionDetails" style="font-size: 12px;">Fees Details</a><br/>
            </div> 
            
            <h5 style="font-size: 12px"><a href="#">Exams</a></h5>
            
            <div>
                <a target="mainFrame" href="/riyan/marksentry" style="font-size: 12px;">Enter Marks</a><br/>
                <a target="mainFrame" href="/riyan/MarksDetailsProcess/getSubjectsExams" style="font-size: 12px;">View Marks</a><br/>
            	<a target="mainFrame" href="/riyan/progressreport" style="font-size: 12px;">Generate Report</a><br/>
           		<a target="mainFrame" href="/riyan/MarksDetailsProcess/getGraphicalReportData" style="font-size: 12px;">Graphical Report</a><br/>
            </div> 
            
            <h5 style="font-size: 12px"><a href="#" >Administration</a></h5>
            <div>
                <a target="mainFrame" href="/riyan/AdminProcess/viewAllExpenses" style="font-size: 12px;">Expenses</a><br/>
            ...
            <div>
                <a target="mainFrame" href="/riyan/AdvanceSearch" style="font-size: 12px;">Search</a><br/>
            ...
            <div>
                <a target="mainFrame" href="/riyan/Promotion" style="font-size: 12px;">Promotions</a><br/>
            ...
            <div>
                <a target="mainFrame" href="/riyan/StudentProcess/archiveViewAll" >Archive Students</a><br/>
            </div>

            <h5 style="font-size: 12px"><a href="#" >Extras</a></h5>
            <div >
                <a target="mainFrame" href="/riyan/Backup&Restore" style="font-size: 12px;">Backup</a><br/>
                <a target="mainFrame" href="/riyan/changePassword" style="font-size: 12px;">Change Password</a><br/>
                <a target="mainFrame" href="/riyan/uploadattendance" style="font-size: 12px;">upload attendance file</a><br/>
            </div>
            
            
            <h5 style="font-size: 12px"><a href="#" >Generate Cards</a></h5>
            <div >
                <a target="mainFrame" href="/riyan/generateids" style="font-size: 12px;">Generate IDs</a><br/>
            </div>
            
            <h5 style="font-size: 12px"><a href="#" >Documents</a></h5>
            <div >
                <a target="mainFrame" href="/riyan/studentsdetailsreports" style="font-size: 12px;">Student Details</a><br/>
                <a target="mainFrame" href="/riyan/DocumentsProcess/admissionAbstract" style="font-size: 12px;">Admission Abstract</a><br/>
                <a target="mainFrame" href="/riyan/studentsdetailsbonafide" style="font-size: 12px;">Bonafide Certificate</a><br/>
                <a target="mainFrame" href="/riyan/DocumentsProcess/transferCertificate" style="font-size: 12px;">Transfer Certificate</a><br/>
                <a target="mainFrame" href="/riyan/ExamDetailsProcess/generateHallTicket" style="font-size: 12px;">Hall Ticket</a><br/>
                <a target="mainFrame" href="/riyan/PeriodProcess/generateTimeTable" style="font-size: 12px;">Time Table</a><br/>
            </div> 
            
            <h5 style="font-size: 12px"><a href="#" >Send Notifications</a></h5>
            <div >
                <a target="mainFrame" href="/riyan/sendsms" style="font-size: 12px;">SMS</a><br/>
                <a target="mainFrame" href="/riyan/sendemail" style="font-size: 12px;">Email</a><br/>
            </div>
            
            <h5 style="font-size: 12px"><a href="#" >Accounts</a></h5>
            <div >
                <a target="mainFrame" href="/riyan/AccountProcess/createAccount" style="font-size: 12px;">Ledger Account</a><br/>
                <a target="mainFrame" href="/riyan/AccountProcess/createVoucher" style="font-size: 12px;">Create Voucher</a><br/>
                <a target="mainFrame" href="/riyan/AccountProcess/viewVoucherReceipt" style="font-size: 12px;">Find/Edit Voucher</a><br/>
                <a target="mainFrame" href="/riyan/AccountProcess/trialBalance" style="font-size: 12px;">Trial Balance</a><br/>
                <a target="mainFrame" href="/riyan/AccountProcess/balanceSheet" style="font-size: 12px;">Balance Sheet</a><br/>
            </div>
            ...
            <div >
                ...
                <a target="mainFrame" href="/riyan/HrProcess/salaryIssue" style="font-size: 12px;">Advance Salary Issue</a><br/>
