...
%>
<body>
	<form id="form1" action="/global/EnquiryProcess/deleteEnquiry" method="post">
                   ...
                   <tbody>
					...
					<c:forEach items="${admissionEnquiryList}" var="admissionEnquiryList" varStatus="status">
						...
						<tr style="border-color: #000000" border="1" cellpadding="1"
							...
							<td class="dataText"><a class="dataTextInActive" href="/global/EnquiryProcess/getStudentEnquiryform?id=<c:out value='${admissionEnquiryList.id}'/>"><c:out value="${admissionEnquiryList.name}" /></a></td>
