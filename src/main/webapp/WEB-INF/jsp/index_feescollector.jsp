...
%>
    <frameset    rows="55,*"frameborder="0" border="0" framespacing="0"  >
			    ...
			    <frame   src="/brainystars/header_feescollector"   name="topFrame" scrolling="NO" noresize frameborder="0">

            <frameset  cols="195,*" frameborder="0" border="0" framespacing="0">
                <frame  src="/brainystars/left_feescollector" name="leftFrame" scrolling="yes"  frameborder="1"   />
                <frame src="/brainystars/welcome" name="mainFrame" scrolling="yes" />
            </frameset>
