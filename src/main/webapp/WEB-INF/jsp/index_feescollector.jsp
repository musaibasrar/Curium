...
%>
    <frameset    rows="70,*"frameborder="0" border="0" framespacing="0"  >
        <frame   src="/presidency/header_feescollector"   name="topFrame" scrolling="NO" noresize frameborder="0">

            <frameset  cols="195,*" frameborder="0" border="0" framespacing="0">
                <frame  src="/presidency/left_feescollector" name="leftFrame" scrolling="yes"  frameborder="1"   />
                <frame src="/presidency/welcome" name="mainFrame" scrolling="yes" />
            </frameset>
