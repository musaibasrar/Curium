...
<script type="text/javascript">
	function searchClass() {
		...
		form1.action = "/syedbarey/ClassProcess/searchByClass";
		form1.method = "POST";
		form1.submit();
    ...
    function graduateMultiple(){
        ...
        var form1=document.getElementById("form1");
        form1.action="/syedbarey/ClassProcess/graduateMultiple";
       form1.submit();
    ...
    function dropoutMultiple(){
        ...
        var form1=document.getElementById("form1");
        form1.action="/syedbarey/ClassProcess/dropoutMultiple";
       form1.submit();
    ...
    function leftoutMultiple(){
        ...
        var form1=document.getElementById("form1");
        form1.action="/syedbarey/ClassProcess/leftoutMultiple";
       form1.submit();
...
<body>
	<form id="form1"
		action="/syedbarey/StudentProcess/promoteClass" method="POST">
                    ...
                    <tbody>
                        <c:forEach items="${studentList}" var="Student" varStatus="status">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/syedbarey/StudentProcess/ViewDetails?id=<c:out value='${Student.student.sid}'/>"><c:out value="${Student.student.studentexternalid}"/></a></td>
                                <td  class="dataTextInActive"><a class="dataTextInActive" href="/syedbarey/StudentProcess/ViewDetails?id=<c:out value='${Student.student.sid}'/>"><c:out value="${Student.student.admissionnumber}"/></a></td>
