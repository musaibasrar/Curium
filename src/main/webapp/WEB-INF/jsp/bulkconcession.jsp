...
$(document).ready(function () {
	...
	function searchForStudents() {
		...
		form1.action = "/orchids/FeesCollection/searchFeesReportBulkConcession";
		form1.method = "POST";
		form1.submit();
	...
	function applyConcession() {
		...
		var form1 = document.getElementById("form1");
		form1.action = "/orchids/FeesProcess/applyBulkConcession";
		form1.method = "POST";
		form1.submit();
}
...
%>
<body>
	<form id="form1" action="/orchids/FeesProcess/applyBulkConcession" method="POST">
