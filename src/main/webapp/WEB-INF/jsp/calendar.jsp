    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: '/dolphin/EventProcess/getEvents',
            ...
            document.getElementById('eventForm').addEventListener('submit', function(e) {
                ...
                var url = '/dolphin/EventProcess/createEvent';
                var method = 'POST';
                if (eventId) {
                    url = '/dolphin/EventProcess/updateEvent?id=' + eventId;
                }
            ...
            deleteButton.onclick = function() {
                ...
                if (eventId && confirm('Are you sure you want to delete this event?')) {
                    fetch('/dolphin/EventProcess/deleteEvent?id=' + eventId, {
                        method: 'POST'
                    })
                    .then(response => {
                        if (response.ok) {
