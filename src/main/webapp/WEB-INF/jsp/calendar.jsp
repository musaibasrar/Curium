    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: '/salihath/EventProcess/getEvents',
            ...
            document.getElementById('eventForm').addEventListener('submit', function(e) {
                ...
                var url = '/salihath/EventProcess/createEvent';
                var method = 'POST';
                if (eventId) {
                    url = '/salihath/EventProcess/updateEvent?id=' + eventId;
                }
            ...
            deleteButton.onclick = function() {
                ...
                if (eventId && confirm('Are you sure you want to delete this event?')) {
                    fetch('/salihath/EventProcess/deleteEvent?id=' + eventId, {
                        method: 'POST'
                    })
                    .then(response => {
                        if (response.ok) {
