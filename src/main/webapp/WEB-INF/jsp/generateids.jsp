...
<script type="text/javascript">
	function searchDetails() {
		...
		form1.action="/curium/Printids/searchDetails";
		form1.method = "POST";
		form1.submit();
	...
	function printPreview() {
		var form1 = document.getElementById("form1");
		form1.action="/curium/Printids/printPreview";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/curium/Printids/printPreview" method="POST">
					...
					<c:forEach items="${searchStudentList}" var="Parents">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataTextInActive"><a class="dataTextInActive"
								href="/curium/StudentProcess/ViewFeesStructure?id=<c:out value='${Parents.student.sid}'/>"><c:out
