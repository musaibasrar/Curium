...
<script type="text/javascript">
	function searchDetails() {
		...
		form1.action = "/daralmajd/Printids/searchDetails";
		form1.method = "POST";
		form1.submit();
	...
	function printPreview() {
		var form1 = document.getElementById("form1");
		form1.action = "/daralmajd/Printids/printPreview";
		form1.method = "POST";
		form1.submit();
	...
	function printBackPreview() {
		var form1 = document.getElementById("form1");
		form1.action = "/daralmajd/Printids/generateIdBackPart";
		form1.method = "POST";
		form1.submit();
	}
...
%>
<body>
	<form id="form1" action="/daralmajd/Printids/printPreview" method="POST">
