...
<script type="text/javascript" src="/beaconias/js/datetimepicker_css.js"></script>
	...
	<script type="text/javascript">
		function completeAppointment() {
			...
			form1.action = "/beaconias/AppointmentProcess/completeAppointments";
			form1.method = "POST";
			form1.submit();
		}
		...
		function cancelAppointment() {
			var form1 = document.getElementById("form1");
			form1.action = "/beaconias/AppointmentProcess/cancelAppointments";
			form1.method = "POST";
			form1.submit();
		}
	</script>
		        	...
		        	function closediv(divid){
		        		var x = document.getElementById("div"+divid);
		        		  if (x.style.display === "none") {
		        		    ...
		        		    var form1 = document.getElementById("form1");
		        			form1.action = "/beaconias/AppointmentProcess/viewAllAppointments";
		        			form1.method = "POST";
		        			form1.submit();
		        		  }
		        	}
	...
	$(function() {
	 ...
	 $(function(){
	   ...
	   function updateAppointment(){
       	...
       	var form1 = document.getElementById("form1");
   		form1.action = "/beaconias/AppointmentProcess/updateAppointment";
   		form1.method = "POST";
   		form1.submit();
       }
                ...
                <div align="center">
		             <%--For displaying Previous link except for the 1st page --%>
		                <c:if test="${currentPage != 1}">
		                    <td><a style="color: #4B6A84;font-size: 12px" href="/beaconias/AppointmentProcess/viewAllAppointments&page=${currentPage - 1}">Previous</a></td>
		                </c:if>
		                ...
		                <table border="0" cellpadding="2" cellspacing="2">
		                	<c:forEach begin="1" end="${noOfPages}" var="i" varStatus="status">
		                            ...
		                            <c:choose>
		                                ...
		                                <c:otherwise>
		                                    <td style="color: black;font-weight:bold;font-size: 15px "><a style="color: #4B6A84" href="/beaconias/AppointmentProcess/viewAllAppointments&page=${i}">${i}</a></td>
		                                </c:otherwise>
		                            </c:choose>
		                ...
		                <c:if test="${currentPage lt noOfPages}">
		                    <td ><a style="color: #4B6A84;font-size: 12px" href="/beaconias/AppointmentProcess/viewAllAppointments&page=${currentPage + 1}">Next</a></td>
		                </c:if>
                </div>
		</div>
	</form>
