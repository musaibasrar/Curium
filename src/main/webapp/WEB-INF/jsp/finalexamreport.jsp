...
<script type="text/javascript">
	function searchForReports() {
		...
		form1.action = "/hamidullah/MarksDetailsProcess/searchForFinalReport";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/hamidullah/MarksDetailsProcess/generatefinalexamReport" method="POST">
