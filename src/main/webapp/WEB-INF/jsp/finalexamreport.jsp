...
<script type="text/javascript">
	function searchForReports() {
		...
		form1.action = "/brainystars/MarksDetailsProcess/searchForFinalReport";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/brainystars/MarksDetailsProcess/generatefinalexamReport" method="POST">
