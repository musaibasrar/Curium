...
<script type="text/javascript">
	...
	function searchForStudents() {
		...
		form1.action = "/bright/FeesCollection/searchFeesReportDue";
		form1.method = "POST";
		form1.submit();
	...
	function sendSMS() {
		var form1 = document.getElementById("form1");
		form1.action = "/bright/SMSProcess/sendSMSFeesDueReminder";
		form1.method = "POST";
		form1.submit();
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/bright/FeesDetails/printDataForFeesReportdue";
		form1.method = "POST";
		form1.submit();
}
...
%>
<body>
	<form id="form1" action="/bright/FeesCollection/exportDataForStudentsFeesReport" method="POST">
