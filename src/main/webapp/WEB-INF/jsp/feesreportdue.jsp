...
<script type="text/javascript">
	...
	function searchForStudents() {
		...
		form1.action = "/brilliantgrammar/FeesCollection/searchFeesReportDue";
		form1.method = "POST";
		form1.submit();
	...
	function sendSMS() {
		var form1 = document.getElementById("form1");
		form1.action = "/brilliantgrammar/SMSProcess/sendSMSFeesDueReminder";
		form1.method = "POST";
		form1.submit();
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/brilliantgrammar/FeesDetails/printDataForFeesReportdue";
		form1.method = "POST";
		form1.submit();
}
...
<script type="text/javascript">
    ...
    function getFeesCategory() {
		...
		var selected=document.getElementById('academicyear').value;
			...
			xmlHttp.open("GET", "/brilliantgrammar/StampFeesProcess/showFeesDetailsYearly?year="+selected,true);
			xmlHttp.send(null);
	}
...
%>
<body>
	<form id="form1" action="/brilliantgrammar/FeesCollection/exportDataForStudentsFeesReport" method="POST">
			...
			<table width="100%" border="0" style="border-color: #4b6a84;"
				...
				<tr>
                    ...
                    <td  class="footerTD" colspan="9" >
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;
                             &nbsp;&nbsp;&nbsp;&nbsp;
                           <label style="color:white;font-weight: bold;font-size: 14px;">Total Due Amount: Rs. ${TotalDueAmount } (<fmt:formatNumber value="${TotalDueper}" pattern="0" />%)</label>
                            </td>
                   </tr>
