...
<script type="text/javascript">
	...
	function searchForStudents() {
		...
		form1.action = "/aashiyana/FeesCollection/searchFeesReportDue";
		form1.method = "POST";
		form1.submit();
	...
	function sendSMS() {
		var form1 = document.getElementById("form1");
		form1.action = "/aashiyana/SMSProcess/sendSMSFeesDueReminder";
		form1.method = "POST";
		form1.submit();
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/aashiyana/FeesDetails/printDataForFeesReportdue";
		form1.method = "POST";
		form1.submit();
}
...
%>
<body>
	<form id="form1" action="/aashiyana/FeesCollection/exportDataForStudentsFeesReport" method="POST">
