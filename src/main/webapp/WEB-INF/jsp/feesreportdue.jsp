...
<script type="text/javascript">
	...
	function searchForStudents() {
		...
		form1.action = "/alalmas/FeesCollection/searchFeesReportDue";
		form1.method = "POST";
		form1.submit();
	...
	function sendSMS() {
		var form1 = document.getElementById("form1");
		form1.action = "/alalmas/SMSProcess/sendSMSFeesDueReminder";
		form1.method = "POST";
		form1.submit();
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/alalmas/FeesDetails/printDataForFeesReportdue";
		form1.method = "POST";
		form1.submit();
}
...
<script type="text/javascript">
    ...
    function getFeesCategory() {
		...
		var selected=document.getElementById('academicyear').value;
			...
			xmlHttp.open("GET", "/alalmas/StampFeesProcess/showFeesDetailsYearly?year="+selected,true);
			xmlHttp.send(null);
	}
...
%>
<body>
	<form id="form1" action="/alalmas/FeesCollection/exportDataForStudentsFeesReport" method="POST">
