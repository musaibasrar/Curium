	...
	<style type="text/css">
		...
		@font-face {
		  font-family: "IBMPlexSans";
  		  src: url("/divine/fonts/IBMPlexSans-Regular.ttf");
		}
...
%>
	...
	<div class="row" style="padding-left: 150px;">
						<h2><img border="0" style="vertical-align: text-bottom;height: 280px;width: 80px;" alt="ideoholic" src="/divine/images/divine.png"></h2>
	</div>
        					...
        					<td style="padding-left:10px;padding-top:1px;">
        					 ...
        					 <c:choose>
                                <c:when test="${todaysAttendance eq 'P'}">
									...
									src="/divine/images/studentattendance.svg" width="40" height="40"
                                ...
                                <c:otherwise>
									...
									src="/divine/images/studentabsent.svg" width="40" height="40"
									alt="Student Profile" style="vertical-align: bottom;" />Today's Attendance:${todaysAttendance}
									</a>
                                </c:otherwise>
                            </c:choose>
        			...
        			<table>
        				<tr>
        					...
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/divine/StudentProcess/ViewDetailsbyexternalid?id=${username}&urlbranchid=${branchid}"> <img
									src="/divine/images/studentprofile.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size: 34px;"
								href="/divine/DiaryProcess/viewDiaryStudentParent?id=${username}&urlbranchid=${branchid}"> <img
									src="/divine/images/diary.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/divine/StudentProcess/ViewFeesDetailsbyexternalid?id=${username}&urlbranchid=${branchid}"> <img
									src="/divine/images/fees.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/divine/MarksDetailsProcess/generateReportParent?id=${username}"> <img
									src="/divine/images/progressreport.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/divine/StudentDiaryProcess/viewDiaryStudentParent?id=${username}&urlbranchid=${branchid}"> <img
									src="/divine/images/logbook.svg" width="50" height="50"
		       	...
		       	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/divine/EventProcess/viewCalendar"> <img
									src="/divine/images/viewcalendar.png" width="50" height="50"
