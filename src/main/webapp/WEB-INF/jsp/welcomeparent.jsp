	...
	<style type="text/css">
		...
		@font-face {
		  font-family: "IBMPlexSans";
  		  src: url("/daralmajd/fonts/IBMPlexSans-Regular.ttf");
		}
...
%>
	...
	<div class="row" style="padding-left: 150px;">
						<h2><img border="0" style="vertical-align: text-bottom;height: 80px;width: 80px;" alt="ideoholic" src="/daralmajd/images/daralmajd.png"></h2>
	</div>
        					...
        					<td style="padding-left:10px;padding-top:1px;">
        					 ...
        					 <c:choose>
                                <c:when test="${todaysAttendance eq 'P'}">
									...
									src="/daralmajd/images/studentattendance.svg" width="40" height="40"
                                ...
                                <c:otherwise>
									...
									src="/daralmajd/images/studentabsent.svg" width="40" height="40"
									alt="Student Profile" style="vertical-align: bottom;" />Today's Attendance:${todaysAttendance}
									</a>
                                </c:otherwise>
                            </c:choose>
        			...
        			<table>
        				<tr>
        					...
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/daralmajd/StudentProcess/ViewDetailsbyexternalid?id=${username}&urlbranchid=${Parents.student.branchid}"> <img
									src="/daralmajd/images/studentprofile.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size: 34px;"
								href="/daralmajd/DiaryProcess/viewDiaryStudentParent?id=${username}&urlbranchid=${Parents.student.branchid}"> <img
									src="/daralmajd/images/diary.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/daralmajd/StudentProcess/ViewFeesDetailsbyexternalid?id=${username}&urlbranchid=${Parents.student.branchid}"> <img
									src="/daralmajd/images/fees.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/daralmajd/MarksDetailsProcess/generateReportParent?id=${username}"> <img
									src="/daralmajd/images/progressreport.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/daralmajd/StudentDiaryProcess/viewDiaryStudentParent?id=${username}&urlbranchid=${Parents.student.branchid}"> <img
									src="/daralmajd/images/logbook.svg" width="50" height="50"
		       	...
		       	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/daralmajd/EventProcess/viewCalendar"> <img
									src="/daralmajd/images/viewcalendar.png" width="50" height="50"
