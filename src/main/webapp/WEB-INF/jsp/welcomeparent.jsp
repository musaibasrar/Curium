...
<html>
    <head>
        ...
        <script src="/noman/js/Chart.min.js"></script>
	...
	<style type="text/css">
		...
		@font-face {
		  font-family: "IBMPlexSans";
  		  src: url("/noman/fonts/IBMPlexSans-Regular.ttf");
		}
        			...
        			<table>
        				<tr>
        					...
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/noman/StudentProcess/ViewDetailsbyexternalid?id=${username}&urlbranchid=${Parents.student.branchid}"> <img
									src="/noman/images/studentprofile.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size: 34px;"
								href="/noman/DiaryProcess/viewDiaryStudentParent?id=${username}&urlbranchid=${Parents.student.branchid}"> <img
									src="/noman/images/diary.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/noman/StudentProcess/ViewFeesDetailsbyexternalid?id=${username}&urlbranchid=${Parents.student.branchid}"> <img
									src="/noman/images/fees.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/noman/MarksDetailsProcess/generateReportParent?id=${username}"> <img
									src="/noman/images/progressreport.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/noman/StudentDiaryProcess/viewDiaryStudentParent?id=${username}&urlbranchid=${Parents.student.branchid}"> <img
									src="/noman/images/logbook.svg" width="50" height="50"
