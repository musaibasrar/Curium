...
<html>
    <head>
        ...
        <script src="/stanley/js/Chart.min.js"></script>
	...
	<style type="text/css">
		...
		@font-face {
		  font-family: "IBMPlexSans";
  		  src: url("/stanley/fonts/IBMPlexSans-Regular.ttf");
		}
...
%>
	...
	<div class="row" style="padding-left: 150px;">
						<h2><img border="0" style="vertical-align: text-bottom;height: 80px;width: 218px;" alt="ideoholic" src="/stanley/images/stanley${branchid}.png"></h2>
	</div>
        					...
        					<td style="padding-left:10px;padding-top:1px;">
        					 ...
        					 <c:choose>
                                <c:when test="${todaysAttendance eq 'P'}">
									...
									src="/stanley/images/studentattendance.svg" width="40" height="40"
                                ...
                                <c:otherwise>
									...
									src="/stanley/images/studentabsent.svg" width="40" height="40"
									alt="Student Profile" style="vertical-align: bottom;" />Today's Attendance:${todaysAttendance}
									</a>
                                </c:otherwise>
                            </c:choose>
        			...
        			<table>
        				<tr>
        					...
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/stanley/StudentProcess/ViewDetailsbyexternalid?id=${username}&urlbranchid=${Parents.student.branchid}"> <img
									src="/stanley/images/studentprofile.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size: 34px;"
								href="/stanley/DiaryProcess/viewDiaryStudentParent?id=${username}&urlbranchid=${Parents.student.branchid}"> <img
									src="/stanley/images/diary.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/stanley/StudentProcess/ViewFeesDetailsbyexternalid?id=${username}&urlbranchid=${Parents.student.branchid}"> <img
									src="/stanley/images/fees.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/stanley/MarksDetailsProcess/generateReportParent?id=${username}"> <img
									src="/stanley/images/progressreport.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/stanley/StudentDiaryProcess/viewDiaryStudentParent?id=${username}&urlbranchid=${Parents.student.branchid}"> <img
									src="/stanley/images/logbook.svg" width="50" height="50"
		       	...
		       	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/stanley/EventProcess/viewCalendar"> <img
									src="/stanley/images/viewcalendar.png" width="50" height="50"
