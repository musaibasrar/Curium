	...
	<style type="text/css">
		...
		@font-face {
		  font-family: "IBMPlexSans";
  		  src: url("/alfarooq/fonts/IBMPlexSans-Regular.ttf");
		}
...
%>
	...
	<div class="row" style="padding-left: 150px;">
						<h2><img border="0" style="vertical-align: text-bottom;height: 80px;width: 90px;" alt="ideoholic" src="/alfarooq/images/alfarooq.png"></h2>
	</div>
        					...
        					<td style="padding-left:10px;padding-top:1px;">
        					 ...
        					 <c:choose>
                                <c:when test="${todaysAttendance eq 'P'}">
									...
									src="/alfarooq/images/studentattendance.svg" width="40" height="40"
                                ...
                                <c:otherwise>
									...
									src="/alfarooq/images/studentabsent.svg" width="40" height="40"
									alt="Student Profile" style="vertical-align: bottom;" />Today's Attendance:${todaysAttendance}
									</a>
                                </c:otherwise>
                            </c:choose>
        			...
        			<table>
        				<tr>
        					...
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/alfarooq/StudentProcess/ViewDetailsbyexternalid?id=${username}&urlbranchid=${Parents.student.branchid}"> <img
									src="/alfarooq/images/studentprofile.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size: 34px;"
								href="/alfarooq/DiaryProcess/viewDiaryStudentParent?id=${username}&urlbranchid=${Parents.student.branchid}"> <img
									src="/alfarooq/images/diary.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/alfarooq/StudentProcess/ViewFeesDetailsbyexternalid?id=${username}&urlbranchid=${Parents.student.branchid}"> <img
									src="/alfarooq/images/fees.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/alfarooq/MarksDetailsProcess/generateReportParent?id=${username}"> <img
									src="/alfarooq/images/progressreport.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/alfarooq/StudentDiaryProcess/viewDiaryStudentParent?id=${username}&urlbranchid=${Parents.student.branchid}"> <img
									src="/alfarooq/images/logbook.svg" width="50" height="50"
		       	...
		       	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/alfarooq/EventProcess/viewCalendar"> <img
									src="/alfarooq/images/viewcalendar.png" width="50" height="50"
