...
<html>
    <head>
        ...
        <script src="/hira/js/Chart.min.js"></script>
	...
	<style type="text/css">
		...
		@font-face {
		  font-family: "IBMPlexSans";
  		  src: url("/hira/fonts/IBMPlexSans-Regular.ttf");
		}
...
%>
	...
	<div class="row" style="padding-left: 150px;">
						<h2><img border="0" style="vertical-align: text-bottom;height: 80px;width: 80px;" alt="ideoholic" src="/hira/images/hira.png"></h2>
	</div>
        					...
        					<td style="padding-left:10px;padding-top:1px;">
        					 ...
        					 <c:choose>
                                <c:when test="${todaysAttendance eq 'P'}">
									...
									src="/hira/images/studentattendance.svg" width="40" height="40"
                                ...
                                <c:otherwise>
									...
									src="/hira/images/studentabsent.svg" width="40" height="40"
									alt="Student Profile" style="vertical-align: bottom;" />Today's Attendance:${todaysAttendance}
									</a>
                                </c:otherwise>
                            </c:choose>
        			...
        			<table>
        				<tr>
        					...
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/hira/StudentProcess/ViewDetailsbyexternalid?id=${username}&urlbranchid=${branchid}"> <img
									src="/hira/images/studentprofile.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size: 34px;"
								href="/hira/DiaryProcess/viewDiaryStudentParent?id=${username}&urlbranchid=${branchid}"> <img
									src="/hira/images/diary.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/hira/StudentProcess/ViewFeesDetailsbyexternalid?id=${username}&urlbranchid=${branchid}"> <img
									src="/hira/images/fees.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/hira/MarksDetailsProcess/generateReportParent?id=${username}"> <img
									src="/hira/images/progressreport.svg" width="50" height="50"
        	...
        	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/hira/StudentDiaryProcess/viewDiaryStudentParent?id=${username}&urlbranchid=${branchid}"> <img
									src="/hira/images/logbook.svg" width="50" height="50"
		       	...
		       	<div class="col" style="padding-bottom: 40px;">
        			...
        			<table>
        				<tr>
        					<td style="padding-left:10px;padding-top:1px;">
        					<a target="mainFrame" style="color:#ffffff;font-size:34px;"
								href="/hira/EventProcess/viewCalendar"> <img
									src="/hira/images/viewcalendar.png" width="50" height="50"
