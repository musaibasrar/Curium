...
<script type="text/javascript">
	...
	function exportVoucher(){
		var form1 = document.getElementById("form1");
		form1.action = "/jihtel/AccountProcess/exportVoucher";
		form1.method = "POST";
		form1.submit();
	}
			...
			<table width="100%" border="0" style="border-color: #4b6a84;"
				...
				<thead>
					<tr>
						...
						<th title="click to sort" class="headerText">Dr Account</th>
						<th title="click to sort" class="headerText">Cr Account</th>
						<th title="click to sort" class="headerText">Fund Source</th>
				 ...
				 <fmt:setLocale value="en_IN" scope="session"/>
					...
					<c:forEach items="${vouchertransactions}" var="vouchertransactions">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataTextInActive"><c:out value="${vouchertransactions.key.voucherno}" />
							</td>
