...
<html>
    <head>
        ...
        <script type="text/javascript" src="/jihtel/js/datePicker/ui/jquery.effects.slide.js"></script>
        <script type="text/javascript" src="/jihtel/js/datePicker/ui/jquery.effects.bounce.js"></script>
        <script type="text/javascript" src="/jihtel/js/datePicker/ui/jquery.effects.clip.js"></script>
        <script type="text/javascript" src="/jihtel/js/datePicker/ui/jquery.effects.transfer.js"></script>
        <script type="text/javascript" src="/jihtel/js/datePicker/ui/jquery.effects.blind.js"></script>
        <style type="text/css">
            <!--
            .labelCss {
                font-family: Tahoma;
 ...
 function submitfees(cashpayment,banktransfer,chequetransfer,ackno,transferdate,transferbankname,chequeno,chequedate,chequebankname){
        		...
        		form1.action="/jihtel/FeesCollection/feesAdd?paymentmethod="+paymentmethodvalue+"&ackno="+acknovalue+"&transferdate="+transferdatevalue+"&transferbankname="+transferbanknamevalue+"&chequeno="+chequenovalue+"&chequedate="+chequedatevalue+"&chequebankname="+chequebanknamevalue+"";
        		form1.method = "POST";
        		form1.submit();
            ...
            function getstampfees(){
            	var form1 = document.getElementById("form1");
        		form1.action="/jihtel/FeesCollection/StampFees";
        		form1.method = "POST";
        		form1.submit();
            }
            	...
            	<table  width="50%">
                 <tbody>
                    ...
                    <tr>
                        ...
                        <td class="alignLeft" >Receipt No.:&nbsp;&nbsp;&nbsp;&nbsp; <input  type="text" name="bookreceiptno" id="bookreceiptno" class="myclass" onblur="checkDuplicate()"/><div id="bookreceiptnodiv"></div></td>
