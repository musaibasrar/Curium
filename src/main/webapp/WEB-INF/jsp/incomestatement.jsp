...
<script type="text/javascript">
	...
	function getIncomeStatement(){
		...
		form1.action = "/jihtel/AccountProcess/incomeStatement";
		form1.method = "POST";
		form1.submit();
	}
			...
			<table width="50%" border="0" style="border-color: #4b6a84;float: left"	>
				...
				<tfoot>
					<tr>
						...
						<a id="print" href="/jihtel/AccountProcess/incomeStatementPrint?fromdate=<c:out value="${fromdate}" />&todate=<c:out value="${todate}"/>">Print</a>
						<input 
							type="hidden"  id="delete" />
							</td>
