...
<script type="text/javascript">
	...
	function getDayBook(){
		...
		form1.action = "/shatabdi/AccountProcess/daybook";
		form1.method = "POST";
		form1.submit();
	}
			...
			<table width="100%" border="0" style="border-color: #4b6a84;float: left;margin-bottom:50px;">
				...
				<thead>
					...
					<tr>
						...
						<th title="click to sort" class="headerText" style="font-weight: bold;">Date</th>
				...
				<tbody>
					...
					<c:forEach items="${voucherentrytransactions}" var="ledgersaccount" varStatus="status">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataText" style="text-align: right"><c:out value="${ledgersaccount.key.transactiondate}" /></td>
				...
				<tfoot>
					<tr>
						<td class="footerTD" colspan="4"><input 
