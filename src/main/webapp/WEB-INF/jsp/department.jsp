...
<script type="text/javascript">
	function addDepartment() {
		...
		form1.action = "/brainystars/DepartmentProcess/addDepartment";
		form1.method = "POST";
		form1.submit();
	...
	function deleteDepartment() {
		var form1 = document.getElementById("form1");
		form1.action = "/brainystars/DepartmentProcess/deleteMultiple";
		form1.method = "POST";
		form1.submit();
...
<body>
	<form id="form1"
		action="/brainystars/DepartmentProcess/deleteMultiple" method="POST">
