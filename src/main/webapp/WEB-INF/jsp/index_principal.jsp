...
%>
    <frameset    rows="55,*"frameborder="0" border="0" framespacing="0"  >
		   ...
		   <c:if test="${(userType == 'principal')}">
			    <frame   src="/jrs/header_principal"   name="topFrame" scrolling="NO" noresize frameborder="0">
		   </c:if>

            <frameset  cols="195,*" frameborder="0" border="0" framespacing="0">
                <frame  src="/jrs/left_principal" name="leftFrame" scrolling="yes"  frameborder="1"   />
