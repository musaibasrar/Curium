...
%>
    <frameset    rows="55,*"frameborder="0" border="0" framespacing="0"  >
		   ...
		   <c:if test="${(userType == 'parents')}">
			    <frame   src="/scholargroup/header_parent"   name="topFrame" scrolling="NO" noresize frameborder="0">
		   </c:if>
			<frame src="/scholargroup/welcomeparent" name="mainFrame" scrolling="yes" />
           <!--  <frameset  cols="195,*" frameborder="0" border="0" framespacing="0">
                <frame  src="/scholargroup/left_parent" name="leftFrame" scrolling="yes"  frameborder="1"   />
                <frame src="/scholargroup/welcomeparent" name="mainFrame" scrolling="yes" />
            </frameset> -->
...
<h1>NAME</h1>
  <div class="row">
    ...
    <div class="col-6" id="f1">
     ...
     <a target="mainFrame" href="/scholargroup/StudentProcess/ViewDetailsbyexternalid?id=<c:out value='${username}'/>&urlbranchid=<c:out value='${Parents.student.branchid}'/>" style="font-size: 12px;"><h5>Student Profile</h5></a>
    ...
    <i class="fa-solid fa-book"></i>
     <a target="mainFrame" href="/scholargroup/DiaryProcess/viewDiaryStudentParent?id=<c:out value='${username}'/>&urlbranchid=<c:out value='${Parents.student.branchid}'/>" style="font-size: 12px;"><h5>Student Diary</h5></a>
    </div>
