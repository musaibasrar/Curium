...
<script type="text/javascript" src="/redrose/js/globalize.min.js"></script>
<script type="text/javascript" charset="utf-8" src="/redrose/js/globalize.cultures.js"></script>
...
<script type="text/javascript">
	function searchForFees() {
		...
		form1.action = "/redrose/StampFeesProcess/othersearch";
		form1.method = "POST";
		form1.submit();
	}
	$(function() {
	...
	function deleteFeesStamp(){
		var form1 = document.getElementById("form1");
		form1.action = "/redrose/StampFeesProcess/delete";
		form1.method = "POST";
		form1.submit();
	}
</script>
...
<script type="text/javascript">
    ...
    function addRow() {
        ...
        var col5="<td class='dataTextInActive'><input type='text' value='0' onclick='SelectAll("+rowCount+");calculate("+rowCount+");' onfocus='SelectAll("+rowCount+")' onkeyup='calculate("+rowCount+")' name='feesCount' id=feesCount_"+rowCount+" /></td>";
        var col6="<td class='dataTextInActive'><input type='text' value='0' name='feesConcession' id=feesConcession_"+rowCount+" /></td>";
        var col7="<td class='dataTextInActive'><input class='feesFullAmount' type='text' value='0'   name='fessFullCat'  id=hiddenfees_full_amount_"+rowCount+" /></td>";
...
%>
<body>
	<form id="form1" action="/redrose/StampFeesProcess/applyotherFees" method="POST">
					...
					<c:forEach items="${searchStudentList}" var="Parents">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataTextInActive"><a class="dataTextInActive"
								href="/redrose/StudentProcess/ViewDetails?id=<c:out value='${Parents.student.sid}'/>&urlbranchid=<c:out value='${Parents.student.branchid}'/>"><c:out
