...
<script type="text/javascript" src="/children/js/globalize.min.js"></script>
<script type="text/javascript" charset="utf-8" src="/children/js/globalize.cultures.js"></script>
...
<script type="text/javascript">
	function searchForFees() {
		...
		form1.action = "/children/StampFeesProcess/othersearch";
		form1.method = "POST";
		form1.submit();
	}
	$(function() {
	...
	function deleteFeesStamp(){
		var form1 = document.getElementById("form1");
		form1.action = "/children/StampFeesProcess/delete";
		form1.method = "POST";
		form1.submit();
	}
</script>
...
%>
<body>
	<form id="form1" action="/children/StampFeesProcess/applyotherFees" method="POST">
					...
					<c:forEach items="${searchStudentList}" var="Parents">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataTextInActive"><a class="dataTextInActive"
								href="/children/StudentProcess/ViewDetails?id=<c:out value='${Parents.student.sid}'/>&urlbranchid=<c:out value='${Parents.student.branchid}'/>"><c:out
