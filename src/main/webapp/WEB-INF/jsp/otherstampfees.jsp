...
<script type="text/javascript" src="/jih/js/globalize.min.js"></script>
<script type="text/javascript" charset="utf-8" src="/jih/js/globalize.cultures.js"></script>
...
<script type="text/javascript">
	function searchForFees() {
		...
		form1.action = "/jih/StampFeesProcess/othersearch";
		form1.method = "POST";
		form1.submit();
	}
	$(function() {
	...
	function deleteFeesStamp(){
		var form1 = document.getElementById("form1");
		form1.action = "/jih/StampFeesProcess/delete";
		form1.method = "POST";
		form1.submit();
	}
</script>
...
%>
<body>
	<form id="form1" action="/jih/StampFeesProcess/applyotherFees" method="POST">
