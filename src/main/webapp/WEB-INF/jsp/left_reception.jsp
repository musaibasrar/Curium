...
%>
	...
	<label style="font-size: 14px;">&nbsp;${subbranchname}</label></div>
        ...
        <div id="container" style="width: 100%" >
            ...
            <div>
                <a target="mainFrame" href="/scholar/StudentProcess/viewAll" >View All</a><br/>
                <a target="mainFrame" href="/scholar/feesstructure" >Fees Structure</a><br/>
                

            </div>
            <!-- <h5 style="font-size: 12px"><a href="#">Human Resource</a></h5>
            <div>
                <a target="mainFrame" href="/scholar/EmployeeProcess/viewAllEmployee" >View Employee List</a><br/>
                <a target="mainFrame" href="/scholar/EmployeeProcess/addEmployeePage" >Add Employee</a>
                <a target="mainFrame" href="/scholar/DepartmentProcess/departmentView" >Add Department</a>
                <a target="mainFrame" href="/scholar/PositionProcess/positionView" >Add Position</a>
            ...
            <div>
            	<a target="mainFrame" href="/scholar/FeesProcess/feesView" >Fees Category</a>
                <a target="mainFrame" href="/scholar/FeesProcess/feesCollect" >Fees Collect</a><br/>
            ...
            <div>
                <a target="mainFrame" href="/scholar/AdminProcess/viewAllExpenses" >Expenses</a><br/>
            ...
            <div>
                <a target="mainFrame" href="/scholar/AdvanceSearch" >Search</a><br/>
            ...
            <div>
                <a target="mainFrame" href="/scholar/Promotion" >Promotions</a><br/>
            ...
            <div>
            	<a target="mainFrame" href="/scholar/StampFeesProcess/showFeesDetails" >Stamp Fee</a><br/>
                <a target="mainFrame" href="/scholar/YearProcess/updateYear" >Academic year</a><br/>
            ...
            <div >
               <!--  <a target="mainFrame" href="/scholar/Backup&Restore" >Backup</a><br/>
                <a target="mainFrame" href="/scholar/currentIssue" >Current Issue</a><br/>
                <a target="mainFrame" href="/scholar/changePassword" >Change Password</a><br/> -->
                <a target="mainFrame" href="/scholar/feesCollectionDetails" >Fees Collection Details</a><br/>
            </div>
            
           <!--  <h5 style="font-size: 12px"><a href="#" >Reports</a></h5>
            <div >
                <a target="mainFrame" href="/scholar/studentsdetailsreports" >Student Details</a><br/>
