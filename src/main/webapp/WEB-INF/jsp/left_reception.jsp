...
%>
	...
	<label style="font-size: 12px;">&nbsp;${branchname}</label></div>
        ...
        <div id="container" style="width: 100%" >
            ...
            <div>
                <a target="mainFrame" href="/global/StudentProcess/viewAll" >View All</a><br/>
                <a target="mainFrame" href="/global/feesstructure" >Fees Structure</a><br/>
                

            </div>
            <!-- <h5 style="font-size: 12px"><a href="#">Human Resource</a></h5>
            <div>
                <a target="mainFrame" href="/global/EmployeeProcess/viewAllEmployee" >View Employee List</a><br/>
                <a target="mainFrame" href="/global/EmployeeProcess/addEmployeePage" >Add Employee</a>
                <a target="mainFrame" href="/global/DepartmentProcess/departmentView" >Add Department</a>
                <a target="mainFrame" href="/global/PositionProcess/positionView" >Add Position</a>
            ...
            <div>
            	<a target="mainFrame" href="/global/FeesProcess/feesView" >Fees Category</a>
                <a target="mainFrame" href="/global/FeesProcess/feesCollect" >Fees Collect</a><br/>
            ...
            <div>
                <a target="mainFrame" href="/global/AdminProcess/viewAllExpenses" >Expenses</a><br/>
            ...
            <div>
                <a target="mainFrame" href="/global/AdvanceSearch" >Search</a><br/>
            ...
            <div>
                <a target="mainFrame" href="/global/Promotion" >Promotions</a><br/>
            ...
            <div>
            	<a target="mainFrame" href="/global/StampFeesProcess/showFeesDetails" >Stamp Fee</a><br/>
                <a target="mainFrame" href="/global/YearProcess/updateYear" >Academic year</a><br/>
            ...
            <div >
               <!--  <a target="mainFrame" href="/global/Backup&Restore" >Backup</a><br/>
                <a target="mainFrame" href="/global/currentIssue" >Current Issue</a><br/>
                <a target="mainFrame" href="/global/changePassword" >Change Password</a><br/> -->
                <a target="mainFrame" href="/global/feesCollectionDetails" >Fees Collection Details</a><br/>
            </div>
            
           <!--  <h5 style="font-size: 12px"><a href="#" >Reports</a></h5>
            <div >
                <a target="mainFrame" href="/global/studentsdetailsreports" >Student Details</a><br/>
