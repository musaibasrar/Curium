...
%>
	...
	<div class="headerTD" style="width: 95%" ><label style="font-size:14px;">A.Y:&nbsp;<c:out default="" value="${currentAcademicYear}"/></label>
	<br><c:choose>
        ...
        <div id="container" style="width: 95%" >
            ...
            <div style="padding-left: 0px;padding-right: 0px;">
            	<table style=" border-collapse: collapse;width: 100%">
            		...
            		<tr>
            			<td style="text-align: left;  padding: 4px;padding-left:20px ;background-color: #f5f8f9;">
            				            		                <a target="mainFrame" href="/littleflower/PeriodProcess/periodConfiguration" style="font-size: 12px;">Time Table</a>
            			</td>
            		</tr>
