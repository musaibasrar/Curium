...
%>
    <body onload="StartClock()" onunload="KillClock()">
        ...
        <div id="container" style="width: 100%" >
            ...
            <div>
                <a target="mainFrame" href="/alirfan/StudentProcess/viewAll" >View All</a><br/>
                <a target="mainFrame" href="/alirfan/feesstructure" >Fees Structure</a><br/>
                

            </div>
            <!-- <h5 style="font-size: 12px"><a href="#">Human Resource</a></h5>
            <div>
                <a target="mainFrame" href="/alirfan/EmployeeProcess/viewAllEmployee" >View Employee List</a><br/>
                <a target="mainFrame" href="/alirfan/EmployeeProcess/addEmployeePage" >Add Employee</a>
                <a target="mainFrame" href="/alirfan/DepartmentProcess/departmentView" >Add Department</a>
                <a target="mainFrame" href="/alirfan/PositionProcess/positionView" >Add Position</a>
            ...
            <div>
            	<a target="mainFrame" href="/alirfan/FeesProcess/feesView" >Fees Category</a>
                <a target="mainFrame" href="/alirfan/FeesProcess/feesCollect" >Fees Collect</a><br/>
            ...
            <div>
                <a target="mainFrame" href="/alirfan/AdminProcess/viewAllExpenses" >Expenses</a><br/>
            ...
            <div>
                <a target="mainFrame" href="/alirfan/AdvanceSearch" >Search</a><br/>
            ...
            <div>
                <a target="mainFrame" href="/alirfan/Promotion" >Promotions</a><br/>
            ...
            <div>
            	<a target="mainFrame" href="/alirfan/StampFeesProcess/showFeesDetails" >Stamp Fee</a><br/>
                <a target="mainFrame" href="/alirfan/YearProcess/updateYear" >Academic year</a><br/>
            ...
            <div >
               <!--  <a target="mainFrame" href="/alirfan/Backup&Restore" >Backup</a><br/>
                <a target="mainFrame" href="/alirfan/currentIssue" >Current Issue</a><br/>
                <a target="mainFrame" href="/alirfan/changePassword" >Change Password</a><br/> -->
                <a target="mainFrame" href="/alirfan/feesCollectionDetails" >Fees Collection Details</a><br/>
            </div>
            
           <!--  <h5 style="font-size: 12px"><a href="#" >Reports</a></h5>
            <div >
                <a target="mainFrame" href="/alirfan/studentsdetailsreports" >Student Details</a><br/>
