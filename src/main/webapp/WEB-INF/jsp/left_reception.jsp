...
%>
    <body onload="StartClock()" onunload="KillClock()">
        ...
        <div id="container" style="width: 100%" >
            ...
            <div>
                <a target="mainFrame" href="/brightschool/StudentProcess/viewAll" >View All</a><br/>
                <a target="mainFrame" href="/brightschool/feesstructure" >Fees Structure</a><br/>
                

            </div>
            <!-- <h5 style="font-size: 12px"><a href="#">Human Resource</a></h5>
            <div>
                <a target="mainFrame" href="/brightschool/EmployeeProcess/viewAllEmployee" >View Employee List</a><br/>
                <a target="mainFrame" href="/brightschool/EmployeeProcess/addEmployeePage" >Add Employee</a>
                <a target="mainFrame" href="/brightschool/DepartmentProcess/departmentView" >Add Department</a>
                <a target="mainFrame" href="/brightschool/PositionProcess/positionView" >Add Position</a>
            ...
            <div>
            	<a target="mainFrame" href="/brightschool/FeesProcess/feesView" >Fees Category</a>
                <a target="mainFrame" href="/brightschool/FeesProcess/feesCollect" >Fees Collect</a><br/>
            ...
            <div>
                <a target="mainFrame" href="/brightschool/AdminProcess/viewAllExpenses" >Expenses</a><br/>
            ...
            <div>
                <a target="mainFrame" href="/brightschool/AdvanceSearch" >Search</a><br/>
            ...
            <div>
                <a target="mainFrame" href="/brightschool/Promotion" >Promotions</a><br/>
            ...
            <div>
            	<a target="mainFrame" href="/brightschool/StampFeesProcess/showFeesDetails" >Stamp Fee</a><br/>
                <a target="mainFrame" href="/brightschool/YearProcess/updateYear" >Academic year</a><br/>
            ...
            <div >
               <!--  <a target="mainFrame" href="/brightschool/Backup&Restore" >Backup</a><br/>
                <a target="mainFrame" href="/brightschool/currentIssue" >Current Issue</a><br/>
                <a target="mainFrame" href="/brightschool/changePassword" >Change Password</a><br/> -->
                <a target="mainFrame" href="/brightschool/feesCollectionDetails" >Fees Collection Details</a><br/>
            </div>
            
           <!--  <h5 style="font-size: 12px"><a href="#" >Reports</a></h5>
            <div >
                <a target="mainFrame" href="/brightschool/studentsdetailsreports" >Student Details</a><br/>
