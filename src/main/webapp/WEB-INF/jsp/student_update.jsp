...
%>
<body>
	<form action="/jih/PersonalProcess/viewAll"
				...
				<tr>
					...
					<table width="70%" border="0" align="center" id="table1">
						...
						<tr>
							...
							<td><input
									name="classsec" type="text" style="text-transform:uppercase"
									value="<c:out value="${student.classstudying}" />" class="myclass"
									id="classsec" size="30" data-validate="validate(required)">
							</label></td>
							
							<td class="alignLeft">Qualification &nbsp;</td>
							<td><input
									name="accno" type="text" style="text-transform:uppercase"
									value="<c:out value="${student.accno}" />" class="myclass"
									id="accno" size="30" data-validate="validate(required)">
							</label></td>
						...
						<tr>
							...
							<td><label> <input
									...
									value="<c:out value="${student.remarks}" />" class="myclass"
									id="remarks" size="30" data-validate="validate(required)">
							</label></td>


							<td class="alignLeft" style="padding-left: 20px;">Area &nbsp;</td>
							<td><input
									name="nationality" type="text" style="text-transform:uppercase" 
									value="<c:out value="${student.nationality}" />" class="myclass"
									id="nationality" size="30" data-validate="validate(required)">
							</label></td>
						...
						<tr>
							...
							<tr>
							<td class="alignLeft">Skill &nbsp;</td>
							<td><label> <input
									name="progress" type="text" style="text-transform:uppercase" 
									value="<c:out value="${student.subsequentprogress}" />" class="myclass"
									id="progress" size="30" data-validate="validate(required)">
							</label></td>


							<td class="alignLeft" style="padding-left: 20px;">Languages Known &nbsp;</td>
							<td><input
									name="languagesstudied" type="text" style="text-transform:uppercase" 
									value="<c:out value="${student.languagesstudied}" />" class="myclass"
...
<tr>
						...
						<tr>
							...
							<td class="alignLeft" style="padding-left: 20px;">Donor's Aadhar Card No.&nbsp;</td>
							<td><label> <input
				...
				<div id="tabs-3">
					<table width="100%" border="0" align="center" >
						<tr>
							...
							<td>
                  		  	<img src="data:image;base64,<c:out value="${student.studentpic}"/>" alt="Donor's Pic" style="width: 200px;height: 200px;">
                   			 </td>
						...
						<script type="text/javascript">
							...
							function updateStudent() {
								...
								if(form1.checkValidity()) {
									form1.action = "/jih/StudentProcess/updateStudent";
									form1.submit();
								  }
							}
						</script>
