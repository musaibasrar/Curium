	...
	<form action="/abc/PersonalProcess/viewAll"
		...
		<div>
		    ...
		    <input type="hidden" value="<c:out value="${student.archive}"/>" id="archive" name="archive">
                    ...
                    <input type="hidden" value="<c:out value="${student.stream}"/>" id="stream" name="stream">
                    <input type="hidden" value="<c:out value="${student.urbanrural}"/>" id="urbanrural" name="urbanrural">
                    </td>
                    </tr>
