...
%>
<body>
	<form action="/greatindiaacademy/PersonalProcess/viewAll" modelAttribute="student"
 ...
 --%>
						...
						<tr>
							...
							<tr>
								...
								onclick="yesCheck(this.id);" ${student.belongtobpl == '1' ? 'checked' : ''}/>&nbsp; &nbsp;Residential<input
						...
						<script type="text/javascript">
							...
							function updateStudent() {
								...
								if(form1.checkValidity()) {
									form1.action = "/greatindiaacademy/StudentProcess/updateStudent";
									form1.submit();
								  }
							}
						</script>
