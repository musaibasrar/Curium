...
%>
<body>
	<form action="/alfalahschool/PersonalProcess/viewAll" modelAttribute="student"
...
<tr>
 ...
 --%>
 							<td class="alignLeft" style="padding-left: 20px;">Students Caste<br/> Cert.No.</td>
							<td><label> <input
						...
						<script type="text/javascript">
							...
							function updateStudent() {
								...
								if(form1.checkValidity()) {
									form1.action = "/alfalahschool/StudentProcess/updateStudent";
									form1.submit();
								  }
							}
						</script>
