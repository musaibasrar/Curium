...
<script src="/beaconias/js/print/jquery.printPage.js" type="text/javascript"></script>
...
function issueStaffSalary(){
	...
	form1.action = "/beaconias/HrProcess/issueProcessedSalary";
	form1.method = "POST";
	form1.submit();
...
function cancelStaffSalary(){
	var form1 = document.getElementById("form1");
	form1.action = "/beaconias/HrProcess/cancelStaffSalary";
	form1.method = "POST";
	form1.submit();
				...
				<tbody>
					   <c:forEach items="${processsalarydetailslist}" var="processsalarydetailslist">
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td class="dataText"><a id="print" href="/beaconias/HrProcess/printSalarySlip?salaryid=<c:out value="${processsalarydetailslist.idprocesssalarydetails}" />"><div align="center" align="center"><img  alt="Printsalaryslip" src="/beaconias/images/printer.png" width="30" height="30" /> <div id="" class="noti_bubbleEmpty"></div></div></a></td>
                            </tr>
                        </c:forEach>
				</tbody>
				<tfoot><tr>
