...
<script type="text/javascript"
	src="/tajacc/js/datePicker/ui/jquery.ui.dialog.js"></script>
<script type="text/javascript"
	src="/tajacc/js/datePicker/ui/jquery.ui.autocomplete.js"></script>
...
<script type="text/javascript"
	src="/tajacc/js/datePicker/ui/jquery-ui-timepicker-addon.js"></script>
<script type="text/javascript"
	src="/tajacc/js/datePicker/ui/jquery.ui.position.js"></script>
<script type="text/javascript" src="/tajacc/js/datePicker/ui/jquery.ui.mouse.js"></script>
<script type="text/javascript"
	src="/tajacc/js/datePicker/ui/jquery.ui.draggable.js"></script>
<script type="text/javascript"
	src="/tajacc/js/datePicker/ui/jquery.ui.resizable.js"></script>
    ...
    $(function() {
        ...
        $( "#effect" ).hide();
             ...
             function addPatient(){
                ...
                form1.action="/tajacc/PatientProcess/add";
                form1.submit();
            }
        </script>
<script type="text/javascript">
...
<body>
	<form id="form1"
		action="/tajacc/FeesCollection/feesAdd"
