...
<script type="text/javascript"
	src="/littleangels/js/datePicker/ui/jquery.ui.dialog.js"></script>
<script type="text/javascript"
	src="/littleangels/js/datePicker/ui/jquery.ui.autocomplete.js"></script>
...
<script type="text/javascript"
	src="/littleangels/js/datePicker/ui/jquery-ui-timepicker-addon.js"></script>
<script type="text/javascript"
	src="/littleangels/js/datePicker/ui/jquery.ui.position.js"></script>
<script type="text/javascript" src="/littleangels/js/datePicker/ui/jquery.ui.mouse.js"></script>
<script type="text/javascript"
	src="/littleangels/js/datePicker/ui/jquery.ui.draggable.js"></script>
<script type="text/javascript"
	src="/littleangels/js/datePicker/ui/jquery.ui.resizable.js"></script>
    ...
    $(function() {
        ...
        $( "#effect" ).hide();
             ...
             function addPatient(){
                ...
                form1.action="/littleangels/PatientProcess/add";
                form1.submit();
            }
        </script>
<script type="text/javascript">
            ...
            function searchForFees() {
        		var form1 = document.getElementById("form1");
        		form1.action = "/littleangels/StampFeesProcess/search";
        		form1.method = "POST";
        		form1.submit();
...
<body>
	<form id="form1"
		action="/littleangels/FeesCollection/feesAdd"
						...
						<c:forEach items="${searchStudentList}" var="Parents">
							...
							<tr class="trClass" style="border-color: #000000" border="1"
								...
								<td class="dataTextInActive"><a class="dataTextInActive"
									href="/littleangels/StudentProcess/ViewDetails?id=<c:out value='${Parents.student.sid}'/>"><c:out
