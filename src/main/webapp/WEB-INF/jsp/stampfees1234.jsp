...
<script type="text/javascript"
	src="/pips/js/datePicker/ui/jquery.ui.dialog.js"></script>
<script type="text/javascript"
	src="/pips/js/datePicker/ui/jquery.ui.autocomplete.js"></script>
...
<script type="text/javascript"
	src="/pips/js/datePicker/ui/jquery-ui-timepicker-addon.js"></script>
<script type="text/javascript"
	src="/pips/js/datePicker/ui/jquery.ui.position.js"></script>
<script type="text/javascript" src="/pips/js/datePicker/ui/jquery.ui.mouse.js"></script>
<script type="text/javascript"
	src="/pips/js/datePicker/ui/jquery.ui.draggable.js"></script>
<script type="text/javascript"
	src="/pips/js/datePicker/ui/jquery.ui.resizable.js"></script>
    ...
    $(function() {
        ...
        $( "#effect" ).hide();
             ...
             function addPatient(){
                ...
                form1.action="/pips/PatientProcess/add";
                form1.submit();
            }
        </script>
<script type="text/javascript">
            ...
            function searchForFees() {
        		var form1 = document.getElementById("form1");
        		form1.action = "/pips/StampFeesProcess/search";
        		form1.method = "POST";
        		form1.submit();
...
<body>
	<form id="form1"
		action="/pips/FeesCollection/feesAdd"
