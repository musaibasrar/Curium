...
<script type="text/javascript">
	...
	function searchStaffAttendanceDetailsMonthly() {
		...
		if(form1.checkValidity()) {
			form1.action = "/futurestars/AttendanceProcess/searchStaffAttendanceDetailsMonthly";
			form1.method = "POST";
			form1.submit();
		  }
	}
	...
	function searchStaffAttendanceDetails() {
		var form1 = document.getElementById("form1");
		form1.action = "/futurestars/AttendanceProcess/searchStaffAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	}
	...
	function updateRecords(){
		var form1 = document.getElementById("form1");
		form1.action = "/futurestars/AttendanceProcess/updateStaffAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	}
