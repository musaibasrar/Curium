...
<script src="/flora/js/Chart.js"></script>
...
<link rel="stylesheet" href="/flora/css/graph/jquery.jqplot.min.css">
  ...
  <script type="text/javascript" src="/flora/js/datePicker/jquery-1.7.1.js"></script>
        ...
        <script src="/flora/js/jquery.jqplot.min.js" ></script>
        <script src="/flora/js/graph/plugins/jqplot.pieRenderer.min.js" ></script> 
...
<script type="text/javascript">
	...
	function searchStaffAttendanceDetailsMonthly() {
		...
		if(form1.checkValidity()) {
			form1.action="/flora/AttendanceProcess/searchStaffAttendanceDetailsMonthly";
			form1.method = "POST";
			form1.submit();
		  }
	}
	...
	function searchStaffAttendanceDetails() {
		var form1 = document.getElementById("form1");
		form1.action="/flora/AttendanceProcess/searchStaffAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	}
	...
	function updateRecords(){
		var form1 = document.getElementById("form1");
		form1.action="/flora/AttendanceProcess/updateStaffAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	}
...
<jsp:useBean id="now" class="java.util.Date" scope="page" />
	<form id="form1" action="/flora/StampFeesProcess/applyFees" method="POST">
