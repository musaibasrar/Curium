...
<script src="/lflower/js/Chart.js"></script>
...
<link rel="stylesheet" href="/lflower/css/graph/jquery.jqplot.min.css">
  ...
  <script type="text/javascript" src="/lflower/js/datePicker/jquery-1.7.1.js"></script>
        ...
        <script src="/lflower/js/jquery.jqplot.min.js" ></script>
        <script src="/lflower/js/graph/plugins/jqplot.pieRenderer.min.js" ></script> 
...
<script type="text/javascript">
	...
	function searchStaffAttendanceDetailsMonthly() {
		...
		if(form1.checkValidity()) {
			form1.action="/lflower/AttendanceProcess/searchStaffAttendanceDetailsMonthly";
			form1.method = "POST";
			form1.submit();
		  }
	}
	...
	function searchStaffAttendanceDetails() {
		var form1 = document.getElementById("form1");
		form1.action="/lflower/AttendanceProcess/searchStaffAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	}
	...
	function updateRecords(){
		var form1 = document.getElementById("form1");
		form1.action="/lflower/AttendanceProcess/updateStaffAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	}
...
<jsp:useBean id="now" class="java.util.Date" scope="page" />
	<form id="form1" action="/lflower/StampFeesProcess/applyFees" method="POST">
