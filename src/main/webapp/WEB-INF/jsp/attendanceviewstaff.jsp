...
<script src="/rauzamission/js/Chart.js"></script>
...
<link rel="stylesheet" href="/rauzamission/css/graph/jquery.jqplot.min.css">
  ...
  <script type="text/javascript" src="/rauzamission/js/datePicker/jquery-1.7.1.js"></script>
        ...
        <script src="/rauzamission/js/jquery.jqplot.min.js" ></script>
        <script src="/rauzamission/js/graph/plugins/jqplot.pieRenderer.min.js" ></script> 
...
<script type="text/javascript">
	...
	function searchStaffAttendanceDetailsMonthly() {
		...
		if(form1.checkValidity()) {
			form1.action="/rauzamission/AttendanceProcess/searchStaffAttendanceDetailsMonthly";
			form1.method = "POST";
			form1.submit();
		  }
	}
	...
	function searchStaffAttendanceDetails() {
		var form1 = document.getElementById("form1");
		form1.action="/rauzamission/AttendanceProcess/searchStaffAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	}
	...
	function updateRecords(){
		var form1 = document.getElementById("form1");
		form1.action="/rauzamission/AttendanceProcess/updateStaffAttendanceDetails";
		form1.method = "POST";
		form1.submit();
	}
