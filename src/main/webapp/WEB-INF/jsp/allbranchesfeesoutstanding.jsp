...
<script type="text/javascript">
	...
	function searchForStudents() {
		...
		form1.action = "/alfarooq/FeesCollection/searchFeesReportOutstandingFeesAllBranches";
		form1.method = "POST";
		form1.submit();
...
<body>
	<form id="form1" action="/alfarooq/FeesCollection/exportDataForStudentsFeesReport" method="POST">
		...
		<div id="effect" class="ui-widget-content ui-corner-all">
			<div id="tabs">
				<ul>
					<li><a href="#tabs-1">All Branches Fees Outstanding</a></li>
					...
					<table>
                        ...
                        <td style="font-weight: bold;color:#325F6D">Branch:&nbsp;&nbsp;&nbsp;&nbsp;</td> 
                        	...
                        	<td>
									...
									style="width: 120px">
										<option></option>
										<c:forEach var="branches" items="${branchdetail}">
        										<option value="${branches.idbranch}">${branches.branchname}</option>
    									</c:forEach>
										</select>
