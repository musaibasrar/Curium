    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 45px;">
								...
								<a target="mainFrame" href="/theage/welcome" >
								<img src="/theage/images/curiumheader.png" width="112" height="41"/>
								</a>
								</td>
								
							<!-- <td align="left"><img src="/theage/images/theageheader.png"
								style="width: 200px; height: 20px;" /></td> -->

							<td><a href="javascript:parent.toggleLeftFrame()" style="cursor: pointer;"> <img
									src="/theage/images/menu.svg" width="18" height="18" 
									alt="Toggle Menu" style="vertical-align: bottom;" />
							</a></td>
							
							<td><a target="leftFrame" href="/theage/left_admin"> <img
									src="/theage/images/home.svg" width="18" height="18" 
									alt="Home" style="vertical-align: bottom;font-size: 144px;" />Home
							</a></td>

							<td><a target="mainFrame"
								href="/theage/FeesProcess/feesCollect"> <img
									src="/theage/images/feescollect.svg" width="18" height="18"
							...
							<td ><a target="leftFrame" href="/theage/leftsettings">
							...
							<td ><!-- <a target="mainFrame" href="/theage/sendsms"><img
								...
								<a target="leftFrame" href="/theage/reports"><img
							...
							<td ><a target="mainFrame"
								href="/theage/dashboardloader"><img
