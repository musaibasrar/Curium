    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 45px;">
								...
								<a target="mainFrame" href="/littleangel/welcome" >
								<img src="/littleangel/images/curiumheader.png" width="112" height="41"/>
								</a>
								</td>
								
							<!-- <td align="left"><img src="/littleangel/images/littleangelheader.png"
								style="width: 200px; height: 20px;" /></td> -->
							<td><a target="leftFrame" href="/littleangel/left_admin"> <img
							...
							<td ><a target="mainFrame"
								href="/littleangel/dashboardloader"><img
