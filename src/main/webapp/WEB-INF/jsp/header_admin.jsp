    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 45px;">
								...
								<a target="mainFrame" href="/greatindiaacademy/welcome" >
								<img src="/greatindiaacademy/images/curiumheader.png" width="112" height="41"/>
								</a>
								</td>
								
							<!-- <td align="left"><img src="/greatindiaacademy/images/greatindiaacademyheader.png"
								style="width: 200px; height: 20px;" /></td> -->

							<td><a href="javascript:parent.toggleLeftFrame()" style="cursor: pointer;"> <img
									src="/greatindiaacademy/images/menu.svg" width="18" height="18" 
									alt="Toggle Menu" style="vertical-align: bottom;" />
							</a></td>
							
							<td><a target="leftFrame" href="/greatindiaacademy/left_admin"> <img
									src="/greatindiaacademy/images/home.svg" width="18" height="18" 
									alt="Home" style="vertical-align: bottom;font-size: 144px;" />Home
							</a></td>

							<td><a target="mainFrame"
								href="/greatindiaacademy/FeesProcess/feesCollect"> <img
									src="/greatindiaacademy/images/feescollect.svg" width="18" height="18"
							...
							<td><a target="mainFrame"
								href="/greatindiaacademy/StudentProcess/addNew"> <img
									src="/greatindiaacademy/images/student_header.svg" width="18" height="18"
									alt="Add New Student" style="vertical-align: bottom;" />Add Student
							</a></td>

							<td ><a target="leftFrame" href="/greatindiaacademy/leftsettings">
							...
							<td ><!-- <a target="mainFrame" href="/greatindiaacademy/sendsms"><img
									src="/greatindiaacademy/images/sendmessage.svg" width="18" height="18" alt="Send SMS" style="vertical-align: bottom;"/>
									Send Message		
							</a> -->
								<a target="leftFrame" href="/greatindiaacademy/reports"><img
									src="/greatindiaacademy/images/reports.svg" width="18" height="18" alt="Reports" style="vertical-align: bottom;"/>
									Reports		
								</a>
								
								<!-- <a target="leftFrame" href="/greatindiaacademy/reports_officeadmin"><img
									src="/greatindiaacademy/images/reports.svg" width="18" height="18" alt="Reports" style="vertical-align: bottom;"/>
									Reports		
								</a> -->
							...
							<td ><a target="mainFrame"
								href="/greatindiaacademy/StudentProcess/viewAllStudentsWithParents"><img
									alt="View All Students" src="/greatindiaacademy/images/students.svg" width="18"
									height="18" style="vertical-align: bottom;"/>
								View Students
							</a></td>
							
							<td ><a target="mainFrame"
								href="/greatindiaacademy/dashboardloader"><img
									alt="Dash Board" src="/greatindiaacademy/images/dashboard.svg" width="18"
									height="18" style="vertical-align: bottom;"/>
									Dash Board
									</a></td>
								
							<td ><a target="_parent"
								href="/greatindiaacademy/UserProcess/logout"><img
									src="/greatindiaacademy/images/logout.svg" width="18" height="18" alt="Log Out" 
