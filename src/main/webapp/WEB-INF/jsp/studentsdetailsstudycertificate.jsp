...
<script type="text/javascript">
	function searchStudentsForBonafide() {
		...
		form1.action = "/sanmarg/DocumentsProcess/searchStudentsForStudyCertificate";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/sanmarg/DocumentsProcess/GenerateStudyCertificate" method="POST">
