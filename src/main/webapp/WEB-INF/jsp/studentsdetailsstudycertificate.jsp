...
<script type="text/javascript">
	function searchStudentsForBonafide() {
		...
		form1.action = "/hamidullah/DocumentsProcess/searchStudentsForStudyCertificate";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/hamidullah/DocumentsProcess/GenerateStudyCertificate" method="POST">
