...
<script type="text/javascript">
	function searchStudentsForBonafide() {
		...
		form1.action = "/brainystars/DocumentsProcess/searchStudentsForStudyCertificate";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/brainystars/DocumentsProcess/GenerateStudyCertificate" method="POST">
