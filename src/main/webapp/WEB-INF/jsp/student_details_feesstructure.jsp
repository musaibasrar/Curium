    ...
    font-weight: bold;
        ...
        <script type="text/javascript">
            ...
            function searchFeesStructure() {
                ...
                form1.action = "/vasu/StudentProcess/feesStructurePerYear?id="+id;
                form1.submit();
            ...
            function deleteRecord() {
                ...
                var form1 = document.getElementById("form1");
                form1.action = "/vasu/FeesProcess/deleteFeesCategory";
                form1.submit();
            ...
            function waiveOff() {
                ...
                var form1 = document.getElementById("form1");
                form1.action = "/vasu/FeesProcess/waiveOffFees";
                form1.submit();
            ...
            function applyConcession() {
                ...
                var form1 = document.getElementById("form1");
                form1.action = "/vasu/FeesProcess/applyConcession";
                form1.submit();
...
%>
    <body background="/images/bg.jpg">
        ...
        <form  method="post" id="form1">
            ...
            <table width="100%">
                <tr>
                    <td  class="headerTD">Permanent Number: &nbsp;<c:out value="${student.studentexternalid}" />&nbsp;&nbsp; NAME: &nbsp;<c:out value="${student.name}" />&nbsp;&nbsp; Class: &nbsp;<c:out value="${student.classstudying}" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <tr>
                                        <td align="left">
                                            ...
                                            <!-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                             ...
                                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                             <button id="print" onclick="window.location.href='/vasu/printstudentdetailsfeesstructure'">Print</button>
