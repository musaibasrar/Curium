...
.btn:hover, .btn:focus{
	...
	<div class="container-fluid">
		...
		<!-- 	<div class="col-md-4 text-center company__info">
			...
			<h2><img border="0" style="vertical-align: text-bottom;height: 80px;width: 100px;" alt="ideoholic" src="/peace/images/peace/.png"></h2>
			<h2 style="font-weight: bold;">Roshan<img border="0" style="vertical-align: text-bottom;height: 120px;width: 200px;" alt="ideoholic" src="/peace/images/shaheenwhitelogo.png"> </h2></span>
			</div>
			<div class="col-md-8 col-xs-12 col-sm-12 login_form ">
				<div class="container-fluid">
					...
					<div class="row">
						<form action="/peace/UserProcess/authenticateUser"  method="post" class="form-group">
							<div class="row">
