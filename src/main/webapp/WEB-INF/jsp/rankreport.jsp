...
<script type="text/javascript">
	function searchForReports() {
		...
		form1.action = "/greatindiaacademy/MarksDetailsProcess/searchForRank";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/greatindiaacademy/MarksDetailsProcess/generateRankReport" method="POST">
