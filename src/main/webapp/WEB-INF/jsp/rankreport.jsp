...
<script type="text/javascript">
	function searchForReports() {
		...
		form1.action = "/childrenandglobal/MarksDetailsProcess/searchForRank";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/childrenandglobal/MarksDetailsProcess/generateRankReport" method="POST">
