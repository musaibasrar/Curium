...
<title>Deenyaat Progress Card</title>
...
<script type="text/javascript">
	function searchForReports() {
		...
		form1.action = "/brainystars/MarksDetailsProcess/searchForDeenyaatReport";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/brainystars/MarksDetailsProcess/generateDeenyaatReport" method="POST">
		...
		<div id="effect" class="ui-widget-content ui-corner-all">
			<div id="tabs">
				<ul>
					<li><a href="#tabs-1">Deenyaat Progress Report</a></li>
