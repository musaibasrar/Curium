			...
			<tbody>
						...
						<c:forEach items="${parenttaskslist}" var="task" varStatus="status">
                            <tr>
                                ...
                                <td class="datatd" style="font-size: 9px;"><c:out value="${task.teacher.teachername}"/><br></td>
                                ...
                                <td class="datatd" style="font-size: 9px;"><fmt:formatDate pattern="dd/MM/yyyy" value="${task.jobquery.expecteddeliverydate}"/></td>
