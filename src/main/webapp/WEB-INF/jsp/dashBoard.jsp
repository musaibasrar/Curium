...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/syedbarey/css/datePicker/jquery-ui-1.8.17.custom.css">
        <link rel="stylesheet" href="/syedbarey/css/datePicker/demos.css">
        <!--<script type="text/javascript" language="javascript" src="/syedbarey/js/dataTable/jquery.js"></script>-->
        ...
        <script type="text/javascript" src="/syedbarey/js/datePicker/ui/jquery.ui.button.js"></script>
...
-->
        ...
        <script type="text/javascript">
            ...
            function ViewAll(){
                ...
                form1.action="/syedbarey/PersonalProcess/viewAll";
                form1.submit();
            }
        </script>
