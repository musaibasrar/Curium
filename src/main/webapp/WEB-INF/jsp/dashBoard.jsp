...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/fathima/css/datePicker/jquery-ui-1.8.17.custom.css">
        <link rel="stylesheet" href="/fathima/css/datePicker/demos.css">
        <!--<script type="text/javascript" language="javascript" src="/fathima/js/dataTable/jquery.js"></script>-->
...
-->
        ...
        <script type="text/javascript">
            ...
            function ViewAll(){
                ...
                form1.action="/fathima/PersonalProcess/viewAll";
                form1.submit();
            }
        </script>
