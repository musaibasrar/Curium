...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/bbis/css/datePicker/jquery-ui-1.8.17.custom.css">
        <link rel="stylesheet" href="/bbis/css/datePicker/demos.css">
        <!--<script type="text/javascript" language="javascript" src="/bbis/js/dataTable/jquery.js"></script>-->
        ...
        <script type="text/javascript" src="/bbis/js/datePicker/ui/jquery.ui.button.js"></script>
...
-->
        ...
        <script type="text/javascript">
            ...
            function ViewAll(){
                ...
                form1.action="/bbis/PersonalProcess/viewAll";
                form1.submit();
            }
        </script>
