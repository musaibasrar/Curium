...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/orion/css/datePicker/jquery-ui-1.8.17.custom.css">
        <link rel="stylesheet" href="/orion/css/datePicker/demos.css">
        <!--<script type="text/javascript" language="javascript" src="/orion/js/dataTable/jquery.js"></script>-->
        <script type="text/javascript" src="/orion/js/datePicker/jquery-1.7.1.js"></script>
        <script type="text/javascript" language="javascript" src="/orion/js/dataTable/jquery.dataTables.js"></script>
        ...
        <script type="text/javascript" src="/orion/js/datePicker/ui/jquery.ui.button.js"></script>
...
-->
        ...
        <script type="text/javascript">
            ...
            function ViewAll(){
                ...
                form1.action="/orion/PersonalProcess/viewAll";
                form1.submit();
            }
        </script>
