    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 45px;">
								...
								<a target="mainFrame" href="/dolphin/welcome" >
								<img src="/dolphin/images/curiumheader.png" width="112" height="41"/>
								</a>
								</td>
							...
							<!-- <td align="left"><img src="/dolphin/images/dolphinheader.png"
								...
								<td><a href="javascript:parent.toggleLeftFrame()" style="cursor: pointer;"> <img
									src="/dolphin/images/menu.svg" width="18" height="18" 
									alt="Toggle Menu" style="vertical-align: bottom;" />
							</a></td>
							
							<td>
							<a target="leftFrame" href="/dolphin/left_teacher"><img
									src="/dolphin/images/home.svg" width="18" height="18" alt="Reports" style="vertical-align: bottom;"/>
									Home		
								</a>
							</td>
							
							<td>
							<a target="leftFrame" href="/dolphin/reports_teacher"><img
