    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 45px;">
							...
							<td>
							<a target="leftFrame" href="${ctx}/left_teacher"><img
									src="${imagesPath}/home.svg" width="18" height="18" alt="Reports" style="vertical-align: bottom;"/>
									Home		
								</a>
							</td>
							
							<td>
							<a target="leftFrame" href="${ctx}/reports_teacher"><img
