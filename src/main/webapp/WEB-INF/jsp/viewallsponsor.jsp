...
<html >
    <head >
        ...
        <link rel="stylesheet" href="/hira/css/datePicker/jquery-ui-1.8.17.custom.css">
        <link rel="stylesheet" href="/hira/css/datePicker/demos.css">
        <!--<script type="text/javascript" language="javascript" src="/hira/js/dataTable/jquery.js"></script>-->
        <script type="text/javascript" src="/hira/js/datePicker/jquery-1.7.1.js"></script>
        <script type="text/javascript" language="javascript" src="/hira/js/dataTable/jquery.dataTables.js"></script>
        ...
        <script type="text/javascript" src="/hira/js/datePicker/ui/jquery.ui.button.js"></script>
        <style type="text/css" >
            <!--
            .header {
        ...
        <script type="text/javascript">
            ...
            function refreshPage(){
                 var form1=document.getElementById("form1");
                form1.action="/hira/PersonalProcess/ViewAllGo";
                form1.submit();
            ...
            function redirect(){
                 var form1=document.getElementById("form1");
                    form1.action="/hira/PersonalProcess/redirect";
                    form1.submit();
            ...
            function createQuery(tid,branchid){
                var form1=document.getElementById("form1");
               form1.action="/hira/JobProcess/CreateQuery?id="+tid+"&urlbranchid="+branchid+"";
               form1.submit();
            }
        </script>
    </head>
...
%>
    <body  >
        ...
        <form name="form1" id="form1"action="/hira/SponserProcess/deleteMultiple" method="post">
                    ...
                    <tbody>
                        <c:forEach items="${sponsorlist}" var="sponsor">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive" style="text-transform:uppercase"><a class="dataTextInActive" href="/hira/SponserProcess/viewDetailsSponsor?id=<c:out value='${sponsor.id}'/>"><c:out value="${sponsor.name}"/></a></td>
            ...
            <div align="center">
             <%--For displaying Previous link except for the 1st page --%>
                <c:if test="${currentPage != 1}">
                    <td><a style="color: #4B6A84;font-size: 12px" href="/hira/PersonalProcessPages&page=${currentPage - 1}">Previous</a></td>
                </c:if>
                    ...
                    <tr>
                        <c:forEach begin="1" end="${noOfPages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <td style="color: black;font-weight:bold;font-size: 15px "><a style="color: #4B6A84" href="/hira/PersonalProcessPages&page=${i}">${i}</a></td>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                    </tr>
                ...
                <c:if test="${currentPage lt noOfPages}">
                    <td ><a style="color: #4B6A84;font-size: 12px" href="/hira/PersonalProcessPages&page=${currentPage + 1}">Next</a></td>
                </c:if>
                    </div>
