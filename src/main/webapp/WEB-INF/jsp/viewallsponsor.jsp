    ...
    <head >
        ...
        <script type="text/javascript">
            ...
            function createQuery(tid,branchid){
                var form1=document.getElementById("form1");
               form1.action="/noble/JobProcess/CreateQuery?id="+tid+"&urlbranchid="+branchid+"";
               form1.submit();
            }
        </script>
    </head>
...
%>
    <body  >
        ...
        <form name="form1" id="form1"action="/noble/SponserProcess/deleteMultiple" method="post">
                    ...
                    <tbody>
                        <c:forEach items="${sponsorlist}" var="sponsor">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive" style="text-transform:uppercase"><a class="dataTextInActive" href="/noble/SponserProcess/viewDetailsSponsor?id=<c:out value='${sponsor.id}'/>"><c:out value="${sponsor.name}"/></a></td>
