    ...
    <head >
        ...
        <script type="text/javascript">
            ...
            function refreshPage(){
                 var form1=document.getElementById("form1");
                form1.action="/sac/PersonalProcess/ViewAllGo";
                form1.submit();
            ...
            function redirect(){
                 var form1=document.getElementById("form1");
                    form1.action="/sac/PersonalProcess/redirect";
                    form1.submit();
            ...
            function createQuery(tid,branchid){
                var form1=document.getElementById("form1");
               form1.action="/sac/JobProcess/CreateQuery?id="+tid+"&urlbranchid="+branchid+"";
               form1.submit();
            }
        </script>
    </head>
...
%>
    <body  >
        ...
        <form name="form1" id="form1"action="/sac/SponserProcess/deleteMultiple" method="post">
                    ...
                    <tbody>
                        <c:forEach items="${sponsorlist}" var="sponsor">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive" style="text-transform:uppercase"><a class="dataTextInActive" href="/sac/SponserProcess/viewDetailsSponsor?id=<c:out value='${sponsor.id}'/>"><c:out value="${sponsor.name}"/></a></td>
            ...
            <div align="center">
             <%--For displaying Previous link except for the 1st page --%>
                <c:if test="${currentPage != 1}">
                    <td><a style="color: #4B6A84;font-size: 12px" href="/sac/PersonalProcessPages&page=${currentPage - 1}">Previous</a></td>
                </c:if>
                    ...
                    <tr>
                        <c:forEach begin="1" end="${noOfPages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <td style="color: black;font-weight:bold;font-size: 15px "><a style="color: #4B6A84" href="/sac/PersonalProcessPages&page=${i}">${i}</a></td>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                    </tr>
                ...
                <c:if test="${currentPage lt noOfPages}">
                    <td ><a style="color: #4B6A84;font-size: 12px" href="/sac/PersonalProcessPages&page=${currentPage + 1}">Next</a></td>
                </c:if>
                    </div>
