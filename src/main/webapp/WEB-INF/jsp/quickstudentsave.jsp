...
<script src="/iqraschool/js/datePicker/jquery-1.7.1.js"></script>
<script src="/iqraschool/js/datePicker/ui/jquery.ui.core.js"></script>
...
<script src="/iqraschool/js/validation/jquery.ketchup.all.min.js"></script>
<script type="text/javascript"
...
<link href="/iqraschool/css/select2.min.css" rel="stylesheet" />
<script src="/iqraschool/js/select2.min.js"></script>
...
<script>
    ...
    function searchfeecategory() {
    	...
    	if (!addClass) {
			...
			xmlHttp.onreadystatechange = stateChanged;
			xmlHttp.open("GET", "/iqraschool/FeesProcess/searchfeecategory?classstudying="+addClass+"&yearofadmission="+yoa+"&feescategories="+checkedFeesCategoryValues+"",true);
			xmlHttp.send(null);
...
function searchOtherFeecategory() {
    ...
    xmlHttpof.open("GET", "/iqraschool/FeesProcess/searchOtherFeecategory?classstudying="+addClass+"&yearofadmission="+yoa, true);
    xmlHttpof.send(null);
}
</script>
<script>
...
<script type="text/javascript" charset="utf-8">
        ...
        function searchListOfParent() {
            ...
            xmlHttpParent.open(
                "GET",
                "/iqraschool/StudentProcess/searchListOfParent",
                true
            );
	...
	function searchStudentDuplicate() {
		...
		xmlHttp2.open(
			"GET",
			"/iqraschool/StudentProcess/checkDuplicateStudent?"
	...
	<script type="text/javascript">
							function addStudent() {
								...
								if(form1.checkValidity()) {
									...
									form1.action = "/iqraschool/StudentProcess/AddStudent";
									form1.submit();
								  }
							}
