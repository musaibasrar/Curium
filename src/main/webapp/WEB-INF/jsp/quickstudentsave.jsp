...
<script src="/awami/js/datePicker/jquery-1.7.1.js"></script>
<script src="/awami/js/datePicker/ui/jquery.ui.core.js"></script>
...
<script src="/awami/js/validation/jquery.ketchup.all.min.js"></script>
<script type="text/javascript"
...
<script>
    ...
    function searchfeecategory() {
    	...
    	if (!addClass) {
			...
			xmlHttp.onreadystatechange = stateChanged;
			xmlHttp.open("GET", "/awami/FeesProcess/searchfeecategory?classstudying="+addClass+"&yearofadmission="+yoa+"&feescategories="+checkedFeesCategoryValues+"",true);
			xmlHttp.send(null);
...
function searchOtherFeecategory() {
    ...
    xmlHttpof.open("GET", "/awami/FeesProcess/searchOtherFeecategory?classstudying="+addClass+"&yearofadmission="+yoa, true);
    xmlHttpof.send(null);
}
</script>
<script>
...
<script type="text/javascript" charset="utf-8">
        ...
        function searchListOfParent() {
            ...
            xmlHttpParent.open(
                "GET",
                "/awami/StudentProcess/searchListOfParent",
                true
            );
	...
	<script type="text/javascript">
							function addStudent() {
								...
								if(form1.checkValidity()) {
									...
									form1.action = "/awami/StudentProcess/AddStudent";
									form1.submit();
								  }
							}
