...
<script src="/salihath/js/datePicker/jquery-1.7.1.js"></script>
<script src="/salihath/js/datePicker/ui/jquery.ui.core.js"></script>
...
<script src="/salihath/js/datePicker/ui/jquery.ui.tabs.js"></script>
...
<script src="/salihath/js/validation/jquery.ketchup.all.min.js"></script>
<script type="text/javascript"
...
<link href="/salihath/css/select2.min.css" rel="stylesheet" />
<script src="/salihath/js/select2.min.js"></script>
...
<script>
    ...
    function searchfeecategory() {
    	...
    	if (!addClass) {
			...
			xmlHttp.onreadystatechange = stateChanged;
			xmlHttp.open("GET", "/salihath/FeesProcess/searchfeecategory?classstudying="+addClass+"&yearofadmission="+yoa+"&feescategories="+checkedFeesCategoryValues+"",true);
			xmlHttp.send(null);
...
function searchOtherFeecategory() {
    ...
    xmlHttpof.open("GET", "/salihath/FeesProcess/searchOtherFeecategory?classstudying="+addClass+"&yearofadmission="+yoa, true);
    xmlHttpof.send(null);
}
</script>
<script>
...
<script type="text/javascript" charset="utf-8">
        ...
        function searchListOfParent() {
            ...
            xmlHttpParent.open(
                "GET",
                "/salihath/StudentProcess/searchListOfParent",
                true
            );
	...
	function searchStudentDuplicate() {
		...
		xmlHttp2.open(
			"GET",
			"/salihath/StudentProcess/checkDuplicateStudent?"
	...
	<script type="text/javascript">
							function addStudent() {
								...
								if(form1.checkValidity()) {
									...
									form1.action = "/salihath/StudentProcess/AddStudent";
									form1.submit();
								  }
							}
