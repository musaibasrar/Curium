...
<script type="text/javascript">
	...
	function saveissueentry() {
		...
		if(form1.checkValidity()) {
			form1.action = "/genius/MessItemsMoveProcess/saveStockMove";
			form1.method = "POST";
			form1.submit();
		}
	...
	function cancelRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/genius/MessItemsMoveProcess/cancelStockMove";
		form1.method = "POST";
		form1.submit();
	...
	function generatebill(cashpayment,banktransfer,chequetransfer,ackno,transferdate,transferbankname,chequeno,chequedate,chequebankname,totalcashamount,totalbanktransferamount,
 	...
 	function getLastPrice(rowIndex){
 		...
 		var customerName = document.getElementById('issuedto').value;
 			...
 			xmlHttp.open("GET", "/genius/MessItemsMoveProcess/getCustomerLastPrice?customerName="+customerName+"&itemid="+itemId+"",true);
 			xmlHttp.send(null);
 	}
							...
							<td>
								<div class="container">
										<div class="row">
										        ...
										        </select><!-- &nbsp;&nbsp;<a target="mainFrame" href="/genius/StudentProcess/addNew">New Customer --></a>
									 	</div>
								</div>
							</td>
