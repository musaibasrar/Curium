...
<link href="/shbranchtl/css/select2.min.css" rel="stylesheet" />
<script src="/shbranchtl/js/select2.min.js"></script>
...
<script type="text/javascript">
	...
	function saveissueentry() {
		...
		if(form1.checkValidity()) {
			form1.action = "/shbranchtl/MessItemsMoveProcess/saveStockMove";
			form1.method = "POST";
			form1.submit();
		}
	...
	function cancelRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/shbranchtl/MessItemsMoveProcess/cancelStockMove";
		form1.method = "POST";
		form1.submit();
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/shbranchtl/AdminProcess/printVoucher";
		form1.method = "POST";
		form1.submit();
	}
	...
	function approveRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/shbranchtl/AdminProcess/approveVoucher";
		form1.method = "POST";
		form1.submit();
	}
	...
	function rejectRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/shbranchtl/AdminProcess/rejectVoucher";
		form1.method = "POST";
		form1.submit();
	}
	...
	function generatebill(cashpayment,banktransfer,chequetransfer,ackno,transferdate,transferbankname,chequeno,chequedate,chequebankname,totalcashamount,totalbanktransferamount,
 	...
 	function getLastPrice(rowIndex){
 		...
 		var customerName = document.getElementById('issuedto').value;
 			...
 			xmlHttp.open("GET", "/shbranchtl/MessItemsMoveProcess/getCustomerLastPrice?customerName="+customerName+"&itemid="+itemId+"",true);
 			xmlHttp.send(null);
 	}
							...
							<td>
								<div class="container">
										<div class="row">
										        ...
										        </select><!-- &nbsp;&nbsp;<a target="mainFrame" href="/shbranchtl/StudentProcess/addNew">New Customer --></a>
									 	</div>
								</div>
							</td>
