...
<script type="text/javascript">
	...
	function searchForEmployees(staffName, staffDepartment){
		...
		form1.action = "/rkgnyanaganga/HrProcess/searchEmployees?staffName="+staffName+"&staffDepartment="+staffDepartment+"";
		form1.method = "POST";
		form1.submit();
	...
	function applyLeave() {
		var form1 = document.getElementById("form1");
		form1.action = "/rkgnyanaganga/HrProcess/applyLeave";
		form1.method = "POST";
		form1.submit();
	}
