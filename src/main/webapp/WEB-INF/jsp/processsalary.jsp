...
<script type="text/javascript">
	...
	function searchForEmployees(staffName, staffDepartment){
		...
		form1.action="/kwrs/HrProcess/searchEmployeesForProcessSalary?staffName="+staffName+"&staffDepartment="+staffDepartment+"";
		form1.method = "POST";
		form1.submit();
...
function processStaffSalary(){
	var form1 = document.getElementById("form1");
	form1.action="/kwrs/HrProcess/processStaffSalary";
	form1.method = "POST";
	form1.submit();
