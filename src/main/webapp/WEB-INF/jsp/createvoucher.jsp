...
<html>
    <head>
        ...
        <script type="text/javascript" src="/greatindiaacademy/js/jquery-1.7.1.min.js"></script>
        ...
        <style type="text/css">
            ...
            .style1 { <link rel="stylesheet" href="/greatindiaacademy/https://cdnjs.cloudflare.com/ajax/libs/jquery-confirm/3.3.2/jquery-confirm.min.css">
		<script src="/greatindiaacademy/https://cdnjs.cloudflare.com/ajax/libs/jquery-confirm/3.3.2/jquery-confirm.min.js"></script>
                font-family: Tahoma;
                font-size: 14px;
            }
            .style2 {
    ...
    function saveReceipt(){
    	...
    	if(document.getElementById("dramount").vlaue == 0 || document.getElementById("cramountsecond").value == 0){
        	...
        	if(confirm('Are you sure,you want to save the receipt voucher?')){
                ...
                form1.action = "/greatindiaacademy/AccountProcess/saveReceipt";
                form1.submit();	
        	}
    ...
    function savePayment(){
    	...
    	if(document.getElementById("dramountpayment").vlaue == 0 || document.getElementById("cramountpaymentsecond").value == 0){
        	  ...
        	  if(confirm('Are you sure,you want to save the payment voucher?')){
        		  ...
        		  var form1 = document.getElementById("form1");
              	  form1.action = "/greatindiaacademy/AccountProcess/savePayment";
              	  form1.submit();
    ...
    function saveContra(){
      ...
      if(accountOne == accountTwo){
    	  ...
    	  var form1 = document.getElementById("form1");
          form1.action = "/greatindiaacademy/AccountProcess/saveContra";
          form1.submit();
    	  }
      }
    ...
    function saveJournal(){
    	...
    	if(document.getElementById("dramountjournal").value == 0 || document.getElementById("cramountjournalsecond").value == 0){
        	...
        	if(confirm('Are you sure,you want to save the journal voucher?')){
        	 var form1 = document.getElementById("form1");
             form1.action = "/greatindiaacademy/AccountProcess/saveJournal";
             form1.submit();
        	}
        }
    }
