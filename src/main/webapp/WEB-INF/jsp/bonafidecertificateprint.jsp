...
<body style="text-align: center" class="bodymargin">
	...
	<form method="post" class="bodymargin">
		...
		<table align="center">
			...
			<tr>
			<td>
			<img border="0" style="vertical-align: text-bottom;height: 105px;width: 100px;" alt="logo" src="/sky/images/sky.png">
			</td>
				<td >
					<br>
		...
		<td></td>
			...
			<tr>
              <td align="center"><a id="print" href="/sky/DocumentsProcess/printBonafide">Print</a></td>
            </tr>
		</TABLE>
	</form>
</body>
