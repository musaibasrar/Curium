...
<body style="text-align: center" class="bodymargin">
	...
	<form method="post" class="bodymargin">
		...
		<table align="center">
			...
			<tr>
			<td>
			<img border="0" style="vertical-align: text-bottom;height: 105px;width: 118px;" alt="logo" src="/aysha/images/aysha.png">
			</td>
				<td >
					<br>
		...
		<td></td>
			...
			<tr>
              <td align="center"><a id="print" href="/aysha/DocumentsProcess/printBonafide">Print</a></td>
            </tr>
		</TABLE>
	</form>
</body>
