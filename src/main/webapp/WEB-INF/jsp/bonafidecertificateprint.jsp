...
<body style="text-align: center" class="bodymargin">
	...
	<form method="post" class="bodymargin">
		...
		<table align="center">
			...
			<tr>
			<td>
			<img border="0" style="vertical-align: text-bottom;height: 105px;width: 88px;" alt="logo" src="/patriswamy/images/patriswamy.png">
			</td>
				<td >
					<br>
		...
		<table>
			...
			<tr>
				...
				<h3 style="font-weight: normal;" >
					He/She is/was studied/passed/filled in&nbsp;&nbsp; <span style="font-weight: bold;width: 70px;">
								&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<td></td>
			...
			<tr>
              <td align="center"><a id="print" href="/patriswamy/DocumentsProcess/printBonafide">Print</a></td>
            </tr>
		</TABLE>
	</form>
</body>
