...
<script type="text/javascript">
	function addExamSchedule() {
		...
		form1.action = "/brilliantgrammar/ExamDetailsProcess/addSchedule";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/brilliantgrammar/ExamDetailsProcess/deleteExamSchedule";
		form1.method = "POST";
		form1.submit();
		...
		<div style="overflow: scroll; height: 600px">
			...
			<table width="100%" border="0" style="border-color: #4b6a84;"
				...
				<tbody>
					...
					<c:forEach items="${examschedule}" var="examschedule" varStatus="status">
