...
<body>
    ...
    <tbody>
		...
		<table width="100%">
			<tr>
				<td rowspan="8"
					style="writing-mode: vertical-lr; font-weight: bold; transform: rotate(180deg); text-align: center;">Part
					B</td>
				<td>General Knowledge</td>
				<td>&emsp;&emsp;</td>
				<td rowspan="3">Performance</td>
				<td>Excellent <span height="20px" width="20px"
					style="display: inline-flex; border: 1px solid black">&emsp;&emsp;</span></td>
			</tr>
			<tr>
				<td>Moral/Deenyat</td>
				<td>&emsp;&emsp;</td>
				<td>Good <span height="20px" width="20px"
					style="display: inline-flex; border: 1px solid black">&emsp;&emsp;</span></td>
			</tr>
			<tr>
				<td>Fine,Arts & Deenyaat</td>
				<td>&emsp;&emsp;</td>
				<td>Average <span height="20px" width="20px"
					style="display: inline-flex; border: 1px solid black">&emsp;&emsp;</span></td>
			</tr>
			<tr>
				<
