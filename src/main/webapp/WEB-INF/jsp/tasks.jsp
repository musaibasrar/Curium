...
<script type="text/javascript" src="/dolphin/js/datetimepicker_css.js"></script>
	...
	<script type="text/javascript">
		function completeTasks() {
			...
			form1.action = "/dolphin/JobProcess/completeTasks?display=viewtask";
			form1.method = "POST";
			form1.submit();
		}
		...
		function cancelTasks() {
			var form1 = document.getElementById("form1");
			form1.action = "/dolphin/JobProcess/cancelTasks?display=viewtask";
			form1.method = "POST";
			form1.submit();
		}
		...
		function inProgressTasks() {
			var form1 = document.getElementById("form1");
			form1.action = "/dolphin/JobProcess/inProgressTasks?display=viewtask";
			form1.method = "POST";
			form1.submit();
		}
		...
		function toDoTasks() {
			var form1 = document.getElementById("form1");
			form1.action = "/dolphin/JobProcess/toDoTasks?display=viewtask";
			form1.method = "POST";
			form1.submit();
		}
		...
		function updateQueryRemarks(queryRemarksAdded,queryRemarks, queryid, username) {
			...
			form1.action = "/dolphin/JobProcess/updateTaskRemarks?queryremarks="+result+"&queryid="+queryid.value+"&jobid="+queryid.value+"&display=viewtask";
			form1.method = "POST";
			form1.submit();
		}
