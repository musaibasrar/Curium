...
<script type="text/javascript">
	function searchStudentsForCharacterCertificate() {
		...
		form1.action = "/gnyanganga/DocumentsProcess/searchStudentsForCharacter";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/gnyanganga/DocumentsProcess/GenerateCharacterCertificate" method="POST">
