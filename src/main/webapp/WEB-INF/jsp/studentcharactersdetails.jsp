<%--
    Document   : studentsdetailscharacter
...
<title>Students Details Character</title>
...
<script type="text/javascript">
	function searchStudentsForCharacterCertificate() {
		...
		form1.action = "/brilliantgrammar/DocumentsProcess/searchStudentsForCharacter";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/brilliantgrammar/DocumentsProcess/GenerateCharacterCertificate" method="POST">
		...
		<div id="effect" class="ui-widget-content ui-corner-all">
			<div id="tabs">
				<ul>
					<li><a href="#tabs-1">Character Certificate</a></li>
