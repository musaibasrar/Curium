...
<script type="text/javascript">
	function searchStudentsForCharacterCertificate() {
		...
		form1.action = "/presidency/DocumentsProcess/searchStudentsForCharacter";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/presidency/DocumentsProcess/GenerateCharacterCertificate" method="POST">
