...
<script src="/fathima/js/datePicker/jquery-1.7.1.js"></script>
<script src="/fathima/js/datePicker/ui/jquery.ui.core.js"></script>
...
<script src="/fathima/JavaScript/actb.js"></script>
<script src="/fathima/JavaScript/common.js"></script>
					...
					<table width="100%" border="0" align="center" id="table1">
						...
						<script type="text/javascript">
							function updateSponsor() {
								...
								form1.action = "/fathima/SponserProcess/updateSponsor";
								form1.submit();
							}

							function Cancel() {
								var form1 = document.getElementById("form1");
								form1.action = "/fathima/SponserProcess/viewAllEmployee";
								form1.submit();
							}
