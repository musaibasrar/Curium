...
<script src="/rkgnyanaganga/JavaScript/actb.js"></script>
<script src="/rkgnyanaganga/JavaScript/common.js"></script>
					...
					<table width="100%" border="0" align="center" id="table1">
						...
						<script type="text/javascript">
							function updateSponsor() {
								...
								form1.action = "/rkgnyanaganga/SponserProcess/updateSponsor";
								form1.submit();
							}

							function Cancel() {
								var form1 = document.getElementById("form1");
								form1.action = "/rkgnyanaganga/SponserProcess/viewAllEmployee";
								form1.submit();
							}
