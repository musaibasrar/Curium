...
<script src="/iqra/JavaScript/actb.js"></script>
<script src="/iqra/JavaScript/common.js"></script>
					...
					<table width="100%" border="0" align="center" id="table1">
						...
						<script type="text/javascript">
							function updateSponsor() {
								...
								form1.action = "/iqra/SponserProcess/updateSponsor";
								form1.submit();
							}

							function Cancel() {
								var form1 = document.getElementById("form1");
								form1.action = "/iqra/SponserProcess/viewAllEmployee";
								form1.submit();
							}
