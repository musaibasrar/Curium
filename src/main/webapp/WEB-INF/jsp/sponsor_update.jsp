...
<script src="/theage/js/datePicker/jquery-1.7.1.js"></script>
<script src="/theage/js/datePicker/ui/jquery.ui.core.js"></script>
...
<script src="/theage/js/datePicker/ui/jquery.ui.tabs.js"></script>
...
<script src="/theage/JavaScript/actb.js"></script>
<script src="/theage/JavaScript/common.js"></script>
					...
					<table width="100%" border="0" align="center" id="table1">
						...
						<script type="text/javascript">
							function updateSponsor() {
								...
								form1.action = "/theage/SponserProcess/updateSponsor";
								form1.submit();
							}

							function Cancel() {
								var form1 = document.getElementById("form1");
								form1.action = "/theage/SponserProcess/viewAllEmployee";
								form1.submit();
							}
