...
<script type="text/javascript">
	 ...
	 function saveaccount(){
		 ...
		 var form1 = document.getElementById("form1");
			...
			if(form1.checkValidity()) {
				var form1=document.getElementById("form1");
		        form1.action="/tajacc/AccountProcess/saveAccount";
		        form1.submit();
			  }
	...
	function deleteRecords(){
		...
		if(confirm('Are you sure, you want to delete the account?')){
			var form1=document.getElementById("form1");
	         form1.action="/tajacc/AccountProcess/deleteAccount";
	        form1.submit();
		}
				...
				<thead>
					<tr>
						...
						<th title="click to sort" class="headerText">Account Type<img
							...
							src="/tajacc/css/dataTable/images/sort_both.png" />&nbsp;&nbsp;
						</th>
						...
						<th title="click to sort" class="headerText">Account Code<img
							alt=" " style="position: relative; top: 4px;"
							src="/tajacc/css/dataTable/images/sort_both.png" /></th>
