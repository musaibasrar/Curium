...
<script type="text/javascript">
	 ...
	 function saveaccount(){
		 ...
		 var form1 = document.getElementById("form1");
			...
			if(form1.checkValidity()) {
				var form1=document.getElementById("form1");
		        form1.action="/brilliantgrammar/AccountProcess/saveAccount";
		        form1.submit();
			  }
	...
	function deleteRecords(){
		...
		if(confirm('Are you sure, you want to delete the account?')){
			var form1=document.getElementById("form1");
	         form1.action="/brilliantgrammar/AccountProcess/deleteAccount";
	        form1.submit();
		}
...
<script type="text/javascript">
    ...
    function getSubGroup() {
		...
		if(selected.includes("Select Group") || selected.includes("New Group")){
			...
			xmlHttp.open("GET", "/brilliantgrammar/SubGroupName/getSubGroupNames?groupname="+selected,true);
			xmlHttp.send(null);
		}
    ...
    function getSSGroup() {
		...
		if(selected.includes("Select Sub-Group") || selected.includes("New Sub-Group")){
			...
			xmlHttp.open("GET", "/brilliantgrammar/SubGroupName/getSSGroupNames?subgroupname="+selected,true);
			xmlHttp.send(null);
		}
				...
				<thead>
					<tr>
						...
						<th title="click to sort" class="headerText">Account Type<img
							...
							src="/brilliantgrammar/css/dataTable/images/sort_both.png" />&nbsp;&nbsp;
						</th>
