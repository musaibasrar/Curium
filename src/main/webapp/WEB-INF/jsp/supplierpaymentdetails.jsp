...
<script type="text/javascript">
	function search() {
		...
		if(form1.checkValidity()) {
			form1.action = "/noblewisdom/MessSuppliersProcess/searchSupplierPaymentDetails";
			form1.method = "POST";
			form1.submit();
		  }
	}
	...
	function printRecords() {
			var form1 = document.getElementById("form1");
			form1.action = "/noblewisdom/MessSuppliersProcess/printSearchSupplierPaymentDetails";
			form1.method = "POST";
			form1.submit();
	}
