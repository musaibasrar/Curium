					...
					<table width="100%" border="0" align="center" id="table1">
						...
						<script type="text/javascript">
							function sendEmailAll() {
								...
								form1.action = "/littleangels/EmailProcess/sendAllEmail";
								form1.submit();
							}
							
							function sendSMSNumbers() {
								var form1 = document.getElementById("form1");
								form1.action = "/littleangels/SMSProcess/sendNumbersSMS";
								form1.submit();
							}
							
							function sendSMSStaff() {
								var form1 = document.getElementById("form1");
								form1.action = "/littleangels/SMSProcess/sendStaffSMS";
								form1.submit();
							}
