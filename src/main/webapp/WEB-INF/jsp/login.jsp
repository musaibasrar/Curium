...
.btn:hover, .btn:focus{
        ...
        <script type="text/javascript">
            ...
            if(flag1){
            	...
            	if(type=='superadmin'){
                	...
                	window.open('/vasu/index_teacher','_self');
	...
	<div class="container-fluid">
		<div class="row main-content bg-success text-center">
			...
			<h2><img border="0" style="vertical-align: text-bottom;height: 120px;width: 108px;" alt="ideoholic" src="/vasu/images/vasu.png"></h2>
			</div>
