...
.btn:hover, .btn:focus{
        ...
        <script type="text/javascript">
            ...
            if(flag1){
            	...
            	if(type=='superadmin'){
                	...
                	window.open('/noble/index_teacher','_self');
                }else if(type=='marksentry'){
                	window.open('/noble/index_marksentry','_self');
                }else if(type=='parents'){
                	window.open('/noble/index_parents','_self');
                }
            }
            else if(!flag1){
	...
	<div class="container-fluid">
		<div class="row main-content bg-success text-center">
			...
			<h2><img border="0" style="vertical-align: text-bottom;height: 200px;width: 200px;" alt="ideoholic" src="/noble/images/noble.png"></h2>
			</div>
			<div class="col-md-8 col-xs-12 col-sm-12 login_form ">
				<div class="container-fluid">
					...
					<div class="row">
						<form action="/noble/UserProcess/authenticateUser" id="loginForm"  method="post" class="form-group">
							<div class="row">
