...
.btn:hover, .btn:focus{
	...
	<div class="container-fluid">
		<div class="row main-content bg-success text-center">
			...
			<h2><img border="0" style="vertical-align: text-bottom;height: 105px;width: 100px;" alt="ideoholic" src="/roshan/images/roshan.png"></h2>
			</div>
			<div class="col-md-8 col-xs-12 col-sm-12 login_form ">
				<div class="container-fluid">
					...
					<div class="row">
						<form action="/roshan/UserProcess/authenticateUser" id="loginForm"  method="post" class="form-group">
							<div class="row">
