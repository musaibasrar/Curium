...
.btn:hover, .btn:focus{
        ...
        <script type="text/javascript">
            ...
            if(flag1){
            	...
            	if(type=='superadmin'){
                	...
                	window.open('${ctx}/index_teacher','_self');
	...
	<div class="container-fluid">
		<div class="row main-content bg-success text-center">
			...
			<h2><img border="0" style="vertical-align: text-bottom;height: 170px;width: 168px;" alt="ideoholic" src="${logoUrl}"></h2>
			</div>
			<div class="col-md-8 col-xs-12 col-sm-12 login_form ">
				<div class="container-fluid">
					<div class="row">
						<!-- <span class="company__logo"><h2><img border="0" style="vertical-align: text-bottom;height: 50px;width: 73px;" alt="ideoholic" src="${pageContext.request.contextPath}/images/shaheenlogo.png"></h2></span> -->
						<h3>Log In</h3>
					</div>
					<div class="row">
	...
	<div class="container-fluid text-center footer">
		<p>
			<!-- <p>An <img border="0" style="vertical-align: text-bottom;" alt="ideoholic" src="${pageContext.request.contextPath}/images/ideoholic.png"> image with a default alignment.</p> --> 
