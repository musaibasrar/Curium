...
<script type="text/javascript">
	...
	function generateCaveatReport() {
			var form1 = document.getElementById("form1");
				form1.action = "/sla/CaveatProcess/generateCaveatsReport";
				form1.method = "POST";
				form1.submit();
	}
	 ...
	 function printRecords() {
			var form1 = document.getElementById("form1");
			form1.action = "/sla/CaveatProcess/printCaveatsReport";
			form1.method = "POST";
			form1.submit();
		}
...
<body>
	...
	<form id="form1"
		...
		<div style="overflow: scroll; height: 600px">
			<table width="100%">
				<tr>
					<td class="headerTD">Caveats Report <br>
			...
			<table width="100%" border="0" style="border-color: #4b6a84;"
				...
				<thead>
                    ...
                    <tbody>
                        <c:forEach items="${caveatslist}" var="caveat">
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td class="dataText"><fmt:formatDate pattern="dd/MM/yyyy" value="${caveat.updateddate}"/></td>
                            </tr>
                        </c:forEach>
                    </tbody>
					<tfoot>
