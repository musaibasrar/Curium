...
%>
    <frameset    rows="55,*"frameborder="0" border="0" framespacing="0"  >
		   ...
		   <c:if test="${(userType == 'admissioncoordinator')}">
			    <frame   src="/scholar/header_admissioncoordinator"   name="topFrame" scrolling="NO" noresize frameborder="0">
		   </c:if>

            <frameset  cols="195,*" frameborder="0" border="0" framespacing="0">
                <frame  src="/scholar/left_admissioncoordinator" name="leftFrame" scrolling="yes"  frameborder="1"   />
