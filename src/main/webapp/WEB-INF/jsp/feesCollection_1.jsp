...
%>
    <body>
        <form id="form1" action="/childrenandglobal/FeesCollection/feesAdd" method="post" onkeypress="if (event.keyCode == 92) addRow();">
