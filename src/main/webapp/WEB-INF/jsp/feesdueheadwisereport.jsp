...
<script type="text/javascript">
	...
	function searchForStudents() {
		...
		form1.action = "/theage/FeesCollection/searchFeesDueHeadWiseReport";
		form1.method = "POST";
		form1.submit();
...
var xmlHttp;
    ...
    function searchfeecategory() {
		...
		var yoa=document.getElementById('yearofadmission').value;
			...
			xmlHttp.open("GET", "/theage/FeesProcess/searchfeecategoryheadwise?classstudying="+classsearch+"&yearofadmission="+yoa+"",true);
			xmlHttp.send(null);
...
%>
<body>
	<form id="form1" action="/theage/FeesCollection/printFeesDueHeadWiseReport" method="POST">
