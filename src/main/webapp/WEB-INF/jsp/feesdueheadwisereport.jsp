...
<script type="text/javascript">
	...
	function searchForStudents() {
		...
		form1.action = "/littleflower/FeesCollection/searchFeesDueHeadWiseReport";
		form1.method = "POST";
		form1.submit();
...
var xmlHttp;
    ...
    function searchfeecategory() {
		...
		var studenttype=document.getElementById('studenttype').value;
			...
			xmlHttp.open("GET", "/littleflower/FeesProcess/searchfeecategoryheadwise?classstudying="+classsearch+"&yearofadmission="+yoa+"&studenttype="+studenttype+"",true);
			xmlHttp.send(null);
...
%>
<body>
	<form id="form1" action="/littleflower/FeesCollection/printFeesDueHeadWiseReport" method="POST">
