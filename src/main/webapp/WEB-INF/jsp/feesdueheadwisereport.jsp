...
<script type="text/javascript">
	...
	function searchForStudents() {
		...
		form1.action = "/brilliantgrammar/FeesCollection/searchFeesDueHeadWiseReport";
		form1.method = "POST";
		form1.submit();
...
var xmlHttp;
    ...
    function searchfeecategory() {
		...
		var yoa=document.getElementById('yearofadmission').value;
			...
			xmlHttp.open("GET", "/brilliantgrammar/FeesProcess/searchfeecategoryheadwise?classstudying="+classsearch+"&yearofadmission="+yoa+"",true);
			xmlHttp.send(null);
...
%>
<body>
	<form id="form1" action="/brilliantgrammar/FeesCollection/printFeesDueHeadWiseReport" method="POST">
