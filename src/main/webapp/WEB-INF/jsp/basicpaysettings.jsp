...
<script type="text/javascript">
	...
	function searchForEmployees(staffName, staffDepartment){
		...
		form1.action = "/jasmine/HrProcess/searchEmployeesForbasicpay?staffName="+staffName+"&staffDepartment="+staffDepartment+"";
		form1.method = "POST";
		form1.submit();
	...
	function addBasicPay() {
		var form1 = document.getElementById("form1");
		form1.action = "/jasmine/HrProcess/addBasicPay";
		form1.method = "POST";
		form1.submit();
	}
