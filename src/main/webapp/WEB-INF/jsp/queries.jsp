...
.emptyFieldSet {
	...
	background-image: url(/skps/images/close.JPG);
...
.headerText {
	...
	text-align: center;
	background-image:
		url("/skps/images/ui-bg_diagonals-small_50_466580_40x40.png");
}
...
<script type="text/javascript" src="/skps/js/datetimepicker_css.js"></script>
	...
	<script type="text/javascript">
		function completeQueries() {
			...
			form1.action = "/skps/JobProcess/completeQueries";
			form1.method = "POST";
			form1.submit();
		}
		...
		function cancelQueries() {
			var form1 = document.getElementById("form1");
			form1.action = "/skps/JobProcess/cancelQueries";
			form1.method = "POST";
			form1.submit();
		}
		...
		function inProgressQueries() {
			var form1 = document.getElementById("form1");
			form1.action = "/skps/JobProcess/inProgressQueries";
			form1.method = "POST";
			form1.submit();
		}
		...
		function toDoQueries() {
			var form1 = document.getElementById("form1");
			form1.action = "/skps/JobProcess/toDoQueries";
			form1.method = "POST";
			form1.submit();
		}
		...
		function updateQueryRemarks(queryRemarksAdded,queryRemarks, queryid, username) {
			...
			form1.action = "/skps/JobProcess/updateQueryRemarks?queryremarks="+result+"&queryid="+queryid.value+"&jobid="+queryid.value+"";
			form1.method = "POST";
			form1.submit();
		}
		...
		function updateQueryResponse(parentQuery, response, queryid) {
			var form1 = document.getElementById("form1");
			form1.action = "/skps/JobProcess/updateQueries&parentquery="+parentQuery.value+"&response="+response.value+"&queryid="+queryid.value+"";
			form1.method = "POST";
			form1.submit();
		}
		        	...
		        	function closediv(divid){
		        		var x = document.getElementById("div"+divid);
		        		  if (x.style.display === "none") {
		        		    ...
		        		    var form1 = document.getElementById("form1");
		        			form1.action = "/skps/JobProcess/viewAllQueries";
		        			form1.method = "POST";
		        			form1.submit();
		        		  }
		        	}
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
            ...
            function viewStudentDetails(sid,branchid){
                var form1=document.getElementById("form1");
               form1.action="/skps/StudentProcess/ViewDetails?id="+sid+"&urlbranchid="+branchid+"";
               form1.submit();
            ...
            function viewTaskDetails(jobid){
               var form1=document.getElementById("form1");
               form1.action="/skps/JobProcess/ViewTaskDetails?jobid="+jobid+"";
               form1.submit();
           }
            
            function createTask(jobid,jobno){
                var form1=document.getElementById("form1");
                form1.action="/skps/JobProcess/CreateTask?jobid="+jobid+"&jobno="+jobno+"";
                form1.submit();
            }
        ...
        <script type="text/javascript">
            ...
            function openPopupReferredby(referredby){
        			...
        			xmlHttp.open("GET", "/skps/JobProcess/viewReferredby?referredby="+referredby+"",true);;
        			xmlHttp.send(null);
                ...
                <div align="center">
		             <%--For displaying Previous link except for the 1st page --%>
		                <c:if test="${currentPage != 1}">
		                    <td><a style="color: #4B6A84;font-size: 12px" href="/skps/JobProcess/viewAllQueries&page=${currentPage - 1}">Previous</a></td>
		                </c:if>
		                ...
		                <table border="0" cellpadding="2" cellspacing="2">
		                	<c:forEach begin="1" end="${noOfPages}" var="i" varStatus="status">
		                            ...
		                            <c:choose>
		                                ...
		                                <c:otherwise>
		                                    <td style="color: black;font-weight:bold;font-size: 15px "><a style="color: #4B6A84" href="/skps/JobProcess/viewAllQueries&page=${i}">${i}</a></td>
		                                </c:otherwise>
		                            </c:choose>
		                ...
		                <c:if test="${currentPage lt noOfPages}">
		                    <td ><a style="color: #4B6A84;font-size: 12px" href="/skps/JobProcess/viewAllQueries&page=${currentPage + 1}">Next</a></td>
		                </c:if>
                </div>
		</div>
