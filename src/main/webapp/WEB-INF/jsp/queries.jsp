...
<script type="text/javascript">
 ...
 <script type="text/javascript">
            ...
            function createTask(jobid,jobno){
                var form1=document.getElementById("form1");
                form1.action="/brightschool/JobProcess/CreateTask?jobid="+jobid+"&jobno="+jobno+"";
                form1.submit();
            }
        ...
        <script type="text/javascript">
            ...
            function openPopupReferredby(referredby){
        			...
        			xmlHttp.open("GET", "/brightschool/JobProcess/viewReferredby?referredby="+referredby+"",true);;
        			xmlHttp.send(null);
