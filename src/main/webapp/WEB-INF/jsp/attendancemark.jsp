...
<script type="text/javascript">
	...
	function searchStudentAttendanceDetailsMark() {
		var form1 = document.getElementById("form1");
		form1.action = "/alirfan/AttendanceProcess/searchStudentAttendanceDetailsMark";
		form1.method = "POST";
		form1.submit();
	...
	function updateRecords(){
		var form1 = document.getElementById("form1");
		form1.action = "/alirfan/AttendanceProcess/markStudentsAttendance";
		form1.method = "POST";
		form1.submit();
	}
