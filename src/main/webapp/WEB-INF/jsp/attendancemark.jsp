...
<script type="text/javascript">
	...
	function searchStudentAttendanceDetailsMark() {
		var form1 = document.getElementById("form1");
		form1.action = "/shadaan/AttendanceProcess/searchStudentAttendanceDetailsMark";
		form1.method = "POST";
		form1.submit();
	...
	function updateRecords(){
		var form1 = document.getElementById("form1");
		form1.action = "/shadaan/AttendanceProcess/markStudentsAttendance";
		form1.method = "POST";
		form1.submit();
	}
					...
					<c:forEach items="${StudentListAttendance}" var="attendanceList" varStatus="status">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataText" style="display: none;"><input type="checkbox" checked="checked" 
								id="<c:out value="${attendanceList.key.studentexternalid}"/>" class="chcktbl"
								name="externalIDs"
								value="<c:out value="${attendanceList.key.studentexternalid},${status.index}"/>" /></td>
							<td class="dataTextInActive"><a class="dataTextInActive"><c:out
										value="${attendanceList.key.admissionnumber}" /></a></td>
							<td class="dataText"><c:out value="${attendanceList.key.name}" /></td>
							<td class="dataText"><c:out value="${attendanceList.value.fathersname}" /></td>
							<td class="dataText">
