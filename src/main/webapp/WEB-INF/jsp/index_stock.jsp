...
%>
    <frameset    rows="55,*"frameborder="0" border="0" framespacing="0"  >
		   ...
		   <c:if test="${(userType == 'stock')}">
			    <frame   src="/roshan/header_stock"   name="topFrame" scrolling="NO" noresize frameborder="0">
		   </c:if>

            <frameset  cols="195,*" frameborder="0" border="0" framespacing="0">
                <frame  src="/roshan/left_stock" name="leftFrame" scrolling="yes"  frameborder="1"   />
