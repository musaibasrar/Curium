...
<script type="text/javascript">
	function searchForMarksSub() {
		...
		form1.action = "/noble/MarksDetailsProcess/viewMarksSub";
		form1.method = "POST";
		form1.submit();
	...
	function printMarksReportSub() {
		var form1 = document.getElementById("form1");
		form1.action = "/noble/MarksDetailsProcess/printMarksReportSub";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/noble/MarksDetailsProcess/updateMarksSub" method="POST">
