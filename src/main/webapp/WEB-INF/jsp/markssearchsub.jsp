...
<script type="text/javascript">
	function searchForMarksSub() {
		...
		form1.action = "/cambridge/MarksDetailsProcess/viewMarksSub";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/cambridge/MarksDetailsProcess/deleteMultiple";
		form1.method = "POST";
		form1.submit();
	...
	function printMarksReportSub() {
		var form1 = document.getElementById("form1");
		form1.action = "/cambridge/MarksDetailsProcess/printMarksReportSub";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/cambridge/MarksDetailsProcess/updateMarksSub" method="POST">
