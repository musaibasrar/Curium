...
<script type="text/javascript">
	function searchForMarksSub() {
		...
		form1.action = "/fathima/MarksDetailsProcess/viewMarksSub";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/fathima/MarksDetailsProcess/deleteMultiple";
		form1.method = "POST";
		form1.submit();
	...
	function printMarksReportSub() {
		var form1 = document.getElementById("form1");
		form1.action = "/fathima/MarksDetailsProcess/printMarksReportSub";
		form1.method = "POST";
		form1.submit();
...
function checkMandatoryandSubmit(){
    	...
    	if(document.getElementById("exam").value == ""){
    		...
    		var form1 = document.getElementById("form1");
    		form1.action = "/fathima/MarksDetailsProcess/addMarks";
    		form1.method = "POST";
    		form1.submit();
...
%>
<body>
	<form id="form1" action="/fathima/MarksDetailsProcess/updateMarksSub" method="POST">
