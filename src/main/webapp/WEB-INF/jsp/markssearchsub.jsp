...
<script type="text/javascript">
	function searchForMarksSub() {
		...
		form1.action = "/brilliantgrammar/MarksDetailsProcess/viewMarksSub";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/brilliantgrammar/MarksDetailsProcess/deleteMultiple";
		form1.method = "POST";
		form1.submit();
	...
	function printMarksReportSub() {
		var form1 = document.getElementById("form1");
		form1.action = "/brilliantgrammar/MarksDetailsProcess/printMarksReportSub";
		form1.method = "POST";
		form1.submit();
...
function checkMandatoryandSubmit(){
    	...
    	if(document.getElementById("exam").value == ""){
    		...
    		var form1 = document.getElementById("form1");
    		form1.action = "/brilliantgrammar/MarksDetailsProcess/addMarks";
    		form1.method = "POST";
    		form1.submit();
...
%>
<body>
	<form id="form1" action="/brilliantgrammar/MarksDetailsProcess/updateMarksSub" method="POST">
				...
				<tbody>
					<c:forEach items="${studentmarkmap}" var="Parents" varStatus="status">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<input type="text" id="studentMarks" name="studentMarks" value="<c:out value="${marksscored}" />"
								onkeypress="return (event.charCode >= 00 && event.charCode <=57) || event.charCode == 65"
								maxlength="4" style="width: 50px;border-radius:4px;"
							>
