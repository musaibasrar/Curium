...
<script type="text/javascript">
	function searchForMarksSub() {
		...
		form1.action = "/littleflower/MarksDetailsProcess/viewMarksSub";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/littleflower/MarksDetailsProcess/deleteMultiple";
		form1.method = "POST";
		form1.submit();
	...
	function printMarksReportSub() {
		var form1 = document.getElementById("form1");
		form1.action = "/littleflower/MarksDetailsProcess/printMarksReportSub";
		form1.method = "POST";
		form1.submit();
...
function checkMandatoryandSubmit(){
    	...
    	if(document.getElementById("exam").value == ""){
    		...
    		var form1 = document.getElementById("form1");
    		form1.action = "/littleflower/MarksDetailsProcess/addMarks";
    		form1.method = "POST";
    		form1.submit();
...
%>
<body>
	<form id="form1" action="/littleflower/MarksDetailsProcess/updateMarksSub" method="POST">
					...
					<tr>
						...
						<c:choose>
						    ...
						    <c:otherwise>
						        ...
						        <th class="headerText">A3</th>
						        <th class="headerText">A4</th>
						    </c:otherwise>
						</c:choose>
					</tr>
				</thead>
