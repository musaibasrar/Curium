...
<script type="text/javascript">
	function searchForReports() {
		...
		form1.action = "/stanley/MarksDetailsProcess/searchForReportSingleExams";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/stanley/MarksDetailsProcess/generateReportSingleExams" method="POST">
