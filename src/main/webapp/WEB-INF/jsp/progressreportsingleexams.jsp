...
<script type="text/javascript">
	function searchForReports() {
		...
		form1.action = "/shatabdi/MarksDetailsProcess/searchForReportSingleExams";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/shatabdi/MarksDetailsProcess/generateReportSingleExams" method="POST">
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td width="12%" align="left"><label> <input
									name="namesearch" type="text" class="myclass" id="namesearch" style="width: 256px;border-radius: 4px;background: white;height: 18px;"
									size="40">
							</label></td>
