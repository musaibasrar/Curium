...
<script type="text/javascript">
	function searchForReports() {
		...
		form1.action = "/nortuntrading/MarksDetailsProcess/searchForReportSingleExams";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/nortuntrading/MarksDetailsProcess/generateReportSingleExams" method="POST">
