...
<script type="text/javascript">
	function searchForReports() {
		...
		form1.action = "/demov2/MarksDetailsProcess/searchForReportSingleExams";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/demov2/MarksDetailsProcess/generateReportSingleExams" method="POST">
