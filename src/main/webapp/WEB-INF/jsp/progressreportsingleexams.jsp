...
<script type="text/javascript">
	function searchForReports() {
		...
		form1.action = "/noblewisdom/MarksDetailsProcess/searchForReportSingleExams";
		form1.method = "POST";
		form1.submit();
	...
	function generateReportVertical() {
		...
		var form1 = document.getElementById("form1");
		form1.action = "/noblewisdom/MarksDetailsProcess/generateReportSingleExamsVertical";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/noblewisdom/MarksDetailsProcess/generateReportSingleExams" method="POST">
