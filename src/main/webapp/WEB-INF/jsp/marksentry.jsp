...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/bsr/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
function checkMandatoryandSubmit(){
    	...
    	if(document.getElementById("exam").value == ""){
    		...
    		var form1 = document.getElementById("form1");
    		form1.action = "/bsr/MarksDetailsProcess/addMarks";
    		form1.method = "POST";
    		form1.submit();
...
%>
<body>
	<form id="form1" action="/bsr/MarksDetailsProcess/addMarks" method="POST">
					...
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<td width="30%" class="alignRight">Exam Class &nbsp;</td>
							<td width="16%" height="30" class="alignLeft"><label>
									<select name="classsearchselected"
