...
function getSubjectDetails() {
    ...
    var url = "/brilliantgrammar/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/brilliantgrammar/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/brilliantgrammar/MarksDetailsProcess/addMarks" method="POST">
