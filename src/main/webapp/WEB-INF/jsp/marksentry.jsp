...
function getSubjectDetails() {
    ...
    var url = "/fathima/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/fathima/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/fathima/MarksDetailsProcess/addMarks" method="POST">
