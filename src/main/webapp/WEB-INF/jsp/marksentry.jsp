...
function getSubjectDetails() {
    ...
    var url = "/shaheen/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/shaheen/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/shaheen/MarksDetailsProcess/addMarks" method="POST">
