...
function getSubjectDetails() {
    ...
    var url = "/jdh/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/jdh/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/jdh/MarksDetailsProcess/addMarks" method="POST">
