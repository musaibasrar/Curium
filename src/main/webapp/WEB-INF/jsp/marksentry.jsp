...
function getSubjectDetails() {
    ...
    var url = "/littleflower/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/littleflower/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/littleflower/MarksDetailsProcess/addMarks" method="POST">
