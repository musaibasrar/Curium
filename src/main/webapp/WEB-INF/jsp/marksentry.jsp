...
function getSubjectDetails() {
    ...
    var url = "/aashiyana/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/aashiyana/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/aashiyana/MarksDetailsProcess/addMarks" method="POST">
