...
function getSubjectDetails() {
    ...
    var url = "/hira/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/hira/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/hira/MarksDetailsProcess/addMarks" method="POST">
