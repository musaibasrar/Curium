...
function getSubjectDetails() {
    ...
    var url = "/bbis/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/bbis/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/bbis/MarksDetailsProcess/addMarks" method="POST">
