...
function getSubjectDetails() {
    ...
    var url = "/rahmani/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/rahmani/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/rahmani/MarksDetailsProcess/addMarks" method="POST">
