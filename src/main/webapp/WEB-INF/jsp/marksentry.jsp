...
function getSubjectDetails() {
    ...
    var url = "/roshan/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/roshan/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/roshan/MarksDetailsProcess/addMarks" method="POST">
