...
function getSubjectDetails() {
    ...
    var url = "/noble/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/noble/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/noble/MarksDetailsProcess/addMarks" method="POST">
