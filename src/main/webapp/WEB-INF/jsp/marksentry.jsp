...
function getSubjectDetails() {
    ...
    var url = "/brainystars/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/brainystars/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/brainystars/MarksDetailsProcess/addMarks" method="POST">
