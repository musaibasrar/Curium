...
function getSubjectDetails() {
    ...
    var url = "/dolphin/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/dolphin/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/dolphin/MarksDetailsProcess/addMarks" method="POST">
