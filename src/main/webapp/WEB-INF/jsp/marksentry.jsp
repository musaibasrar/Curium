...
function getSubjectDetails() {
    ...
    var url = "/sac/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/sac/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/sac/MarksDetailsProcess/addMarks" method="POST">
