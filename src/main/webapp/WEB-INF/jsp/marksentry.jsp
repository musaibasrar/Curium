...
function getSubjectDetails() {
    ...
    var url = "/awami/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/awami/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/awami/MarksDetailsProcess/addMarks" method="POST">
