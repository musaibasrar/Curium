...
function getSubjectDetails() {
    ...
    var url = "/salihath/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/salihath/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/salihath/MarksDetailsProcess/addMarks" method="POST">
