...
function getSubjectDetails() {
    ...
    var url = "/rkgnyanaganga/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/rkgnyanaganga/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/rkgnyanaganga/MarksDetailsProcess/addMarks" method="POST">
