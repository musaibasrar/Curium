...
function getSubjectDetails() {
    ...
    var url = "/mfds/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/mfds/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/mfds/MarksDetailsProcess/addMarks" method="POST">
