...
function getSubjectDetails() {
    ...
    var url = "/global/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/global/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/global/MarksDetailsProcess/addMarks" method="POST">
