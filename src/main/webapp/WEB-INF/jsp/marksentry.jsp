...
function getSubjectDetails() {
    ...
    var url = "/daralmajd/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/daralmajd/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/daralmajd/MarksDetailsProcess/addMarks" method="POST">
