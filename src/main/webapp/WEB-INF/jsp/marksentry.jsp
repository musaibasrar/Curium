...
function getSubjectDetails() {
    ...
    var url = "/syedbarey/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/syedbarey/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/syedbarey/MarksDetailsProcess/addMarks" method="POST">
