...
function getSubjectDetails() {
    ...
    var url = "/orion/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/orion/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/orion/MarksDetailsProcess/addMarks" method="POST">
