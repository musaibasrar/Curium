...
function getSubjectDetails() {
    ...
    var url = "/iqra/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/iqra/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/iqra/MarksDetailsProcess/addMarks" method="POST">
