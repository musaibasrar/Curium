...
function getSubjectDetails() {
    ...
    var url = "/bright/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/bright/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/bright/MarksDetailsProcess/addMarks" method="POST">
