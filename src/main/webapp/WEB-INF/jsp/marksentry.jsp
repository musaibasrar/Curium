...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action="/flora/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
function checkMandatoryandSubmit(){
    	...
    	if(document.getElementById("exam").value == ""){
    		...
    		var form1 = document.getElementById("form1");
    		form1.action="/flora/MarksDetailsProcess/addMarks";
    		form1.method = "POST";
    		form1.submit();
...
%>
<body>
	<form id="form1" action="/flora/MarksDetailsProcess/addMarks" method="POST">
