...
function getSubjectDetails() {
    ...
    var url = "/noblewisdom/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/noblewisdom/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/noblewisdom/MarksDetailsProcess/addMarks" method="POST">
