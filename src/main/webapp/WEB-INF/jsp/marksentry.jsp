...
function getSubjectDetails() {
    ...
    var url = "/aysha/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/aysha/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/aysha/MarksDetailsProcess/addMarks" method="POST">
