...
function getSubjectDetails() {
    ...
    var url = "/orchids/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/orchids/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/orchids/MarksDetailsProcess/addMarks" method="POST">
