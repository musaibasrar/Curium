...
function getSubjectDetails() {
    ...
    var url = "/patriswamy/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/patriswamy/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/patriswamy/MarksDetailsProcess/addMarks" method="POST">
