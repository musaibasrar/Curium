...
function getSubjectDetails() {
    ...
    var url = "/divine/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/divine/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/divine/MarksDetailsProcess/addMarks" method="POST">
