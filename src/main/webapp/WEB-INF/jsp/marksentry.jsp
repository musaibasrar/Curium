...
function getSubjectDetails() {
    ...
    var url = "/lilyrose/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/lilyrose/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/lilyrose/MarksDetailsProcess/addMarks" method="POST">
