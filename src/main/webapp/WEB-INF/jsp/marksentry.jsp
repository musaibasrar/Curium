...
function getSubjectDetails() {
    ...
    var url = "/theage/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/theage/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/theage/MarksDetailsProcess/addMarks" method="POST">
