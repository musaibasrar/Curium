...
function getSubjectDetails() {
    ...
    var url = "/iqraschool/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/iqraschool/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/iqraschool/MarksDetailsProcess/addMarks" method="POST">
