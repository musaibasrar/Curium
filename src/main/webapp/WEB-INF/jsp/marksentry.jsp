...
function getSubjectDetails() {
    ...
    var url = "/meps/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/meps/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/meps/MarksDetailsProcess/addMarks" method="POST">
