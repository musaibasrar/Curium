...
function getSubjectDetails() {
    ...
    var url = "/scholar/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/scholar/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/scholar/MarksDetailsProcess/addMarks" method="POST">
