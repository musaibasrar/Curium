...
function getSubjectDetails() {
    ...
    var url = "/brightschool/MarksDetailsProcess/getSubjectDetails"
...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/brightschool/MarksDetailsProcess/search";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/brightschool/MarksDetailsProcess/addMarks" method="POST">
