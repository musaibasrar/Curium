...
<TABLE  width="100%" border="1" style="border-collapse:collapse;">
		...
		<tr>
			...
			<tr>
				...
				<h3 style="font-weight: normal;">&nbsp;&nbsp;&nbsp;&nbsp;<span style="font-weight: bold;border-bottom-style: dotted;width:800px;"> </span>
					</h3></td>
				</tr>
				<tr>
			<td class="dataTextBoldLeft">
			...
			<td class="dataTextBoldLeft">
					...
					<span style="font-weight: bold;border-bottom-style: dotted;width:600px;">
					<fmt:formatDate
							value="${studentdetails.student.datetcissued}" pattern="dd/MM/yyyy" />
					</span>
					</h3>
				</td>
			</tr>
		...
		<td align="left">Checked By</td>	
			...
			<tr>
                        <td align="center"><a id="print" href="/children/DocumentsProcess/PrintTransferCertificate?id=<c:out value="${studentdetails.student.sid}" />">Print</a></td>
                    </tr>
		</TABLE>
