...
<jsp:useBean id="now" class="java.util.Date" scope="page" />
	<form method="post" class="bodymargin">
		...
		<table align="center">
			...
			<img  src="/alirfan/images/alirfan.jpg" alt="abc logo" width="103" height="120">&emsp;&emsp;</td>
...
<TABLE align="center">
                ...
                <tr>
                    <td>Email id:</td><td>&nbsp; mail@abcschool.edu.in.com&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                   </td>
