...
<TABLE  width="100%" border="1" style="border-collapse:collapse;">
		...
		<td align="left">Checked By</td>	
			...
			<tr>
                        <td align="center">
                      <a>  <button id="print" type="button" style="background-image: url(/greatindiaacademy/images/print.jpg);width: 63px;height: 60px" onclick="window.print();
                                     loading.style.visibility = 'visible'" class="hide"></button> </a>
                      <!--   <a id="print" href="/greatindiaacademy/DocumentsProcess/PrintTransferCertificate?id=<c:out value="${studentdetails.student.sid}" />">Print</a>--></td>
