...
<TABLE  width="100%" border="1" style="border-collapse:collapse;">
		...
		<td align="left">Clerk</td>	
			...
			<tr>
                        <td align="center"><a id="print" href="/sla/DocumentsProcess/PrintTransferCertificate?id=<c:out value="${studentdetails.student.sid}" />">Print</a></td>
                    </tr>
		</TABLE>
		
		<%-- <a id="print" href="/sla/Controller?process=StudentProcess&action=GenerateBonafide&id=<c:out value="${studentdetails.student.sid}" />">Print</a> --%>
	</form>
