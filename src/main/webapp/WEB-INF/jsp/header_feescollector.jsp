    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 45px;">
							...
							<td>
							<a target="leftFrame" href="/readmodelschool/left_feescollector"><img
									src="/readmodelschool/images/home.svg" width="18" height="18" alt="Reports" style="vertical-align: bottom;"/>
									Home		
								</a>
							</td>
							
							<td><a target="mainFrame"
								href="/readmodelschool/FeesProcess/feesCollect"> <img
									src="/readmodelschool/images/feescollect.svg" width="18" height="18"
									alt="Fees Collection" style="vertical-align: bottom;" />Fees Collection
							</a></td>
							
							<td>
							<a target="leftFrame" href="/readmodelschool/reports_feescollector"><img
							...
							<!-- <td>
								<a target="mainFrame"
								href="/readmodelschool/AccountProcess/createVoucher"> <img
									src="/readmodelschool/images/createvoucher.svg" width="18" height="18"
									alt="Create Voucher" style="vertical-align: bottom;" />
									Create Voucher
								</a>
							</td>

							<td ><a target="mainFrame" href="/readmodelschool/feesCollectionDetails"><img  alt="Fees Details" src="/readmodelschool/images/feescoll.png" width="30" height="30" /> <div id="" class="noti_bubbleEmpty"></div><div id="" class="noti_bubbleEmpty"></div></a></td>
                                            <td><label style="color:white;font-size: 12px;">Fees <br>Details</label></td>

							<td><a target="mainFrame"
								href="/readmodelschool/StudentProcess/addNew"> <img
									src="/readmodelschool/images/student_header.svg" width="18" height="18"
							...
							<td ><a target="mainFrame"
								href="/readmodelschool/AdminProcess/viewAllExpenses"><img
									alt="Admin Exp" src="/readmodelschool/images/adminexp.svg" width="18" height="18" style="vertical-align: bottom;"/>
									Admin Expense
							</a></td>

							<td ><a target="mainFrame" href="/readmodelschool/sendsms"><img
									src="/readmodelschool/images/sendmessage.svg" width="18" height="18" alt="Send SMS" style="vertical-align: bottom;"/>
									Send Message		
							</a>
							...
							<td ><a target="mainFrame"
								href="/readmodelschool/StudentProcess/viewAllStudentsWithParents"><img
									alt="View All Students" src="/readmodelschool/images/students.svg" width="18"
