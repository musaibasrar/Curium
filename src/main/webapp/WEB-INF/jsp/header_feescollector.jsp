    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 45px;">
							...
							<td>
							<a target="leftFrame" href="/rahmani/left_feescollector"><img
									src="/rahmani/images/home.svg" width="18" height="18" alt="Reports" style="vertical-align: bottom;"/>
									Home		
								</a>
							</td>
							
							<td><a target="mainFrame"
								href="/rahmani/FeesProcess/feesCollect"> <img
									src="/rahmani/images/feescollect.svg" width="18" height="18"
									alt="Fees Collection" style="vertical-align: bottom;" />Fees Collection
							</a></td>
							
							<td>
							<a target="leftFrame" href="/rahmani/reports_feescollector"><img
							...
							<!-- <td>
								<a target="mainFrame"
								href="/rahmani/AccountProcess/createVoucher"> <img
									src="/rahmani/images/createvoucher.svg" width="18" height="18"
									alt="Create Voucher" style="vertical-align: bottom;" />
									Create Voucher
								</a>
							</td>

							<td ><a target="mainFrame" href="/rahmani/feesCollectionDetails"><img  alt="Fees Details" src="/rahmani/images/feescoll.png" width="30" height="30" /> <div id="" class="noti_bubbleEmpty"></div><div id="" class="noti_bubbleEmpty"></div></a></td>
                                            <td><label style="color:white;font-size: 12px;">Fees <br>Details</label></td>

							<td><a target="mainFrame"
								href="/rahmani/StudentProcess/addNew"> <img
									src="/rahmani/images/student_header.svg" width="18" height="18"
							...
							<td ><a target="mainFrame"
								href="/rahmani/AdminProcess/viewAllExpenses"><img
									alt="Admin Exp" src="/rahmani/images/adminexp.svg" width="18" height="18" style="vertical-align: bottom;"/>
									Admin Expense
							</a></td>

							<td ><a target="mainFrame" href="/rahmani/sendsms"><img
							...
							<td ><a target="mainFrame"
								href="/rahmani/StudentProcess/viewAllStudentsWithParents"><img
									alt="View All Students" src="/rahmani/images/students.svg" width="18"
							...
							<td ><a target="_parent"
								href="/rahmani/UserProcess/logout"><img
									src="/rahmani/images/logout.svg" width="18" height="18" alt="Log Out" 
