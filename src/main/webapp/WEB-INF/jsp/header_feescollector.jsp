    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 45px;">
								...
								<a target="mainFrame" href="/alirfan/welcome" >
								<img src="/alirfan/images/curiumheader.png" width="112" height="41"/>
								</a>
								</td>
							...
							<td>
							<a target="leftFrame" href="/alirfan/left_feescollector"><img
									src="/alirfan/images/home.svg" width="18" height="18" alt="Reports" style="vertical-align: bottom;"/>
									Home		
								</a>
							</td>
							...
							<td>
							<a target="leftFrame" href="/alirfan/reports_feescollector"><img
							...
							<td ><a target="mainFrame" href="/alirfan/feesCollectionDetails"><img  alt="Fees Details" src="/alirfan/images/feescoll.png" width="30" height="30" /> <div id="" class="noti_bubbleEmpty"></div><div id="" class="noti_bubbleEmpty"></div></a></td>
							...
							<!-- <td ><a target="mainFrame"
								href="/alirfan/UserProcess/dashBoard"><img
									alt="Dash Board" src="/alirfan/images/dashboard.svg" width="18"
									height="18" style="vertical-align: bottom;"/>
									Dash Board
									</a></td> -->
							...
							<td ><a target="_parent"
								href="/alirfan/UserProcess/logout"><img
									src="/alirfan/images/logout.svg" width="18" height="18" alt="Log Out" 
