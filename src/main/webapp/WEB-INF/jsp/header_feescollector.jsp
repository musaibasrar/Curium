    ...
    transition: 0.3s;
        ">
						...
						<tr style="height: 45px;">
							...
							<td>
							<a target="leftFrame" href="/scholargroup/left_feescollector"><img
									src="/scholargroup/images/home.svg" width="18" height="18" alt="Reports" style="vertical-align: bottom;"/>
									Home		
								</a>
							</td>
							...
							<td>
							<a target="leftFrame" href="/scholargroup/reports_feescollector"><img
							...
							<!-- <td>
								<a target="mainFrame"
								href="/scholargroup/AccountProcess/createVoucher"> <img
									src="/scholargroup/images/createvoucher.svg" width="18" height="18"
							...
							<td><a target="mainFrame"
								href="/scholargroup/StudentProcess/addNew"> <img
									src="/scholargroup/images/student_header.svg" width="18" height="18"
									alt="Add New Student" style="vertical-align: bottom;" />Add Student
							</a></td>

							<td ><a target="leftFrame" href="/scholargroup/leftsettings_officeadmin">
									<img alt="Settings" src="/scholargroup/images/settings.svg" width="18"
									height="18" style="vertical-align: bottom;" />Master Settings
							</a></td>

							<td ><a target="mainFrame"
								href="/scholargroup/AdminProcess/viewAllExpenses"><img
									alt="Admin Exp" src="/scholargroup/images/adminexp.svg" width="18" height="18" style="vertical-align: bottom;"/>
									Admin Expense
							</a></td>
							...
							<td ><a target="mainFrame" href="/scholargroup/sendsms"><img
								...
								<a target="leftFrame" href="/scholargroup/reports_officeadmin"><img
									src="/scholargroup/images/reports.svg" width="18" height="18" alt="Reports" style="vertical-align: bottom;"/>
									Reports		
								</a>
							...
							<td ><a target="mainFrame"
								href="/scholargroup/StudentProcess/viewAllStudentsWithParents"><img
									alt="View All Students" src="/scholargroup/images/students.svg" width="18"
									height="18" style="vertical-align: bottom;"/>
								View Students
							</a></td> -->
							
							<!-- <td ><a target="mainFrame"
								href="/scholargroup/UserProcess/dashBoard"><img
							...
							<td ><a target="_parent"
								href="/scholargroup/UserProcess/logout"><img
									src="/scholargroup/images/logout.svg" width="18" height="18" alt="Log Out" 
