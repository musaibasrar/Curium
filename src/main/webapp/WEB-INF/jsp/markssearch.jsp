...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/brightschool/MarksDetailsProcess/viewMarks";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/brightschool/MarksDetailsProcess/deleteMultiple";
		form1.method = "POST";
		form1.submit();
	...
	function printMarksReport() {
		var form1 = document.getElementById("form1");
		form1.action = "/brightschool/MarksDetailsProcess/printMarksReport";
		form1.method = "POST";
		form1.submit();
...
function checkMandatoryandSubmit(){
    	...
    	if(document.getElementById("exam").value == ""){
    		...
    		var form1 = document.getElementById("form1");
    		form1.action = "/brightschool/MarksDetailsProcess/addMarks";
    		form1.method = "POST";
    		form1.submit();
