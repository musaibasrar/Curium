...
<script type="text/javascript">
	function searchForMarks() {
		...
		form1.action = "/brilliantgrammar/MarksDetailsProcess/viewMarks";
		form1.method = "POST";
		form1.submit();
	...
	function printMarksReport() {
		var form1 = document.getElementById("form1");
		form1.action = "/brilliantgrammar/MarksDetailsProcess/printMarksReport";
		form1.method = "POST";
		form1.submit();
...
<tr>
						...
						<tr>
							...
							<td width="12%" align="left"><label> <input
									...
									size="36" value='<c:out value="${examidname}"></c:out>'>
							</label></td>
