...
%>
    ...
    <frameset    rows="139,*"frameborder="0" border="0" framespacing="0"  >
        <frame   src="/sanmarg/header"   name="topFrame" scrolling="NO" noresize frameborder="0">

            <frameset  cols="175,*" frameborder="0" border="0" framespacing="0">
                <frame  src="/sanmarg/left_reception" name="leftFrame" scrolling="NO"  frameborder="1"   />
                <frame src="/sanmarg/StudentProcess/viewAll" name="mainFrame" scrolling="yes" />
            </frameset>
