...
%>
    ...
    <frameset    rows="139,*"frameborder="0" border="0" framespacing="0"  >
        <frame   src="/rauzamission/header"   name="topFrame" scrolling="NO" noresize frameborder="0">

            <frameset  cols="175,*" frameborder="0" border="0" framespacing="0">
                <frame  src="/rauzamission/left_reception" name="leftFrame" scrolling="NO"  frameborder="1"   />
                <frame src="/rauzamission/StudentProcess/viewAll" name="mainFrame" scrolling="yes" />
            </frameset>
