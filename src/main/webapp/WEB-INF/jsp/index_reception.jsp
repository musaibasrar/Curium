...
%>
    ...
    <frameset    rows="139,*"frameborder="0" border="0" framespacing="0"  >
        <frame   src="/orchids/header"   name="topFrame" scrolling="NO" noresize frameborder="0">

            <frameset  cols="175,*" frameborder="0" border="0" framespacing="0">
                <frame  src="/orchids/left_reception" name="leftFrame" scrolling="NO"  frameborder="1"   />
                <frame src="/orchids/StudentProcess/viewAll" name="mainFrame" scrolling="yes" />
            </frameset>
