...
%>
    <frameset    rows="55,*"frameborder="0" border="0" framespacing="0"  >
		   ...
		   <c:if test="${(userType == 'admin')}">
			    <frame   src="/cambridge/header_admin"   name="topFrame" scrolling="NO" noresize frameborder="0">
		   </c:if>

            <frameset  cols="195,*" frameborder="0" border="0" framespacing="0">
                <frame  src="/cambridge/left_admin" name="leftFrame" scrolling="yes"  frameborder="1"   />
