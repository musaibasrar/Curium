...
%>
<body>
	<form id="form1" action="/dolphin/UserProcess/advanceSearch"
		method="post">
		<%
...
<!-- 							<td width="30%" class="alignRight">RTE &nbsp;</td>
						...
						<script type="text/javascript">
							function searchStudent() {
								...
								form1.action = "/dolphin/UserProcess/advanceSearch";
								form1.submit();
							}
							function searchByParents() {
								var form1 = document.getElementById("form1");
								form1.action = "/dolphin/UserProcess/advanceSearchByParents";
								form1.submit();
							}
							function Cancel() {
								var form1 = document.getElementById("form1");
