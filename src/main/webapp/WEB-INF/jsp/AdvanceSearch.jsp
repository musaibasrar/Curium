...
%>
<body>
	<form id="form1" action="/brilliantgrammar/UserProcess/advanceSearch"
		method="post">
		<%
				...
				<div id="tabs-1">
					<table width="100%" border="0" align="center" id="table1">
						...
						<tr>
						 ...
						 <tr>
							<td width="30%" class="alignRight">STS&nbsp;</td>
...
<!-- 							<td width="30%" class="alignRight">RTE &nbsp;</td>
						...
						<script type="text/javascript">
							function searchStudent() {
								...
								form1.action = "/brilliantgrammar/UserProcess/advanceSearch";
								form1.submit();
							}
							function searchByParents() {
								var form1 = document.getElementById("form1");
								form1.action = "/brilliantgrammar/UserProcess/advanceSearchByParents";
								form1.submit();
							}
							function Cancel() {
								var form1 = document.getElementById("form1");
