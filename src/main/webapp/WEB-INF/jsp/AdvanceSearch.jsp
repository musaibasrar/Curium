...
%>
<body>
	<form id="form1" action="/rauzamission/UserProcess/advanceSearch"
		method="post">
		<%
					...
					<table width="100%" border="0" align="center" id="table1">
						...
						<script type="text/javascript">
							function searchStudent() {
								...
								form1.action="/rauzamission/UserProcess/advanceSearch";
								form1.submit();
							}
							function searchByParents() {
								var form1 = document.getElementById("form1");
								form1.action="/rauzamission/UserProcess/advanceSearchByParents";
								form1.submit();
							}
							function Cancel() {
								var form1 = document.getElementById("form1");
