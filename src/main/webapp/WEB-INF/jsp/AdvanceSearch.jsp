...
<script src="/noman/js/datePicker/jquery-1.7.1.js"></script>
<script src="/noman/js/datePicker/ui/jquery.ui.core.js"></script>
...
<script src="/noman/js/validation/jquery.ketchup.all.min.js"></script>
<script type="text/javascript"
...
<script src="/noman/JavaScript/actb.js"></script>
<script src="/noman/JavaScript/common.js"></script>
...
%>
<body>
	<form id="form1" action="/noman/UserProcess/advanceSearch"
		method="post">
		<%
...
<!-- 							<td width="30%" class="alignRight">RTE &nbsp;</td>
						...
						<script type="text/javascript">
							function searchStudent() {
								...
								form1.action = "/noman/UserProcess/advanceSearch";
								form1.submit();
							}
							function searchByParents() {
								var form1 = document.getElementById("form1");
								form1.action = "/noman/UserProcess/advanceSearchByParents";
								form1.submit();
							}
							function Cancel() {
								var form1 = document.getElementById("form1");
