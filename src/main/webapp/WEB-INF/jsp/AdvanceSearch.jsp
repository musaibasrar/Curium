...
<script src="/children/js/validation/jquery.ketchup.all.min.js"></script>
<script type="text/javascript"
...
<script src="/children/JavaScript/actb.js"></script>
<script src="/children/JavaScript/common.js"></script>
...
%>
<body>
	<form id="form1" action="/children/UserProcess/advanceSearch"
		method="post">
		<%
...
<!-- 							<td width="30%" class="alignRight">RTE &nbsp;</td>
						...
						<script type="text/javascript">
							function searchStudent() {
								...
								form1.action = "/children/UserProcess/advanceSearch";
								form1.submit();
							}
							function searchByParents() {
								var form1 = document.getElementById("form1");
								form1.action = "/children/UserProcess/advanceSearchByParents";
								form1.submit();
							}
							function Cancel() {
								var form1 = document.getElementById("form1");
