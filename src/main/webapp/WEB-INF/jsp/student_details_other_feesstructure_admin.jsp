    ...
    font-weight: bold;
        ...
        <script type="text/javascript">
            ...
            function deleteRecord() {
                var form1 = document.getElementById("form1");
                form1.action = "/alfalahschool/FeesProcess/deleteOtherFeesCategory";
                form1.submit();
            }
            
            function waiveOff() {
                var form1 = document.getElementById("form1");
                form1.action = "/alfalahschool/FeesProcess/waiveOffFees";
                form1.submit();
            }
            
            function applyConcession() {
                var form1 = document.getElementById("form1");
                form1.action = "/alfalahschool/FeesProcess/applyotherConcession";
                form1.submit();
            }
                                    ...
                                    <tr>
                                        <td align="left">
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                             ...
                                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                             <button id="print" onclick="window.location.href='/alfalahschool/printstudentdetailsfeesstructure'">Print</button>
