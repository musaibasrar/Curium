    ...
    font-weight: bold;
        ...
        <script type="text/javascript">
            ...
            function searchFeesStructure() {
                ...
                form1.action = "/skps/StudentProcess/otherFeesStructurePerYear?id="+id;
                form1.submit();
            }
            
            function deleteRecord() {
                var form1 = document.getElementById("form1");
                form1.action = "/skps/FeesProcess/deleteOtherFeesCategory";
                form1.submit();
            }
            ...
            function applyConcession() {
                var form1 = document.getElementById("form1");
                form1.action = "/skps/FeesProcess/applyotherConcession";
                form1.submit();
            }
                                    ...
                                    <tr>
                                        <td align="left">
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                             ...
                                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                             <button id="print" onclick="window.location.href='/skps/printstudentdetailsotherfeesstructure'">Print</button>
                                        </td>
