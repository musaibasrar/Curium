...
<script type="text/javascript" src="/brainystars/js/globalize.min.js"></script>
<script type="text/javascript" charset="utf-8" src="/brainystars/js/globalize.cultures.js"></script>
...
<script type="text/javascript">
	function searchForFees() {
		...
		form1.action = "/brainystars/StampFeesProcess/advanceSearchForStampsingleFees";
		form1.method = "POST";
		form1.submit();
	...
	function deleteFeesStamp(){
		var form1 = document.getElementById("form1");
		form1.action = "/brainystars/StampFeesProcess/delete";
		form1.method = "POST";
		form1.submit();
	}
</script>
...
%>
<body>
	<form id="form1" action="/brainystars/StampFeesProcess/applySingleFees" method="POST">
