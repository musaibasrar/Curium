...
<script type="text/javascript" src="/greatindiaacademy/js/globalize.min.js"></script>
<script type="text/javascript" charset="utf-8" src="/greatindiaacademy/js/globalize.cultures.js"></script>
...
<script type="text/javascript">
	function searchForFees() {
		...
		form1.action = "/greatindiaacademy/StampFeesProcess/advanceSearchForStampsingleFees";
		form1.method = "POST";
		form1.submit();
	...
	function deleteFeesStamp(){
		var form1 = document.getElementById("form1");
		form1.action = "/greatindiaacademy/StampFeesProcess/delete";
		form1.method = "POST";
		form1.submit();
	}
</script>
...
%>
<body>
	<form id="form1" action="/greatindiaacademy/StampFeesProcess/applySingleFees" method="POST">
