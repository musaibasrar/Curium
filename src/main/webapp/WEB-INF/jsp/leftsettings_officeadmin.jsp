...
%>
    <body onload="StartClock()" onunload="KillClock()">
        ...
        <div id="container" style="width: 95%" >
            ...
            <div>
                <a target="mainFrame" href="/theage/FeesProcess/otherFeesView" style="font-size: 12px;">Other Fees Category</a><br/>
                <a target="mainFrame" href="/theage/StampFeesProcess/showOtherFeesDetails" style="font-size: 12px;">Other Fee Stamp</a><br/>
