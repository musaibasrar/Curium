...
<script type="text/javascript">
	function searchForStudents() {
		...
		form1.action = "/rkgnyanaganga/DocumentsProcess/multiClassSearchPendingAdmissoinReport";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/rkgnyanaganga/StudentProcess/exportDataForStudents" method="POST">
