...
<script type="text/javascript">
	function searchForStudents() {
		...
		form1.action = "/madina/DocumentsProcess/multiClassSearchPendingAdmissoinReport";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/madina/StudentProcess/exportDataForStudents" method="POST">
