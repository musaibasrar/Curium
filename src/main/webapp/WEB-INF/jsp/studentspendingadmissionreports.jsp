...
<script type="text/javascript">
	function searchForStudents() {
		...
		form1.action = "/brightschool/DocumentsProcess/multiClassSearchPendingAdmissoinReport";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/brightschool/StudentProcess/exportDataForStudents" method="POST">
