...
<script type="text/javascript">
	function searchForStudents() {
		...
		form1.action = "/brainystars/DocumentsProcess/multiClassSearchPendingAdmissoinReport";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/brainystars/StudentProcess/exportDataForStudents" method="POST">
