...
<script type="text/javascript">
	function searchForStudents() {
		...
		form1.action = "/hwfschools/DocumentsProcess/multiClassSearchPendingAdmissoinReport";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/hwfschools/StudentProcess/exportDataForStudents" method="POST">
