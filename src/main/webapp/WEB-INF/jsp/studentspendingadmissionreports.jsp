...
<script type="text/javascript">
	function searchForStudents() {
		...
		form1.action = "/demov2/DocumentsProcess/multiClassSearchPendingAdmissoinReport";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/demov2/StudentProcess/exportDataForStudents" method="POST">
