...
<script type="text/javascript">
	function searchForStudents() {
		...
		form1.action = "/alfalah/DocumentsProcess/multiClassSearchPendingAdmissoinReport";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/alfalah/StudentProcess/exportDataForStudents" method="POST">
