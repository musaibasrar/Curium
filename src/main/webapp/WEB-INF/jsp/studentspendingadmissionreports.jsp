...
<script type="text/javascript">
	function searchForStudents() {
		...
		form1.action = "/alalmas/DocumentsProcess/multiClassSearchPendingAdmissoinReport";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/alalmas/StudentProcess/exportDataForStudents" method="POST">
					...
					<c:forEach items="${searchStudentList}" var="Parents">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataText"><input type="checkbox"
								...
								href="/alalmas/StudentProcess/ViewDetails?id=<c:out value='${Parents.student.sid}'/>"><c:out
