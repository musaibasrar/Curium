...
<script type="text/javascript">
	function searchForStudents() {
		...
		form1.action = "/theage/DocumentsProcess/multiClassSearchPendingAdmissoinReport";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/theage/StudentProcess/exportDataForStudents" method="POST">
					...
					<c:forEach items="${searchStudentList}" var="Parents" varStatus="status">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataText"><input type="checkbox"
								...
								href="/theage/StudentProcess/ViewDetails?id=<c:out value='${Parents.student.sid}'/>"><c:out
