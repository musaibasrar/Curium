...
<script type="text/javascript">
	function searchForStudents() {
		...
		form1.action = "/iica/DocumentsProcess/multiClassSearchPendingAdmissoinReport";
		form1.method = "POST";
		form1.submit();
...
%>
<body>
	<form id="form1" action="/iica/StudentProcess/exportDataForStudents" method="POST">
					...
					<c:forEach items="${searchStudentList}" var="Parents">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataTextInActive"><a class="dataTextInActive"
								href="/iica/StudentProcess/ViewDetails?id=<c:out value='${Parents.student.sid}'/>"><c:out
