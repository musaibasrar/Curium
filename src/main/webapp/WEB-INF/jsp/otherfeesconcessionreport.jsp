...
<script type="text/javascript">
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/gnyanganga/FeesProcess/printFeesConcessionReport";
		form1.method = "POST";
		form1.submit();
	}
	...
	<form id="form1" action="/gnyanganga/FeesCollection/exportDataForStudentsFeesReport" method="POST">
		...
		<div style="overflow: scroll; height: 600px">
			...
			<table width="100%" border="0" style="border-color: #4b6a84;"
						...
						<c:forEach items="${students.value}" var="fees">
							...
							<tr class="trClass" style="border-color: #000000" border="1" cellpadding="1" cellspacing="1">
								...
								<td class="dataTextInActive"><a class="dataTextInActive"
									href="/gnyanganga/StudentProcess/ViewFeesStructure?id=<c:out value='${students.key.student.sid}'/>"><c:out
				...
				<tfoot>
					<tr>
						<td class="footerTD" colspan="2"><button id="print">Print</button><input value="Export"
