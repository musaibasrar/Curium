...
<body style="text-align: center" class="bodymargin">
	<form method="post" class="bodymargin">
		<table width="100%" style="border-collapse: collapse;">
			<tr>
				<td align="center">
				<img src="/brilliantgrammar/images/brilliantgrammar.jpg" width="129" height="100"/>
				</td>
...
<TABLE  width="100%" border="1" style="border-collapse:collapse;">
			...
			<table class="datatable">
						<tr>
							...
							Total Paid: Rs.<fmt:formatNumber type="number"  maxFractionDigits = "2"   value="${grandtotalpaidAmount}" />
							</label>
							</td>
							
							<td class="dataTextLeft" >
							<label style="font-weight: bold;">
							Total Due: Rs.<fmt:formatNumber type="number"  maxFractionDigits = "2"   value="${grandtotaldueamount}" />
							</label>
							</td>
							<td class="dataTextLeft" >
							<label style="font-weight: bold;">
							Total: Rs.<fmt:formatNumber type="number"  maxFractionDigits = "2"   value="${grandtotalAmount}" />
							</label>
							</td>
						</tr>
