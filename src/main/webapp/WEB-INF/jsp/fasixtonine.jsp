    ...
    <div style="border: 2px solid brown; padding: 4px;">
        ...
        <table width="100%" style="margin-top: 5px; border-collapse: collapse;">
            <thead>
                ...
                <tr>
                    <td style="text-align: center; font-weight: normal; padding: 5px;">Written Assignment(10)</td>
                    <td style="text-align: center; font-weight: normal; padding: 5px;">Listening Comprehension(10)</td>
                    <td style="text-align: center; font-weight: normal; padding: 5px;">Conversation & Dialogue(10)</td>
                    <td style="text-align: center; font-weight: normal; padding: 5px;">Optional Activity(10)</td>
                </tr>
            </thead>
                                ...
                                <tr style="border-top: 1px solid #ccc;">
                                    ...
                                    <c:choose>
                                        <c:when test="${submarks.key eq 'Mathematics'}">
                                            <td><div class="col-header-math">Written Assignment(10)</div><hr style="border-top: 1px solid black; margin: 2px 0;"> ${marksParts[0]}</td>
                                            <td><div class="col-header-math">Group Project(10)</div><hr style="border-top: 1px solid black; margin: 2px 0;"> ${marksParts[1]}</td>
                                            <td><div class="col-header-math">MCQs(10)</div><hr style="border-top: 1px solid black; margin: 2px 0;"> ${marksParts[2]}</td>
                                            <td><div class="col-header-math">Optional Activity(10)</div><hr style="border-top: 1px solid black; margin: 2px 0;"> ${marksParts[3]}</td>
                                        </c:when>
                                        
                                        <c:when test="${submarks.key eq 'Science'}">
                                            <td> ${marksParts[0]}</td>
                                            <td>${marksParts[1]}</td>
                                            <td>${marksParts[2]}</td>
                                            <td>${marksParts[3]}</td>
                                        ...
                                        <c:when test="${submarks.key eq 'Social'}">
                                            <td> ${marksParts[0]}</td>
                                            <td>${marksParts[1]}</td>
                                            <td>${marksParts[2]}</td>
                                            <td>${marksParts[3]}</td>
