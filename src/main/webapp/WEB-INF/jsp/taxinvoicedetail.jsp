...
<link href="/orion/css/select2.min.css" rel="stylesheet" />
<script src="/orion/js/select2.min.js"></script>
...
<script type="text/javascript">
	...
	function saveissueentry() {
		...
		if(form1.checkValidity()) {
			form1.action = "/orion/MessItemsMoveProcess/saveStockMove";
			form1.method = "POST";
			form1.submit();
		}
	...
	function cancelRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/orion/MessItemsMoveProcess/cancelStockMove";
		form1.method = "POST";
		form1.submit();
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/orion/AdminProcess/printVoucher";
		form1.method = "POST";
		form1.submit();
	}
	...
	function generatebill(cashpayment,banktransfer,chequetransfer,ackno,transferdate,transferbankname,chequeno,chequedate,chequebankname,totalcashamount,totalbanktransferamount,
 	...
 	function getLastPrice(rowIndex){
 		...
 		var customerName = document.getElementById('issuedto').value;
 			...
 			xmlHttp.open("GET", "/orion/MessItemsMoveProcess/getCustomerLastPrice?customerName="+customerName+"&itemid="+itemId+"",true);
 			xmlHttp.send(null);
 	}
							...
							<td>
								<div class="container">
										<div class="row">
										        ...
										        </select><!-- &nbsp;&nbsp;<a target="mainFrame" href="/orion/StudentProcess/addNew">New Customer --></a>
									 	</div>
								</div>
							</td>
