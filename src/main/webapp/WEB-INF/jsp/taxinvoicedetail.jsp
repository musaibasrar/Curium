...
<link href="/brilliantgrammar/css/select2.min.css" rel="stylesheet" />
<script src="/brilliantgrammar/js/select2.min.js"></script>
...
<script type="text/javascript">
	...
	function saveissueentry() {
		...
		if(form1.checkValidity()) {
			form1.action = "/brilliantgrammar/MessItemsMoveProcess/saveStockMove";
			form1.method = "POST";
			form1.submit();
		}
	...
	function cancelRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/brilliantgrammar/MessItemsMoveProcess/cancelStockMove";
		form1.method = "POST";
		form1.submit();
	...
	function printRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/brilliantgrammar/AdminProcess/printVoucher";
		form1.method = "POST";
		form1.submit();
	}
	...
	function generatebill(cashpayment,banktransfer,chequetransfer,ackno,transferdate,transferbankname,chequeno,chequedate,chequebankname,totalcashamount,totalbanktransferamount,
    	...
    	var form1 = document.getElementById("form1");
		form1.action="/brilliantgrammar/MessItemsMoveProcess/saveStockMoveInvoiceTax?paymentmethodbanktransfer="+paymentmethodbanktransfer+"&paymentmethodchequetransfer="+paymentmethodchequetransfer+"&paymentmethodcash="+paymentmethodcash+"&ackno="+acknovalue+"&transferdate="+transferdatevalue+"&transferbankname="+transferbanknamevalue+"&chequeno="+chequenovalue+"&chequedate="+chequedatevalue+"&chequebankname="+chequebanknamevalue+"&totalcashamount="+totalcashamountvalue+"&totalbanktransferamount="+totalbanktransferamountvalue+"&totalchequetransferamount="+totalchequetransferamountvalue+"&itemsGrandTotalAmountWithoutGST="+itemsTotalAmountWithoutGST+"&itemsGrandNetDueAmount="+itemsGrandNetDueAmountvalue+"";
		form1.method = "POST";
		form1.submit();
 	...
 	function getLastPrice(rowIndex){
 		...
 		var customerName = document.getElementById('issuedto').value;
 			...
 			xmlHttp.open("GET", "/brilliantgrammar/MessItemsMoveProcess/getCustomerLastPrice?customerName="+customerName+"&itemid="+itemId+"",true);
 			xmlHttp.send(null);
 	}
							...
							<td>
								<div class="container">
										<div class="row">
										        ...
										        </select><!-- &nbsp;&nbsp;<a target="mainFrame" href="/brilliantgrammar/StudentProcess/addNew">New Customer --></a>
									 	</div>
								</div>
							</td>
						...
						<tfoot>
							<tr>
								...
								<td align="center"><input type="text"
									name="itemsTotalAmount" id="itemsTotalAmount" class="textfieldvaluesshorts" style="font-size: 14px;font-weight: bold;" value="0" onkeyup="calculateTransportationCharges();"/>
									<input type="hidden" name="totalsgst" id="totalsgst" />
									<input type="hidden" name="totalcgst" id="totalcgst" />
									</td>
							</tr>
						</tfoot>
					</table>
