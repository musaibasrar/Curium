...
%>
    <body onload="StartClock()" onunload="KillClock()">
        ...
        <div id="container" style="width: 95%" >
            ...
            <div>
                <a target="mainFrame" href="/salihath/HolisticAssessmentProcess/readListOfAssessments" style="font-size: 12px;">Assessment Details</a><br/>
                <!-- <a target="mainFrame" href="/salihath/HolisticAssessmentProcess/assessmentSchedule" style="font-size: 12px;">Assessment Schedule</a><br/> -->
                <a target="mainFrame" href="/salihath/AssessmentSubjectDetailsProcess/readListOfSubjectNames" style="font-size: 12px;">Assessment Subject Master</a><br/>
                <a target="mainFrame" href="/salihath/AssessmentSubjectDetailsProcess/readListOfSubjects" style="font-size: 12px;">Assessment Subject Details</a>
            </div>
