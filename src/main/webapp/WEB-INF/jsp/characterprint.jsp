	...
	<form method="post" class="bodymargin">
		<br>
		 ...
		 <table align="center">
			...
			<tr>
				<td ><img src="/sneha/images/sneha.jpg" width="150" height="140"/></td>
				<td  class="dataTextBoldCenter">
				<h1 style="margin-bottom:0px;">	${branchname}</h1>
				<h4 style="margin-top:0px;margin-bottom:0px;">	${branchaddress}<br>${branchcontact}</h4>
		...
		<!-- 	<tr>
              <td align="center"><a id="print" href="/sneha/DocumentsProcess/printCharacterCertificate">Print</a></td>
            </tr>-->
		</TABLE>
	</form>
</body>
