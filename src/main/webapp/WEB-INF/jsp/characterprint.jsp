		 ...
		 <table align="center">
			...
			<tr>
				...
				<td class="dataTextBoldLeft">
					...
					<td class="dataTextBoldLeft">
					<h3 style="font-weight: normal;" >
					has passed the AISSE/AISSCE<span style="font-weigh: bold;text-transform: capitalize;border-bottom:dotted;width:150px;">&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<td class="dataTextBoldLeft">
			<h3 style="font-weight: normal;" >
			His/Her date of Birth as per our record is<span class="rightside" style="font-weight: bold;text-transform: capitalize;width:400px;border-bottom:dotted;">&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${studentdetailsbonafide.student.dateofbirth}" /></span>
			</h3>
			</td>
			</tr>
			<tr>
