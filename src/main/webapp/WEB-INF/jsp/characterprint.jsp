		 ...
		 <table align="center">
			...
			<tr>
				...
				<td class="dataTextBoldLeft">
					...
					&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<label >SATS No. &nbsp;&nbsp;
			...
			<td class="dataTextBoldLeft">
			<h3 style="font-weight: normal;" >
			He/She bears<span style="font-weight: bold;text-transform: capitalize;width:470px;border-bottom:dotted;">&nbsp;&nbsp;&nbsp;&nbsp;<c:out value="${character}" /></span>character
			</h3>
			</td>
			</tr>
			<tr>
