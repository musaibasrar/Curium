...
<script type="text/javascript">
	function searchForFees() {
		...
		form1.action = "/brainystars/StampFeesProcess/searchForFees";
		form1.method = "POST";
		form1.submit();
				...
				<tbody>
					<c:forEach items="${searchStudentList}" var="Parents">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataTextInActive"><a class="dataTextInActive"
								href="/brainystars/StudentProcess/ViewotherFeesStructure?id=<c:out value='${Parents.student.sid}'/>"><c:out
