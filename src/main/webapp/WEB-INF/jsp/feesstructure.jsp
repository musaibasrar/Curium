...
<script type="text/javascript">
	function searchForFees() {
		...
		form1.action = "/aashiyana/StampFeesProcess/searchForFees";
		form1.method = "POST";
		form1.submit();
					...
					<c:forEach items="${searchStudentList}" var="Parents">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataTextInActive"><a class="dataTextInActive"
								href="/aashiyana/StudentProcess/ViewFeesStructure?id=<c:out value='${Parents.student.sid}'/>"><c:out
										value="${Parents.student.studentexternalid}" /></a></td>
							<td class="dataTextInActive"><a class="dataTextInActive"
								href="/aashiyana/StudentProcess/ViewotherFeesStructure?id=<c:out value='${Parents.student.sid}'/>"><c:out
										value="${Parents.student.studentexternalid}" /></a></td>
