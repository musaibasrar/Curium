...
<script type="text/javascript">
	function searchForFees() {
		...
		form1.action = "/noblewisdom/StampFeesProcess/searchForFees";
		form1.method = "POST";
		form1.submit();
				...
				<tbody>
					<c:forEach items="${searchStudentList}" var="Parents">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataTextInActive"><a class="dataTextInActive"
								href="/noblewisdom/StudentProcess/ViewotherFeesStructure?id=<c:out value='${Parents.student.sid}'/>"><c:out
