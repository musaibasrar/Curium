...
body::before {
    ...
    width: 100%;
    height: 100%;
    background: url("/abc/images/abc${branchid}.png") no-repeat center;
...
<body style="border-style:dotted;">
    ...
    <img border="0" style="vertical-align: text-bottom;height: 100px;width: 100px;" alt="logo" src="/abc/images/abc${branchid}.png">
