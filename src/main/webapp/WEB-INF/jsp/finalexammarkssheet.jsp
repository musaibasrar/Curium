...
body::before {
    ...
    width: 100%;
    height: 100%;
    background: url("/noble/images/noble${branchid}.png") no-repeat center;
...
<body style="border-style:dotted;">
    ...
    <img border="0" style="vertical-align: text-bottom;height: 100px;width: 100px;" alt="logo" src="/noble/images/noble${branchid}.png">
