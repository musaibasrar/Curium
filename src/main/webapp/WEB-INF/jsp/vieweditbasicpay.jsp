...
<script type="text/javascript">
	...
	function searchForEmployees(staffName, staffDepartment){
		...
		form1.action = "/sky/HrProcess/searchEmployeesForbasicpay?staffName="+staffName+"&staffDepartment="+staffDepartment+"";
		form1.method = "POST";
		form1.submit();
	...
	function updateBasicPay() {
		var form1 = document.getElementById("form1");
		form1.action = "/sky/HrProcess/updateBasicPay";
		form1.method = "POST";
		form1.submit();
	}
				...
				<tbody>
					   <c:forEach items="${vieweditbasicpay}" var="employee" varStatus="status">
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td  class="dataTextInActive" style="text-transform:uppercase"><a class="dataTextInActive" href="/sky/HrProcess/viewLeavesDetails?id=<c:out value='${employee.teacher.tid}'/>"><c:out value="${employee.teacher.teachername}"/></a></td>
