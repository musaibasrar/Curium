...
<script type="text/javascript">
	function addAssessmentSchedule() {
		...
		form1.action = "/brightschool/HolisticAssessmentDetailsProcess/addAssessmentSchedule";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "/brightschool/HolisticAssessmentDetailsProcess/deleteAssessmentSchedule";
		form1.method = "POST";
		form1.submit();
				...
				<thead>
					<tr>
						...
						<th title="click to sort" class="headerText">End Time<img
							alt=" " style="position: relative; top: 4px;"
							src="/brightschool/css/dataTable/images/sort_both.png" />&nbsp;&nbsp;
						</th>
