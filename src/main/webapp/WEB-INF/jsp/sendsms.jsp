					...
					<table  border="0" style="width: auto;height: auto;"  id="table1">
						...
						<tr>
							...
							<td >
								...
								<br><br>
								<label style="color: red;">End Date:&nbsp;&nbsp;</label><input type="text" id="feesremindervar1" name="feesremindervar1" maxlength="10">
 ...
 -->
						...
						<script type="text/javascript">
							function sendSMSAll() {
								...
								form1.action = "/shadaan/SMSProcess/sendAllSMS";
								form1.submit();
							}
							
							function sendSMSNumbers() {
								var form1 = document.getElementById("form1");
								form1.action = "/shadaan/SMSProcess/sendNumbersSMS";
								form1.submit();
							}
							
							function sendSMSStaff() {
								var form1 = document.getElementById("form1");
								form1.action = "/shadaan/SMSProcess/sendStaffSMS";
								form1.submit();
							}
