...
<tr>
					...
					<tr>
							...
							<a href="/Controller?process=SMSProcess/SMSbalanceCheck" title="Click to check SMS balance">SMS Balance</a>
											: ${smsbalance}
							</td>
						</tr>
					...
					<table width="100%" border="0" align="center" id="table1">
						...
						<script type="text/javascript">
							function sendSMSAll() {
								...
								form1.action = "Controller?process=SMSProcess/sendAllSMS";
								form1.submit();
							}
							...
							function sendSMSStaff() {
								var form1 = document.getElementById("form1");
								form1.action = "Controller?process=SMSProcess/sendStaffSMS";
								form1.submit();
							}
