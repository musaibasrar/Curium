...
<script src="/tajacc/js/datePicker/jquery-1.7.1.js"></script>
<script src="/tajacc/js/datePicker/ui/jquery.ui.core.js"></script>
...
<script src="/tajacc/js/datePicker/ui/jquery.ui.tabs.js"></script>
...
<script src="/tajacc/js/validation/jquery.ketchup.all.min.js"></script>
<script type="text/javascript"
...
<tr>
					...
					<tr>
							...
							<a href="/tajacc/SMSProcess/SMSbalanceCheck" title="Click to check SMS balance">SMS Balance</a>
											: ${smsbalance}
							</td>
						</tr>
					...
					<table width="100%" border="0" align="center" id="table1">
						...
						<script type="text/javascript">
							function sendSMSAll() {
								...
								form1.action="/tajacc/SMSProcess/sendAllSMS";
								form1.submit();
							}
							
							function sendSMSNumbers() {
								var form1 = document.getElementById("form1");
								form1.action="/tajacc/SMSProcess/sendNumbersSMS";
								form1.submit();
							}
							
							function sendSMSStaff() {
								var form1 = document.getElementById("form1");
								form1.action="/tajacc/SMSProcess/sendStaffSMS";
								form1.submit();
							}
