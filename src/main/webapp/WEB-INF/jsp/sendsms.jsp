					...
					<table  border="0" style="width: auto;height: auto;"  id="table1">
						...
						<tr>
							...
							<td >
								...
								<br><br>
								<label style="color: red;">Date:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" id="examsvar3"
								 value="<fmt:formatDate type="date" value="${now}" pattern="dd/MM/yyyy"/>" name="examsvar3" maxlength="30">
 ...
 -->
						...
						<script type="text/javascript">
							function sendSMSAll() {
								...
								form1.action = "/littleflower/SMSProcess/sendAllSMS";
								form1.submit();
							}
							
							function sendSMSNumbers() {
								var form1 = document.getElementById("form1");
								form1.action = "/littleflower/SMSProcess/sendNumbersSMS";
								form1.submit();
							}
							
							function sendSMSStaff() {
								var form1 = document.getElementById("form1");
								form1.action = "/littleflower/SMSProcess/sendStaffSMS";
								form1.submit();
							}
