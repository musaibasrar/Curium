					...
					<table  border="0" style="width: auto;height: auto;"  id="table1">
						...
						<tr>
							...
							<td >
								...
								<span style="font-size: 16px;">Dear parents, College will be closed on </span> <span style="font-weight: bold;color: red">Date</span>  <span style="font-size: 16px;">due to</span> <span style="font-weight: bold;color: red">Reason</span>
								<br><br>
 ...
 -->
						...
						<script type="text/javascript">
							function sendSMSAll() {
								...
								form1.action = "/patriswamy/SMSProcess/sendAllSMS";
								form1.submit();
							}
							
							function sendSMSNumbers() {
								var form1 = document.getElementById("form1");
								form1.action = "/patriswamy/SMSProcess/sendNumbersSMS";
								form1.submit();
							}
							
							function sendSMSStaff() {
								var form1 = document.getElementById("form1");
								form1.action = "/patriswamy/SMSProcess/sendStaffSMS";
								form1.submit();
							}
