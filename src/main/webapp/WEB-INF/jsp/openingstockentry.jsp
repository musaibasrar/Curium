...
<script type="text/javascript">
	...
	function saveInventory() {
		...
		if(form1.checkValidity()) {
			form1.action = "/nortuntrading/MessItemsProcess/saveOpeningStock";
			form1.method = "POST";
			form1.submit();
		}
	...
	function cancelPurchase() {
				...
				var form1 = document.getElementById("form1");
				form1.action = "/nortuntrading/MessItemsProcess/cancelPurchase";
				form1.method = "POST";
				form1.submit();
	...
	function calculate(value2) {
          ...
          var gstprice = parseFloat(purchaseprice)+parseFloat(sgstpercentage);
...
<script type="text/javascript">
            ...
            function openPopup(invoicedetailsid,date, supplierrefno, name, invoicetotal){
        			...
        			xmlHttp.open("GET", "/nortuntrading/stockentry/mrvDetails?invoicedetailsid="+invoicedetailsid+"&entrydate="+date+"&supplierreferenceno="+supplierrefno+"&suppliername="+name+"&invoicetotal="+invoicetotal+"",true);
        			xmlHttp.send(null);
...
<body>
	<form id="form1" method="POST">
		...
		<div class="alert-box success" id="div1">Items has been added successfully!!!&nbsp;&nbsp;&nbsp;<button class="button" id="1" onclick="closediv(this.id);">OK</button></div>
		<div class="alert-box failure" id="div2">Items could not be added, please try again!!!&nbsp;&nbsp;&nbsp;<button class="buttonred" id="2" onclick="closediv(this.id);">OK</button></div>
		
		<div style="height: 28px">
			<button id="add">Opening Stock Entry</button>
			<br />
		</div>
