...
<body style="text-align: center" class="bodymargin">
	...
	<form method="post" class="bodymargin">
		...
		<table align="center">
			...
			<tr>
			<td>
			<img border="0" style="vertical-align: text-bottom;height: 86px;width: 100px;" alt="logo" src="/roshan/images/roshan.png">
			</td>
				<td >
					<br>
			...
			<tr>
				...
				<td class="dataTextBoldLeft">
					...
					&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;SATS NO.<span style="font-weight: bold;text-transform: capitalize;width:150px;"> <c:out value="${studentdetailsbonafide.student.sts}" /></span> </h3>
				</td>
			</tr>
			...
			<tr>
				...
				<td class="dataTextBoldLeft">
					...
					<span style="font-weight: bold;text-transform: capitalize;width:400px;border-bottom:0px solid black;">&nbsp;&nbsp;&nbsp;&nbsp;
					&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</span>Headmaster
					</h3>
				</td>
			</tr>
		...
		<TABLE id="dataTable" width="100%" border="0"
			...
			<tr>
              <td align="center"><a id="print" href="/roshan/DocumentsProcess/printStudyCertificate">Print</a></td>
            </tr>
		</TABLE>
	</form>
</body>
