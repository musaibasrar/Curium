...
<body style="text-align: center" class="bodymargin">
	...
	<form method="post" class="bodymargin">
		...
		<table align="center">
			...
			<tr>
			<td>
			<img border="0" style="vertical-align: text-bottom;height: 86px;width: 100px;" alt="logo" src="/littleangels/images/littleangels.png">
			</td>
				<td >
					<br>
		...
		<TABLE id="dataTable" width="100%" border="0"
			...
			<tr>
              <td align="center"><a id="print" href="/littleangels/DocumentsProcess/printStudyCertificate">Print</a></td>
            </tr>
		</TABLE>
	</form>
</body>
