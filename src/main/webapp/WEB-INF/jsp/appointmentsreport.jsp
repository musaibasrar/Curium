...
<script type="text/javascript">
	...
	function generateAppointmentsReport() {
			...
			form1.action = "/brilliantgrammar/AppointmentProcess/generateAppointmentsReport";
			form1.method = "POST";
			form1.submit();
	}
	 ...
	 function exportRecords() {
			var form1 = document.getElementById("form1");
			form1.action = "/brilliantgrammar/AppointmentProcess/exportAppointmentsReport";
			form1.method = "POST";
			form1.submit();
		}
	 ...
	 function printRecords() {
			var form1 = document.getElementById("form1");
			form1.action = "/brilliantgrammar/AppointmentProcess/printAppointmentsReport";
			form1.method = "POST";
			form1.submit();
		}
	 ...
	 var students = [
         <c:forEach varStatus="status" items="${studentList}" var="student">{
             ...
             admissionno:'<c:out default="0" value="${student.name}" />',
             regno:'<c:out default="0" value="${student.name}" />',
...
<body>
	...
	<form id="form1"
				...
				<div id="tabs-1">
					...
					<table style="margin-left: auto;margin-right: auto;">
						...
						<tr>
							...
							<td ><label>
										<input  type="text" name="clientname" id="clientname"  class="myclass" style="width: 220px" /> 
		...
		<div style="overflow: scroll; height: 600px">
			<table width="100%">
				<tr>
					<td class="headerTD">Appointments Report <br>
