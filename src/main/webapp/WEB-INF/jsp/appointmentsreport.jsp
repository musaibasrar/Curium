...
<script type="text/javascript">
	...
	function generateAppointmentsReport() {
			...
			form1.action = "/noble/AppointmentProcess/generateAppointmentsReport";
			form1.method = "POST";
			form1.submit();
	}
	 ...
	 function exportRecords() {
			var form1 = document.getElementById("form1");
			form1.action = "/noble/AppointmentProcess/exportAppointmentsReport";
			form1.method = "POST";
			form1.submit();
		}
	 ...
	 function printRecords() {
			var form1 = document.getElementById("form1");
			form1.action = "/noble/AppointmentProcess/printAppointmentsReport";
			form1.method = "POST";
			form1.submit();
		}
