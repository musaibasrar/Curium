	...
	public void advanceSearch() {
		...
		if (!addSec.equalsIgnoreCase("")) {
			...
			if(!rte.equalsIgnoreCase("")  &&  !querySub.equalsIgnoreCase("") ){
				querySub = querySub + " AND parents.Student.rte = '"+rte+"'";
			}else if(!rte.equalsIgnoreCase("")){
				querySub = querySub + " parents.Student.rte = '"+rte+"'";
			}
			
			if(!contactNumber.equalsIgnoreCase("")  &&  !querySub.equalsIgnoreCase("") ){
				querySub = querySub + " AND parents.contactnumber = '"+contactNumber+"'";
			}else if(!contactNumber.equalsIgnoreCase("")){
				querySub = querySub + " parents.contactnumber = '"+contactNumber+"'";
			}
