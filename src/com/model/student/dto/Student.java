 ...
 */
@Entity
@Table(name = "student", catalog = "school", uniqueConstraints = @UniqueConstraint(columnNames = "studentexternalid"))
public class Student implements java.io.Serializable {
	...
	public Student(String name, String classstudying, String classadmittedin,
			...
			Integer notcissued, Date datetcissued, String guardiandetails) {
		this.name = name;
