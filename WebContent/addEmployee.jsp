					...
					<table width="100%" border="0" align="center" id="table1">
						...
						<tr>
							...
							<td align="left"><label> <input
								...
								<input name="teacherexternalid" value="${teacherexternalid}" type="hidden" id="teacherexternalid">
							</td>
								...
								<table width="100%">
									...
									<tr>
										<td align="center">
											...
											<button id="savep" class="save" name="saveemployee">Save</button>

											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<button  id="cancelp" class="cancel">Cancel</button>
