...
<html>
    <head>
        ...
        <title>Organizers Success</title>
...
%>
    ...
    <table height="462" class="tableCSS"  >
      <tr>
        <td height="250" align="center" valign="middle"><p class="style1">Organizer has been added successfully</p>
        <p class="style1">
        </p></td>
      </tr>
    </table>
