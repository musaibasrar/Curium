			...
			<div id="tabs">
				...
				<div id="fragment-1">
					<table style="width: auto;height: auto;" border="0" align="center" id="table1">
						...
						<tr>
							<td  class="alignLeft" >Was in receipt of <br>any scholarship&nbsp;</td>
							<td>&nbsp;Yes<input
							...
							<td class="alignLeft" style="padding-left: 20px;">Student's adhar Card No.
								&nbsp;</td>
							<td ><label> <input
						...
						<tr>
							<td class="alignLeft" >Whether Vaccinated
								&nbsp;</td>
								<td>&nbsp;Yes<input
							...
							<td  class="alignLeft" style="padding-left: 20px;">Marks of Identification<br> on Pupil's body&nbsp;</td>
							<td ><label> <input
...
<tr>
						...
						<div id="fragment-2">
							<table style="width: auto;height: auto;" border="0" align="center" id="table1">
								...
								<tr>
									<td class="alignLeft">Fathers Occupation
										&nbsp;</td>
									<td><label> <input
									...
									<td class="alignLeft" style="padding-left: 20px;">Mothers Occupation
										&nbsp;</td>
									<td ><label> <input
