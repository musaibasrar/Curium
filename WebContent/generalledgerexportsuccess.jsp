...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="Controller?process=AccountProcess&action=downloadGeneralLedger";
                form1.submit();
            }
        </script>
</head>
...
%>
    ...
    <table height="462" class="tableCSS"  >
      <tr>
        <td height="50" align="center" valign="middle"><p class="style1"> General Ledger has been exported successfully</p>
        </td>
