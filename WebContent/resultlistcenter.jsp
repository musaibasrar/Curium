...
<script type="text/javascript">
	...
	function searchResultList() {
		...
		if(form1.checkValidity()) {
			form1.action = "Controller?process=StudentProcess&action=searchResultList&centervalue=true";
			form1.method = "POST";
			form1.submit();
		  }
	}
...
<body>
	<form id="form1" method="POST">
		...
		<div style="overflow: scroll; height: 600px">
			<table width="100%">
				<tr>
					<td class="headerTD" >Result List</td>
				</tr>
			</table>
				...
				<tfoot>
					<tr>
						...
						<td class="footerTD" colspan="2">
						  <a id="printranklistreport" href="Controller?process=StudentProcess&action=printResultList">Print</a>
						</td>
						<td class="footerTD" colspan="2">
