...
<script type="text/javascript">
	function addDistricts() {
		...
		form1.action = "Controller?process=BranchProcess&action=addDistricts";
		form1.method = "POST";
		form1.submit();
	...
	function updateRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "Controller?process=BranchProcess&action=updateMultiple";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "Controller?process=BranchProcess&action=deleteMultiple";
		form1.method = "POST";
		form1.submit();
...
<body>
	<form id="form1" method="POST">
		...
		<div class="alert-box success">District has been added successfully!!!</div>
		<div class="alert-box failure">Saving Failed, Unable to create new District!!!</div>
		
		<div class="alert-box update">District has been updated successfully!!!</div>
		<div class="alert-box updatefailure">Update Failed, Unable to update District!!!</div>
		...
		<div style="height: 28px">
			<button id="add">Add District</button>
			<br />
		</div>
		...
		<div id="effect" class="ui-widget-content ui-corner-all">
			<div id="tabs">
				<ul>
					<li><a href="#tabs-1">District Details</a></li>
				...
				<div id="tabs-1">
					<table width="100%" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td width="70%"><label> <input id="districtcode"
									name="districtcode" type="text" class="textField" required size="30">
						...
						<tr>
							<td width="10%" class="alignRight">District Name &nbsp;</td>
							<td width="70%"><label> <input id="districtname"
									name="districtname" type="text" class="textField" required size="30">
		...
		<div style="overflow: scroll; height: 600px">
			<table width="100%">
				<tr>
					<td class="headerTD">Districts</td>
				</tr>
			</table>
