        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid">
                     ...
                     <label style="padding-left: 20px;font-weight: bold;">Total Paid :&nbsp;</label><label style="color:#00b000"> &#x20B9; ${sumoffees}</label>
  ...
  <tbody>
					  	...
					  	<c:forEach items="${receiptinfo}" var="receiptinfo">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <td><c:out value="${receiptinfo.date}"/></td>
                                <td style="text-align: right;"><c:out value="MA${receiptinfo.receiptnumber}"/></td>
                                <td style="text-align: right;"><c:out value="${receiptinfo.totalamount}"/></td>
                            </tr>
                        </c:forEach>
  </tbody>
</table>
