...
-->
        ...
        <script type="text/javascript">
            ...
            function downloadFile(){
                ...
                form1.action="Controller?process=StudentProcess&action=downloadImportTemplate";
                form1.submit();
            }
        </script>
</head>
...
%>
    ...
    <table height="462" class="tableCSS"  >
      <tr>
        <td height="50" align="center" valign="middle"><p class="style1"> Click to download the template</p>
        </td>
