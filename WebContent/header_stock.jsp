        ...
        <div style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2); transition: 0.3s;">
                    ...
                    <table width="100%" border="0" cellpadding="2" cellspacing="0" bordercolor="#FFFFFF">
						...
						<tr>
							...
							<td><a target="mainFrame" href="Controller?process=MessItemsMoveProcess&action=issueItems"> <img
									src="images/issuestock.svg" width="18" height="18" 
									alt="Home" style="vertical-align: bottom;font-size: 144px;" />Issue Stock
							</a></td>

							<td style="padding-right: 400px;"><a target="mainFrame"
								href="Controller?process=MessItemsProcess&action=purchaseItems"> <img
									src="images/receivestock.svg" width="18" height="18"
									alt="Fees Collection" style="vertical-align: bottom;" />Receive Stock
							</a></td>
