...
%>
    <body  >
        ...
        <form name="form1" id="form1"action="Controller?process=EmployeeProcess&action=deleteMultipleOrganizers" method="post">
            <div style="overflow: hidden">
                <table width="100%">
                    <tr>
                        <td  class="headerTD">View All Organizers</td>
                    </tr>
                ...
                <table   width="100%"  border="0" style="border-color:#4b6a84;"  id="myTable">
                    ...
                    <tbody>
                        <c:forEach items="${organizersList}" var="organizerslist">
