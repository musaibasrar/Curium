<%-- 
    Document   : Update Attendance Success
    Created on : Aug 02, 2018, 4:11:53 PM
    Author     : Musaib
--%>
...
<html>
    <head>
        ...
        <title>Update Attendance Success</title>
...
%>
    ...
    <table height="462" class="tableCSS"  >
      <tr>
        <td height="250" align="center" valign="middle"><p class="style1"> Attendance Has been updated successfully!!!</p><br>
        <a id="viewattendance" href="Controller?process=AttendanceProcess&action=viewAttendance">View Attendance</a>
        </td>
      </tr>
    </table>
            </form>
