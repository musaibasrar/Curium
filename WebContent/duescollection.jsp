...
<script type="text/javascript">
    ...
    function selectAllRow(tableID){
		...
		<script type="text/javascript">
			...
			function sendSMS() {
				var form1 = document.getElementById("form1");
				form1.action = "Controller?process=SMSProcess&action=dueContributionSendSMS";
				form1.method = "POST";
				form1.submit();
	...
	<form id="form1" action="Controller?process=StudentProcess&action=exportDataForStudents" method="POST">
		...
		<div style="overflow: scroll; height: 600px">
			...
			<table width="100%" border="0" style="border-color: #4b6a84;"
					...
					<c:forEach items="${studentfeesreportlist}" var="studentfeesreportlist">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataText"><c:out
										value="${studentfeesreportlist.student.classadmittedin}" /></td>
				...
				<tfoot>
					<tr>
						<td class="footerTD" colspan="2"><a id="print" >Send Reminder</a>
						  &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
						 <label style="font-size: 12px;color: white;font-weight: bold;">Total Amount: ${TotalSum}</label>
						 &nbsp;&nbsp;&nbsp;
						 <label style="font-size: 12px;color: white;font-weight: bold;">Total Paid Amount : ${TotalPaidAmount} &nbsp;&nbsp;&nbsp; Total Due Amount: ${TotalDueAmount }</label>
						</td>
