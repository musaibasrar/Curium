...
<jsp:useBean id="now" class="java.util.Date" scope="page" />
	<form method="post" class="bodymargin">
			...
			<tr>
				...
				<label class="addressLine">Fateh Complex, Near Gutti Hospital, Ambedkar Circle, <br>Bidar. Ph.No- +91-8197415966</label>
				</td>
			</tr>
			<tr>
			<td></td></tr>
				...
				<td class="namedetails"><label>Father's Name:&nbsp;&nbsp;&nbsp;</label><label style="font-weight: bold;"><c:out value="${Parents.fathersname}"/></label></td>	
                           ...
                           <!-- <tr>
                            ...
                            <table style=" border-collapse: collapse;width: 30%;float: left">
                            	<tr>
                            		<td>
                            			<img src="data:image;base64,<c:out value="${Parents.student.studentpic}"/>" alt="Student's Photo" style="width: 80px;height: 80px;">
                            		</td>
                            	</tr>
