...
<html>
    <head>
        ...
        <title>Special Contribution</title>
    ...
    function saveReceipt(){
    	...
    	if(document.getElementById("dramount").vlaue == 0 || document.getElementById("cramountsecond").value == 0){
        	...
        	if(confirm('Are you sure,you want to save the voucher?')){
        		
        		var form1 = document.getElementById("form1");
                form1.action = "Controller?process=AccountProcess&action=saveFriday";
                form1.submit();	
        	}
    ...
    function saveGuests(){
    	...
    	if(document.getElementById("dramountpayment").vlaue == 0 || document.getElementById("cramountpaymentsecond").value == 0){
        	  ...
        	  if(confirm('Are you sure,you want to save the voucher?')){
        		  ...
        		  var form1 = document.getElementById("form1");
              	  form1.action = "Controller?process=AccountProcess&action=saveGuests";
              	  form1.submit();
    ...
    function saveEvents(){
      ...
      if(accountOne == accountTwo){
    	  ...
    	  var form1 = document.getElementById("form1");
          form1.action = "Controller?process=AccountProcess&action=saveEvents";
          form1.submit();
    	  }
      }
...
%>    
    ...
    <jsp:useBean id="now" class="java.util.Date" scope="page" />
        <form id="form1" method="post" ">
            ...
            <div id="tabs">
				<ul>
					<li><a href="#tabs-1">Friday</a></li>
					<li><a href="#tabs-2">Guests</a></li>
                ...
                <tbody>
	                ...
	                <tr>
                    	<td align="center">
                    	<label style="font-weight: bold;font-size: 20px;color: #EB6000">Friday&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                    	</td>
                    </tr>
    ...
    text-overflow: '';font-weight: bold;color: black;"">
										...
										<c:forEach items="${accountdetailsbalancereceipt}" var="accountdetailsbalance">
											...
											<option  value="${accountdetailsbalance.accountDetails.accountdetailsid}">
												<c:out value="${accountdetailsbalance.currentbalance}" /> 
											</option>
					...
					<td align="center"><label>
									...
									style="width: 240px;"">
										...
										<c:forEach items="${accountdetailsbalanceexbc}" var="accountdetailsbalance">
											...
											<c:if test="${accountdetailsbalance.accountDetails.accountname == 'Friday Contribution'}">
    ...
    text-overflow: '';font-weight: bold;color: black;"">
				...
				<tfoot>
					...
					<tr>
						<td>
						<label style="align-content: space-around;"><b>Narration&nbsp;&nbsp;</b></label>
						
							<label><textarea  name="receiptnarration" style="vertical-align: middle;"
											type="text" class="textField" id="receiptnarration" rows="4" cols="25"
                ...
                <tr>
                    	<td align="center">
                    	<label style="font-weight: bold;font-size: 20px;color: #EB6000">Guests&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                    	</td>
                    </tr>
					...
					<td align="center"><label>
									...
									style="width: 240px;"">
										...
										<c:forEach items="${accountdetailsbalanceexbc}" var="accountdetailsbalance">
											...
											<c:if test="${accountdetailsbalance.accountDetails.accountname == 'Guests Contribution'}">
    ...
    text-overflow: '';font-weight: bold;color: black;"">
                ...
                <tbody>
	                ...
	                <tr>
                    	<td align="center">
                    	<label style="font-weight: bold;font-size: 20px;color: #EB6000">Events&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                    	</td>
                    </tr>
    ...
    text-overflow: '';font-weight: bold;color: black;"">
					...
					<td align="center"><label>
									...
									style="width: 240px;"">
											...
											<c:if test="${accountdetailsbalance.accountDetails.accountname == 'Events Contribution'}">
    ...
    text-overflow: '';font-weight: bold;color: black;">
				...
				<tfoot>
					...
					<tr>
						<td><b>Narration&nbsp;&nbsp;</b>
                        <label><textarea  name="contranarration" style="vertical-align: middle;"
											type="text" class="textField" id="contranarration" rows="4" cols="25"
