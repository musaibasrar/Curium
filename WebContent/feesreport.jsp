								...
								<c:forEach items="${studentfeesreportlist.studentFeesStructure}" var="studentfeescatagorydetails">
									<table>
										<tr>
											...
											<td align="left">
												${studentfeescatagorydetails.feesamount-studentfeescatagorydetails.feespaid - studentfeescatagorydetails.concession}/${studentfeescatagorydetails.feesamount - studentfeescatagorydetails.concession}
											</td>
										</tr>
									</table>
									<c:set var="DueAmount" value="${DueAmount+studentfeescatagorydetails.feesamount-studentfeescatagorydetails.feespaid-studentfeescatagorydetails.concession}" />
									<c:set var="TotalAmount" value="${TotalAmount+studentfeescatagorydetails.feesamount-studentfeescatagorydetails.concession}" />
									
									<c:set var="TotalPaidAmount" value="${TotalPaidAmount+studentfeescatagorydetails.feespaid-studentfeescatagorydetails.concession}" />
									<c:set var="TotalDueAmount" value="${TotalDueAmount+(studentfeescatagorydetails.feesamount-studentfeescatagorydetails.feespaid-studentfeescatagorydetails.concession)}" />
									<c:set var="TotalSum" value="${TotalSum+studentfeescatagorydetails.feesamount-studentfeescatagorydetails.concession}" />
								</c:forEach>
							</td>
							<td class="dataText">
									<table>
