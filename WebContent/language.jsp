...
<script type="text/javascript">
	function addLanguage() {
		...
		form1.action = "Controller?process=LanguageProcess&action=addLanguage";
		form1.method = "POST";
		form1.submit();
	...
	function updateRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "Controller?process=LanguageProcess&action=updateMultipleLanguage";
		form1.method = "POST";
		form1.submit();
	...
	function deleteRecords() {
		var form1 = document.getElementById("form1");
		form1.action = "Controller?process=LanguageProcess&action=deleteMultipleLanguage";
		form1.method = "POST";
		form1.submit();
...
<script type="text/javascript">
					...
					var languagesave='<c:out default="" value="${languagesave}"/>';
		            var languageupdate='<c:out default="" value="${languageupdate}"/>';
		            var languagedelete='<c:out default="" value="${languagedelete}"/>';
		            
		            if(languagesave == "true"){
		            	 $(function(){
		            		 $( "div.success" ).fadeIn( 800 ).delay( 2000 ).fadeOut( 1400 );
		            	 });
		            	 }else if(languagesave == "false"){
		            	  $(function(){
		            		 $( "div.failure" ).fadeIn( 800 ).delay( 2000 ).fadeOut( 1400 );
		            		 });
		            	 }else if(languageupdate == "true"){
		                   	 $(function(){
		                   		 $( "div.update" ).fadeIn( 800 ).delay( 2000 ).fadeOut( 1400 );
		                   	 });
		                   	 }else if(languageupdate == "false"){
		                   	  $(function(){
		                   		 $( "div.updatefailure" ).fadeIn( 800 ).delay( 2000 ).fadeOut( 1400 );
		                   		 });
		                   	 }else if(languagedelete == "true"){
			                   	 $(function(){
			                   		 $( "div.delete" ).fadeIn( 800 ).delay( 2000 ).fadeOut( 1400 );
			                   	 });
			                   	 }else if(languagedelete == "false"){
			                   	  $(function(){
...
<body>
	<form id="form1" method="POST">
		...
		<div class="alert-box success">Language has been added successfully!!!</div>
		<div class="alert-box failure">Saving Failed, Unable to create new Language!!!</div>
		
		<div class="alert-box update">Language has been updated successfully!!!</div>
		<div class="alert-box updatefailure">Update Failed, Unable to update Language!!!</div>
		
		<div class="alert-box delete">Language has been deleted successfully!!!</div>
		<div class="alert-box deletefailure">Deletion Failed, Unable to delete Language!!!</div>
		
		<div style="height: 28px">
			<button id="add">Add Language</button>
			<br />
		</div>
		...
		<div id="effect" class="ui-widget-content ui-corner-all">
			<div id="tabs">
				<ul>
					<li><a href="#tabs-1">Language Details</a></li>
		...
		<div style="overflow: scroll; height: 600px">
			<table width="100%">
				<tr>
					<td class="headerTD">Languages</td>
				</tr>
			</table>
				...
				<thead>
					<tr>
						<th class="headerText"><input type="checkbox" id="chckHead" /></th>
							<th title="click to sort" class="headerText">Languages<img
