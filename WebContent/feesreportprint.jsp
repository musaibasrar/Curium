			...
			<tbody>
					...
					<c:forEach items="${studentfeesreportlist}" var="studentfeesreportlist">
						...
						<tr>
								...
								<td class="datatd" style="font-size: 9px;"><c:out value="${studentfeesreportlist.student.admissionnumber}" /></td>
								<td class="datatd" style="font-size: 9px;"><c:out value="${studentfeesreportlist.student.name}" /></td>
								<td class="datatd" style="font-size: 9px;"><c:out value="${studentfeesreportlist.student.classstudying}" /></td>
