<%--
    Document   : Add Books Info
    Created on : Mar 03, 2021, 10:26:28 AM
    Author     : Musaib
--%>
...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#addBooksInfo").button().click(function() {
			addBooksInfo();
		});
		$("#effect").hide();
		
		$("#deleteBooksInfo").button({
            icons:{
	...
	function addBooksInfo(){
		...
		if(form1.checkValidity()) {
			form1.action = "Controller?process=BooksInfoProcess&action=addBooksInfo";
			form1.method = "POST";
			form1.submit();
		}
	...
	function deleteBooksInfo(){
			form1.action = "Controller?process=BooksInfoProcess&action=deleteBooksInfo";
			form1.method = "POST";
			form1.submit();	
	}
...
<body>
	<form id="form1" method="post">
		...
		<div class="alert-box success" id="div1">${booktitle} has been added successfully!!!&nbsp;&nbsp;&nbsp;<button class="button" id="1" onclick="closediv(this.id);">OK</button></div>
	...
	<div style="height: 28px">
			<button id="add">Add Book Info</button>
			<br />
		</div>
		...
		<div id="effect" class="ui-widget-content ui-corner-all">
			<div id="tabs">
				<ul>
					<li><a href="#tabs-1">Book Details</a></li>
				...
				<div id="tabs-1">
					<table align="center" >
						...
						<tr>
							...
							<td><label> <input name="title" required
									type="text" class="textfieldvalues" id="title" 
									style="font-size: 14px;">

							</label></td>
							<td class="alignRight">&nbsp;&nbsp;&nbsp;&nbsp;Author &nbsp;</td>
							<td><label> <input name="author" required
									type="text" class="textfieldvalues" id="author" 
									style="font-size: 14px;">
					...
					<table id="table2" width="100%" border="0" align="center">
						<tr>
							<td align="center">
								<button id="addBooksInfo">Add</button>
							</td>
						</tr>
					</table>
				</div>
		...
		<table width="100%">
			...
			<table   border="0" style="border-color:#4b6a84;"  id="myTable">
                    ...
                    <tbody>
                        <c:forEach items="${booksinfolist}" var="bookinfo" varStatus="status">
											
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                <td class="dataText"><input type="checkbox" id = "<c:out value="${bookinfo.id}"/>" class = "chcktbl"  name="booksinfoids"  value="<c:out value="${bookinfo.id}"/>"/></td>
                                <td class="dataText" style="text-transform:uppercase">
                                	<c:out value="${bookinfo.title}"/>
                                </td>
                                <td class="dataText" style="text-transform:uppercase">
                                	<c:out value="${bookinfo.author}"/>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
                    <tfoot><tr>
                            <td  class="footerTD" colspan="2" >
                           			<button id="deleteBooksInfo">Delete</button>
                           </td>
                        </tr>
                    </tfoot>
                </table>
