...
<script type="text/javascript">
	...
	function generateQueriesReport() {
			...
			form1.action = "Controller?process=QueryProcess&action=generateQueriesReport";
			form1.method = "POST";
			form1.submit();
	}
	 ...
	 function printRecords() {
			var form1 = document.getElementById("form1");
			form1.action = "Controller?process=QueryProcess&action=printQueriesReport";
			form1.method = "POST";
			form1.submit();
		}
	 ...
	 $(function() {
         $( "#admnno").autocomplete({
             ...
             select: function( event, ui ) {
    			...
    			$( "#admnno").val( ui.item.admissionno );
...
<body>
	...
	<form id="form1"
		...
		<div style="overflow: scroll; height: 600px">
			<table width="100%">
				<tr>
					<td class="headerTD">Queries Report <br>
