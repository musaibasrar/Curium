		...
		<TABLE  width="100%" border="1" style="border-collapse:collapse;">
            ...
            <thead>
					<tr>
						...
						<th title="click to sort" class="datath">Discount</th>
					...
					<c:forEach items="${ordersummarylist}" var="resultlist" varStatus="status">
						<tr>
							...
							<td class="datatdright">
	                 			<c:set var="itemTotal" value="${itemTotal + resultlist.totalafterdiscount}" />
                                <fmt:setLocale value="en_IN" scope="request"/>
								<fmt:formatNumber type="currency"  value="${resultlist.totalafterdiscount}" />
							</td>							
						</tr>
					</c:forEach>
			</tbody>
