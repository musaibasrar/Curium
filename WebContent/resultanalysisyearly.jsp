<%--
    ...
    Created on : Jul 25, 2019, 08:15:28 PM
    Author     : Musaib
--%>
...
<title>Yearly Result Analysis</title>
...
<script type="text/javascript">
	...
	function searchResultAnalysisYearly() {
		var form1 = document.getElementById("form1");
		form1.action = "Controller?process=StudentProcess&action=resultAnalysis";
		form1.method = "POST";
		form1.submit();
	}
...
<body>
	<form id="form1" action="Controller?process=MarksDetailsProcess&action=addMarks" method="POST">
		...
		<div id="effect" class="ui-widget-content ui-corner-all">
			<div id="tabs">
				<ul>
					<li><a href="#tabs-1">Result Analysis</a></li>
