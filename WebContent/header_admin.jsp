                    ...
                    <td valign="top" background="images/h_bg.jpg">
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
                            ...
                            <tr>
                                            ...
                                            <!-- <td width="40" ><div align="center" ><a target="mainFrame" href="Controller?process=FeesProcess&action=feesCollect"><img   src="images/feescollectw.png" width="40" height="40" alt="Fees Collection" title="Fees Collection"/></a><div class="noti_bubbleEmpty"></div><div id="" class="noti_bubbleEmpty"></div></td>
                            				...
                            				<td width="40"><a target="mainFrame" href="Controller?process=AccountProcess&action=createVoucher"><div align="center" align="center"><img  alt="Create Voucher" title="Create Voucher" src="images/voucherw.png" width="30" height="30" /> <div id="" class="noti_bubbleEmpty"></div><div id="" class="noti_bubbleEmpty"></div></a></td>
                            				...
                            				<td><label style="color:white;font-size: 12px;">Add <br>New</label><div class="noti_bubbleEmpty"></div><div id="" class="noti_bubbleEmpty"></div></td>
                           					...
                           					<td width="40"><a target="leftFrame" href="leftsettings.jsp"><div align="center" align="center"><img  alt="Settings" src="images/ssettingsw.png" width="30" height="30" title="settings"/> <div id="" class="noti_bubbleEmpty"></div><div id="" class="noti_bubbleEmpty"></div></a></td>
                                            ...
                                            <td width="40"><a target="mainFrame" href="Controller?process=AdminProcess&action=viewAllExpenses"><div align="center" align="center"><img  alt="Admin Exp" src="images/adexpw.png" width="30" height="30" title="Add Expenses"/> <div id="" class="noti_bubbleEmpty"></div><div id="" class="noti_bubbleEmpty"></div></a></td>
                                            ...
                                            <td width="40" ><div align="center" ><a target="mainFrame" href="sendsms.jsp"><img   src="images/sendsmsw.png" width="30" height="30" alt="Send SMS" title="Send SMS"/></a><div class="noti_bubbleEmpty"></div><div id="" class="noti_bubbleEmpty"></div></td>
                                            ...
                                            <td width="40"><a target="mainFrame" href="Controller?process=StudentProcess&action=viewAllStudentsWithParents"><div align="center" align="center"><img  alt="View All Students" src="images/allusersw.png" width="30" height="30" title="View All Students"/> <div id="" class="noti_bubbleEmpty"></div><div id="" class="noti_bubbleEmpty"></div></a></td>
                                            ...
                                            <td width="40"><a target="mainFrame" href="Controller?process=UserProcess&action=dashBoard"><div align="center" align="center"><img  alt="Dash Board" src="images/dashboardw.png" width="30" height="30" title="Dash Board"/> <div id="" class="noti_bubbleEmpty"></div><div id="" class="noti_bubbleEmpty"></div></a></td>
