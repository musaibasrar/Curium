					...
					<c:forEach items="${paymenttransactions}" var="paymenttransactions">
						...
						<tr class="trClass" style="border-color: #000000" border="1"
							...
							<td class="dataTextInActive"><a class="dataTextInActive"
								href="Controller?process=StudentProcess&action=ViewFeesStructure&id=<c:out value='${paymenttransactions.key.transactionsid}'/>"><c:out
										value="${paymenttransactions.key.transactionsid}" /></a></td>
