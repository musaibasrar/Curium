<%--
    Document   : Books Sales Summary Report
...
<title>Books Sales Summary Report</title>
...
<script type="text/javascript">
	...
	function printSummaryReport() {
		...
		form1.action = "Controller?process=OrderProcess&action=printSalesSummaryReport";
		form1.method = "POST";
		form1.submit();
	}
	...
	$(function() {
	 ...
	 $(function() {
			...
			$("#anim").change(function() {
			 ...
			 $("#generatereport").button({
	             ...
	             generateBooksSalesSummaryReport();
	             return false;
	 ...
	 function generateBooksSalesSummaryReport() {
			var form1 = document.getElementById("form1");
			form1.action = "Controller?process=OrderProcess&action=generateBooksSalesSummaryReport";
			form1.method = "POST";
			form1.submit();
	}
</script>
...
<body>
	...
	<form id="form1" method="POST">
			...
			<div id="tabs">
				...
				<div id="tabs-1">
					...
					<table style="margin-left: auto;margin-right: auto;">
						...
						<tr>
						<td class="alignRight">Order From Date&nbsp;</td>
							...
							<td class="alignRight">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Order To Date&nbsp;</td>
		...
		<div style="overflow: scroll; height: 600px">
			<table width="100%">
				<tr>
					<td class="headerTD">Books Sales Summary Report<br>
			...
			<table   width="100%"  border="0" style="border-color:#4b6a84;"  id="myTable">
                    ...
                    <tbody>
                        ...
                        <c:forEach items="${ordersummarylist}" var="books" varStatus="status">
                            ...
                            <tr class="trClass" style="border-color:#000000" border="1"  cellpadding="1"  cellspacing="1" >
                                ...
                                <c:set var="itemTotal" value="${itemTotal + books.totalafterdiscount}" />
                                <fmt:setLocale value="en_IN" scope="request"/>
								<fmt:formatNumber type="currency"  value="${books.totalafterdiscount}" />
                               </td>
                            </tr>
                        </c:forEach>
                    </tbody>
                    ...
                    <tr>
                     		<td  class="footerTD" >
                           <button id="printsummaryreport">Print</button> 
                           </td>
