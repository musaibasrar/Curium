			...
			<div id="tabs">
				<ul>
					...
					<div id="fragment-0">
							...
							<td width="28%"><label style="color: #325F6D;font-weight: bold;font-size: 15px">&nbsp;&nbsp;&nbsp;&nbsp;Studying in Class&nbsp;</label>
							
							<label> <input
									name="addclass" type="text" class="myclass" id="addclass" size="30"
									>
							</label>
							
							<label> <input
									name="addsec" type="text" class="myclass" id="addsec" size="30"
									>
							</label>
								...
								<td width="16%" height="30" class="alignLeft"><label style="color: #325F6D;font-weight: bold;font-size: 16px">
								&nbsp;&nbsp;&nbsp;&nbsp;Gender &nbsp;&nbsp;</label>
								
								<label> <input
									name="gender" type="text" class="myclass" id="gender" size="30"
									>
							</label>
								</td>
