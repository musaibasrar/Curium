 ...
 <script type="text/javascript">
	...
	<div class="container-fluid">
		<div class="row main-content bg-success text-center">
			...
			<h2 style="font-weight: bold;">Roshan<!-- <img border="0" style="vertical-align: text-bottom;height: 120px;width: 200px;" alt="ideoholic" src="images/shaheenwhitelogo.png"> --></h2><h3> Education Trust (R)</h3></span></span>
