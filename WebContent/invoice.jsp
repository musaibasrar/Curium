    ...
    <body onload="printReceipt()">
       ...
       <%--  <input type="hidden" value="${duplicate}" id="duplicate" name="duplicate"> --%>
            <table  width="100%">
                ...
                <tbody>
                    <tr>
                        <td style="width: 35%">Student Name: <c:out value="${name}" /></td>
                        <td style="width: 20%">Date:  <c:out value="${date}" /></td>
            ...
            <TABLE id="dataTable" width="100%" border="1" >
                ...
                <tbody>
                    <c:forEach items="${feesdetails}" var="feesdetails">
                        <tr>
                            <td align="center"><c:out value="${feesdetails.feescategoryname}" /></td>
                            <td align="center"><c:out value="${feesdetails.amount}" /></td>
                        </tr>
                    </c:forEach>
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <td align="center"><a id="print" href="Controller?process=FeesCollection&action=printInvoice">Print</a></td>
                    </tr>
                </tfoot>
            </TABLE>
