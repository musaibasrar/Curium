...
-->
        ...
        <script type="text/javascript">
            ...
            function search(){
                ...
                form1.action="Controller?process=StudentProcess&action=mainAdvanceSearchStudents";
                form1.submit();
            }
        </script>
</head>
...
%>
    ...
    <table height="462" class="tableCSS"  >
      <tr>
        <td height="50" align="center" valign="middle"><p class="style1"> Appointment scheduled successfully</p>
        </td>
