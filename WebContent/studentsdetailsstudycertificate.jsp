...
<script type="text/javascript">
	function searchStudentsForStudyCertificate() {
		var form1 = document.getElementById("form1");
		form1.action = "Controller?process=DocumentsProcess&action=searchStudentsForStudyCertificate";
		form1.method = "POST";
		form1.submit();
	...
	$(function() {
		...
		$("#search").button().click(function() {
			searchStudentsForStudyCertificate();
		});
...
%>
<body>
	<form id="form1" action="Controller?process=DocumentsProcess&action=generateStudyCertificate" method="POST">
