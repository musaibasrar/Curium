	...
	<form method="post" class="bodymargin">
			...
			<table style="border-collapse: collapse;width: 70%;float: left">
                            ...
                            <tr style="border-color:#000000">
                                <td class="namedetails"><label>Student Name:&nbsp;&nbsp;&nbsp;</label><label style="font-weight: bold;text-transform: uppercase;"><c:out value="${Parents.student.name}"/></label></td>
						    ...
						    ${splt} 
                             ...
                             <tr>   
				<td class="namedetails"><label>Father's Name:&nbsp;&nbsp;&nbsp;</label><label style="font-weight: bold;text-transform: uppercase;"><c:out value="${Parents.fathersname}"/></label></td>	
