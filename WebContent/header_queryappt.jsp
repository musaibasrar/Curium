<%-- 
    Document   : header_queries
    Created on : Dec 22, 2021, 01:55:08 AM
    Author     : Musaib
--%>
    ...
    transition: 0.3s;
        ">
						...
						<tr>
								...
								<a target="mainFrame" href="Controller?process=QueryProcess&action=viewAllQueriesDepartmentWise" ><img src="images/logo.jpg"/></a>
								</td>
								
								<td ><a target="mainFrame"
								href="Controller?process=QueryProcess&action=viewAllQueriesDepartmentWise"><img
									alt="Admin Exp" src="images/reports.svg" width="18" height="18" style="vertical-align: bottom;"/>
									Queries
							</a></td>
													
													
							<td ><a target="mainFrame"
								href="Controller?process=AppointmentProcess&action=viewAllAppointments"><img
									alt="Appointments" src="images/adminexp.svg" width="18" height="18" style="vertical-align: bottom;"/>
									Appointments
							</a></td>															
							...
							<td ><a target="mainFrame" href="sendsms.jsp"><img
								...
								<a target="leftFrame" href="reports.jsp"><img
