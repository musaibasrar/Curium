    ...
    <body onload="printReceipt()">
        ...
        <input type="hidden" value="${duplicate}" id="duplicate" name="duplicate">
            <table  width="100%">
                ...
                <tbody>
                    <tr>
                        <td style="width: 35%">Member Name: <c:out value="${membername}" /></td>
                        <%-- <td style="width: 20%">Admission No:  <c:out value="${student.admissionnumber}" /></td> --%>
                        <td style="width: 20%">Date:  <c:out value="${date}" /></td>
                        <td style="width: 20%">Receipt No:  <c:out value="${vouchernumber}" /></td>
            ...
            <TABLE id="dataTable" width="100%" border="1" >
                ...
                <tbody>
                        <tr>
                            <td align="center"><c:out value="Donation" /></td>
                            <td align="center"><c:out value="${totalamount}" /></td>
                        </tr>
                </tbody>
                <tfoot>
                    ...
                    <tr>
                        ...
                        <td align="center"><a id="print" href="voucherdetailsprint.jsp">Print</a></td>
                    </tr>
                </tfoot>
            </TABLE>
