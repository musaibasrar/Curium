...
<script type="text/javascript">
	...
	function printQuestionPaperSet() {
		var form1 = document.getElementById("form1");
		form1.action = "Controller?process=StudentProcess&action=printQuestionSet";
		form1.method = "POST";
		form1.submit();
	}
	...
	$(function() {
		...
		$("#tabs").tabs();
		 ...
		 $("#printquestionpaperreport").button({
				icons : {
					primary : "ui-icon-print"
				}
			}).click(function() {
				printQuestionPaperSet();
			});
...
<body>
	<form id="form1" action="Controller?process=StudentProcess&action=exportStudentsReport" method="POST">
		<div style="height: 28px">
			<button id="add">Question Paper Set</button>
			<br />
		</div>
		...
		<div id="effect" class="ui-widget-content ui-corner-all">
			<div id="tabs">
				<ul>
					<li><a href="#tabs-1">Question Paper Set</a></li>
