...
<html>
  ...
  <tr>
    ...
    <td><input type="hidden" id="nursery" name="nursery" value="${studentNursery}"/></td>
 ...
 <td></td>
	...
	var lkg = document.getElementById("lkg").value;
	var ukg = document.getElementById("ukg").value;
	...
	var VIII = document.getElementById("VIII").value;
	var IX = document.getElementById("IX").value;
	var X = document.getElementById("X").value;
	var barChartData = {
		labels : ["Nursery - "+nursery,"L.K.G - "+lkg,"U.K.G - "+ukg,"I - "+I,"II - "+II,"III - "+III,"IV - "+IV,"V - "+V,"VI - "+VI,"VII - "+VII,"VIII - "+VIII,"IX - "+IX,"X - "+X],
		datasets : [
			{
				...
				data : [nursery,lkg,ukg,I,II,III,IV,V,VI,VII,VIII,IX,X]
			}
		]
	}
