 ...
 <script type="text/javascript">
	...
	<div class="container-fluid">
		<div class="row main-content bg-success text-center">
			...
			<span class="company__logo"><h2><img border="0" style="vertical-align: text-bottom;height: 140px;width: 160px;" alt="ideoholic" src="images/alilogo.jpg"></h2></span>
			...
			<div class="col-md-8 col-xs-12 col-sm-12 login_form ">
				<div class="container-fluid">
					<div class="row">
						...
						<h2><img border="0" style="vertical-align: text-bottom;height: 80px;width: 110px;" alt="ideoholic" src="images/aliwhite.jpg"></h2>
						<h3>Log In</h3>	
					</div>
					<div class="row">
						<form action="Controller?process=UserProcess&action=authenticateUser"  method="post" class="form-group">
							<div class="row">
