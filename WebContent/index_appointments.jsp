...
%>
    <frameset    rows="55,*"frameborder="0" border="0" framespacing="0"  >
			...
			<frame   src="header_appointments.jsp"   name="topFrame" scrolling="NO" noresize frameborder="0">

            <frameset  cols="*" frameborder="0" border="0" framespacing="0">
                <!-- <frame  src="left_admin.jsp" name="leftFrame" scrolling="yes"  frameborder="1"   /> -->
                <frame src="Controller?process=AppointmentProcess&action=viewAllAppointments" name="mainFrame" scrolling="yes" />
            </frameset>
