	...
	<form method="post" class="bodymargin">
		<table width="100%" style="border-collapse: collapse;">
			<tr>
				...
				<label class="addressLine">Attendance Report</label><br>
				<label class="addressLineTwo">${daterange}
				</label>
				</td>
			</tr>
	</table>
			...
			<tbody>
					...
					<c:forEach items="${StudentDailyAttendanceDate}" var="attendanceList" varStatus="status">
						...
						<tr>
							...
							<td class="datatd" style="font-size: 9px;"><c:out value="${StudentListAttendance[status.index].admissionnumber}" /></td>
							<td class="datatd" style="font-size: 9px;"><c:out value="${StudentListAttendance[status.index].name}" /></td>
							<td class="datatd" style="font-size: 9px;"><c:out value="${StudentListAttendance[status.index].gender}" /></td>
							<td class="datatd" style="font-size: 9px;"><c:out value="${attendanceList.attendancestatus}" /></td>
						</tr>
					</c:forEach>
