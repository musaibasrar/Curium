<%-- 
    Document   : index clerk
    Created on : Feb 08, 2021, 5:42:37 PM
    Author     : Musaib
--%>
...
%>
    <frameset    rows="55,*"frameborder="0" border="0" framespacing="0"  >
			...
			<frame   src="header_clerk.jsp"   name="topFrame" scrolling="NO" noresize frameborder="0">

            <frameset  cols="195,*" frameborder="0" border="0" framespacing="0">
                <frame  src="left_clerk.jsp" name="leftFrame" scrolling="yes"  frameborder="1"   />
