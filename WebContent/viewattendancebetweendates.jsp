...
<script type="text/javascript">
	...
	function searchStudentAttendanceDetailsMonthly() {
		...
		form1.action = "Controller?process=AttendanceProcess&action=searchStudentsAttendanceMonthly";
	...
	function printStudentAttendanceDetails() {
		var form1 = document.getElementById("form1");
		form1.action = "Controller?process=AttendanceProcess&action=printStudentAttendanceDetails";
		form1.method = "POST";
		form1.submit();
		...
		<div id="effect" class="ui-widget-content ui-corner-all">
			<div id="tabs">
				<ul>
					...
					<li style="display: none;"><a href="#tabs-3">Monthly Attendance Graph</a></li>
				</ul>
				<div id="tabs-1">
