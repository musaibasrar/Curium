<%--
    Document   : Result Report Center
    Created on : AUG 27, 2018, 12:14:28 PM
    Author     : Musaib
--%>
...
<title>Result Report Center</title>
...
<script type="text/javascript">
	...
	function searchResultReport() {
		...
		form1.action = "Controller?process=StudentProcess&action=searchResultReportCenter";
		form1.method = "POST";
		form1.submit();
	}
