...
<body>
	...
	<jsp:useBean id="now" class="java.util.Date" scope="page" />
		<div>
			<div id="tabs">
				<ul>
					<li><a href="#fragment-1">Organizer's Details</a></li>
...
<div>
						...
						<script type="text/javascript">
							function addOrganizer() {
								...
								form1.action = "Controller?process=EmployeeProcess&action=addOrganizer";
								form1.submit();
							}
